	...
	// Factory __get__ creates and invokes (NOT: returns) a factory f for one of three curried functions for func
	// Which caller is produced by the factory f depends on what's to the left of the dot
