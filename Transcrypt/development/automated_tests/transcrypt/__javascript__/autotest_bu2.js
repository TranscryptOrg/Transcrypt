...
function autotest () {
	...
	var object = __all__.__class__ ('object', [], {
		...
		// Could this be done with a global function?
		...
		'properties', {
			__all__: {
				...
				__init__: function (__all__) {
					...
					// unless maybe the property function is inheritec

					Object.defineProperty (A, 'x', temp)	// temp [3][5] e.g.
					This is part of the recursion.
