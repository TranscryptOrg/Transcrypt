"use strict";
// Transcrypt'ed from Python, 2016-01-20 14:38:12
function autotest () {
	var __all__ = {};
				...
				__init__: function (__all__) {
					var Exception = __class__ ('Exception', [object], {
						get __init__ () {return __get__ (this, function () {
							var args = [] .slice.apply (arguments) .slice (0);
							self.args = args;
						});},
						get __repr__ () {return __get__ (this, function () {
							var args = [] .slice.apply (arguments) .slice (0);
							if (len (args) > 1) {
						...
						get __str__ () {return __get__ (this, function () {
							var args = [] .slice.apply (arguments) .slice (0);
							if (len (args) > 1) {
