'use strict';function pong(){function Q(k,l,p){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof p&&(p=1);if(0<p&&k>=l||0>p&&k<=l)return[];for(var g=[];0<p?k<l:k>l;k+=p)g.push(k);return g}function U(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=k[p]);return l}function V(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=V(k[p]));return l}function x(k){k=k?[].slice.apply(k):[];k.__class__=x;return k}function y(k){k=
k?[].slice.apply(k):[];k.__class__=y;return k}function J(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=J;return l}function W(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var p=0;p<k.length;p++)l[pair[0]]=pair[1];l.__class__=R;l.keys=W;return l}function K(k){return new String(k)}var n={},H=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,m=0;m<l.length;m++){if(!k.hasOwnProperty(l[m])){g=m;break}k=
k[l[m]]}for(m=g;m<l.length;m++)k[l[m]]={},k=k[l[m]]}for(var c in p)k[c]=p[c]};n.__nest__=H;var O=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};n.__init__=O;var r=function(k,l){return k?k.hasOwnProperty("__class__")?function(p){p=[].slice.apply(arguments);return l.apply(null,[k].concat(p))}:l:l};n.__get__=r;var D=function(k,l,p){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},m=l.length-1;0<=m;m--){var c=l[m],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,
h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in p)d=Object.getOwnPropertyDescriptor(p,h),Object.defineProperty(g,h,d);return g};n.__class__=D;var L=n.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});n.object=L;n.__pragma__=function(){};H(n,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=
D("__Envir__",[L],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="0.0.49";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});H(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",[L],{get __init__(){return r(this,function(g){var m=y([].slice.apply(arguments).slice(1));g.args=m})},get __repr__(){return r(this,function(g){return M(g.args)?"{}{}".format(g.__class__.__name__,X(y(g.args))):
"???"})},get __str__(){return r(this,function(g){return 1<M(g.args)?K(y(g.args)):M(g.args)?K(g.args[0]):"???"})}}),p=function(g,m,c){if("undefined"==typeof m||null!=m&&m.__class__==t)m=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":m=h[d];break;case "reverse":c=h[d]}}}console.log(111,c);m?g.sort(function(a,b){if(arguments.length){var f=
arguments.length-1;if(arguments[f]&&arguments[f].__class__==t){var f=arguments[f--],e;for(e in f)switch(e){case "a":a=f[e];break;case "b":b=f[e]}}}return m(a)>m(b)}):g.sort();c&&g.reverse()};k.Exception=l;k.sort=p;k.sorted=function(g,m,c){if("undefined"==typeof m||null!=m&&m.__class__==t)m=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=
h[d];break;case "key":m=h[d];break;case "reverse":c=h[d]}}}d=U(g);p(d,m,c);return d}}}});H(n,"",O(n.org.transcrypt.__base__));var Y=n.__envir__;H(n,"",O(n.org.transcrypt.__standard__));Y.executorName=Y.transpilerName;n.main={__file__:""};n.__except__=null;var t=function(k){t.__name__="__kwargdict__";k.__class__=t;k.constructor=Object;return k};n.___kwargdict__=t;n.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];for(g in l)p[g]=l[g];return p};var Z=function(){console.log([].slice.apply(arguments).join(" "))};
n.print=Z;console.log.apply=function(){Z([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};n.__in__=F;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==k};n.__specialattrib__=S;var M=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};n.len=M;var aa={__name__:"bool"};n.bool=aa;var ba={__name__:"int"};n.int=ba;var ca={__name__:"float"};n.float=ca;n.type=function(k){try{return k.__class__}catch(p){var l=
typeof k;return"boolean"==l?aa:"number"==l?0==k%1?ba:ca:l}};n.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var m=0;m<g.__bases__.length;m++)if(p(g.__bases__[m],l))return!0;return!1}return p(k.__class__)};var X=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",p=!1,g;for(g in k)if(!S(g)){var m=g.isnumeric()?g:"'"+g+"'";p?l+=", ":p=!0;try{l+=m+": "+k[g].__repr__()}catch(d){l+=m+": "+k[g].toString()}}return l+"}"}return"boolean"==
typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};n.repr=X;n.chr=function(k){return String.fromCharCode(k)};var N=function(k){return k.charCodeAt(0)};n.org=N;var P=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,p){return k.length<p.length?k:p})).map(function(l,p){return k.map(function(g){return g[p]})})};n.zip=P;n.range=Q;n.enumerate=function(k){return P(Q(M(k)),
k)};n.copy=U;n.deepcopy=V;n.list=x;Array.prototype.__class__=x;x.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=p)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==J&&!this.length)return"set()";for(var k=this.__class__&&this.__class__!=x?this.__class__==y?"(":"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(p){k+=this[l].toString()}}this.__class__==
y&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=x?this.__class__==y?")":"}":"]"};Array.prototype.__setslice__=function(k,l,p,g){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==p)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var m=0;k<l;k+=p)this[k]=g[m++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=
function(k){this.push.apply(this,k)};n.tuple=y;y.__name__="tuple";n.set=J;J.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};n.__keys__=W;n.dict=R;R.__name__="dict";n.str=K;String.prototype.__class__=K;K.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=
function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(k){return""==k||this.slice(-k.length)==k};String.prototype.find=function(k,l){return this.indexOf(k,l)};String.prototype.format=function(){var k=arguments,l=0;return this.replace(/\{(\w*)\}/g,function(p,g){""==g&&(g=l++);if(g==+g)return"undefined"==k[g]?p:k[g];for(var m=0;m<k.length;m++)if("object"==typeof k[m]&&"undefined"!=typeof k[m][g])return k[m][g];return p})};String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&
isFinite(this)};String.prototype.join=function(k){return k.join(this)};String.prototype.jsSplit=String.prototype.split;String.prototype.lower=function(){return this.toLowerCase()};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(k,l){return this.lastIndexOf(k,l)};String.prototype.rsplit=function(k,l){var p=this.split(k||/s+/);return l?[p.slice(0,-l).join(k)].concat(p.slice(-l)):p};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};
String.prototype.split=function(k,l){k||(k=" ");return this.jsSplit(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};H(n,"org.transcrypt.fabric",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k={},g=g||{version:"1.5.0"};"undefined"!==typeof k&&(k.fabric=g);"undefined"!==typeof document&&"undefined"!==typeof window?(g.document=document,
g.window=window,window.fabric=g):(g.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),g.window=g.document.createWindow?g.document.createWindow():g.document.parentWindow);g.isTouchSupported="ontouchstart"in g.document.documentElement;g.isLikelyNode="undefined"!==typeof Buffer&&"undefined"===typeof window;g.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");
g.DPI=96;g.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function m(a,b){this.__eventListeners[a]&&(b?g.util.removeFromArray(this.__eventListeners[a],b):this.__eventListeners[a].length=0)}function c(a,b){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var f in a)this.on(f,a[f]);else this.__eventListeners[a]||(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function h(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners=
{};else if(1===arguments.length&&"object"===typeof arguments[0])for(var f in a)m.call(this,f,a[f]);else m.call(this,a,b);return this}}function d(a,b){if(this.__eventListeners){var f=this.__eventListeners[a];if(f){for(var e=0,d=f.length;e<d;e++)f[e].call(this,b||{});return this}}}g.Observable={observe:c,stopObserving:h,fire:d,on:c,off:h,trigger:d}})();g.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var g=0,c=arguments.length;g<c;g++)this._onObjectAdded(arguments[g]);
...
h[d],d,h);return this},getObjects:function(g){return"undefined"===typeof g?this._objects:this._objects.filter(function(c){return c.type===g})},item:function(g){return this.getObjects()[g]},isEmpty:function(){return 0===this.getObjects().length},size:function(){return this.getObjects().length},contains:function(g){return-1<this.getObjects().indexOf(g)},complexity:function(){return this.getObjects().reduce(function(g,c){return g+=c.complexity?c.complexity():0},0)}};(function(m){var c=Math.sqrt,h=Math.atan2,
...
4);return d}}})("undefined"!==typeof k?k:this);(function(){function m(f,b,d,g,m,k,da){var T=e.call(arguments);if(a[T])return a[T];var A=Math.PI,l=da*A/180,G=Math.sin(l),l=Math.cos(l),p=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-l*f*.5-G*b*.5,n=-l*b*.5+G*f*.5,r=d*d,w=g*g,E=n*n,u=z*z,t=r*w-r*E-w*u,x=0;0>t?(r=Math.sqrt(1-t/(r*w)),d*=r,g*=r):x=(m===k?-1:1)*Math.sqrt(t/(r*E+w*u));E=x*d*n/g;u=-x*g*z/d;x=l*E-G*u+.5*f;r=G*E+l*u+.5*b;w=h(1,0,(z-E)/d,(n-u)/g);n=h((z-E)/d,(n-u)/g,(-z-E)/d,(-n-u)/g);0===k&&0<n?
n-=2*A:1===k&&0>n&&(n+=2*A);A=Math.ceil(Math.abs(n/A*2));z=[];n/=A;E=8/3*Math.sin(n/4)*Math.sin(n/4)/Math.sin(n/2);u=w+n;for(t=0;t<A;t++)z[t]=c(w,u,l,G,d,g,x,r,E,p,C),p=z[t][4],C=z[t][5],w=u,u+=n;return a[T]=z}function c(f,a,d,c,h,g,m,k,A,l,G){var n=e.call(arguments);if(b[n])return b[n];var p=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),w=d*h*r-c*g*t+m,x=c*h*r+d*g*t+k;b[n]=[l+A*(-d*h*z-c*g*p),G+A*(-c*h*z+d*g*p),w+A*(d*h*t+c*g*r),x+A*(c*h*t-d*g*r),w,x];return b[n]}function h(f,e,a,b){f=Math.atan2(e,
f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,m,k){var A=e.call(arguments);if(f[A])return f[A];var l=Math.sqrt,n=Math.min,p=Math.max,C=Math.abs,z=[],r=[[],[]],t,w,x,u,y;w=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*m;x=3*d-3*a;for(var D=0;2>D;++D)0<D&&(w=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*k,x=3*c-3*b),1E-12>C(t)?1E-12>C(w)||(u=-x/w,0<u&&1>u&&z.push(u)):(u=w*w-4*x*t,0>u||(y=l(u),u=(-w+y)/(2*t),0<u&&1>u&&z.push(u),u=(-w-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=l=z.length;l--;)u=z[l],w=1-u,t=
w*w*w*a+3*w*w*u*d+3*w*u*u*h+u*u*u*m,r[0][l]=t,t=w*w*w*b+3*w*w*u*c+3*w*u*u*g+u*u*u*k,r[1][l]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=m;r[1][C+1]=k;n=[{x:n.apply(null,r[0]),y:n.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];return f[A]=n}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=m(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+
e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,k,A){var l=0,n=0,p=[],C=[];a=m(k-f,A-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)p=d(l,n,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],a[c][5]),b[0].x=p[0].x+f,b[0].y=p[0].y+e,b[1].x=p[1].x+f,b[1].y=p[1].y+e,C.push(b[0]),C.push(b[1]),l=a[c][4],n=a[c][5];return C};g.util.getBoundsOfCurve=d})();(function(){function m(c,d,a){if(c&&0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&
...
Function.prototype.bind||(Function.prototype.bind=function(d){var a=this,b=g.call(arguments,1),f;f=b.length?function(){return c.call(a,this instanceof h?this:d,b.concat(g.call(arguments)))}:function(){return c.call(a,this instanceof h?this:d,arguments)};h.prototype=this.prototype;f.prototype=new h;return f})})();(function(){function m(){}function c(f){var e=this.constructor.superclass.prototype[f];return 1<arguments.length?e.apply(this,h.call(arguments,1)):e.call(this)}var h=Array.prototype.slice,
...
e.toString),e.valueOf!==Object.prototype.valueOf&&(f.prototype.valueOf=e.valueOf))};g.util.createClass=function(){function f(){this.initialize.apply(this,arguments)}var e=null,a=h.call(arguments,0);"function"===typeof a[0]&&(e=a.shift());f.superclass=e;f.subclasses=[];e&&(m.prototype=e.prototype,f.prototype=new m,e.subclasses.push(f));for(var g=0,B=a.length;g<B;g++)b(f,a[g],e);f.prototype.initialize||(f.prototype.initialize=d);f.prototype.constructor=f;f.prototype.callSuper=c;return f}})();(function(){function m(f){var e=
...
0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=m(g.document.documentElement,"addEventListener","removeEventListener")&&m(g.window,"addEventListener","removeEventListener"),q=m(g.document.documentElement,"attachEvent","detachEvent")&&m(g.window,"attachEvent","detachEvent"),v={},B={};e?(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,
...
B[e][a]){a=B[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var k=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(k=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:
null),e);return{x:k(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var m=g.document.createElement("div"),c="string"===typeof m.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof m.style.opacity?d=function(a,b){a.style.opacity=b;return a}:c&&(d=function(a,b){var f=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&(f.zoom=1);h.test(f.filter)?f.filter=f.filter.replace(h,.9999<=b?"":"alpha(opacity="+100*b+")"):f.filter+=
" alpha(opacity="+100*b+")";return a});g.util.setStyle=function(a,b){var f=a.style;if(!f)return a;if("string"===typeof b)return a.style.cssText+=";"+b,-1<b.indexOf("opacity")?d(a,b.match(/opacity:\s*(\d?\.?\d*)/)[1]):a;for(var e in b)"opacity"===e?d(a,b[e]):f["float"===e||"cssFloat"===e?"undefined"===typeof f.styleFloat?"cssFloat":"styleFloat":e]=b[e];return a}})();(function(){function m(a,f){var e=g.document.createElement(a),d;for(d in f)"class"===d?e.className=f[d]:"for"===d?e.htmlFor=f[d]:e.setAttribute(d,
...
d;g.util.makeElement=m;g.util.addClass=function(a,f){a&&-1===(" "+a.className+" ").indexOf(" "+f+" ")&&(a.className+=(a.className?" ":"")+f)};g.util.wrapElement=function(a,f,e){"string"===typeof f&&(f=m(f,e));a.parentNode&&a.parentNode.replaceChild(f,a);f.appendChild(a);return f};g.util.getScrollLeftTop=function(a,f){var e,d,c=0,h=0,m=g.document.documentElement,k=g.document.body||{scrollLeft:0,scrollTop:0};for(d=a;a&&a.parentNode&&!e;)a=a.parentNode,1===a.nodeType&&"fixed"===g.util.getElementStyle(a,
"position")&&(e=a),1===a.nodeType&&d!==f&&"absolute"===g.util.getElementStyle(a,"position")?h=c=0:a===g.document?(c=k.scrollLeft||m.scrollLeft||0,h=k.scrollTop||m.scrollTop||0):(c+=a.scrollLeft||0,h+=a.scrollTop||0);return{left:c,top:h}};g.util.getElementOffset=function(b){var f;f=b&&b.ownerDocument;var e={left:0,top:0},d={left:0,top:0},c={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!f)return{left:0,top:0};for(var h in c)d[c[h]]+=parseInt(a(b,h),10)||0;f=f.documentElement;
"undefined"!==typeof b.getBoundingClientRect&&(e=b.getBoundingClientRect());b=g.util.getScrollLeftTop(b,null);return{left:e.left+b.left-(f.clientLeft||0)+d.left,top:e.top+b.top-(f.clientTop||0)+d.top}};g.util.getElementStyle=a})();(function(){function m(d,a){return d+(/\?/.test(d)?"&":"?")+a}function c(){}var h=function(){for(var d=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},
function(){return new XMLHttpRequest}],a=d.length;a--;)try{if(d[a]())return d[a]}catch(b){}}();g.util.request=function(d,a){a||(a={});var b=a.method?a.method.toUpperCase():"GET",f=a.onComplete||function(){},e=h(),q;e.onreadystatechange=function(){4===e.readyState&&(f(e),e.onreadystatechange=c)};"GET"===b&&(q=null,"string"===typeof a.parameters&&(d=m(d,a.parameters)));e.open(b,d,!0);"POST"!==b&&"PUT"!==b||e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(q);return e}})();
g.log=function(){};g.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(m){"undefined"!==typeof console[m]&&"function"===typeof console[m].apply&&(g[m]=function(){return console[m].apply(console,arguments)})});(function(g){function c(c,d){this.x=c;this.y=d}g=g.fabric||(g.fabric={});g.Point?g.warn("fabric.Point is already defined"):(g.Point=c,c.prototype={constructor:c,add:function(h){return new c(this.x+h.x,this.y+h.y)},addEquals:function(c){this.x+=c.x;this.y+=c.y;return this},
...
b);this._setObjectScale(f,b,c,h,a,k);d.setPositionByOrigin(m,b.originX,b.originY)}},_setObjectScale:function(f,e,a,b,d,c){var h=e.target,g=!1,k=!1,m=h.stroke?h.strokeWidth:0;e.newScaleX=f.x/(h.width+m/2);e.newScaleY=f.y/(h.height+m/2);c&&0>=e.newScaleX&&e.newScaleX<h.scaleX&&(g=!0);c&&0>=e.newScaleY&&e.newScaleY<h.scaleY&&(k=!0);"equally"!==d||a||b?d?"x"!==d||h.get("lockUniScaling")?"y"!==d||h.get("lockUniScaling")||k||b||h.set("scaleY",e.newScaleY):g||a||h.set("scaleX",e.newScaleX):(g||a||h.set("scaleX",
...
return k},__getCroppedCanvas:function(k,c){var h,d;if("left"in c||"top"in c||"width"in c||"height"in c)h=g.util.createCanvasElement(),d=h.getContext("2d"),h.width=c.width||this.width,h.height=c.height||this.height,d.drawImage(k,-c.left||0,-c.top||0);return h},__toDataURLWithMultiplier:function(g,c,h,d){var a=this.getWidth(),b=this.getHeight(),f=a*d,e=b*d,q=this.getActiveObject(),v=this.getActiveGroup(),k=this.contextTop||this.contextContainer;1<d&&this.setWidth(f).setHeight(e);k.scale(d,d);h.left&&
(h.left*=d);h.top&&(h.top*=d);h.width?h.width*=d:1>d&&(h.width=f);h.height?h.height*=d:1>d&&(h.height=e);v?this._tempRemoveBordersControlsFromGroup(v):q&&this.deactivateAll&&this.deactivateAll();this.renderAll(!0);g=this.__toDataURL(g,c,h);this.width=a;this.height=b;k.scale(1/d,1/d);this.setWidth(a).setHeight(b);v?this._restoreBordersControlsOnGroup(v):q&&this.setActiveObject&&this.setActiveObject(q);this.contextTop&&this.clearContext(this.contextTop);this.renderAll();return g},toDataURLWithMultiplier:function(g,
...
v=this.getCenterPoint(),f=new g.Point(b,f),v=new g.Point(v.x-q,v.y-e),e=new g.Point(v.x+f.x*c,v.y+f.x*a),b=d(new g.Point(v.x-f.y*a,v.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(v),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),v=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),B=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),I=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(v.x+a*this.rotatingPointOffset,v.y-c*this.rotatingPointOffset);this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:v,mr:B,mb:I,mtr:a};this._setCornerCoords&&
