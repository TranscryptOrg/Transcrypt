'use strict';function pong(){function Q(k,l,p){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof p&&(p=1);if(0<p&&k>=l||0>p&&k<=l)return[];for(var g=[];0<p?k<l:k>l;k+=p)g.push(k);return g}function V(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=k[p]);return l}function W(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=W(k[p]));return l}function y(k){k=k?[].slice.apply(k):[];k.__class__=y;return k}function v(k){k=
k?[].slice.apply(k):[];k.__class__=v;return k}function H(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=H;return l}function X(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var p=0;p<k.length;p++){var g=k[p];l[g[0]]=g[1]}l.__class__=R;l.py_keys=X;return l}function I(k){return new String(k)}var m={},G=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;
break}k=k[l[n]]}for(n=g;n<l.length;n++)k[l[n]]={},k=k[l[n]]}for(var c in p)k[c]=p[c]};m.__nest__=G;var N=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};m.__init__=N;var r=function(k,l,p){return k&&(k.hasOwnProperty("__class__")||"string"==typeof k||k instanceof String)?(p&&Object.defineProperty(k,p,{value:function(){var g=[].slice.apply(arguments);return l.apply(null,[k].concat(g))},writable:!0,enumerable:!0,configurable:!0}),function(){var g=[].slice.apply(arguments);return l.apply(null,
...
{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});m.object=J;m.__pragma__=function(){};G(m,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[J],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.84";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});G(m,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",
[J],{get __init__(){return r(this,function(g){var n=v([].slice.apply(arguments).slice(1));g.args=n})},get __repr__(){return r(this,function(g){return K(g.args)?"{}{}".format(g.__class__.__name__,Y(v(g.args))):"???"})},get __str__(){return r(this,function(g){return 1<K(g.args)?I(v(g.args)):K(g.args)?I(g.args[0]):"???"})}}),p=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&
arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}n?g.sort(function(a,b){if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].__class__==t){var f=arguments[f--],e;for(e in f)switch(e){case "a":a=f[e];break;case "b":b=f[e]}}}return n(a)>n(b)}):g.sort();c&&g.reverse()};k.Exception=l;k.__sort__=p;k.sorted=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==
typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=V(g);p(d,n,c);return d}}}});G(m,"",N(m.org.transcrypt.__base__));var Z=m.__envir__;G(m,"",N(m.org.transcrypt.__standard__));var da=m.__sort__;Z.executorName=Z.transpilerName;m.main={__file__:""};m.__except__=null;var t=function(k){k.__class__=t;k.constructor=
Object;return k};m.___kwargdict__=t;m.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};m.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];for(g in l)p[g]=l[g];return p};var aa=function(){console.log([].slice.apply(arguments).join(" "))};m.print=aa;console.log.apply=function(){aa([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};m.__in__=F;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==
k||k.startswith("py_")};m.__specialattrib__=S;var K=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};m.len=K;var ba={__name__:"bool"};m.bool=ba;var T=function(k){return k|0};T.__name__="int";m.int=T;var ca={__name__:"float"};m.float=ca;m.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?ba:"number"==l?0==k%1?T:ca:l}};m.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var n=0;n<g.__bases__.length;n++)if(p(g.__bases__[n],
l))return!0;return!1}return p(k.__class__)};var Y=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",p=!1,g;for(g in k)if(!S(g)){var n=g.isnumeric()?g:"'"+g+"'";p?l+=", ":p=!0;try{l+=n+": "+k[g].__repr__()}catch(d){l+=n+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};m.repr=Y;m.chr=
function(k){return String.fromCharCode(k)};var L=function(k){return k.charCodeAt(0)};m.org=L;var O=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,p){return k.length<p.length?k:p})).map(function(l,p){return k.map(function(g){return g[p]})})};m.zip=O;m.range=Q;m.enumerate=function(k){return O(Q(K(k)),k)};m.copy=V;m.deepcopy=W;m.list=y;Array.prototype.__class__=y;y.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:
...
1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==p)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var n=0;k<l;k+=p)this[k]=g[n++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};Array.prototype.py_sort=function(){da.apply(null,[this].concat([].slice.apply(arguments)))};m.tuple=v;v.__name__="tuple";m.set=H;
H.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};m.__keys__=X;m.dict=R;R.__name__="dict";m.str=I;String.prototype.__class__=I;I.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};
...
e.toString),e.valueOf!==Object.prototype.valueOf&&(f.prototype.valueOf=e.valueOf))};g.util.createClass=function(){function f(){this.initialize.apply(this,arguments)}var e=null,a=h.call(arguments,0);"function"===typeof a[0]&&(e=a.shift());f.superclass=e;f.subclasses=[];e&&(k.prototype=e.prototype,f.prototype=new k,e.subclasses.push(f));for(var g=0,A=a.length;g<A;g++)b(f,a[g],e);f.prototype.initialize||(f.prototype.initialize=d);f.prototype.constructor=f;f.prototype.callSuper=c;return f}})();(function(){function k(f){var e=
...
A[e][a]){a=A[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var P=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(P=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:
null),e);return{x:P(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var k=g.document.createElement("div"),c="string"===typeof k.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof k.style.opacity?d=function(a,b){a.style.opacity=b;return a}:c&&(d=function(a,b){var f=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&(f.zoom=1);h.test(f.filter)?f.filter=f.filter.replace(h,.9999<=b?"":"alpha(opacity="+100*b+")"):f.filter+=
...
x=this.getCenterPoint(),f=new g.Point(b,f),x=new g.Point(x.x-q,x.y-e),e=new g.Point(x.x+f.x*c,x.y+f.x*a),b=d(new g.Point(x.x-f.y*a,x.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(x),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),x=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),A=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),P=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(x.x+a*this.rotatingPointOffset,x.y-c*this.rotatingPointOffset);this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:x,mr:A,mb:P,mtr:a};this._setCornerCoords&&
...
b.nameShift=75;b.hintShift=25;var l=D("Game",[J],{get __init__(){return r(this,function(c){c.serviceIndex=.5<Math.random()?1:0;c.pause=!0;c.keySet=H();c.canvas=new k.Canvas("canvas",{backgroundColor:"black",originX:"center",originY:"center"});c.canvas.onWindowResise=c.resize;c.canvas.onWindowDraw=c.draw;c.canvas.lineWidth=2;c.canvas.clear();c.attributes=y([]);for(var f=[],g=Q(2),h=0;h<g.length;h++)f.append(d(c,g[h]));c.paddles=f;c.ball=a(c);c.scoreboard=b(c);window.setInterval(c.update,10);window.setInterval(c.draw,
