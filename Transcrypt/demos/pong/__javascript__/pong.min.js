...
k?[].slice.apply(k):[];k.__class__=y;return k}function I(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=I;return l}function W(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var p=0;p<k.length;p++)l[pair[0]]=pair[1];l.__class__=R;l.keys=W;return l}function J(k){return new String(k)}var n={},G=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,m=0;m<l.length;m++){if(!k.hasOwnProperty(l[m])){g=m;break}k=
k[l[m]]}for(m=g;m<l.length;m++)k[l[m]]={},k=k[l[m]]}for(var c in p)k[c]=p[c]};n.__nest__=G;var O=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};n.__init__=O;var r=function(k,l){return k?k.hasOwnProperty("__class__")?function(p){p=[].slice.apply(arguments);return l.apply(null,[k].concat(p))}:l:l};n.__get__=r;var D=function(k,l,p){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},m=l.length-1;0<=m;m--){var c=l[m],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,
h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in p)d=Object.getOwnPropertyDescriptor(p,h),Object.defineProperty(g,h,d);return g};n.__class__=D;var K=n.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});n.object=K;n.__pragma__=function(){};G(n,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=
D("__Envir__",[K],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="0.0.56";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});G(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",[K],{get __init__(){return r(this,function(g){var m=y([].slice.apply(arguments).slice(1));g.args=m})},get __repr__(){return r(this,function(g){return L(g.args)?"{}{}".format(g.__class__.__name__,X(y(g.args))):
"???"})},get __str__(){return r(this,function(g){return 1<L(g.args)?J(y(g.args)):L(g.args)?J(g.args[0]):"???"})}}),p=function(g,m,c){if("undefined"==typeof m||null!=m&&m.__class__==t)m=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":m=h[d];break;case "reverse":c=h[d]}}}m?g.sort(function(a,b){if(arguments.length){var f=
...
h[d];break;case "key":m=h[d];break;case "reverse":c=h[d]}}}d=U(g);p(d,m,c);return d}}}});G(n,"",O(n.org.transcrypt.__base__));var Y=n.__envir__;G(n,"",O(n.org.transcrypt.__standard__));Y.executorName=Y.transpilerName;n.main={__file__:""};n.__except__=null;var t=function(k){k.__class__=t;k.constructor=Object;return k};n.___kwargdict__=t;n.propdesc=null;n.property=function(k,l){var p=this;return{__class__:null,get:function(){return cls.getter(p)},set:function(g){cls.setter(p,g)},enumerable:!0}};n.__merge__=
function(k,l){var p={},g;for(g in k)p[g]=k[g];for(g in l)p[g]=l[g];return p};var Z=function(){console.log([].slice.apply(arguments).join(" "))};n.print=Z;console.log.apply=function(){Z([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};n.__in__=F;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==k};n.__specialattrib__=S;var L=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};n.len=L;var aa=
{__name__:"bool"};n.bool=aa;var ba={__name__:"int"};n.int=ba;var ca={__name__:"float"};n.float=ca;n.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?aa:"number"==l?0==k%1?ba:ca:l}};n.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var m=0;m<g.__bases__.length;m++)if(p(g.__bases__[m],l))return!0;return!1}return p(k.__class__)};var X=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",p=!1,
g;for(g in k)if(!S(g)){var m=g.isnumeric()?g:"'"+g+"'";p?l+=", ":p=!0;try{l+=m+": "+k[g].__repr__()}catch(d){l+=m+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};n.repr=X;n.chr=function(k){return String.fromCharCode(k)};var M=function(k){return k.charCodeAt(0)};n.org=M;var P=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,
p){return k.length<p.length?k:p})).map(function(l,p){return k.map(function(g){return g[p]})})};n.zip=P;n.range=Q;n.enumerate=function(k){return P(Q(L(k)),k)};n.copy=U;n.deepcopy=V;n.list=x;Array.prototype.__class__=x;x.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=p)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==I&&!this.length)return"set()";for(var k=this.__class__&&
...
Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};n.tuple=y;y.__name__="tuple";n.set=I;I.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};n.__keys__=W;n.dict=R;R.__name__="dict";n.str=J;String.prototype.__class__=J;J.__name__="str";String.prototype.__repr__=
function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(k){return""==k||this.slice(-k.length)==k};String.prototype.find=function(k,l){return this.indexOf(k,l)};String.prototype.format=function(){var k=arguments,l=0;return this.replace(/\{(\w*)\}/g,function(p,g){""==g&&(g=l++);if(g==+g)return"undefined"==
k[g]?p:k[g];for(var m=0;m<k.length;m++)if("object"==typeof k[m]&&"undefined"!=typeof k[m][g])return k[m][g];return p})};String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(k){return k.join(this)};String.prototype.jsSplit=String.prototype.split;String.prototype.lower=function(){return this.toLowerCase()};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(k,l){return this.lastIndexOf(k,
l)};String.prototype.rsplit=function(k,l){var p=this.split(k||/s+/);return l?[p.slice(0,-l).join(k)].concat(p.slice(-l)):p};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.split=function(k,l){k||(k=" ");return this.jsSplit(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};G(n,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=
...
g.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");g.DPI=96;g.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function m(a,b){this.__eventListeners[a]&&(b?g.util.removeFromArray(this.__eventListeners[a],b):this.__eventListeners[a].length=0)}function c(a,b){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var f in a)this.on(f,
a[f]);else this.__eventListeners[a]||(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function h(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var f in a)m.call(this,f,a[f]);else m.call(this,a,b);return this}}function d(a,b){if(this.__eventListeners){var f=this.__eventListeners[a];if(f){for(var e=0,d=f.length;e<d;e++)f[e].call(this,b||{});return this}}}g.Observable={observe:c,
stopObserving:h,fire:d,on:c,off:h,trigger:d}})();g.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var g=0,c=arguments.length;g<c;g++)this._onObjectAdded(arguments[g]);this.renderOnAddRemove&&this.renderAll();return this},insertAt:function(g,c,h){var d=this.getObjects();h?d[c]=g:d.splice(c,0,g);this._onObjectAdded(g);this.renderOnAddRemove&&this.renderAll();return this},remove:function(){for(var g=this.getObjects(),c,h=0,d=arguments.length;h<d;h++)c=g.indexOf(arguments[h]),
-1!==c&&(g.splice(c,1),this._onObjectRemoved(arguments[h]));this.renderOnAddRemove&&this.renderAll();return this},forEachObject:function(g,c){for(var h=this.getObjects(),d=h.length;d--;)g.call(c,h[d],d,h);return this},getObjects:function(g){return"undefined"===typeof g?this._objects:this._objects.filter(function(c){return c.type===g})},item:function(g){return this.getObjects()[g]},isEmpty:function(){return 0===this.getObjects().length},size:function(){return this.getObjects().length},contains:function(g){return-1<
this.getObjects().indexOf(g)},complexity:function(){return this.getObjects().reduce(function(g,c){return g+=c.complexity?c.complexity():0},0)}};(function(m){var c=Math.sqrt,h=Math.atan2,d=Math.PI/180;g.util={removeFromArray:function(a,b){var f=a.indexOf(b);-1!==f&&a.splice(f,1);return a},getRandomInt:function(a,b){return Math.floor(Math.random()*(b-a+1))+a},degreesToRadians:function(a){return a*d},radiansToDegrees:function(a){return a/d},rotatePoint:function(a,b,f){var e=Math.sin(f);f=Math.cos(f);
a.subtractEquals(b);return(new g.Point(a.x*f-a.y*e,a.x*e+a.y*f)).addEquals(b)},transformPoint:function(a,b,f){return f?new g.Point(b[0]*a.x+b[2]*a.y,b[1]*a.x+b[3]*a.y):new g.Point(b[0]*a.x+b[2]*a.y+b[4],b[1]*a.x+b[3]*a.y+b[5])},invertTransform:function(a){var b=a.slice(),b=1/(a[0]*a[3]-a[1]*a[2]),b=[b*a[3],-b*a[1],-b*a[2],b*a[0],0,0];a=g.util.transformPoint({x:a[4],y:a[5]},b);b[4]=-a.x;b[5]=-a.y;return b},toFixed:function(a,b){return parseFloat(Number(a).toFixed(b))},parseUnit:function(a,b){var f=
/\D{0,2}$/.exec(a),e=parseFloat(a);b||(b=g.Text.DEFAULT_SVG_FONT_SIZE);switch(f[0]){case "mm":return e*g.DPI/25.4;case "cm":return e*g.DPI/2.54;case "in":return e*g.DPI;case "pt":return e*g.DPI/72;case "pc":return e*g.DPI/72*12;case "em":return e*b;default:return e}},falseFunction:function(){return!1},getKlass:function(a,b){a=g.util.string.camelize(a.charAt(0).toUpperCase()+a.slice(1));return g.util.resolveNamespace(b)[a]},resolveNamespace:function(a){if(!a)return g;a=a.split(".");for(var b=a.length,
f=m||g.window,e=0;e<b;++e)f=f[a[e]];return f},loadImage:function(a,b,f,e){if(a){var d=g.util.createImage();d.onload=function(){b&&b.call(f,d);d=d.onload=d.onerror=null};d.onerror=function(){g.log("Error loading "+d.src);b&&b.call(f,null,!0);d=d.onload=d.onerror=null};0!==a.indexOf("data")&&"undefined"!==typeof e&&(d.crossOrigin=e);d.src=a}else b&&b.call(f,a)},enlivenObjects:function(a,b,f,e){function d(){++h===H&&b&&b(c)}a=a||[];var c=[],h=0,H=a.length;H?a.forEach(function(a,b){if(a&&a.type){var h=
g.util.getKlass(a.type,f);h.async?h.fromObject(a,function(f,h){h||(c[b]=f,e&&e(a,c[b]));d()}):(c[b]=h.fromObject(a),e&&e(a,c[b]),d())}else d()}):b&&b(c)},groupSVGElements:function(a,b,f){a=new g.PathGroup(a,b);"undefined"!==typeof f&&a.setSourcePath(f);return a},populateWithProperties:function(a,b,f){if(f&&"[object Array]"===Object.prototype.toString.call(f))for(var e=0,d=f.length;e<d;e++)f[e]in a&&(b[f[e]]=a[f[e]])},drawDashedLine:function(a,b,f,e,d,v){e-=b;var g=d-f;d=c(e*e+g*g);e=h(g,e);var g=
v.length,H=0,m=!0;a.save();a.translate(b,f);a.moveTo(0,0);a.rotate(e);for(b=0;d>b;)b+=v[H++%g],b>d&&(b=d),a[m?"lineTo":"moveTo"](b,0),m=!m;a.restore()},createCanvasElement:function(a){a||(a=g.document.createElement("canvas"));a.getContext||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(a);return a},createImage:function(){return g.isLikelyNode?new (require("canvas").Image):g.document.createElement("img")},createAccessors:function(a){a=a.prototype;for(var b=a.stateProperties.length;b--;){var f=
...
{})[1]},isTransparent:function(a,b,f,e){0<e&&(b=b>e?b-e:0,f=f>e?f-e:0);var d=!0;a=a.getImageData(b,f,2*e||1,2*e||1);b=3;for(f=a.data.length;b<f&&(d=0>=a.data[b],!1!==d);b+=4);return d}}})("undefined"!==typeof k?k:this);(function(){function m(f,b,d,g,m,k,da){var T=e.call(arguments);if(a[T])return a[T];var A=Math.PI,l=da*A/180,N=Math.sin(l),l=Math.cos(l),p=0,B=0;d=Math.abs(d);g=Math.abs(g);var z=-l*f*.5-N*b*.5,n=-l*b*.5+N*f*.5,r=d*d,w=g*g,E=n*n,u=z*z,t=r*w-r*E-w*u,x=0;0>t?(r=Math.sqrt(1-t/(r*w)),d*=
r,g*=r):x=(m===k?-1:1)*Math.sqrt(t/(r*E+w*u));E=x*d*n/g;u=-x*g*z/d;x=l*E-N*u+.5*f;r=N*E+l*u+.5*b;w=h(1,0,(z-E)/d,(n-u)/g);n=h((z-E)/d,(n-u)/g,(-z-E)/d,(-n-u)/g);0===k&&0<n?n-=2*A:1===k&&0>n&&(n+=2*A);A=Math.ceil(Math.abs(n/A*2));z=[];n/=A;E=8/3*Math.sin(n/4)*Math.sin(n/4)/Math.sin(n/2);u=w+n;for(t=0;t<A;t++)z[t]=c(w,u,l,N,d,g,x,r,E,p,B),p=z[t][4],B=z[t][5],w=u,u+=n;return a[T]=z}function c(f,a,d,c,h,g,m,k,A,l,n){var p=e.call(arguments);if(b[p])return b[p];var B=Math.cos(f),z=Math.sin(f),r=Math.cos(a),
t=Math.sin(a),w=d*h*r-c*g*t+m,x=c*h*r+d*g*t+k;b[p]=[l+A*(-d*h*z-c*g*B),n+A*(-c*h*z+d*g*B),w+A*(d*h*t+c*g*r),x+A*(c*h*t-d*g*r),w,x];return b[p]}function h(f,e,a,b){f=Math.atan2(e,f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,m,k){var A=e.call(arguments);if(f[A])return f[A];var l=Math.sqrt,n=Math.min,p=Math.max,B=Math.abs,z=[],r=[[],[]],t,w,x,u,y;w=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*m;x=3*d-3*a;for(var D=0;2>D;++D)0<D&&(w=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*k,x=3*c-3*b),1E-12>B(t)?
1E-12>B(w)||(u=-x/w,0<u&&1>u&&z.push(u)):(u=w*w-4*x*t,0>u||(y=l(u),u=(-w+y)/(2*t),0<u&&1>u&&z.push(u),u=(-w-y)/(2*t),0<u&&1>u&&z.push(u)));for(B=l=z.length;l--;)u=z[l],w=1-u,t=w*w*w*a+3*w*w*u*d+3*w*u*u*h+u*u*u*m,r[0][l]=t,t=w*w*w*b+3*w*w*u*c+3*w*u*u*g+u*u*u*k,r[1][l]=t;r[0][B]=a;r[1][B]=b;r[0][B+1]=m;r[1][B+1]=k;n=[{x:n.apply(null,r[0]),y:n.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];return f[A]=n}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=
[[],[],[],[]];b=m(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,k,A){var l=0,n=0,p=[],B=[];a=m(k-f,A-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)p=d(l,n,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],a[c][5]),b[0].x=p[0].x+f,b[0].y=p[0].y+e,b[1].x=p[1].x+f,b[1].y=p[1].y+e,B.push(b[0]),B.push(b[1]),
l=a[c][4],n=a[c][5];return B};g.util.getBoundsOfCurve=d})();(function(){function m(c,d,a){if(c&&0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&(f=c[b][d]);else for(;b--;)a(c[b],f)&&(f=c[b]);return f}}var c=Array.prototype.slice;Array.prototype.indexOf||(Array.prototype.indexOf=function(c){if(void 0===this||null===this)throw new TypeError;var d=Object(this),a=d.length>>>0;if(0===a)return-1;var b=0;0<arguments.length&&(b=Number(arguments[1]),b!==b?b=0:0!==b&&b!==Number.POSITIVE_INFINITY&&
b!==Number.NEGATIVE_INFINITY&&(b=(0<b||-1)*Math.floor(Math.abs(b))));if(b>=a)return-1;for(b=0<=b?b:Math.max(a-Math.abs(b),0);b<a;b++)if(b in d&&d[b]===c)return b;return-1});Array.prototype.forEach||(Array.prototype.forEach=function(c,d){for(var a=0,b=this.length>>>0;a<b;a++)a in this&&c.call(d,this[a],a,this)});Array.prototype.map||(Array.prototype.map=function(c,d){for(var a=[],b=0,f=this.length>>>0;b<f;b++)b in this&&(a[b]=c.call(d,this[b],b,this));return a});Array.prototype.every||(Array.prototype.every=
function(c,d){for(var a=0,b=this.length>>>0;a<b;a++)if(a in this&&!c.call(d,this[a],a,this))return!1;return!0});Array.prototype.some||(Array.prototype.some=function(c,d){for(var a=0,b=this.length>>>0;a<b;a++)if(a in this&&c.call(d,this[a],a,this))return!0;return!1});Array.prototype.filter||(Array.prototype.filter=function(c,d){for(var a=[],b,f=0,e=this.length>>>0;f<e;f++)f in this&&(b=this[f],c.call(d,b,f,this)&&a.push(b));return a});Array.prototype.reduce||(Array.prototype.reduce=function(c){var d=
this.length>>>0,a=0,b;if(1<arguments.length)b=arguments[1];else{do{if(a in this){b=this[a++];break}if(++a>=d)throw new TypeError;}while(1)}for(;a<d;a++)a in this&&(b=c.call(null,b,this[a],a,this));return b});g.util.array={invoke:function(h,d){for(var a=c.call(arguments,2),b=[],f=0,e=h.length;f<e;f++)b[f]=a.length?h[f][d].apply(h[f],a):h[f][d].call(h[f]);return b},min:function(c,d){return m(c,d,function(a,b){return a<b})},max:function(c,d){return m(c,d,function(a,b){return a>=b})}}})();(function(){function m(c,
h){for(var d in h)c[d]=h[d];return c}g.util.object={extend:m,clone:function(c){return m({},c)}}})();(function(){String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});g.util.string={camelize:function(g){return g.replace(/-+(.)?/g,function(c,h){return h?h.toUpperCase():""})},capitalize:function(g,c){return g.charAt(0).toUpperCase()+(c?g.slice(1):g.slice(1).toLowerCase())},escapeXml:function(g){return g.replace(/&/g,"&amp;").replace(/"/g,
"&quot;").replace(/'/g,"&apos;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}})();(function(){var g=Array.prototype.slice,c=Function.prototype.apply,h=function(){};Function.prototype.bind||(Function.prototype.bind=function(d){var a=this,b=g.call(arguments,1),f;f=b.length?function(){return c.call(a,this instanceof h?this:d,b.concat(g.call(arguments)))}:function(){return c.call(a,this instanceof h?this:d,arguments)};h.prototype=this.prototype;f.prototype=new h;return f})})();(function(){function m(){}
function c(f){var e=this.constructor.superclass.prototype[f];return 1<arguments.length?e.apply(this,h.call(arguments,1)):e.call(this)}var h=Array.prototype.slice,d=function(){},a=function(){for(var f in{toString:1})if("toString"===f)return!1;return!0}(),b=function(f,e,b){for(var d in e)d in f.prototype&&"function"===typeof f.prototype[d]&&-1<(e[d]+"").indexOf("callSuper")?f.prototype[d]=function(f){return function(){var a=this.constructor.superclass;this.constructor.superclass=b;var d=e[f].apply(this,
arguments);this.constructor.superclass=a;if("initialize"!==f)return d}}(d):f.prototype[d]=e[d],a&&(e.toString!==Object.prototype.toString&&(f.prototype.toString=e.toString),e.valueOf!==Object.prototype.valueOf&&(f.prototype.valueOf=e.valueOf))};g.util.createClass=function(){function f(){this.initialize.apply(this,arguments)}var e=null,a=h.call(arguments,0);"function"===typeof a[0]&&(e=a.shift());f.superclass=e;f.subclasses=[];e&&(m.prototype=e.prototype,f.prototype=new m,e.subclasses.push(f));for(var g=
0,C=a.length;g<C;g++)b(f,a[g],e);f.prototype.initialize||(f.prototype.initialize=d);f.prototype.constructor=f;f.prototype.callSuper=c;return f}})();(function(){function m(f){var e=Array.prototype.slice.call(arguments,1),a,b,d=e.length;for(b=0;b<d;b++)if(a=typeof f[e[b]],!/^(?:function|object|unknown)$/.test(a))return!1;return!0}function c(f,e){return function(b){e.call(a(f),b||g.window.event)}}function h(f,e){return function(a){if(C[f]&&C[f][e])for(var b=C[f][e],d=0,c=b.length;d<c;d++)b[d].call(this,
a||g.window.event)}}function d(f,e,a){var b="touchend"===f.type?"changedTouches":"touches";return f[b]&&f[b][0]?f[b][0][e]-(f[b][0][e]-f[b][0][a])||f[a]:f[a]}var a,b,f=function(){var f=0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=m(g.document.documentElement,"addEventListener","removeEventListener")&&m(g.window,"addEventListener","removeEventListener"),q=m(g.document.documentElement,
"attachEvent","detachEvent")&&m(g.window,"attachEvent","detachEvent"),v={},C={};e?(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,a,d){var h=f(e);b(h,e);v[h]||(v[h]={});v[h][a]||(v[h][a]=[]);d={handler:d,wrappedHandler:c(h,d)};v[h][a].push(d);e.attachEvent("on"+a,d.wrappedHandler)},q=function(e,a,b){var d=f(e),c;if(v[d]&&v[d][a])for(var h=0,q=v[d][a].length;h<q;h++)(c=v[d][a][h])&&c.handler===b&&(e.detachEvent("on"+a,c.wrappedHandler),
v[d][a][h]=null)}):(e=function(e,a,b){var d=f(e);C[d]||(C[d]={});if(!C[d][a]){C[d][a]=[];var c=e["on"+a];c&&C[d][a].push(c);e["on"+a]=h(d,a)}C[d][a].push(b)},q=function(e,a,b){e=f(e);if(C[e]&&C[e][a]){a=C[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var k=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(k=function(f){return d(f,"pageX","clientX")},
l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:null),e);return{x:k(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var m=g.document.createElement("div"),c="string"===typeof m.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof m.style.opacity?d=function(a,b){a.style.opacity=b;return a}:
...
"cssFloat":"styleFloat":e]=b[e];return a}})();(function(){function m(a,f){var e=g.document.createElement(a),d;for(d in f)"class"===d?e.className=f[d]:"for"===d?e.htmlFor=f[d]:e.setAttribute(d,f[d]);return e}var c=Array.prototype.slice,h,d=function(a){return c.call(a,0)};try{h=d(g.document.childNodes)instanceof Array}catch(b){}h||(d=function(a){for(var f=Array(a.length),e=a.length;e--;)f[e]=a[e];return f});var a;a=g.document.defaultView&&g.document.defaultView.getComputedStyle?function(a,f){var e=
g.document.defaultView.getComputedStyle(a,null);return e?e[f]:void 0}:function(a,f){var e=a.style[f];!e&&a.currentStyle&&(e=a.currentStyle[f]);return e};(function(){var a=g.document.documentElement.style,f="userSelect"in a?"userSelect":"MozUserSelect"in a?"MozUserSelect":"WebkitUserSelect"in a?"WebkitUserSelect":"KhtmlUserSelect"in a?"KhtmlUserSelect":"";g.util.makeElementUnselectable=function(e){"undefined"!==typeof e.onselectstart&&(e.onselectstart=g.util.falseFunction);f?e.style[f]="none":"string"===
typeof e.unselectable&&(e.unselectable="on");return e};g.util.makeElementSelectable=function(e){"undefined"!==typeof e.onselectstart&&(e.onselectstart=null);f?e.style[f]="":"string"===typeof e.unselectable&&(e.unselectable="");return e}})();(function(){g.util.getScript=function(a,f){var e=g.document.getElementsByTagName("head")[0],d=g.document.createElement("script"),c=!0;d.onload=d.onreadystatechange=function(e){!c||"string"===typeof this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||
(c=!1,f(e||g.window.event),d=d.onload=d.onreadystatechange=null)};d.src=a;e.appendChild(d)}})();g.util.getById=function(a){return"string"===typeof a?g.document.getElementById(a):a};g.util.toArray=d;g.util.makeElement=m;g.util.addClass=function(a,f){a&&-1===(" "+a.className+" ").indexOf(" "+f+" ")&&(a.className+=(a.className?" ":"")+f)};g.util.wrapElement=function(a,f,e){"string"===typeof f&&(f=m(f,e));a.parentNode&&a.parentNode.replaceChild(f,a);f.appendChild(a);return f};g.util.getScrollLeftTop=
function(a,f){var e,d,c=0,h=0,m=g.document.documentElement,k=g.document.body||{scrollLeft:0,scrollTop:0};for(d=a;a&&a.parentNode&&!e;)a=a.parentNode,1===a.nodeType&&"fixed"===g.util.getElementStyle(a,"position")&&(e=a),1===a.nodeType&&d!==f&&"absolute"===g.util.getElementStyle(a,"position")?h=c=0:a===g.document?(c=k.scrollLeft||m.scrollLeft||0,h=k.scrollTop||m.scrollTop||0):(c+=a.scrollLeft||0,h+=a.scrollTop||0);return{left:c,top:h}};g.util.getElementOffset=function(b){var f;f=b&&b.ownerDocument;
var e={left:0,top:0},d={left:0,top:0},c={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!f)return{left:0,top:0};for(var h in c)d[c[h]]+=parseInt(a(b,h),10)||0;f=f.documentElement;"undefined"!==typeof b.getBoundingClientRect&&(e=b.getBoundingClientRect());b=g.util.getScrollLeftTop(b,null);return{left:e.left+b.left-(f.clientLeft||0)+d.left,top:e.top+b.top-(f.clientTop||0)+d.top}};g.util.getElementStyle=a})();(function(){function m(d,a){return d+(/\?/.test(d)?"&":
"?")+a}function c(){}var h=function(){for(var d=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},function(){return new XMLHttpRequest}],a=d.length;a--;)try{if(d[a]())return d[a]}catch(b){}}();g.util.request=function(d,a){a||(a={});var b=a.method?a.method.toUpperCase():"GET",f=a.onComplete||function(){},e=h(),q;e.onreadystatechange=function(){4===e.readyState&&(f(e),e.onreadystatechange=
c)};"GET"===b&&(q=null,"string"===typeof a.parameters&&(d=m(d,a.parameters)));e.open(b,d,!0);"POST"!==b&&"PUT"!==b||e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(q);return e}})();g.log=function(){};g.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(m){"undefined"!==typeof console[m]&&"function"===typeof console[m].apply&&(g[m]=function(){return console[m].apply(console,arguments)})});(function(g){function c(c,d){this.x=c;this.y=d}g=g.fabric||
(g.fabric={});g.Point?g.warn("fabric.Point is already defined"):(g.Point=c,c.prototype={constructor:c,add:function(h){return new c(this.x+h.x,this.y+h.y)},addEquals:function(c){this.x+=c.x;this.y+=c.y;return this},scalarAdd:function(h){return new c(this.x+h,this.y+h)},scalarAddEquals:function(c){this.x+=c;this.y+=c;return this},subtract:function(h){return new c(this.x-h.x,this.y-h.y)},subtractEquals:function(c){this.x-=c.x;this.y-=c.y;return this},scalarSubtract:function(h){return new c(this.x-h,
this.y-h)},scalarSubtractEquals:function(c){this.x-=c;this.y-=c;return this},multiply:function(h){return new c(this.x*h,this.y*h)},multiplyEquals:function(c){this.x*=c;this.y*=c;return this},divide:function(h){return new c(this.x/h,this.y/h)},divideEquals:function(c){this.x/=c;this.y/=c;return this},eq:function(c){return this.x===c.x&&this.y===c.y},lt:function(c){return this.x<c.x&&this.y<c.y},lte:function(c){return this.x<=c.x&&this.y<=c.y},gt:function(c){return this.x>c.x&&this.y>c.y},gte:function(c){return this.x>=
...
1<d&&this.setWidth(f).setHeight(e);k.scale(d,d);h.left&&(h.left*=d);h.top&&(h.top*=d);h.width?h.width*=d:1>d&&(h.width=f);h.height?h.height*=d:1>d&&(h.height=e);v?this._tempRemoveBordersControlsFromGroup(v):q&&this.deactivateAll&&this.deactivateAll();this.renderAll(!0);g=this.__toDataURL(g,c,h);this.width=a;this.height=b;k.scale(1/d,1/d);this.setWidth(a).setHeight(b);v?this._restoreBordersControlsOnGroup(v):q&&this.setActiveObject&&this.setActiveObject(q);this.contextTop&&this.clearContext(this.contextTop);
...
b)?f/b:0),q=Math.cos(e+c)*a,e=Math.sin(e+c)*a,a=Math.sin(c),c=Math.cos(c),v=this.getCenterPoint(),f=new g.Point(b,f),v=new g.Point(v.x-q,v.y-e),e=new g.Point(v.x+f.x*c,v.y+f.x*a),b=d(new g.Point(v.x-f.y*a,v.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(v),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),v=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),C=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),H=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(v.x+a*this.rotatingPointOffset,v.y-c*this.rotatingPointOffset);
this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:v,mr:C,mb:H,mtr:a};this._setCornerCoords&&this._setCornerCoords();return this}})})();g.util.object.extend(g.Object.prototype,{sendToBack:function(){this.group?g.StaticCanvas.prototype.sendToBack.call(this.group,this):this.canvas.sendToBack(this);return this},bringToFront:function(){this.group?g.StaticCanvas.prototype.bringToFront.call(this.group,this):this.canvas.bringToFront(this);return this},sendBackwards:function(k){this.group?g.StaticCanvas.prototype.sendBackwards.call(this.group,
