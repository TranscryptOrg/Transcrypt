'use strict';function pong(){function Q(k,l,p){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof p&&(p=1);if(0<p&&k>=l||0>p&&k<=l)return[];for(var g=[];0<p?k<l:k>l;k+=p)g.push(k);return g}function U(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=k[p]);return l}function V(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=V(k[p]));return l}function w(k){k=k?[].slice.apply(k):[];k.__class__=w;return k}function y(k){k=
k?[].slice.apply(k):[];k.__class__=y;return k}function J(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=J;return l}function W(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var p=0;p<k.length;p++)l[pair[0]]=pair[1];l.__class__=R;l.keys=W;return l}function K(k){return new String(k)}var m={},H=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;break}k=
k[l[n]]}for(n=g;n<l.length;n++)k[l[n]]={},k=k[l[n]]}for(var c in p)k[c]=p[c]};m.__nest__=H;var O=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};m.__init__=O;var r=function(k,l){return k?k.hasOwnProperty("__class__")?function(p){p=[].slice.apply(arguments);return l.apply(null,[k].concat(p))}:l:l};m.__get__=r;var D=function(k,l,p){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},n=l.length-1;0<=n;n--){var c=l[n],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,
h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in p)d=Object.getOwnPropertyDescriptor(p,h),Object.defineProperty(g,h,d);return g};m.__class__=D;var L=m.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});m.object=L;m.__pragma__=function(){};H(m,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=
D("__Envir__",[L],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="0.0.56";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});H(m,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",[L],{get __init__(){return r(this,function(g){var n=y([].slice.apply(arguments).slice(1));g.args=n})},get __repr__(){return r(this,function(g){return M(g.args)?"{}{}".format(g.__class__.__name__,X(y(g.args))):
"???"})},get __str__(){return r(this,function(g){return 1<M(g.args)?K(y(g.args)):M(g.args)?K(g.args[0]):"???"})}}),p=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}n?g.sort(function(a,b){if(arguments.length){var f=
arguments.length-1;if(arguments[f]&&arguments[f].__class__==t){var f=arguments[f--],e;for(e in f)switch(e){case "a":a=f[e];break;case "b":b=f[e]}}}return n(a)>n(b)}):g.sort();c&&g.reverse()};k.Exception=l;k.sort=p;k.sorted=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=
h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=U(g);p(d,n,c);return d}}}});H(m,"",O(m.org.transcrypt.__base__));var Y=m.__envir__;H(m,"",O(m.org.transcrypt.__standard__));Y.executorName=Y.transpilerName;m.main={__file__:""};m.__except__=null;var t=function(k){k.__class__=t;k.constructor=Object;return k};m.___kwargdict__=t;m.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};m.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];
for(g in l)p[g]=l[g];return p};var Z=function(){console.log([].slice.apply(arguments).join(" "))};m.print=Z;console.log.apply=function(){Z([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};m.__in__=F;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==k};m.__specialattrib__=S;var M=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};m.len=M;var aa={__name__:"bool"};m.bool=aa;var ba={__name__:"int"};
m.int=ba;var ca={__name__:"float"};m.float=ca;m.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?aa:"number"==l?0==k%1?ba:ca:l}};m.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var n=0;n<g.__bases__.length;n++)if(p(g.__bases__[n],l))return!0;return!1}return p(k.__class__)};var X=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",p=!1,g;for(g in k)if(!S(g)){var n=g.isnumeric()?g:"'"+g+
"'";p?l+=", ":p=!0;try{l+=n+": "+k[g].__repr__()}catch(d){l+=n+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};m.repr=X;m.chr=function(k){return String.fromCharCode(k)};var N=function(k){return k.charCodeAt(0)};m.org=N;var P=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,p){return k.length<p.length?k:p})).map(function(l,
p){return k.map(function(g){return g[p]})})};m.zip=P;m.range=Q;m.enumerate=function(k){return P(Q(M(k)),k)};m.copy=U;m.deepcopy=V;m.list=w;Array.prototype.__class__=w;w.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=p)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==J&&!this.length)return"set()";for(var k=this.__class__&&this.__class__!=w?this.__class__==y?"(":
"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(p){k+=this[l].toString()}}this.__class__==y&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=w?this.__class__==y?")":"}":"]"};Array.prototype.__setslice__=function(k,l,p,g){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==p)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var n=0;k<l;k+=p)this[k]=g[n++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=
function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};m.tuple=y;y.__name__="tuple";m.set=J;J.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};m.__keys__=W;m.dict=R;R.__name__="dict";m.str=K;String.prototype.__class__=K;K.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?
"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(k){return""==k||this.slice(-k.length)==k};String.prototype.find=function(k,l){return this.indexOf(k,l)};String.prototype.format=function(){var k=arguments,l=0;return this.replace(/\{(\w*)\}/g,function(p,g){""==g&&(g=l++);if(g==+g)return"undefined"==k[g]?p:k[g];for(var n=0;n<k.length;n++)if("object"==
typeof k[n]&&"undefined"!=typeof k[n][g])return k[n][g];return p})};String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(k){return k.join(this)};String.prototype.jsSplit=String.prototype.split;String.prototype.lower=function(){return this.toLowerCase()};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(k,l){return this.lastIndexOf(k,l)};String.prototype.rsplit=function(k,l){var p=this.split(k||
/s+/);return l?[p.slice(0,-l).join(k)].concat(p.slice(-l)):p};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.split=function(k,l){k||(k=" ");return this.jsSplit(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};H(m,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k={},g=g||{version:"1.5.0"};
...
4);return d}}})("undefined"!==typeof k?k:this);(function(){function n(f,b,d,g,n,k,da){var T=e.call(arguments);if(a[T])return a[T];var B=Math.PI,l=da*B/180,G=Math.sin(l),l=Math.cos(l),p=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-l*f*.5-G*b*.5,m=-l*b*.5+G*f*.5,r=d*d,v=g*g,E=m*m,u=z*z,t=r*v-r*E-v*u,w=0;0>t?(r=Math.sqrt(1-t/(r*v)),d*=r,g*=r):w=(n===k?-1:1)*Math.sqrt(t/(r*E+v*u));E=w*d*m/g;u=-w*g*z/d;w=l*E-G*u+.5*f;r=G*E+l*u+.5*b;v=h(1,0,(z-E)/d,(m-u)/g);m=h((z-E)/d,(m-u)/g,(-z-E)/d,(-m-u)/g);0===k&&0<m?
m-=2*B:1===k&&0>m&&(m+=2*B);B=Math.ceil(Math.abs(m/B*2));z=[];m/=B;E=8/3*Math.sin(m/4)*Math.sin(m/4)/Math.sin(m/2);u=v+m;for(t=0;t<B;t++)z[t]=c(v,u,l,G,d,g,w,r,E,p,C),p=z[t][4],C=z[t][5],v=u,u+=m;return a[T]=z}function c(f,a,d,c,h,g,n,k,B,l,G){var m=e.call(arguments);if(b[m])return b[m];var p=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),v=d*h*r-c*g*t+n,w=c*h*r+d*g*t+k;b[m]=[l+B*(-d*h*z-c*g*p),G+B*(-c*h*z+d*g*p),v+B*(d*h*t+c*g*r),w+B*(c*h*t-d*g*r),v,w];return b[m]}function h(f,e,a,b){f=Math.atan2(e,
f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,n,k){var B=e.call(arguments);if(f[B])return f[B];var l=Math.sqrt,m=Math.min,p=Math.max,C=Math.abs,z=[],r=[[],[]],t,v,w,u,y;v=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*n;w=3*d-3*a;for(var D=0;2>D;++D)0<D&&(v=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*k,w=3*c-3*b),1E-12>C(t)?1E-12>C(v)||(u=-w/v,0<u&&1>u&&z.push(u)):(u=v*v-4*w*t,0>u||(y=l(u),u=(-v+y)/(2*t),0<u&&1>u&&z.push(u),u=(-v-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=l=z.length;l--;)u=z[l],v=1-u,t=
v*v*v*a+3*v*v*u*d+3*v*u*u*h+u*u*u*n,r[0][l]=t,t=v*v*v*b+3*v*v*u*c+3*v*u*u*g+u*u*u*k,r[1][l]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=n;r[1][C+1]=k;m=[{x:m.apply(null,r[0]),y:m.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];return f[B]=m}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=n(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+
...
x=this.getCenterPoint(),f=new g.Point(b,f),x=new g.Point(x.x-q,x.y-e),e=new g.Point(x.x+f.x*c,x.y+f.x*a),b=d(new g.Point(x.x-f.y*a,x.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(x),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),x=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),A=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),I=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(x.x+a*this.rotatingPointOffset,x.y-c*this.rotatingPointOffset);this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:x,mr:A,mb:I,mtr:a};this._setCornerCoords&&
...
(g=-d.getWidth()/2);d.set({left:d.getLeft()+g,top:d.getTop()-d.getHeight()/2+d.fontSize*(.18+d._fontSizeFraction)});return d},c.Text.fromObject=function(a){return new c.Text(a.text,d(a))},c.util.createAccessors(c.Text))})("undefined"!==typeof k?k:this);delete window.fabric;return k}().fabric;k.fabric=l}}});(function(){var k=O(m.com.fabricjs).fabric,l=y(w([13,27,32])),p=l[0],g=l[1],n=l[2],c=D("Attribute",[L],{get __init__(){return r(this,function(a,b){a.game=b;a.game.attributes.append(a);a.install();
a.reset()})},get reset(){return r(this,function(a){a.commit()})},get predict(){return r(this,function(a){})},get interact(){return r(this,function(a){})},get commit(){return r(this,function(a){})}}),h=D("Sprite",[c],{get __init__(){return r(this,function(a,b,d,f){a.width=d;a.height=f;c.__init__(a,b)})},get install(){return r(this,function(a){a.image=new k.Rect({width:a.game.scaleX(a.width),height:a.game.scaleY(a.height),originX:"center",originY:"center",fill:"white"})})},get reset(){return r(this,
...
a.y=g;c.reset(a)})},get predict(){return r(this,function(a){a.x+=a.vX*a.game.deltaT;a.y+=a.vY*a.game.deltaT})},get commit(){return r(this,function(a){a.image.left=a.game.orthoX(a.x);a.image.top=a.game.orthoY(a.y)})},get draw(){return r(this,function(a){a.game.canvas.add(a.image)})}}),d=D("Paddle",[h],{get __init__(){return r(this,function(a,b,c){a.index=c;h.__init__(a,b,a.width,a.height)})},get reset(){return r(this,function(a){h.reset(a,t({x:a.index?Math.floor(1E3)/Math.floor(2)-a.margin:Math.floor(-1E3)/
Math.floor(2)+a.margin,y:0}))})},get predict(){return r(this,function(a){a.vY=0;a.index?F(N("K"),a.game.keySet)?a.vY=a.speed:F(N("M"),a.game.keySet)&&(a.vY=-a.speed):F(N("A"),a.game.keySet)?a.vY=a.speed:F(N("Z"),a.game.keySet)&&(a.vY=-a.speed);h.predict(a)})},get interact(){return r(this,function(a){a.y=Math.max(Math.floor(a.height)/Math.floor(2)-Math.floor(650)/Math.floor(2),Math.min(a.y,Math.floor(650)/Math.floor(2)-Math.floor(a.height)/Math.floor(2)));a.y-Math.floor(a.height)/Math.floor(2)<a.game.ball.y&&
a.game.ball.y<a.y+Math.floor(a.height)/Math.floor(2)&&(0==a.index&&a.game.ball.x<a.x||1==a.index&&a.game.ball.x>a.x)&&(a.game.ball.x=a.x,a.game.ball.vX=-a.game.ball.vX,a.game.ball.speedUp(a))})}});d.margin=30;d.width=10;d.height=100;d.speed=400;var a=D("Ball",[h],{get __init__(){return r(this,function(a,b){h.__init__(a,b,a.side,a.side)})},get reset(){return r(this,function(a){var b=a.game.serviceIndex*Math.PI+(.5<Math.random()?1:-1)*Math.random()*Math.atan(.65);h.reset(a,t({vX:a.speed*Math.cos(b),
...
(a.vX*=c,a.vY*=c)})}});a.side=8;a.speed=300;var b=D("Scoreboard",[c],{get install(){return r(this,function(a){for(var b=[],c=y(w([y(w(["AZ keys:",-.4375])),y(w(["KM keys:",.0625]))])),d=0;d<c.length;d++){var f=c[d],g=f[1];b.append(new k.Text("Player {}".format(f[0]),{fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.nameShift)}))}a.playerLabels=b;a.hintLabel=new k.Text("[spacebar] starts game, [enter] resets score",{fill:"white",
fontFamily:"arial",fontSize:"12",left:a.game.orthoX(-437.5),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.hintShift)});a.image=new k.Line(w([a.game.orthoX(Math.floor(-1E3)/Math.floor(2)),a.game.orthoY(Math.floor(650)/Math.floor(2)),a.game.orthoX(Math.floor(1E3)/Math.floor(2)),a.game.orthoY(Math.floor(650)/Math.floor(2))]),{stroke:"white"})})},get increment(){return r(this,function(a,b){a.scores[b]++})},get reset(){return r(this,function(a){a.scores=w([0,0]);c.reset(a)})},get commit(){return r(this,
function(a){for(var b=[],c=P(a.scores,y(w([-.125,.375]))),d=0;d<c.length;d++){var f=c[d],g=f[1];b.append(new k.Text("{}".format(f[0]),{fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.nameShift)}))}a.scoreLabels=b})},get draw(){return r(this,function(a){for(var b=P(a.playerLabels,a.scoreLabels),c=0;c<b.length;c++){var d=b[c],f=d[1];a.game.canvas.add(d[0]);a.game.canvas.add(f);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)})}});
b.nameShift=75;b.hintShift=25;var l=D("Game",[L],{get __init__(){return r(this,function(c){c.serviceIndex=.5<Math.random()?1:0;c.pause=!0;c.keySet=J();c.canvas=new k.Canvas("canvas",{backgroundColor:"black",originX:"center",originY:"center"});c.canvas.onWindowResise=c.resize;c.canvas.onWindowDraw=c.draw;c.canvas.lineWidth=2;c.canvas.clear();c.attributes=w([]);for(var f=[],g=Q(2),h=0;h<g.length;h++)f.append(d(c,g[h]));c.paddles=f;c.ball=a(c);c.scoreboard=b(c);window.setInterval(c.update,10);window.setInterval(c.draw,
...
Math.floor(2))})},get orthoY(){return r(this,function(a,b){return a.scaleY(750-Math.floor(650)/Math.floor(2)-b)})},get keydown(){return r(this,function(a,b){a.keySet.add(b.keyCode)})},get keyup(){return r(this,function(a,b){a.keySet.remove(b.keyCode)})}}),f=l();m.Attribute=c;m.Ball=a;m.Game=l;m.Paddle=d;m.Scoreboard=b;m.Sprite=h;m.enter=p;m.esc=g;m.fieldHeight=650;m.game=f;m.orthoHeight=750;m.orthoWidth=1E3;m.space=n})();return m}window.pong=pong;
