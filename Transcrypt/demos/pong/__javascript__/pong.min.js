'use strict';function pong(){function R(k,l,m){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof m&&(m=1);if(0<m&&k>=l||0>m&&k<=l)return[];for(var g=[];0<m?k<l:k>l;k+=m)g.push(k);return g}function W(k){if(null==k||"object"==typeof k)return k;var l={},m;for(m in obj)k.hasOwnProperty(m)&&(l[m]=k[m]);return l}function X(k){if(null==k||"object"==typeof k)return k;var l={},m;for(m in obj)k.hasOwnProperty(m)&&(l[m]=X(k[m]));return l}function y(k){k=k?[].slice.apply(k):[];k.__class__=y;return k}function w(k){k=
k?[].slice.apply(k):[];k.__class__=w;return k}function I(k){var l=[];if(k)for(var m=0;m<k.length;m++)l.add(k[m]);l.__class__=I;return l}function Y(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function S(k){var l={};if(k)for(var m=0;m<k.length;m++){var g=k[m];l[g[0]]=g[1]}l.__class__=S;l.py_keys=Y;return l}function J(k){return new String(k)}var p={},H=function(k,l,m){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;
break}k=k[l[n]]}for(n=g;n<l.length;n++)k[l[n]]={},k=k[l[n]]}for(var c in m)k[c]=m[c]};p.__nest__=H;var O=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};p.__init__=O;var r=function(k,l,m){return k&&(k.hasOwnProperty("__class__")||"string"==typeof k||k instanceof String)?(m&&Object.defineProperty(k,m,{value:function(){var g=[].slice.apply(arguments);return l.apply(null,[k].concat(g))},writable:!0,enumerable:!0,configurable:!0}),function(){var g=[].slice.apply(arguments);return l.apply(null,
[k].concat(g))}):l};p.__get__=r;var D=function(k,l,m){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},n=l.length-1;0<=n;n--){var c=l[n],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in m)d=Object.getOwnPropertyDescriptor(m,h),Object.defineProperty(g,h,d);return g};p.__class__=D;var K=p.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,
{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});p.object=K;p.__pragma__=function(){};H(p,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[K],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.85";g.targetSubDir="__javascript__"},"__init__")}}),m=l();k.__Envir__=l;k.__envir__=m}}});H(p,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",
[K],{get __init__(){return r(this,function(g){var n=w([].slice.apply(arguments).slice(1));g.args=n},"__init__")},get __repr__(){return r(this,function(g){return L(g.args)?"{}{}".format(g.__class__.__name__,Z(w(g.args))):"???"},"__repr__")},get __str__(){return r(this,function(g){return 1<L(g.args)?J(w(g.args)):L(g.args)?J(g.args[0]):"???"},"__str__")}}),m=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=
arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}n?g.sort(function(a,b){if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].__class__==t){var f=arguments[f--],e;for(e in f)switch(e){case "a":a=f[e];break;case "b":b=f[e]}}}return n(a)>n(b)}):g.sort();c&&g.reverse()};k.Exception=l;k.__sort__=m;k.sorted=function(g,n,c){if("undefined"==typeof n||
null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=W(g);m(d,n,c);return d}}}});H(p,"",O(p.org.transcrypt.__base__));var aa=p.__envir__;H(p,"",O(p.org.transcrypt.__standard__));var ea=p.__sort__;aa.executorName=aa.transpilerName;p.main={__file__:""};p.__except__=
null;var t=function(k){k.__class__=t;k.constructor=Object;return k};p.___kwargdict__=t;p.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};p.__merge__=function(k,l){var m={},g;for(g in k)m[g]=k[g];for(g in l)m[g]=l[g];return m};var ba=function(){console.log([].slice.apply(arguments).join(" "))};p.print=ba;console.log.apply=function(){ba([].slice.apply(arguments).slice(1))};var G=function(k,l){return-1<l.indexOf(k)};p.__in__=G;var T=function(k){return k.startswith("__")&&
k.endswith("__")||"constructor"==k||k.startswith("py_")};p.__specialattrib__=T;var L=function(k){try{return k.length}catch(l){result=0;for(attrib in k)T(attrib)||result++;return result}};p.len=L;var ca={__name__:"bool"};p.bool=ca;var U=function(k){return k|0};U.__name__="int";p.int=U;var da={__name__:"float"};p.float=da;p.type=function(k){try{return k.__class__}catch(m){var l=typeof k;return"boolean"==l?ca:"number"==l?0==k%1?U:da:l}};p.isinstance=function(k,l){function m(g){if(g==l)return!0;for(var n=
0;n<g.__bases__.length;n++)if(m(g.__bases__[n],l))return!0;return!1}return m(k.__class__)};var Z=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",m=!1,g;for(g in k)if(!T(g)){var n=g.isnumeric()?g:"'"+g+"'";m?l+=", ":m=!0;try{l+=n+": "+k[g].__repr__()}catch(d){l+=n+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+
typeof k+">)"),"???"}}}};p.repr=Z;p.chr=function(k){return String.fromCharCode(k)};var M=function(k){return k.charCodeAt(0)};p.org=M;var P=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,m){return k.length<m.length?k:m})).map(function(l,m){return k.map(function(g){return g[m]})})};p.zip=P;p.range=R;p.enumerate=function(k){return P(R(L(k)),k)};p.copy=W;p.deepcopy=X;p.list=y;Array.prototype.__class__=y;y.__name__="list";Array.prototype.__getslice__=function(k,l,m){0>
k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=m)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==I&&!this.length)return"set()";for(var k=this.__class__&&this.__class__!=y?this.__class__==w?"(":"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(m){k+=this[l].toString()}}this.__class__==w&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=y?this.__class__==w?")":"}":"]"};Array.prototype.__setslice__=
function(k,l,m,g){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==m)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var n=0;k<l;k+=m)this[k]=g[n++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};Array.prototype.py_sort=function(){ea.apply(null,[this].concat([].slice.apply(arguments)))};
p.tuple=w;w.__name__="tuple";p.set=I;I.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};p.__keys__=Y;p.dict=S;S.__name__="dict";p.str=J;String.prototype.__class__=J;J.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+
this.slice(1)};String.prototype.endswith=function(k){return""==k||this.slice(-k.length)==k};String.prototype.find=function(k,l){return this.indexOf(k,l)};Object.defineProperty(String.prototype,"format",{get:function(){return r(this,function(k){var l=w([].slice.apply(arguments).slice(1)),m=0;return k.replace(/\{(\w*)\}/g,function(g,n){""==n&&(n=m++);if(n==+n)return"undefined"==l[n]?g:l[n];for(var c=0;c<l.length;c++)if("object"==typeof l[c]&&"undefined"!=typeof l[c][n])return l[c][n];return g})})},
enumerable:!0});String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(k){return k.join(this)};String.prototype.lower=function(){return this.toLowerCase()};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(k,l){return this.lastIndexOf(k,l)};String.prototype.rsplit=function(k,l){var m=this.split(k||/s+/);return l?[m.slice(0,-l).join(k)].concat(m.slice(-l)):m};String.prototype.rstrip=function(){return this.replace(/\s*$/g,
"")};String.prototype.py_split=function(k,l){k||(k=" ");return this.split(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};p.matmul=function(k,l){return"object"==typeof k&&"__matmul__"in k?k.__matmul__(l):l.__rmatmul__(k)};p.mul=function(k,l){return"object"==typeof k&&"__mul__"in k?k.__mul__(l):"object"==typeof l&&"__rmul__"in l?l.__rmul__(k):k*l};p.div=
function(k,l){return"object"==typeof k&&"__div__"in k?k.__div__(l):"object"==typeof l&&"__rdiv__"in l?l.__rdiv__(k):k/l};p.add=function(k,l){return"object"==typeof k&&"__add__"in k?k.__add__(l):"object"==typeof l&&"__radd__"in l?l.__radd__(k):k+l};p.sub=function(k,l){return"object"==typeof k&&"__sub__"in k?k.__sub__(l):"object"==typeof l&&"__rsub__"in l?l.__rsub__(k):k-l};H(p,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k={},g=g||{version:"1.5.0"};"undefined"!==
typeof k&&(k.fabric=g);"undefined"!==typeof document&&"undefined"!==typeof window?(g.document=document,g.window=window,window.fabric=g):(g.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),g.window=g.document.createWindow?g.document.createWindow():g.document.parentWindow);g.isTouchSupported="ontouchstart"in g.document.documentElement;g.isLikelyNode="undefined"!==typeof Buffer&&"undefined"===typeof window;g.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");
...
h[d],d,h);return this},getObjects:function(g){return"undefined"===typeof g?this._objects:this._objects.filter(function(c){return c.type===g})},item:function(g){return this.getObjects()[g]},isEmpty:function(){return 0===this.getObjects().length},size:function(){return this.getObjects().length},contains:function(g){return-1<this.getObjects().indexOf(g)},complexity:function(){return this.getObjects().reduce(function(g,c){return g+=c.complexity?c.complexity():0},0)}};(function(k){var c=Math.sqrt,h=Math.atan2,
...
4);return d}}})("undefined"!==typeof k?k:this);(function(){function k(f,b,d,g,n,l,fa){var V=e.call(arguments);if(a[V])return a[V];var F=Math.PI,z=fa*F/180,N=Math.sin(z),z=Math.cos(z),m=0,C=0;d=Math.abs(d);g=Math.abs(g);var A=-z*f*.5-N*b*.5,p=-z*b*.5+N*f*.5,r=d*d,x=g*g,E=p*p,u=A*A,t=r*x-r*E-x*u,w=0;0>t?(r=Math.sqrt(1-t/(r*x)),d*=r,g*=r):w=(n===l?-1:1)*Math.sqrt(t/(r*E+x*u));E=w*d*p/g;u=-w*g*A/d;w=z*E-N*u+.5*f;r=N*E+z*u+.5*b;x=h(1,0,(A-E)/d,(p-u)/g);p=h((A-E)/d,(p-u)/g,(-A-E)/d,(-p-u)/g);0===l&&0<p?
p-=2*F:1===l&&0>p&&(p+=2*F);F=Math.ceil(Math.abs(p/F*2));A=[];p/=F;E=8/3*Math.sin(p/4)*Math.sin(p/4)/Math.sin(p/2);u=x+p;for(t=0;t<F;t++)A[t]=c(x,u,z,N,d,g,w,r,E,m,C),m=A[t][4],C=A[t][5],x=u,u+=p;return a[V]=A}function c(f,a,d,c,h,g,k,n,l,z,p){var m=e.call(arguments);if(b[m])return b[m];var C=Math.cos(f),A=Math.sin(f),r=Math.cos(a),t=Math.sin(a),x=d*h*r-c*g*t+k,w=c*h*r+d*g*t+n;b[m]=[z+l*(-d*h*A-c*g*C),p+l*(-c*h*A+d*g*C),x+l*(d*h*t+c*g*r),w+l*(c*h*t-d*g*r),x,w];return b[m]}function h(f,e,a,b){f=Math.atan2(e,
f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,k,n){var l=e.call(arguments);if(f[l])return f[l];var z=Math.sqrt,p=Math.min,m=Math.max,C=Math.abs,A=[],r=[[],[]],t,x,w,u,y;x=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*k;w=3*d-3*a;for(var D=0;2>D;++D)0<D&&(x=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*n,w=3*c-3*b),1E-12>C(t)?1E-12>C(x)||(u=-w/x,0<u&&1>u&&A.push(u)):(u=x*x-4*w*t,0>u||(y=z(u),u=(-x+y)/(2*t),0<u&&1>u&&A.push(u),u=(-x-y)/(2*t),0<u&&1>u&&A.push(u)));for(C=z=A.length;z--;)u=A[z],x=1-u,t=
x*x*x*a+3*x*x*u*d+3*x*u*u*h+u*u*u*k,r[0][z]=t,t=x*x*x*b+3*x*x*u*c+3*x*u*u*g+u*u*u*n,r[1][z]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=k;r[1][C+1]=n;p=[{x:p.apply(null,r[0]),y:p.apply(null,r[1])},{x:m.apply(null,r[0]),y:m.apply(null,r[1])}];return f[l]=p}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=k(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+
e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,l,F){var z=0,p=0,m=[],C=[];a=k(l-f,F-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)m=d(z,p,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],a[c][5]),b[0].x=m[0].x+f,b[0].y=m[0].y+e,b[1].x=m[1].x+f,b[1].y=m[1].y+e,C.push(b[0]),C.push(b[1]),z=a[c][4],p=a[c][5];return C};g.util.getBoundsOfCurve=d})();(function(){function k(c,d,a){if(c&&0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&
...
0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=k(g.document.documentElement,"addEventListener","removeEventListener")&&k(g.window,"addEventListener","removeEventListener"),q=k(g.document.documentElement,"attachEvent","detachEvent")&&k(g.window,"attachEvent","detachEvent"),v={},B={};e?(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,
a,d){var h=f(e);b(h,e);v[h]||(v[h]={});v[h][a]||(v[h][a]=[]);d={handler:d,wrappedHandler:c(h,d)};v[h][a].push(d);e.attachEvent("on"+a,d.wrappedHandler)},q=function(e,a,b){var d=f(e),c;if(v[d]&&v[d][a])for(var h=0,q=v[d][a].length;h<q;h++)(c=v[d][a][h])&&c.handler===b&&(e.detachEvent("on"+a,c.wrappedHandler),v[d][a][h]=null)}):(e=function(e,a,b){var d=f(e);B[d]||(B[d]={});if(!B[d][a]){B[d][a]=[];var c=e["on"+a];c&&B[d][a].push(c);e["on"+a]=h(d,a)}B[d][a].push(b)},q=function(e,a,b){e=f(e);if(B[e]&&
B[e][a]){a=B[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var Q=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(Q=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:
...
function(){return new XMLHttpRequest}],a=d.length;a--;)try{if(d[a]())return d[a]}catch(b){}}();g.util.request=function(d,a){a||(a={});var b=a.method?a.method.toUpperCase():"GET",f=a.onComplete||function(){},e=h(),q;e.onreadystatechange=function(){4===e.readyState&&(f(e),e.onreadystatechange=c)};"GET"===b&&(q=null,"string"===typeof a.parameters&&(d=k(d,a.parameters)));e.open(b,d,!0);"POST"!==b&&"PUT"!==b||e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(q);return e}})();
...
{});h.Intersection?h.warn("fabric.Intersection is already defined"):(h.Intersection=c,h.Intersection.prototype={appendPoint:function(d){this.points.push(d)},appendPoints:function(d){this.points=this.points.concat(d)}},h.Intersection.intersectLineLine=function(d,a,b,f){var e,q=(f.x-b.x)*(d.y-b.y)-(f.y-b.y)*(d.x-b.x);e=(a.x-d.x)*(d.y-b.y)-(a.y-d.y)*(d.x-b.x);b=(f.y-b.y)*(a.x-d.x)-(f.x-b.x)*(a.y-d.y);0!==b?(q/=b,e/=b,0<=q&&1>=q&&0<=e&&1>=e?(e=new c("Intersection"),e.points.push(new h.Point(d.x+q*(a.x-
d.x),d.y+q*(a.y-d.y)))):e=new c):e=0===q||0===e?new c("Coincident"):new c("Parallel");return e},h.Intersection.intersectLinePolygon=function(d,a,b){for(var f=new c,e=b.length,h=0;h<e;h++){var g=c.intersectLineLine(d,a,b[h],b[(h+1)%e]);f.appendPoints(g.points)}0<f.points.length&&(f.status="Intersection");return f},h.Intersection.intersectPolygonPolygon=function(d,a){for(var b=new c,f=d.length,e=0;e<f;e++){var h=c.intersectLinePolygon(d[e],d[(e+1)%f],a);b.appendPoints(h.points)}0<b.points.length&&(b.status=
"Intersection");return b},h.Intersection.intersectPolygonRectangle=function(d,a,b){var f=a.min(b),e=a.max(b);b=new h.Point(e.x,f.y);var q=new h.Point(f.x,e.y);a=c.intersectLinePolygon(f,b,d);b=c.intersectLinePolygon(b,e,d);e=c.intersectLinePolygon(e,q,d);d=c.intersectLinePolygon(q,f,d);f=new c;f.appendPoints(a.points);f.appendPoints(b.points);f.appendPoints(e.points);f.appendPoints(d.points);0<f.points.length&&(f.status="Intersection");return f})})("undefined"!==typeof k?k:this);(function(g){function c(a){a?
...
d.visible&&(d.intersectsWithRect(e,q)||d.isContainedWithinRect(e,q)||d.containsPoint(e)||d.containsPoint(q))&&(d.set("active",!0),h.push(d),a)););return h},_maybeGroupObjects:function(c){this.selection&&this._groupSelector&&this._groupSelectedObjects(c);if(c=this.getActiveGroup())c.setObjectsCoords().setCoords(),c.isMoving=!1,this.setCursor(this.defaultCursor);this._currentTransform=this._groupSelector=null}})})();g.util.object.extend(g.StaticCanvas.prototype,{toDataURL:function(g){g||(g={});var c=
...
return k},__getCroppedCanvas:function(k,c){var h,d;if("left"in c||"top"in c||"width"in c||"height"in c)h=g.util.createCanvasElement(),d=h.getContext("2d"),h.width=c.width||this.width,h.height=c.height||this.height,d.drawImage(k,-c.left||0,-c.top||0);return h},__toDataURLWithMultiplier:function(g,c,h,d){var a=this.getWidth(),b=this.getHeight(),f=a*d,e=b*d,k=this.getActiveObject(),v=this.getActiveGroup(),B=this.contextTop||this.contextContainer;1<d&&this.setWidth(f).setHeight(e);B.scale(d,d);h.left&&
(h.left*=d);h.top&&(h.top*=d);h.width?h.width*=d:1>d&&(h.width=f);h.height?h.height*=d:1>d&&(h.height=e);v?this._tempRemoveBordersControlsFromGroup(v):k&&this.deactivateAll&&this.deactivateAll();this.renderAll(!0);g=this.__toDataURL(g,c,h);this.width=a;this.height=b;B.scale(1/d,1/d);this.setWidth(a).setHeight(b);v?this._restoreBordersControlsOnGroup(v):k&&this.setActiveObject&&this.setActiveObject(k);this.contextTop&&this.clearContext(this.contextTop);this.renderAll();return g},toDataURLWithMultiplier:function(g,
...
this.getWidth();return this.scale(c/this.width/h)},scaleToHeight:function(c){var h=this.getBoundingRectHeight()/this.getHeight();return this.scale(c/this.height/h)},setCoords:function(){var c=k(this.angle),h=this.getViewportTransform(),d=function(a){return g.util.transformPoint(a,h)},a=this._calculateCurrentDimensions(!1),b=a.x,f=a.y;0>b&&(b=Math.abs(b));var a=Math.sqrt(Math.pow(b/2,2)+Math.pow(f/2,2)),e=Math.atan(isFinite(f/b)?f/b:0),q=Math.cos(e+c)*a,e=Math.sin(e+c)*a,a=Math.sin(c),c=Math.cos(c),
v=this.getCenterPoint(),f=new g.Point(b,f),v=new g.Point(v.x-q,v.y-e),e=new g.Point(v.x+f.x*c,v.y+f.x*a),b=d(new g.Point(v.x-f.y*a,v.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(v),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),v=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),B=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),Q=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(v.x+a*this.rotatingPointOffset,v.y-c*this.rotatingPointOffset);this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:v,mr:B,mb:Q,mtr:a};this._setCornerCoords&&
...
this.height=a.height;a.left+="center"===this.originX?this.width/2:"right"===this.originX?this.width:0;a.top+="center"===this.originY?this.height/2:"bottom"===this.originY?this.height:0;this.top=this.top||a.top;this.left=this.left||a.left;this.pathOffset=this.pathOffset||{x:this.minX+this.width/2,y:this.minY+this.height/2}},_render:function(a){var e,b=null,d=0,c=0,h=0,g=0,k=0,q=0,l,p,n=-this.pathOffset.x,m=-this.pathOffset.y;this.group&&"path-group"===this.group.type&&(m=n=0);a.beginPath();for(var r=
0,t=this.path.length;r<t;++r){e=this.path[r];switch(e[0]){case "l":h+=e[1];g+=e[2];a.lineTo(h+n,g+m);break;case "L":h=e[1];g=e[2];a.lineTo(h+n,g+m);break;case "h":h+=e[1];a.lineTo(h+n,g+m);break;case "H":h=e[1];a.lineTo(h+n,g+m);break;case "v":g+=e[1];a.lineTo(h+n,g+m);break;case "V":g=e[1];a.lineTo(h+n,g+m);break;case "m":h+=e[1];g+=e[2];d=h;c=g;a.moveTo(h+n,g+m);break;case "M":h=e[1];g=e[2];d=h;c=g;a.moveTo(h+n,g+m);break;case "c":l=h+e[5];p=g+e[6];k=h+e[3];q=g+e[4];a.bezierCurveTo(h+e[1]+n,g+e[2]+
m,k+n,q+m,l+n,p+m);h=l;g=p;break;case "C":h=e[5];g=e[6];k=e[3];q=e[4];a.bezierCurveTo(e[1]+n,e[2]+m,k+n,q+m,h+n,g+m);break;case "s":l=h+e[3];p=g+e[4];null===b[0].match(/[CcSs]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.bezierCurveTo(k+n,q+m,h+e[1]+n,g+e[2]+m,l+n,p+m);k=h+e[1];q=g+e[2];h=l;g=p;break;case "S":l=e[3];p=e[4];null===b[0].match(/[CcSs]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.bezierCurveTo(k+n,q+m,e[1]+n,e[2]+m,l+n,p+m);h=l;g=p;k=e[1];q=e[2];break;case "q":l=h+e[3];p=g+e[4];k=h+e[1];q=g+e[2];a.quadraticCurveTo(k+
n,q+m,l+n,p+m);h=l;g=p;break;case "Q":l=e[3];p=e[4];a.quadraticCurveTo(e[1]+n,e[2]+m,l+n,p+m);h=l;g=p;k=e[1];q=e[2];break;case "t":l=h+e[1];p=g+e[2];null===b[0].match(/[QqTt]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.quadraticCurveTo(k+n,q+m,l+n,p+m);h=l;g=p;break;case "T":l=e[1];p=e[2];null===b[0].match(/[QqTt]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.quadraticCurveTo(k+n,q+m,l+n,p+m);h=l;g=p;break;case "a":f(a,h+n,g+m,[e[1],e[2],e[3],e[4],e[5],e[6]+h+n,e[7]+g+m]);h+=e[6];g+=e[7];break;case "A":f(a,h+n,g+m,[e[1],e[2],
e[3],e[4],e[5],e[6]+n,e[7]+m]);h=e[6];g=e[7];break;case "z":case "Z":h=d,g=c,a.closePath()}b=e}this._renderFill(a);this._renderStroke(a)},toString:function(){return"#<fabric.Path ("+this.complexity()+'): { "top": '+this.top+', "left": '+this.left+" }>"},toObject:function(e){e=a(this.callSuper("toObject",e),{path:this.path.map(function(a){return a.slice()}),pathOffset:this.pathOffset});this.sourcePath&&(e.sourcePath=this.sourcePath);this.transformMatrix&&(e.transformMatrix=this.transformMatrix);return e},
...
h))),d=n;else a.push(f)}return a},_parseDimensions:function(){for(var a=[],e=[],b,f=null,g=0,k=0,q=0,l=0,n=0,m=0,p,r,t,w=0,y=this.path.length;w<y;++w){b=this.path[w];switch(b[0]){case "l":q+=b[1];l+=b[2];t=[];break;case "L":q=b[1];l=b[2];t=[];break;case "h":q+=b[1];t=[];break;case "H":q=b[1];t=[];break;case "v":l+=b[1];t=[];break;case "V":l=b[1];t=[];break;case "m":q+=b[1];l+=b[2];g=q;k=l;t=[];break;case "M":q=b[1];l=b[2];g=q;k=l;t=[];break;case "c":p=q+b[5];r=l+b[6];n=q+b[3];m=l+b[4];t=c.util.getBoundsOfCurve(q,
l,q+b[1],l+b[2],n,m,p,r);q=p;l=r;break;case "C":q=b[5];l=b[6];n=b[3];m=b[4];t=c.util.getBoundsOfCurve(q,l,b[1],b[2],n,m,q,l);break;case "s":p=q+b[3];r=l+b[4];null===f[0].match(/[CcSs]/)?(n=q,m=l):(n=2*q-n,m=2*l-m);t=c.util.getBoundsOfCurve(q,l,n,m,q+b[1],l+b[2],p,r);n=q+b[1];m=l+b[2];q=p;l=r;break;case "S":p=b[3];r=b[4];null===f[0].match(/[CcSs]/)?(n=q,m=l):(n=2*q-n,m=2*l-m);t=c.util.getBoundsOfCurve(q,l,n,m,b[1],b[2],p,r);q=p;l=r;n=b[1];m=b[2];break;case "q":p=q+b[3];r=l+b[4];n=q+b[1];m=l+b[2];t=
c.util.getBoundsOfCurve(q,l,n,m,n,m,p,r);q=p;l=r;break;case "Q":n=b[1];m=b[2];t=c.util.getBoundsOfCurve(q,l,n,m,n,m,b[3],b[4]);q=b[3];l=b[4];break;case "t":p=q+b[1];r=l+b[2];null===f[0].match(/[QqTt]/)?(n=q,m=l):(n=2*q-n,m=2*l-m);t=c.util.getBoundsOfCurve(q,l,n,m,n,m,p,r);q=p;l=r;break;case "T":p=b[1];r=b[2];null===f[0].match(/[QqTt]/)?(n=q,m=l):(n=2*q-n,m=2*l-m);t=c.util.getBoundsOfCurve(q,l,n,m,n,m,p,r);q=p;l=r;break;case "a":t=c.util.getBoundsOfArc(q,l,b[1],b[2],b[3],b[4],b[5],b[6]+q,b[7]+l);q+=
...
(g=-d.getWidth()/2);d.set({left:d.getLeft()+g,top:d.getTop()-d.getHeight()/2+d.fontSize*(.18+d._fontSizeFraction)});return d},c.Text.fromObject=function(a){return new c.Text(a.text,d(a))},c.util.createAccessors(c.Text))})("undefined"!==typeof k?k:this);delete window.fabric;return k}().fabric;k.fabric=l}}});(function(){var k=O(p.com.fabricjs).fabric,l=w(y([13,27,32])),m=l[0],g=l[1],n=l[2],c=D("Attribute",[K],{get __init__(){return r(this,function(a,b){a.game=b;a.game.attributes.append(a);a.install();
a.reset()},"__init__")},get reset(){return r(this,function(a){a.commit()},"reset")},get predict(){return r(this,function(a){},"predict")},get interact(){return r(this,function(a){},"interact")},get commit(){return r(this,function(a){},"commit")}}),h=D("Sprite",[c],{get __init__(){return r(this,function(a,b,d,f){a.width=d;a.height=f;c.__init__(a,b)},"__init__")},get install(){return r(this,function(a){a.image=new k.Rect({width:a.game.scaleX(a.width),height:a.game.scaleY(a.height),originX:"center",
originY:"center",fill:"white"})},"install")},get reset(){return r(this,function(a,b,d,f,g){if("undefined"==typeof b||null!=b&&b.__class__==t)b=0;if("undefined"==typeof d||null!=d&&d.__class__==t)d=0;if("undefined"==typeof f||null!=f&&f.__class__==t)f=0;if("undefined"==typeof g||null!=g&&g.__class__==t)g=0;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],k;for(k in h)switch(k){case "self":a=h[k];break;case "vX":b=h[k];break;case "vY":d=
h[k];break;case "x":f=h[k];break;case "y":g=h[k]}}}a.vX=b;a.vY=d;a.x=f;a.y=g;c.reset(a)},"reset")},get predict(){return r(this,function(a){a.x+=a.vX*a.game.deltaT;a.y+=a.vY*a.game.deltaT},"predict")},get commit(){return r(this,function(a){a.image.left=a.game.orthoX(a.x);a.image.top=a.game.orthoY(a.y)},"commit")},get draw(){return r(this,function(a){a.game.canvas.add(a.image)},"draw")}}),d=D("Paddle",[h],{get __init__(){return r(this,function(a,b,c){a.index=c;h.__init__(a,b,a.width,a.height)},"__init__")},
get reset(){return r(this,function(a){h.reset(a,t({x:a.index?Math.floor(1E3)/Math.floor(2)-a.margin:Math.floor(-1E3)/Math.floor(2)+a.margin,y:0}))},"reset")},get predict(){return r(this,function(a){a.vY=0;a.index?G(M("K"),a.game.keySet)?a.vY=a.speed:G(M("M"),a.game.keySet)&&(a.vY=-a.speed):G(M("A"),a.game.keySet)?a.vY=a.speed:G(M("Z"),a.game.keySet)&&(a.vY=-a.speed);h.predict(a)},"predict")},get interact(){return r(this,function(a){a.y=Math.max(Math.floor(a.height)/Math.floor(2)-Math.floor(650)/Math.floor(2),
Math.min(a.y,Math.floor(650)/Math.floor(2)-Math.floor(a.height)/Math.floor(2)));a.y-Math.floor(a.height)/Math.floor(2)<a.game.ball.y&&a.game.ball.y<a.y+Math.floor(a.height)/Math.floor(2)&&(0==a.index&&a.game.ball.x<a.x||1==a.index&&a.game.ball.x>a.x)&&(a.game.ball.x=a.x,a.game.ball.vX=-a.game.ball.vX,a.game.ball.speedUp(a))},"interact")}});d.margin=30;d.width=10;d.height=100;d.speed=400;var a=D("Ball",[h],{get __init__(){return r(this,function(a,b){h.__init__(a,b,a.side,a.side)},"__init__")},get reset(){return r(this,
function(a){var b=a.game.serviceIndex*Math.PI+(.5<Math.random()?1:-1)*Math.random()*Math.atan(.65);h.reset(a,t({vX:a.speed*Math.cos(b),vY:a.speed*Math.sin(b)}))},"reset")},get predict(){return r(this,function(a){h.predict(a);a.x<Math.floor(-1E3)/Math.floor(2)?a.game.scored(1):a.x>Math.floor(1E3)/Math.floor(2)&&a.game.scored(0);a.y>Math.floor(650)/Math.floor(2)?(a.y=Math.floor(650)/Math.floor(2),a.vY=-a.vY):a.y<Math.floor(-650)/Math.floor(2)&&(a.y=Math.floor(-650)/Math.floor(2),a.vY=-a.vY)},"predict")},
get speedUp(){return r(this,function(a,b){var c=1+.15*Math.pow(1-Math.abs(a.y-b.y)/Math.floor(b.height)/Math.floor(2),2);Math.abs(a.vX)<3*a.speed&&(a.vX*=c,a.vY*=c)},"speedUp")}});a.side=8;a.speed=300;var b=D("Scoreboard",[c],{get install(){return r(this,function(a){for(var b=[],c=w(y([w(y(["AZ keys:",-.4375])),w(y(["KM keys:",.0625]))])),d=0;d<c.length;d++){var f=c[d],g=f[1];b.append(new k.Text("Player {}".format(f[0]),{fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(650)/
Math.floor(2)+a.nameShift)}))}a.playerLabels=b;a.hintLabel=new k.Text("[spacebar] starts game, [enter] resets score",{fill:"white",fontFamily:"arial",fontSize:"12",left:a.game.orthoX(-437.5),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.hintShift)});a.image=new k.Line(y([a.game.orthoX(Math.floor(-1E3)/Math.floor(2)),a.game.orthoY(Math.floor(650)/Math.floor(2)),a.game.orthoX(Math.floor(1E3)/Math.floor(2)),a.game.orthoY(Math.floor(650)/Math.floor(2))]),{stroke:"white"})},"install")},get increment(){return r(this,
function(a,b){a.scores[b]++},"increment")},get reset(){return r(this,function(a){a.scores=y([0,0]);c.reset(a)},"reset")},get commit(){return r(this,function(a){for(var b=[],c=P(a.scores,w(y([-.125,.375]))),d=0;d<c.length;d++){var f=c[d],g=f[1];b.append(new k.Text("{}".format(f[0]),{fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.nameShift)}))}a.scoreLabels=b},"commit")},get draw(){return r(this,function(a){for(var b=P(a.playerLabels,
a.scoreLabels),c=0;c<b.length;c++){var d=b[c],f=d[1];a.game.canvas.add(d[0]);a.game.canvas.add(f);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)},"draw")}});b.nameShift=75;b.hintShift=25;var l=D("Game",[K],{get __init__(){return r(this,function(c){c.serviceIndex=.5<Math.random()?1:0;c.pause=!0;c.keySet=I();c.canvas=new k.Canvas("canvas",{backgroundColor:"black",originX:"center",originY:"center"});c.canvas.onWindowResise=c.resize;c.canvas.onWindowDraw=c.draw;c.canvas.lineWidth=2;c.canvas.clear();
c.attributes=y([]);for(var f=[],g=R(2),h=0;h<g.length;h++)f.append(d(c,g[h]));c.paddles=f;c.ball=a(c);c.scoreboard=b(c);window.setInterval(c.update,10);window.setInterval(c.draw,20);window.addEventListener("keydown",c.keydown);window.addEventListener("keyup",c.keyup);c.time=+new Date},"__init__")},get update(){return r(this,function(a){var b=a.time;a.time=+new Date;a.deltaT=(a.time-b)/1E3;if(a.pause)G(n,a.keySet)?a.pause=!1:G(m,a.keySet)&&a.scoreboard.reset();else{for(var b=a.attributes,c=0;c<b.length;c++){var d=
b[c];d.predict()}b=a.attributes;for(c=0;c<b.length;c++)d=b[c],d.interact();b=a.attributes;for(c=0;c<b.length;c++)d=b[c],d.commit()}},"update")},get scored(){return r(this,function(a,b){a.scoreboard.increment(b);a.serviceIndex=1-b;for(var c=a.paddles,d=0;d<c.length;d++)c[d].reset();a.ball.reset();a.pause=!0},"scored")},get draw(){return r(this,function(a){a.canvas.clear();a=a.attributes;for(var b=0;b<a.length;b++)a[b].draw()},"draw")},get resize(){return r(this,function(a,b,c){},"resize")},get scaleX(){return r(this,
function(a,b){return b*a.canvas.width/1E3},"scaleX")},get scaleY(){return r(this,function(a,b){return b*a.canvas.height/750},"scaleY")},get orthoX(){return r(this,function(a,b){return a.scaleX(b+Math.floor(1E3)/Math.floor(2))},"orthoX")},get orthoY(){return r(this,function(a,b){return a.scaleY(750-Math.floor(650)/Math.floor(2)-b)},"orthoY")},get keydown(){return r(this,function(a,b){a.keySet.add(b.keyCode)},"keydown")},get keyup(){return r(this,function(a,b){a.keySet.remove(b.keyCode)},"keyup")}}),
f=l();p.Attribute=c;p.Ball=a;p.Game=l;p.Paddle=d;p.Scoreboard=b;p.Sprite=h;p.enter=m;p.esc=g;p.fieldHeight=650;p.game=f;p.orthoHeight=750;p.orthoWidth=1E3;p.space=n})();return p}window.pong=pong();
