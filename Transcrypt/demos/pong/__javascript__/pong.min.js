...
k?[].slice.apply(k):[];k.__class__=v;return k}function H(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=H;return l}function W(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function Q(k){var l={};if(k)for(var p=0;p<k.length;p++)l[pair[0]]=pair[1];l.__class__=Q;l.keys=W;return l}function I(k){return new String(k)}var m={},G=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;break}k=
k[l[n]]}for(n=g;n<l.length;n++)k[l[n]]={},k=k[l[n]]}for(var c in p)k[c]=p[c]};m.__nest__=G;var N=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};m.__init__=N;var r=function(k,l,p){return k&&(k.hasOwnProperty("__class__")||"string"==typeof k||k instanceof String)?(p&&Object.defineProperty(k,p,{value:function(){var g=[].slice.apply(arguments);return l.apply(null,[k].concat(g))},writable:!0,enumerable:!0,configurable:!0}),function(){var g=[].slice.apply(arguments);return l.apply(null,
[k].concat(g))}):l};m.__get__=r;var D=function(k,l,p){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},n=l.length-1;0<=n;n--){var c=l[n],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in p)d=Object.getOwnPropertyDescriptor(p,h),Object.defineProperty(g,h,d);return g};m.__class__=D;var J=m.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,
{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});m.object=J;m.__pragma__=function(){};G(m,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[J],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.79";g.targetSubDir="__javascript__"},"__init__")}}),p=l();k.__Envir__=l;k.__envir__=p}}});G(m,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",
[J],{get __init__(){return r(this,function(g){var n=v([].slice.apply(arguments).slice(1));g.args=n},"__init__")},get __repr__(){return r(this,function(g){return K(g.args)?"{}{}".format(g.__class__.__name__,X(v(g.args))):"???"},"__repr__")},get __str__(){return r(this,function(g){return 1<K(g.args)?I(v(g.args)):K(g.args)?I(g.args[0]):"???"},"__str__")}}),p=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=
...
null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=U(g);p(d,n,c);return d}}}});G(m,"",N(m.org.transcrypt.__base__));var Y=m.__envir__;G(m,"",N(m.org.transcrypt.__standard__));var ca=m.__sort__;Y.executorName=Y.transpilerName;m.main={__file__:""};m.__except__=
null;var t=function(k){k.__class__=t;k.constructor=Object;return k};m.___kwargdict__=t;m.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};m.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];for(g in l)p[g]=l[g];return p};var Z=function(){console.log([].slice.apply(arguments).join(" "))};m.print=Z;console.log.apply=function(){Z([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};m.__in__=F;var R=function(k){return k.startswith("__")&&
k.endswith("__")||"constructor"==k};m.__specialattrib__=R;var K=function(k){try{return k.length}catch(l){result=0;for(attrib in k)R(attrib)||result++;return result}};m.len=K;var aa={__name__:"bool"};m.bool=aa;var S=function(k){return k|0};S.__name__="int";m.int=S;var ba={__name__:"float"};m.float=ba;m.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?aa:"number"==l?0==k%1?S:ba:l}};m.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var n=0;n<g.__bases__.length;n++)if(p(g.__bases__[n],
l))return!0;return!1}return p(k.__class__)};var X=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",p=!1,g;for(g in k)if(!R(g)){var n=g.isnumeric()?g:"'"+g+"'";p?l+=", ":p=!0;try{l+=n+": "+k[g].__repr__()}catch(d){l+=n+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};m.repr=X;m.chr=
function(k){return String.fromCharCode(k)};var L=function(k){return k.charCodeAt(0)};m.org=L;var O=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,p){return k.length<p.length?k:p})).map(function(l,p){return k.map(function(g){return g[p]})})};m.zip=O;m.range=P;m.enumerate=function(k){return O(P(K(k)),k)};m.copy=U;m.deepcopy=V;m.list=y;Array.prototype.__class__=y;y.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:
0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=p)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==H&&!this.length)return"set()";for(var k=this.__class__&&this.__class__!=y?this.__class__==v?"(":"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(p){k+=this[l].toString()}}this.__class__==v&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=y?this.__class__==v?")":"}":"]"};Array.prototype.__setslice__=function(k,l,p,g){0>k&&(k=this.length+
1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==p)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var n=0;k<l;k+=p)this[k]=g[n++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};Array.prototype.py_sort=function(){ca.apply(null,[this].concat([].slice.apply(arguments)))};m.tuple=v;v.__name__="tuple";m.set=H;
H.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};m.__keys__=W;m.dict=Q;Q.__name__="dict";m.str=I;String.prototype.__class__=I;I.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};
...
typeof f&&a.setSourcePath(f);return a},populateWithProperties:function(a,b,f){if(f&&"[object Array]"===Object.prototype.toString.call(f))for(var e=0,d=f.length;e<d;e++)f[e]in a&&(b[f[e]]=a[f[e]])},drawDashedLine:function(a,b,f,e,d,x){e-=b;var g=d-f;d=c(e*e+g*g);e=h(g,e);var g=x.length,n=0,k=!0;a.save();a.translate(b,f);a.moveTo(0,0);a.rotate(e);for(b=0;d>b;)b+=x[n++%g],b>d&&(b=d),a[k?"lineTo":"moveTo"](b,0),k=!k;a.restore()},createCanvasElement:function(a){a||(a=g.document.createElement("canvas"));
...
4);return d}}})("undefined"!==typeof k?k:this);(function(){function n(f,b,d,g,n,k,ea){var T=e.call(arguments);if(a[T])return a[T];var B=Math.PI,l=ea*B/180,M=Math.sin(l),l=Math.cos(l),p=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-l*f*.5-M*b*.5,m=-l*b*.5+M*f*.5,r=d*d,w=g*g,E=m*m,u=z*z,t=r*w-r*E-w*u,v=0;0>t?(r=Math.sqrt(1-t/(r*w)),d*=r,g*=r):v=(n===k?-1:1)*Math.sqrt(t/(r*E+w*u));E=v*d*m/g;u=-v*g*z/d;v=l*E-M*u+.5*f;r=M*E+l*u+.5*b;w=h(1,0,(z-E)/d,(m-u)/g);m=h((z-E)/d,(m-u)/g,(-z-E)/d,(-m-u)/g);0===k&&0<m?
m-=2*B:1===k&&0>m&&(m+=2*B);B=Math.ceil(Math.abs(m/B*2));z=[];m/=B;E=8/3*Math.sin(m/4)*Math.sin(m/4)/Math.sin(m/2);u=w+m;for(t=0;t<B;t++)z[t]=c(w,u,l,M,d,g,v,r,E,p,C),p=z[t][4],C=z[t][5],w=u,u+=m;return a[T]=z}function c(f,a,d,c,h,g,n,k,B,l,m){var p=e.call(arguments);if(b[p])return b[p];var C=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),w=d*h*r-c*g*t+n,v=c*h*r+d*g*t+k;b[p]=[l+B*(-d*h*z-c*g*C),m+B*(-c*h*z+d*g*C),w+B*(d*h*t+c*g*r),v+B*(c*h*t-d*g*r),w,v];return b[p]}function h(f,e,a,b){f=Math.atan2(e,
f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,n,k){var B=e.call(arguments);if(f[B])return f[B];var l=Math.sqrt,m=Math.min,p=Math.max,C=Math.abs,z=[],r=[[],[]],t,w,v,u,y;w=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*n;v=3*d-3*a;for(var D=0;2>D;++D)0<D&&(w=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*k,v=3*c-3*b),1E-12>C(t)?1E-12>C(w)||(u=-v/w,0<u&&1>u&&z.push(u)):(u=w*w-4*v*t,0>u||(y=l(u),u=(-w+y)/(2*t),0<u&&1>u&&z.push(u),u=(-w-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=l=z.length;l--;)u=z[l],w=1-u,t=
w*w*w*a+3*w*w*u*d+3*w*u*u*h+u*u*u*n,r[0][l]=t,t=w*w*w*b+3*w*w*u*c+3*w*u*u*g+u*u*u*k,r[1][l]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=n;r[1][C+1]=k;m=[{x:m.apply(null,r[0]),y:m.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];return f[B]=m}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=n(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+
e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,k,B){var l=0,m=0,p=[],C=[];a=n(k-f,B-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)p=d(l,m,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],a[c][5]),b[0].x=p[0].x+f,b[0].y=p[0].y+e,b[1].x=p[1].x+f,b[1].y=p[1].y+e,C.push(b[0]),C.push(b[1]),l=a[c][4],m=a[c][5];return C};g.util.getBoundsOfCurve=d})();(function(){function n(c,d,a){if(c&&0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&
...
Function.prototype.bind||(Function.prototype.bind=function(d){var a=this,b=g.call(arguments,1),f;f=b.length?function(){return c.call(a,this instanceof h?this:d,b.concat(g.call(arguments)))}:function(){return c.call(a,this instanceof h?this:d,arguments)};h.prototype=this.prototype;f.prototype=new h;return f})})();(function(){function n(){}function c(f){var e=this.constructor.superclass.prototype[f];return 1<arguments.length?e.apply(this,h.call(arguments,1)):e.call(this)}var h=Array.prototype.slice,
...
e.toString),e.valueOf!==Object.prototype.valueOf&&(f.prototype.valueOf=e.valueOf))};g.util.createClass=function(){function f(){this.initialize.apply(this,arguments)}var e=null,a=h.call(arguments,0);"function"===typeof a[0]&&(e=a.shift());f.superclass=e;f.subclasses=[];e&&(n.prototype=e.prototype,f.prototype=new n,e.subclasses.push(f));for(var g=0,A=a.length;g<A;g++)b(f,a[g],e);f.prototype.initialize||(f.prototype.initialize=d);f.prototype.constructor=f;f.prototype.callSuper=c;return f}})();(function(){function n(f){var e=
Array.prototype.slice.call(arguments,1),a,b,d=e.length;for(b=0;b<d;b++)if(a=typeof f[e[b]],!/^(?:function|object|unknown)$/.test(a))return!1;return!0}function c(f,e){return function(b){e.call(a(f),b||g.window.event)}}function h(f,e){return function(a){if(A[f]&&A[f][e])for(var b=A[f][e],d=0,c=b.length;d<c;d++)b[d].call(this,a||g.window.event)}}function d(f,e,a){var b="touchend"===f.type?"changedTouches":"touches";return f[b]&&f[b][0]?f[b][0][e]-(f[b][0][e]-f[b][0][a])||f[a]:f[a]}var a,b,f=function(){var f=
0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=n(g.document.documentElement,"addEventListener","removeEventListener")&&n(g.window,"addEventListener","removeEventListener"),q=n(g.document.documentElement,"attachEvent","detachEvent")&&n(g.window,"attachEvent","detachEvent"),x={},A={};e?(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,
a,d){var h=f(e);b(h,e);x[h]||(x[h]={});x[h][a]||(x[h][a]=[]);d={handler:d,wrappedHandler:c(h,d)};x[h][a].push(d);e.attachEvent("on"+a,d.wrappedHandler)},q=function(e,a,b){var d=f(e),c;if(x[d]&&x[d][a])for(var h=0,q=x[d][a].length;h<q;h++)(c=x[d][a][h])&&c.handler===b&&(e.detachEvent("on"+a,c.wrappedHandler),x[d][a][h]=null)}):(e=function(e,a,b){var d=f(e);A[d]||(A[d]={});if(!A[d][a]){A[d][a]=[];var c=e["on"+a];c&&A[d][a].push(c);e["on"+a]=h(d,a)}A[d][a].push(b)},q=function(e,a,b){e=f(e);if(A[e]&&
A[e][a]){a=A[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var k=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(k=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:
null),e);return{x:k(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var k=g.document.createElement("div"),c="string"===typeof k.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof k.style.opacity?d=function(a,b){a.style.opacity=b;return a}:c&&(d=function(a,b){var f=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&(f.zoom=1);h.test(f.filter)?f.filter=f.filter.replace(h,.9999<=b?"":"alpha(opacity="+100*b+")"):f.filter+=
...
return k},__getCroppedCanvas:function(k,c){var h,d;if("left"in c||"top"in c||"width"in c||"height"in c)h=g.util.createCanvasElement(),d=h.getContext("2d"),h.width=c.width||this.width,h.height=c.height||this.height,d.drawImage(k,-c.left||0,-c.top||0);return h},__toDataURLWithMultiplier:function(g,c,h,d){var a=this.getWidth(),b=this.getHeight(),f=a*d,e=b*d,q=this.getActiveObject(),k=this.getActiveGroup(),A=this.contextTop||this.contextContainer;1<d&&this.setWidth(f).setHeight(e);A.scale(d,d);h.left&&
(h.left*=d);h.top&&(h.top*=d);h.width?h.width*=d:1>d&&(h.width=f);h.height?h.height*=d:1>d&&(h.height=e);k?this._tempRemoveBordersControlsFromGroup(k):q&&this.deactivateAll&&this.deactivateAll();this.renderAll(!0);g=this.__toDataURL(g,c,h);this.width=a;this.height=b;A.scale(1/d,1/d);this.setWidth(a).setHeight(b);k?this._restoreBordersControlsOnGroup(k):q&&this.setActiveObject&&this.setActiveObject(q);this.contextTop&&this.clearContext(this.contextTop);this.renderAll();return g},toDataURLWithMultiplier:function(g,
...
x=this.getCenterPoint(),f=new g.Point(b,f),x=new g.Point(x.x-q,x.y-e),e=new g.Point(x.x+f.x*c,x.y+f.x*a),b=d(new g.Point(x.x-f.y*a,x.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(x),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),x=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),A=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),da=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(x.x+a*this.rotatingPointOffset,x.y-c*this.rotatingPointOffset);this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:x,mr:A,mb:da,mtr:a};this._setCornerCoords&&
...
this.height=a.height;a.left+="center"===this.originX?this.width/2:"right"===this.originX?this.width:0;a.top+="center"===this.originY?this.height/2:"bottom"===this.originY?this.height:0;this.top=this.top||a.top;this.left=this.left||a.left;this.pathOffset=this.pathOffset||{x:this.minX+this.width/2,y:this.minY+this.height/2}},_render:function(a){var e,b=null,d=0,c=0,h=0,g=0,k=0,q=0,l,n,m=-this.pathOffset.x,p=-this.pathOffset.y;this.group&&"path-group"===this.group.type&&(p=m=0);a.beginPath();for(var r=
...
p,k+m,q+p,l+m,n+p);h=l;g=n;break;case "C":h=e[5];g=e[6];k=e[3];q=e[4];a.bezierCurveTo(e[1]+m,e[2]+p,k+m,q+p,h+m,g+p);break;case "s":l=h+e[3];n=g+e[4];null===b[0].match(/[CcSs]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.bezierCurveTo(k+m,q+p,h+e[1]+m,g+e[2]+p,l+m,n+p);k=h+e[1];q=g+e[2];h=l;g=n;break;case "S":l=e[3];n=e[4];null===b[0].match(/[CcSs]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.bezierCurveTo(k+m,q+p,e[1]+m,e[2]+p,l+m,n+p);h=l;g=n;k=e[1];q=e[2];break;case "q":l=h+e[3];n=g+e[4];k=h+e[1];q=g+e[2];a.quadraticCurveTo(k+
m,q+p,l+m,n+p);h=l;g=n;break;case "Q":l=e[3];n=e[4];a.quadraticCurveTo(e[1]+m,e[2]+p,l+m,n+p);h=l;g=n;k=e[1];q=e[2];break;case "t":l=h+e[1];n=g+e[2];null===b[0].match(/[QqTt]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.quadraticCurveTo(k+m,q+p,l+m,n+p);h=l;g=n;break;case "T":l=e[1];n=e[2];null===b[0].match(/[QqTt]/)?(k=h,q=g):(k=2*h-k,q=2*g-q);a.quadraticCurveTo(k+m,q+p,l+m,n+p);h=l;g=n;break;case "a":f(a,h+m,g+p,[e[1],e[2],e[3],e[4],e[5],e[6]+h+m,e[7]+g+p]);h+=e[6];g+=e[7];break;case "A":f(a,h+m,g+p,[e[1],e[2],
...
(g=-d.getWidth()/2);d.set({left:d.getLeft()+g,top:d.getTop()-d.getHeight()/2+d.fontSize*(.18+d._fontSizeFraction)});return d},c.Text.fromObject=function(a){return new c.Text(a.text,d(a))},c.util.createAccessors(c.Text))})("undefined"!==typeof k?k:this);delete window.fabric;return k}().fabric;k.fabric=l}}});(function(){var k=N(m.com.fabricjs).fabric,l=v(y([13,27,32])),p=l[0],g=l[1],n=l[2],c=D("Attribute",[J],{get __init__(){return r(this,function(a,b){a.game=b;a.game.attributes.append(a);a.install();
...
get reset(){return r(this,function(a){h.reset(a,t({x:a.index?Math.floor(1E3)/Math.floor(2)-a.margin:Math.floor(-1E3)/Math.floor(2)+a.margin,y:0}))},"reset")},get predict(){return r(this,function(a){a.vY=0;a.index?F(L("K"),a.game.keySet)?a.vY=a.speed:F(L("M"),a.game.keySet)&&(a.vY=-a.speed):F(L("A"),a.game.keySet)?a.vY=a.speed:F(L("Z"),a.game.keySet)&&(a.vY=-a.speed);h.predict(a)},"predict")},get interact(){return r(this,function(a){a.y=Math.max(Math.floor(a.height)/Math.floor(2)-Math.floor(650)/Math.floor(2),
...
function(a,b){a.scores[b]++},"increment")},get reset(){return r(this,function(a){a.scores=y([0,0]);c.reset(a)},"reset")},get commit(){return r(this,function(a){for(var b=[],c=O(a.scores,v(y([-.125,.375]))),d=0;d<c.length;d++){var f=c[d],g=f[1];b.append(new k.Text("{}".format(f[0]),{fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.nameShift)}))}a.scoreLabels=b},"commit")},get draw(){return r(this,function(a){for(var b=O(a.playerLabels,
a.scoreLabels),c=0;c<b.length;c++){var d=b[c],f=d[1];a.game.canvas.add(d[0]);a.game.canvas.add(f);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)},"draw")}});b.nameShift=75;b.hintShift=25;var l=D("Game",[J],{get __init__(){return r(this,function(c){c.serviceIndex=.5<Math.random()?1:0;c.pause=!0;c.keySet=H();c.canvas=new k.Canvas("canvas",{backgroundColor:"black",originX:"center",originY:"center"});c.canvas.onWindowResise=c.resize;c.canvas.onWindowDraw=c.draw;c.canvas.lineWidth=2;c.canvas.clear();
c.attributes=y([]);for(var f=[],g=P(2),h=0;h<g.length;h++)f.append(d(c,g[h]));c.paddles=f;c.ball=a(c);c.scoreboard=b(c);window.setInterval(c.update,10);window.setInterval(c.draw,20);window.addEventListener("keydown",c.keydown);window.addEventListener("keyup",c.keyup);c.time=+new Date},"__init__")},get update(){return r(this,function(a){var b=a.time;a.time=+new Date;a.deltaT=(a.time-b)/1E3;if(a.pause)F(n,a.keySet)?a.pause=!1:F(p,a.keySet)&&a.scoreboard.reset();else{for(var b=a.attributes,c=0;c<b.length;c++){var d=
