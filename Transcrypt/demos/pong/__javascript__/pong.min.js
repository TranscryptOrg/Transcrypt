'use strict';function pong(){function Q(k,l,p){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof p&&(p=1);if(0<p&&k>=l||0>p&&k<=l)return[];for(var g=[];0<p?k<l:k>l;k+=p)g.push(k);return g}function V(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=k[p]);return l}function W(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=W(k[p]));return l}function y(k){k=k?[].slice.apply(k):[];k.__class__=y;return k}function w(k){k=
k?[].slice.apply(k):[];k.__class__=w;return k}function I(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=I;return l}function X(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var p=0;p<k.length;p++){var g=k[p];l[g[0]]=g[1]}l.__class__=R;l.py_keys=X;return l}function J(k){return new String(k)}var m={},H=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;
break}k=k[l[n]]}for(n=g;n<l.length;n++)k[l[n]]={},k=k[l[n]]}for(var c in p)k[c]=p[c]};m.__nest__=H;var O=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};m.__init__=O;var r=function(k,l,p){return k&&(k.hasOwnProperty("__class__")||"string"==typeof k||k instanceof String)?(p&&Object.defineProperty(k,p,{value:function(){var g=[].slice.apply(arguments);return l.apply(null,[k].concat(g))},writable:!0,enumerable:!0,configurable:!0}),function(){var g=[].slice.apply(arguments);return l.apply(null,
[k].concat(g))}):l};m.__get__=r;var D=function(k,l,p){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},n=l.length-1;0<=n;n--){var c=l[n],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in p)d=Object.getOwnPropertyDescriptor(p,h),Object.defineProperty(g,h,d);return g};m.__class__=D;var K=m.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,
{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});m.object=K;m.__pragma__=function(){};H(m,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[K],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.89";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});H(m,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",
[K],{get __init__(){return r(this,function(g){var n=w([].slice.apply(arguments).slice(1));g.args=n})},get __repr__(){return r(this,function(g){return L(g.args)?"{}{}".format(g.__class__.__name__,Y(w(g.args))):"???"})},get __str__(){return r(this,function(g){return 1<L(g.args)?J(w(g.args)):L(g.args)?J(g.args[0]):"???"})}}),p=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&
...
typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=V(g);p(d,n,c);return d}}}});H(m,"",O(m.org.transcrypt.__base__));var Z=m.__envir__;H(m,"",O(m.org.transcrypt.__standard__));var ea=m.__sort__;Z.executorName=Z.transpilerName;m.main={__file__:""};m.__except__=null;var t=function(k){k.__class__=t;k.constructor=
Object;return k};m.___kwargdict__=t;m.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};m.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];for(g in l)p[g]=l[g];return p};var aa=function(){console.log([].slice.apply(arguments).join(" "))};m.print=aa;console.log.apply=function(){aa([].slice.apply(arguments).slice(1))};var G=function(k,l){return-1<l.indexOf(k)};m.__in__=G;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==
k||k.startswith("py_")};m.__specialattrib__=S;var L=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};m.len=L;var ba={__name__:"bool"};m.bool=ba;var T=function(k){return k|0};T.__name__="int";m.int=T;var ca={__name__:"float"};m.float=ca;m.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?ba:"number"==l?0==k%1?T:ca:l}};m.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var n=0;n<g.__bases__.length;n++)if(p(g.__bases__[n],
...
m.__div__=function(k,l){return"object"==typeof k&&"__div__"in k?k.__div__(l):"object"==typeof l&&"__rdiv__"in l?l.__rdiv__(k):k/l};m.__add__=function(k,l){return"object"==typeof k&&"__add__"in k?k.__add__(l):"object"==typeof l&&"__radd__"in l?l.__radd__(k):k+l};m.__sub__=function(k,l){return"object"==typeof k&&"__sub__"in k?k.__sub__(l):"object"==typeof l&&"__rsub__"in l?l.__rsub__(k):k-l};m.__getitem__=function(k,l){return"object"==typeof k&&"__getitem__"in k?k.__getitem__(l):k[l]};m.__setitem__=
function(k,l,p){"object"==typeof k&&"__setitem__"in k?k.__setitem__(l,p):k[l]=p};m.__call__=function(){var k=[].slice.apply(arguments);return"object"==typeof k[0]&&"__call__"in k[0]?k[0].__call__.apply(null,k.slice(1)):k[0].apply(null,k.slice(1))};H(m,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k={},g=g||{version:"1.5.0"};"undefined"!==typeof k&&(k.fabric=g);"undefined"!==typeof document&&"undefined"!==typeof window?(g.document=document,g.window=window,window.fabric=
g):(g.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),g.window=g.document.createWindow?g.document.createWindow():g.document.parentWindow);g.isTouchSupported="ontouchstart"in g.document.documentElement;g.isLikelyNode="undefined"!==typeof Buffer&&"undefined"===typeof window;g.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");
g.DPI=96;g.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function k(a,b){this.__eventListeners[a]&&(b?g.util.removeFromArray(this.__eventListeners[a],b):this.__eventListeners[a].length=0)}function c(a,b){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var f in a)this.on(f,a[f]);else this.__eventListeners[a]||(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function h(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners=
{};else if(1===arguments.length&&"object"===typeof arguments[0])for(var f in a)k.call(this,f,a[f]);else k.call(this,a,b);return this}}function d(a,b){if(this.__eventListeners){var f=this.__eventListeners[a];if(f){for(var e=0,d=f.length;e<d;e++)f[e].call(this,b||{});return this}}}g.Observable={observe:c,stopObserving:h,fire:d,on:c,off:h,trigger:d}})();g.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var g=0,c=arguments.length;g<c;g++)this._onObjectAdded(arguments[g]);
...
4);return d}}})("undefined"!==typeof k?k:this);(function(){function k(f,b,d,g,n,l,fa){var U=e.call(arguments);if(a[U])return a[U];var F=Math.PI,B=fa*F/180,N=Math.sin(B),B=Math.cos(B),p=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-B*f*.5-N*b*.5,m=-B*b*.5+N*f*.5,r=d*d,x=g*g,E=m*m,u=z*z,t=r*x-r*E-x*u,w=0;0>t?(r=Math.sqrt(1-t/(r*x)),d*=r,g*=r):w=(n===l?-1:1)*Math.sqrt(t/(r*E+x*u));E=w*d*m/g;u=-w*g*z/d;w=B*E-N*u+.5*f;r=N*E+B*u+.5*b;x=h(1,0,(z-E)/d,(m-u)/g);m=h((z-E)/d,(m-u)/g,(-z-E)/d,(-m-u)/g);0===l&&0<m?
m-=2*F:1===l&&0>m&&(m+=2*F);F=Math.ceil(Math.abs(m/F*2));z=[];m/=F;E=8/3*Math.sin(m/4)*Math.sin(m/4)/Math.sin(m/2);u=x+m;for(t=0;t<F;t++)z[t]=c(x,u,B,N,d,g,w,r,E,p,C),p=z[t][4],C=z[t][5],x=u,u+=m;return a[U]=z}function c(f,a,d,c,h,g,k,n,l,B,m){var p=e.call(arguments);if(b[p])return b[p];var C=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),x=d*h*r-c*g*t+k,w=c*h*r+d*g*t+n;b[p]=[B+l*(-d*h*z-c*g*C),m+l*(-c*h*z+d*g*C),x+l*(d*h*t+c*g*r),w+l*(c*h*t-d*g*r),x,w];return b[p]}function h(f,e,a,b){f=Math.atan2(e,
f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,k,n){var l=e.call(arguments);if(f[l])return f[l];var B=Math.sqrt,m=Math.min,p=Math.max,C=Math.abs,z=[],r=[[],[]],t,x,w,u,y;x=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*k;w=3*d-3*a;for(var D=0;2>D;++D)0<D&&(x=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*n,w=3*c-3*b),1E-12>C(t)?1E-12>C(x)||(u=-w/x,0<u&&1>u&&z.push(u)):(u=x*x-4*w*t,0>u||(y=B(u),u=(-x+y)/(2*t),0<u&&1>u&&z.push(u),u=(-x-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=B=z.length;B--;)u=z[B],x=1-u,t=
x*x*x*a+3*x*x*u*d+3*x*u*u*h+u*u*u*k,r[0][B]=t,t=x*x*x*b+3*x*x*u*c+3*x*u*u*g+u*u*u*n,r[1][B]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=k;r[1][C+1]=n;m=[{x:m.apply(null,r[0]),y:m.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];return f[l]=m}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=k(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+
e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,l,F){var m=0,p=0,r=[],C=[];a=k(l-f,F-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)r=d(m,p,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],a[c][5]),b[0].x=r[0].x+f,b[0].y=r[0].y+e,b[1].x=r[1].x+f,b[1].y=r[1].y+e,C.push(b[0]),C.push(b[1]),m=a[c][4],p=a[c][5];return C};g.util.getBoundsOfCurve=d})();(function(){function k(c,d,a){if(c&&0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&
...
0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=k(g.document.documentElement,"addEventListener","removeEventListener")&&k(g.window,"addEventListener","removeEventListener"),q=k(g.document.documentElement,"attachEvent","detachEvent")&&k(g.window,"attachEvent","detachEvent"),v={},A={};e?(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,
a,d){var h=f(e);b(h,e);v[h]||(v[h]={});v[h][a]||(v[h][a]=[]);d={handler:d,wrappedHandler:c(h,d)};v[h][a].push(d);e.attachEvent("on"+a,d.wrappedHandler)},q=function(e,a,b){var d=f(e),c;if(v[d]&&v[d][a])for(var h=0,q=v[d][a].length;h<q;h++)(c=v[d][a][h])&&c.handler===b&&(e.detachEvent("on"+a,c.wrappedHandler),v[d][a][h]=null)}):(e=function(e,a,b){var d=f(e);A[d]||(A[d]={});if(!A[d][a]){A[d][a]=[];var c=e["on"+a];c&&A[d][a].push(c);e["on"+a]=h(d,a)}A[d][a].push(b)},q=function(e,a,b){e=f(e);if(A[e]&&
A[e][a]){a=A[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var da=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(da=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:
null),e);return{x:da(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var k=g.document.createElement("div"),c="string"===typeof k.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof k.style.opacity?d=function(a,b){a.style.opacity=b;return a}:c&&(d=function(a,b){var f=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&(f.zoom=1);h.test(f.filter)?f.filter=f.filter.replace(h,.9999<=b?"":"alpha(opacity="+100*b+")"):f.filter+=
...
v=this.getCenterPoint(),f=new g.Point(b,f),v=new g.Point(v.x-q,v.y-e),e=new g.Point(v.x+f.x*c,v.y+f.x*a),b=d(new g.Point(v.x-f.y*a,v.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(v),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),v=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),A=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),l=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(v.x+a*this.rotatingPointOffset,v.y-c*this.rotatingPointOffset);this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:v,mr:A,mb:l,mtr:a};this._setCornerCoords&&
