...
k?[].slice.apply(k):[];k.__class__=v;return k}function H(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=H;return l}function W(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function Q(k){var l={};if(k)for(var p=0;p<k.length;p++)l[pair[0]]=pair[1];l.__class__=Q;l.keys=W;return l}function I(k){return new String(k)}var n={},G=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,m=0;m<l.length;m++){if(!k.hasOwnProperty(l[m])){g=m;break}k=
k[l[m]]}for(m=g;m<l.length;m++)k[l[m]]={},k=k[l[m]]}for(var c in p)k[c]=p[c]};n.__nest__=G;var N=function(k){k.__inited__||k.__all__.__init__(k.__all__);return k.__all__};n.__init__=N;var r=function(k,l){return k?k.hasOwnProperty("__class__")||"string"==typeof k||k instanceof String?function(p){p=[].slice.apply(arguments);return l.apply(null,[k].concat(p))}:l:l};n.__get__=r;var D=function(k,l,p){for(var g=function(){var a=[].slice.apply(arguments);return g.__new__(a)},m=l.length-1;0<=m;m--){var c=
l[m],h;for(h in c){var d=Object.getOwnPropertyDescriptor(c,h);Object.defineProperty(g,h,d)}}g.__name__=k;g.__bases__=l;for(h in p)d=Object.getOwnPropertyDescriptor(p,h),Object.defineProperty(g,h,d);return g};n.__class__=D;var J=n.__class__("object",[],{__init__:function(k){},__name__:"object",__bases__:[],__new__:function(k){var l=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});n.object=J;n.__pragma__=function(){};G(n,"org.transcrypt.__base__",
{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[J],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.70";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});G(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",[J],{get __init__(){return r(this,function(g){var m=v([].slice.apply(arguments).slice(1));g.args=m})},get __repr__(){return r(this,function(g){return K(g.args)?
"{}{}".format(g.__class__.__name__,X(v(g.args))):"???"})},get __str__(){return r(this,function(g){return 1<K(g.args)?I(v(g.args)):K(g.args)?I(g.args[0]):"???"})}}),p=function(g,m,c){if("undefined"==typeof m||null!=m&&m.__class__==t)m=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":m=h[d];break;case "reverse":c=h[d]}}}m?
g.sort(function(a,b){if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].__class__==t){var f=arguments[f--],e;for(e in f)switch(e){case "a":a=f[e];break;case "b":b=f[e]}}}return m(a)>m(b)}):g.sort();c&&g.reverse()};k.Exception=l;k.__sort__=p;k.sorted=function(g,m,c){if("undefined"==typeof m||null!=m&&m.__class__==t)m=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],
d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":m=h[d];break;case "reverse":c=h[d]}}}d=U(g);p(d,m,c);return d}}}});G(n,"",N(n.org.transcrypt.__base__));var Y=n.__envir__;G(n,"",N(n.org.transcrypt.__standard__));var ca=n.__sort__;Y.executorName=Y.transpilerName;n.main={__file__:""};n.__except__=null;var t=function(k){k.__class__=t;k.constructor=Object;return k};n.___kwargdict__=t;n.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};
n.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];for(g in l)p[g]=l[g];return p};var Z=function(){console.log([].slice.apply(arguments).join(" "))};n.print=Z;console.log.apply=function(){Z([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};n.__in__=F;var R=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==k};n.__specialattrib__=R;var K=function(k){try{return k.length}catch(l){result=0;for(attrib in k)R(attrib)||result++;return result}};n.len=
K;var aa={__name__:"bool"};n.bool=aa;var S=function(k){return k|0};S.__name__="int";n.int=S;var ba={__name__:"float"};n.float=ba;n.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?aa:"number"==l?0==k%1?S:ba:l}};n.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var m=0;m<g.__bases__.length;m++)if(p(g.__bases__[m],l))return!0;return!1}return p(k.__class__)};var X=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==
Object){var l="{",p=!1,g;for(g in k)if(!R(g)){var m=g.isnumeric()?g:"'"+g+"'";p?l+=", ":p=!0;try{l+=m+": "+k[g].__repr__()}catch(d){l+=m+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};n.repr=X;n.chr=function(k){return String.fromCharCode(k)};var L=function(k){return k.charCodeAt(0)};n.org=L;var O=function(){var k=[].slice.call(arguments);return(0==
k.length?[]:k.reduce(function(k,p){return k.length<p.length?k:p})).map(function(l,p){return k.map(function(g){return g[p]})})};n.zip=O;n.range=P;n.enumerate=function(k){return O(P(K(k)),k)};n.copy=U;n.deepcopy=V;n.list=y;Array.prototype.__class__=y;y.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=p)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==H&&!this.length)return"set()";
for(var k=this.__class__&&this.__class__!=y?this.__class__==v?"(":"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(p){k+=this[l].toString()}}this.__class__==v&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=y?this.__class__==v?")":"}":"]"};Array.prototype.__setslice__=function(k,l,p,g){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==p)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var m=0;k<l;k+=p)this[k]=
g[m++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};Array.prototype.py_sort=function(){ca.apply(null,[this].concat([].slice.apply(arguments)))};n.tuple=v;v.__name__="tuple";n.set=H;H.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,
1)};n.__keys__=W;n.dict=Q;Q.__name__="dict";n.str=I;String.prototype.__class__=I;I.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(k){return""==k||this.slice(-k.length)==k};String.prototype.find=function(k,l){return this.indexOf(k,l)};Object.defineProperty(String.prototype,
"format",{get:function(){return r(this,function(k){var l=v([].slice.apply(arguments).slice(1)),p=0;return k.replace(/\{(\w*)\}/g,function(g,m){""==m&&(m=p++);if(m==+m)return"undefined"==l[m]?g:l[m];for(var c=0;c<l.length;c++)if("object"==typeof l[c]&&"undefined"!=typeof l[c][m])return l[c][m];return g})})},enumerable:!0});String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(k){return k.join(this)};String.prototype.lower=function(){return this.toLowerCase()};
String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(k,l){return this.lastIndexOf(k,l)};String.prototype.rsplit=function(k,l){var p=this.split(k||/s+/);return l?[p.slice(0,-l).join(k)].concat(p.slice(-l)):p};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.py_split=function(k,l){k||(k=" ");return this.split(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};
String.prototype.upper=function(){return this.toUpperCase()};G(n,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k={},g=g||{version:"1.5.0"};"undefined"!==typeof k&&(k.fabric=g);"undefined"!==typeof document&&"undefined"!==typeof window?(g.document=document,g.window=window,window.fabric=g):(g.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),g.window=g.document.createWindow?g.document.createWindow():g.document.parentWindow);
...
b[5]+a[5]]},getFunctionBody:function(a){return(String(a).match(/function[^{]*\{([\s\S]*)\}/)||{})[1]},isTransparent:function(a,b,f,e){0<e&&(b=b>e?b-e:0,f=f>e?f-e:0);var d=!0;a=a.getImageData(b,f,2*e||1,2*e||1);b=3;for(f=a.data.length;b<f&&(d=0>=a.data[b],!1!==d);b+=4);return d}}})("undefined"!==typeof k?k:this);(function(){function m(f,b,d,g,m,k,ea){var T=e.call(arguments);if(a[T])return a[T];var B=Math.PI,l=ea*B/180,M=Math.sin(l),l=Math.cos(l),p=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-l*f*.5-M*
b*.5,n=-l*b*.5+M*f*.5,r=d*d,w=g*g,E=n*n,u=z*z,t=r*w-r*E-w*u,v=0;0>t?(r=Math.sqrt(1-t/(r*w)),d*=r,g*=r):v=(m===k?-1:1)*Math.sqrt(t/(r*E+w*u));E=v*d*n/g;u=-v*g*z/d;v=l*E-M*u+.5*f;r=M*E+l*u+.5*b;w=h(1,0,(z-E)/d,(n-u)/g);n=h((z-E)/d,(n-u)/g,(-z-E)/d,(-n-u)/g);0===k&&0<n?n-=2*B:1===k&&0>n&&(n+=2*B);B=Math.ceil(Math.abs(n/B*2));z=[];n/=B;E=8/3*Math.sin(n/4)*Math.sin(n/4)/Math.sin(n/2);u=w+n;for(t=0;t<B;t++)z[t]=c(w,u,l,M,d,g,v,r,E,p,C),p=z[t][4],C=z[t][5],w=u,u+=n;return a[T]=z}function c(f,a,d,c,h,g,m,
k,B,l,n){var p=e.call(arguments);if(b[p])return b[p];var C=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),w=d*h*r-c*g*t+m,v=c*h*r+d*g*t+k;b[p]=[l+B*(-d*h*z-c*g*C),n+B*(-c*h*z+d*g*C),w+B*(d*h*t+c*g*r),v+B*(c*h*t-d*g*r),w,v];return b[p]}function h(f,e,a,b){f=Math.atan2(e,f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,m,k){var B=e.call(arguments);if(f[B])return f[B];var l=Math.sqrt,n=Math.min,p=Math.max,C=Math.abs,z=[],r=[[],[]],t,w,v,u,y;w=6*a-12*d+6*h;t=-3*a+9*d-
9*h+3*m;v=3*d-3*a;for(var D=0;2>D;++D)0<D&&(w=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*k,v=3*c-3*b),1E-12>C(t)?1E-12>C(w)||(u=-v/w,0<u&&1>u&&z.push(u)):(u=w*w-4*v*t,0>u||(y=l(u),u=(-w+y)/(2*t),0<u&&1>u&&z.push(u),u=(-w-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=l=z.length;l--;)u=z[l],w=1-u,t=w*w*w*a+3*w*w*u*d+3*w*u*u*h+u*u*u*m,r[0][l]=t,t=w*w*w*b+3*w*w*u*c+3*w*u*u*g+u*u*u*k,r[1][l]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=m;r[1][C+1]=k;n=[{x:n.apply(null,r[0]),y:n.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];
return f[B]=n}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=m(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,k,B){var l=0,n=0,p=[],C=[];a=m(k-f,B-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)p=d(l,n,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],
