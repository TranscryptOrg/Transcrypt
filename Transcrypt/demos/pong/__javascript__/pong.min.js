...
{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[J],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.73";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});G(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",[J],{get __init__(){return r(this,function(g){var m=v([].slice.apply(arguments).slice(1));g.args=m})},get __repr__(){return r(this,function(g){return K(g.args)?
