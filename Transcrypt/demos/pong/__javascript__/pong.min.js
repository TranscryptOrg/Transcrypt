'use strict';function pong(){function Q(k,l,p){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof p&&(p=1);if(0<p&&k>=l||0>p&&k<=l)return[];for(var g=[];0<p?k<l:k>l;k+=p)g.push(k);return g}function V(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=k[p]);return l}function W(k){if(null==k||"object"==typeof k)return k;var l={},p;for(p in obj)k.hasOwnProperty(p)&&(l[p]=W(k[p]));return l}function w(k){k=k?[].slice.apply(k):[];k.__class__=w;return k}function y(k){k=
k?[].slice.apply(k):[];k.__class__=y;return k}function J(k){var l=[];if(k)for(var p=0;p<k.length;p++)l.add(k[p]);l.__class__=J;return l}function X(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var p=0;p<k.length;p++)l[pair[0]]=pair[1];l.__class__=R;l.keys=X;return l}function K(k){return new String(k)}var m={},H=function(k,l,p){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;break}k=
...
D("__Envir__",[L],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.64";g.targetSubDir="__javascript__"})}}),p=l();k.__Envir__=l;k.__envir__=p}}});H(m,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",[L],{get __init__(){return r(this,function(g){var n=y([].slice.apply(arguments).slice(1));g.args=n})},get __repr__(){return r(this,function(g){return M(g.args)?"{}{}".format(g.__class__.__name__,Y(y(g.args))):
...
h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=V(g);p(d,n,c);return d}}}});H(m,"",O(m.org.transcrypt.__base__));var Z=m.__envir__;H(m,"",O(m.org.transcrypt.__standard__));Z.executorName=Z.transpilerName;m.main={__file__:""};m.__except__=null;var t=function(k){k.__class__=t;k.constructor=Object;return k};m.___kwargdict__=t;m.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};m.__merge__=function(k,l){var p={},g;for(g in k)p[g]=k[g];
for(g in l)p[g]=l[g];return p};var aa=function(){console.log([].slice.apply(arguments).join(" "))};m.print=aa;console.log.apply=function(){aa([].slice.apply(arguments).slice(1))};var F=function(k,l){return-1<l.indexOf(k)};m.__in__=F;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==k};m.__specialattrib__=S;var M=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};m.len=M;var ba={__name__:"bool"};m.bool=ba;var T=function(k){return k|
0};T.__name__="int";m.int=T;var ca={__name__:"float"};m.float=ca;m.type=function(k){try{return k.__class__}catch(p){var l=typeof k;return"boolean"==l?ba:"number"==l?0==k%1?T:ca:l}};m.isinstance=function(k,l){function p(g){if(g==l)return!0;for(var n=0;n<g.__bases__.length;n++)if(p(g.__bases__[n],l))return!0;return!1}return p(k.__class__)};var Y=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",p=!1,g;for(g in k)if(!S(g)){var n=g.isnumeric()?
g:"'"+g+"'";p?l+=", ":p=!0;try{l+=n+": "+k[g].__repr__()}catch(d){l+=n+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};m.repr=Y;m.chr=function(k){return String.fromCharCode(k)};var N=function(k){return k.charCodeAt(0)};m.org=N;var P=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,p){return k.length<p.length?
k:p})).map(function(l,p){return k.map(function(g){return g[p]})})};m.zip=P;m.range=Q;m.enumerate=function(k){return P(Q(M(k)),k)};m.copy=V;m.deepcopy=W;m.list=w;Array.prototype.__class__=w;w.__name__="list";Array.prototype.__getslice__=function(k,l,p){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=p)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==J&&!this.length)return"set()";for(var k=this.__class__&&this.__class__!=w?
this.__class__==y?"(":"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(p){k+=this[l].toString()}}this.__class__==y&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=w?this.__class__==y?")":"}":"]"};Array.prototype.__setslice__=function(k,l,p,g){0>k&&(k=this.length+1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==p)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var n=0;k<l;k+=p)this[k]=g[n++]};Array.prototype.__str__=Array.prototype.__repr__;
Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};m.tuple=y;y.__name__="tuple";m.set=J;J.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};m.__keys__=X;m.dict=R;R.__name__="dict";m.str=K;String.prototype.__class__=K;K.__name__="str";String.prototype.__repr__=function(){return(-1==
...
for(var n=0;n<k.length;n++)if("object"==typeof k[n]&&"undefined"!=typeof k[n][g])return k[n][g];return p})};String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(k){return k.join(this)};String.prototype.jsSplit=String.prototype.split;String.prototype.lower=function(){return this.toLowerCase()};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(k,l){return this.lastIndexOf(k,l)};String.prototype.rsplit=
function(k,l){var p=this.split(k||/s+/);return l?[p.slice(0,-l).join(k)].concat(p.slice(-l)):p};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.split=function(k,l){k||(k=" ");return this.jsSplit(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};H(m,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k=
{},g=g||{version:"1.5.0"};"undefined"!==typeof k&&(k.fabric=g);"undefined"!==typeof document&&"undefined"!==typeof window?(g.document=document,g.window=window,window.fabric=g):(g.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),g.window=g.document.createWindow?g.document.createWindow():g.document.parentWindow);g.isTouchSupported="ontouchstart"in g.document.documentElement;g.isLikelyNode="undefined"!==typeof Buffer&&"undefined"===typeof window;g.SHARED_ATTRIBUTES=
"display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");g.DPI=96;g.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function n(a,b){this.__eventListeners[a]&&(b?g.util.removeFromArray(this.__eventListeners[a],b):this.__eventListeners[a].length=0)}function c(a,b){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var f in a)this.on(f,a[f]);else this.__eventListeners[a]||
(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function h(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var f in a)n.call(this,f,a[f]);else n.call(this,a,b);return this}}function d(a,b){if(this.__eventListeners){var f=this.__eventListeners[a];if(f){for(var e=0,d=f.length;e<d;e++)f[e].call(this,b||{});return this}}}g.Observable={observe:c,stopObserving:h,fire:d,on:c,off:h,
trigger:d}})();g.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var g=0,c=arguments.length;g<c;g++)this._onObjectAdded(arguments[g]);this.renderOnAddRemove&&this.renderAll();return this},insertAt:function(g,c,h){var d=this.getObjects();h?d[c]=g:d.splice(c,0,g);this._onObjectAdded(g);this.renderOnAddRemove&&this.renderAll();return this},remove:function(){for(var g=this.getObjects(),c,h=0,d=arguments.length;h<d;h++)c=g.indexOf(arguments[h]),-1!==c&&(g.splice(c,1),this._onObjectRemoved(arguments[h]));
...
c){return g+=c.complexity?c.complexity():0},0)}};(function(n){var c=Math.sqrt,h=Math.atan2,d=Math.PI/180;g.util={removeFromArray:function(a,b){var f=a.indexOf(b);-1!==f&&a.splice(f,1);return a},getRandomInt:function(a,b){return Math.floor(Math.random()*(b-a+1))+a},degreesToRadians:function(a){return a*d},radiansToDegrees:function(a){return a/d},rotatePoint:function(a,b,f){var e=Math.sin(f);f=Math.cos(f);a.subtractEquals(b);return(new g.Point(a.x*f-a.y*e,a.x*e+a.y*f)).addEquals(b)},transformPoint:function(a,
b,f){return f?new g.Point(b[0]*a.x+b[2]*a.y,b[1]*a.x+b[3]*a.y):new g.Point(b[0]*a.x+b[2]*a.y+b[4],b[1]*a.x+b[3]*a.y+b[5])},invertTransform:function(a){var b=a.slice(),b=1/(a[0]*a[3]-a[1]*a[2]),b=[b*a[3],-b*a[1],-b*a[2],b*a[0],0,0];a=g.util.transformPoint({x:a[4],y:a[5]},b);b[4]=-a.x;b[5]=-a.y;return b},toFixed:function(a,b){return parseFloat(Number(a).toFixed(b))},parseUnit:function(a,b){var f=/\D{0,2}$/.exec(a),e=parseFloat(a);b||(b=g.Text.DEFAULT_SVG_FONT_SIZE);switch(f[0]){case "mm":return e*g.DPI/
25.4;case "cm":return e*g.DPI/2.54;case "in":return e*g.DPI;case "pt":return e*g.DPI/72;case "pc":return e*g.DPI/72*12;case "em":return e*b;default:return e}},falseFunction:function(){return!1},getKlass:function(a,b){a=g.util.string.camelize(a.charAt(0).toUpperCase()+a.slice(1));return g.util.resolveNamespace(b)[a]},resolveNamespace:function(a){if(!a)return g;a=a.split(".");for(var b=a.length,f=n||g.window,e=0;e<b;++e)f=f[a[e]];return f},loadImage:function(a,b,f,e){if(a){var d=g.util.createImage();
d.onload=function(){b&&b.call(f,d);d=d.onload=d.onerror=null};d.onerror=function(){g.log("Error loading "+d.src);b&&b.call(f,null,!0);d=d.onload=d.onerror=null};0!==a.indexOf("data")&&"undefined"!==typeof e&&(d.crossOrigin=e);d.src=a}else b&&b.call(f,a)},enlivenObjects:function(a,b,f,e){function d(){++h===I&&b&&b(c)}a=a||[];var c=[],h=0,I=a.length;I?a.forEach(function(a,b){if(a&&a.type){var h=g.util.getKlass(a.type,f);h.async?h.fromObject(a,function(f,h){h||(c[b]=f,e&&e(a,c[b]));d()}):(c[b]=h.fromObject(a),
e&&e(a,c[b]),d())}else d()}):b&&b(c)},groupSVGElements:function(a,b,f){a=new g.PathGroup(a,b);"undefined"!==typeof f&&a.setSourcePath(f);return a},populateWithProperties:function(a,b,f){if(f&&"[object Array]"===Object.prototype.toString.call(f))for(var e=0,d=f.length;e<d;e++)f[e]in a&&(b[f[e]]=a[f[e]])},drawDashedLine:function(a,b,f,e,d,x){e-=b;var g=d-f;d=c(e*e+g*g);e=h(g,e);var g=x.length,I=0,n=!0;a.save();a.translate(b,f);a.moveTo(0,0);a.rotate(e);for(b=0;d>b;)b+=x[I++%g],b>d&&(b=d),a[n?"lineTo":
"moveTo"](b,0),n=!n;a.restore()},createCanvasElement:function(a){a||(a=g.document.createElement("canvas"));a.getContext||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(a);return a},createImage:function(){return g.isLikelyNode?new (require("canvas").Image):g.document.createElement("img")},createAccessors:function(a){a=a.prototype;for(var b=a.stateProperties.length;b--;){var f=a.stateProperties[b],e=f.charAt(0).toUpperCase()+f.slice(1),d="set"+e,e="get"+e;a[e]||(a[e]=new Function('return this.get("'+
f+'")'));a[d]||(a[d]=new Function("value",'return this.set("'+f+'", value)'))}},clipContext:function(a,b){b.save();b.beginPath();a.clipTo(b);b.clip()},multiplyTransformMatrices:function(a,b){return[a[0]*b[0]+a[2]*b[1],a[1]*b[0]+a[3]*b[1],a[0]*b[2]+a[2]*b[3],a[1]*b[2]+a[3]*b[3],a[0]*b[4]+a[2]*b[5]+a[4],a[1]*b[4]+a[3]*b[5]+a[5]]},getFunctionBody:function(a){return(String(a).match(/function[^{]*\{([\s\S]*)\}/)||{})[1]},isTransparent:function(a,b,f,e){0<e&&(b=b>e?b-e:0,f=f>e?f-e:0);var d=!0;a=a.getImageData(b,
f,2*e||1,2*e||1);b=3;for(f=a.data.length;b<f&&(d=0>=a.data[b],!1!==d);b+=4);return d}}})("undefined"!==typeof k?k:this);(function(){function n(f,b,d,g,n,k,da){var U=e.call(arguments);if(a[U])return a[U];var B=Math.PI,l=da*B/180,G=Math.sin(l),l=Math.cos(l),p=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-l*f*.5-G*b*.5,m=-l*b*.5+G*f*.5,r=d*d,v=g*g,E=m*m,u=z*z,t=r*v-r*E-v*u,w=0;0>t?(r=Math.sqrt(1-t/(r*v)),d*=r,g*=r):w=(n===k?-1:1)*Math.sqrt(t/(r*E+v*u));E=w*d*m/g;u=-w*g*z/d;w=l*E-G*u+.5*f;r=G*E+l*u+.5*b;v=
h(1,0,(z-E)/d,(m-u)/g);m=h((z-E)/d,(m-u)/g,(-z-E)/d,(-m-u)/g);0===k&&0<m?m-=2*B:1===k&&0>m&&(m+=2*B);B=Math.ceil(Math.abs(m/B*2));z=[];m/=B;E=8/3*Math.sin(m/4)*Math.sin(m/4)/Math.sin(m/2);u=v+m;for(t=0;t<B;t++)z[t]=c(v,u,l,G,d,g,w,r,E,p,C),p=z[t][4],C=z[t][5],v=u,u+=m;return a[U]=z}function c(f,a,d,c,h,g,n,k,B,l,G){var m=e.call(arguments);if(b[m])return b[m];var p=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),v=d*h*r-c*g*t+n,w=c*h*r+d*g*t+k;b[m]=[l+B*(-d*h*z-c*g*p),G+B*(-c*h*z+d*g*p),v+B*
(d*h*t+c*g*r),w+B*(c*h*t-d*g*r),v,w];return b[m]}function h(f,e,a,b){f=Math.atan2(e,f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,n,k){var B=e.call(arguments);if(f[B])return f[B];var l=Math.sqrt,m=Math.min,p=Math.max,C=Math.abs,z=[],r=[[],[]],t,v,w,u,y;v=6*a-12*d+6*h;t=-3*a+9*d-9*h+3*n;w=3*d-3*a;for(var D=0;2>D;++D)0<D&&(v=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*k,w=3*c-3*b),1E-12>C(t)?1E-12>C(v)||(u=-w/v,0<u&&1>u&&z.push(u)):(u=v*v-4*w*t,0>u||(y=l(u),u=(-v+y)/(2*t),0<u&&1>u&&
z.push(u),u=(-v-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=l=z.length;l--;)u=z[l],v=1-u,t=v*v*v*a+3*v*v*u*d+3*v*u*u*h+u*u*u*n,r[0][l]=t,t=v*v*v*b+3*v*v*u*c+3*v*u*u*g+u*u*u*k,r[1][l]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=n;r[1][C+1]=k;m=[{x:m.apply(null,r[0]),y:m.apply(null,r[1])},{x:p.apply(null,r[0]),y:p.apply(null,r[1])}];return f[B]=m}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=n(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=
b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,k,B){var l=0,m=0,p=[],C=[];a=n(k-f,B-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)p=d(l,m,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],a[c][5]),b[0].x=p[0].x+f,b[0].y=p[0].y+e,b[1].x=p[1].x+f,b[1].y=p[1].y+e,C.push(b[0]),C.push(b[1]),l=a[c][4],m=a[c][5];return C};g.util.getBoundsOfCurve=d})();(function(){function n(c,d,a){if(c&&
0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&(f=c[b][d]);else for(;b--;)a(c[b],f)&&(f=c[b]);return f}}var c=Array.prototype.slice;Array.prototype.indexOf||(Array.prototype.indexOf=function(c){if(void 0===this||null===this)throw new TypeError;var d=Object(this),a=d.length>>>0;if(0===a)return-1;var b=0;0<arguments.length&&(b=Number(arguments[1]),b!==b?b=0:0!==b&&b!==Number.POSITIVE_INFINITY&&b!==Number.NEGATIVE_INFINITY&&(b=(0<b||-1)*Math.floor(Math.abs(b))));if(b>=a)return-1;
for(b=0<=b?b:Math.max(a-Math.abs(b),0);b<a;b++)if(b in d&&d[b]===c)return b;return-1});Array.prototype.forEach||(Array.prototype.forEach=function(c,d){for(var a=0,b=this.length>>>0;a<b;a++)a in this&&c.call(d,this[a],a,this)});Array.prototype.map||(Array.prototype.map=function(c,d){for(var a=[],b=0,f=this.length>>>0;b<f;b++)b in this&&(a[b]=c.call(d,this[b],b,this));return a});Array.prototype.every||(Array.prototype.every=function(c,d){for(var a=0,b=this.length>>>0;a<b;a++)if(a in this&&!c.call(d,
this[a],a,this))return!1;return!0});Array.prototype.some||(Array.prototype.some=function(c,d){for(var a=0,b=this.length>>>0;a<b;a++)if(a in this&&c.call(d,this[a],a,this))return!0;return!1});Array.prototype.filter||(Array.prototype.filter=function(c,d){for(var a=[],b,f=0,e=this.length>>>0;f<e;f++)f in this&&(b=this[f],c.call(d,b,f,this)&&a.push(b));return a});Array.prototype.reduce||(Array.prototype.reduce=function(c){var d=this.length>>>0,a=0,b;if(1<arguments.length)b=arguments[1];else{do{if(a in
this){b=this[a++];break}if(++a>=d)throw new TypeError;}while(1)}for(;a<d;a++)a in this&&(b=c.call(null,b,this[a],a,this));return b});g.util.array={invoke:function(h,d){for(var a=c.call(arguments,2),b=[],f=0,e=h.length;f<e;f++)b[f]=a.length?h[f][d].apply(h[f],a):h[f][d].call(h[f]);return b},min:function(c,d){return n(c,d,function(a,b){return a<b})},max:function(c,d){return n(c,d,function(a,b){return a>=b})}}})();(function(){function n(c,h){for(var d in h)c[d]=h[d];return c}g.util.object={extend:n,
clone:function(c){return n({},c)}}})();(function(){String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});g.util.string={camelize:function(g){return g.replace(/-+(.)?/g,function(c,h){return h?h.toUpperCase():""})},capitalize:function(g,c){return g.charAt(0).toUpperCase()+(c?g.slice(1):g.slice(1).toLowerCase())},escapeXml:function(g){return g.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&apos;").replace(/</g,"&lt;").replace(/>/g,
"&gt;")}}})();(function(){var g=Array.prototype.slice,c=Function.prototype.apply,h=function(){};Function.prototype.bind||(Function.prototype.bind=function(d){var a=this,b=g.call(arguments,1),f;f=b.length?function(){return c.call(a,this instanceof h?this:d,b.concat(g.call(arguments)))}:function(){return c.call(a,this instanceof h?this:d,arguments)};h.prototype=this.prototype;f.prototype=new h;return f})})();(function(){function n(){}function c(f){var e=this.constructor.superclass.prototype[f];return 1<
arguments.length?e.apply(this,h.call(arguments,1)):e.call(this)}var h=Array.prototype.slice,d=function(){},a=function(){for(var f in{toString:1})if("toString"===f)return!1;return!0}(),b=function(f,e,b){for(var d in e)d in f.prototype&&"function"===typeof f.prototype[d]&&-1<(e[d]+"").indexOf("callSuper")?f.prototype[d]=function(f){return function(){var a=this.constructor.superclass;this.constructor.superclass=b;var d=e[f].apply(this,arguments);this.constructor.superclass=a;if("initialize"!==f)return d}}(d):
f.prototype[d]=e[d],a&&(e.toString!==Object.prototype.toString&&(f.prototype.toString=e.toString),e.valueOf!==Object.prototype.valueOf&&(f.prototype.valueOf=e.valueOf))};g.util.createClass=function(){function f(){this.initialize.apply(this,arguments)}var e=null,a=h.call(arguments,0);"function"===typeof a[0]&&(e=a.shift());f.superclass=e;f.subclasses=[];e&&(n.prototype=e.prototype,f.prototype=new n,e.subclasses.push(f));for(var g=0,A=a.length;g<A;g++)b(f,a[g],e);f.prototype.initialize||(f.prototype.initialize=
d);f.prototype.constructor=f;f.prototype.callSuper=c;return f}})();(function(){function n(f){var e=Array.prototype.slice.call(arguments,1),a,b,d=e.length;for(b=0;b<d;b++)if(a=typeof f[e[b]],!/^(?:function|object|unknown)$/.test(a))return!1;return!0}function c(f,e){return function(b){e.call(a(f),b||g.window.event)}}function h(f,e){return function(a){if(A[f]&&A[f][e])for(var b=A[f][e],d=0,c=b.length;d<c;d++)b[d].call(this,a||g.window.event)}}function d(f,e,a){var b="touchend"===f.type?"changedTouches":
"touches";return f[b]&&f[b][0]?f[b][0][e]-(f[b][0][e]-f[b][0][a])||f[a]:f[a]}var a,b,f=function(){var f=0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=n(g.document.documentElement,"addEventListener","removeEventListener")&&n(g.window,"addEventListener","removeEventListener"),q=n(g.document.documentElement,"attachEvent","detachEvent")&&n(g.window,"attachEvent","detachEvent"),x={},A={};e?
(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,a,d){var h=f(e);b(h,e);x[h]||(x[h]={});x[h][a]||(x[h][a]=[]);d={handler:d,wrappedHandler:c(h,d)};x[h][a].push(d);e.attachEvent("on"+a,d.wrappedHandler)},q=function(e,a,b){var d=f(e),c;if(x[d]&&x[d][a])for(var h=0,q=x[d][a].length;h<q;h++)(c=x[d][a][h])&&c.handler===b&&(e.detachEvent("on"+a,c.wrappedHandler),x[d][a][h]=null)}):(e=function(e,a,b){var d=f(e);A[d]||(A[d]={});if(!A[d][a]){A[d][a]=
[];var c=e["on"+a];c&&A[d][a].push(c);e["on"+a]=h(d,a)}A[d][a].push(b)},q=function(e,a,b){e=f(e);if(A[e]&&A[e][a]){a=A[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var k=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&(k=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||
(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:null),e);return{x:k(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var k=g.document.createElement("div"),c="string"===typeof k.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof k.style.opacity?d=function(a,b){a.style.opacity=b;return a}:c&&(d=function(a,b){var f=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&
(f.zoom=1);h.test(f.filter)?f.filter=f.filter.replace(h,.9999<=b?"":"alpha(opacity="+100*b+")"):f.filter+=" alpha(opacity="+100*b+")";return a});g.util.setStyle=function(a,b){var f=a.style;if(!f)return a;if("string"===typeof b)return a.style.cssText+=";"+b,-1<b.indexOf("opacity")?d(a,b.match(/opacity:\s*(\d?\.?\d*)/)[1]):a;for(var e in b)"opacity"===e?d(a,b[e]):f["float"===e||"cssFloat"===e?"undefined"===typeof f.styleFloat?"cssFloat":"styleFloat":e]=b[e];return a}})();(function(){function k(a,f){var e=
g.document.createElement(a),d;for(d in f)"class"===d?e.className=f[d]:"for"===d?e.htmlFor=f[d]:e.setAttribute(d,f[d]);return e}var c=Array.prototype.slice,h,d=function(a){return c.call(a,0)};try{h=d(g.document.childNodes)instanceof Array}catch(b){}h||(d=function(a){for(var f=Array(a.length),e=a.length;e--;)f[e]=a[e];return f});var a;a=g.document.defaultView&&g.document.defaultView.getComputedStyle?function(a,f){var e=g.document.defaultView.getComputedStyle(a,null);return e?e[f]:void 0}:function(a,
f){var e=a.style[f];!e&&a.currentStyle&&(e=a.currentStyle[f]);return e};(function(){var a=g.document.documentElement.style,f="userSelect"in a?"userSelect":"MozUserSelect"in a?"MozUserSelect":"WebkitUserSelect"in a?"WebkitUserSelect":"KhtmlUserSelect"in a?"KhtmlUserSelect":"";g.util.makeElementUnselectable=function(e){"undefined"!==typeof e.onselectstart&&(e.onselectstart=g.util.falseFunction);f?e.style[f]="none":"string"===typeof e.unselectable&&(e.unselectable="on");return e};g.util.makeElementSelectable=
function(e){"undefined"!==typeof e.onselectstart&&(e.onselectstart=null);f?e.style[f]="":"string"===typeof e.unselectable&&(e.unselectable="");return e}})();(function(){g.util.getScript=function(a,f){var e=g.document.getElementsByTagName("head")[0],d=g.document.createElement("script"),c=!0;d.onload=d.onreadystatechange=function(e){!c||"string"===typeof this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||(c=!1,f(e||g.window.event),d=d.onload=d.onreadystatechange=null)};d.src=
a;e.appendChild(d)}})();g.util.getById=function(a){return"string"===typeof a?g.document.getElementById(a):a};g.util.toArray=d;g.util.makeElement=k;g.util.addClass=function(a,f){a&&-1===(" "+a.className+" ").indexOf(" "+f+" ")&&(a.className+=(a.className?" ":"")+f)};g.util.wrapElement=function(a,f,e){"string"===typeof f&&(f=k(f,e));a.parentNode&&a.parentNode.replaceChild(f,a);f.appendChild(a);return f};g.util.getScrollLeftTop=function(a,f){var e,d,c=0,h=0,k=g.document.documentElement,n=g.document.body||
{scrollLeft:0,scrollTop:0};for(d=a;a&&a.parentNode&&!e;)a=a.parentNode,1===a.nodeType&&"fixed"===g.util.getElementStyle(a,"position")&&(e=a),1===a.nodeType&&d!==f&&"absolute"===g.util.getElementStyle(a,"position")?h=c=0:a===g.document?(c=n.scrollLeft||k.scrollLeft||0,h=n.scrollTop||k.scrollTop||0):(c+=a.scrollLeft||0,h+=a.scrollTop||0);return{left:c,top:h}};g.util.getElementOffset=function(b){var f;f=b&&b.ownerDocument;var e={left:0,top:0},d={left:0,top:0},c={borderLeftWidth:"left",borderTopWidth:"top",
paddingLeft:"left",paddingTop:"top"};if(!f)return{left:0,top:0};for(var h in c)d[c[h]]+=parseInt(a(b,h),10)||0;f=f.documentElement;"undefined"!==typeof b.getBoundingClientRect&&(e=b.getBoundingClientRect());b=g.util.getScrollLeftTop(b,null);return{left:e.left+b.left-(f.clientLeft||0)+d.left,top:e.top+b.top-(f.clientTop||0)+d.top}};g.util.getElementStyle=a})();(function(){function k(d,a){return d+(/\?/.test(d)?"&":"?")+a}function c(){}var h=function(){for(var d=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},
function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},function(){return new XMLHttpRequest}],a=d.length;a--;)try{if(d[a]())return d[a]}catch(b){}}();g.util.request=function(d,a){a||(a={});var b=a.method?a.method.toUpperCase():"GET",f=a.onComplete||function(){},e=h(),q;e.onreadystatechange=function(){4===e.readyState&&(f(e),e.onreadystatechange=c)};"GET"===b&&(q=null,"string"===typeof a.parameters&&(d=k(d,a.parameters)));e.open(b,d,!0);"POST"!==
b&&"PUT"!==b||e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(q);return e}})();g.log=function(){};g.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(k){"undefined"!==typeof console[k]&&"function"===typeof console[k].apply&&(g[k]=function(){return console[k].apply(console,arguments)})});(function(g){function c(c,d){this.x=c;this.y=d}g=g.fabric||(g.fabric={});g.Point?g.warn("fabric.Point is already defined"):(g.Point=c,c.prototype={constructor:c,
add:function(h){return new c(this.x+h.x,this.y+h.y)},addEquals:function(c){this.x+=c.x;this.y+=c.y;return this},scalarAdd:function(h){return new c(this.x+h,this.y+h)},scalarAddEquals:function(c){this.x+=c;this.y+=c;return this},subtract:function(h){return new c(this.x-h.x,this.y-h.y)},subtractEquals:function(c){this.x-=c.x;this.y-=c.y;return this},scalarSubtract:function(h){return new c(this.x-h,this.y-h)},scalarSubtractEquals:function(c){this.x-=c;this.y-=c;return this},multiply:function(h){return new c(this.x*
h,this.y*h)},multiplyEquals:function(c){this.x*=c;this.y*=c;return this},divide:function(h){return new c(this.x/h,this.y/h)},divideEquals:function(c){this.x/=c;this.y/=c;return this},eq:function(c){return this.x===c.x&&this.y===c.y},lt:function(c){return this.x<c.x&&this.y<c.y},lte:function(c){return this.x<=c.x&&this.y<=c.y},gt:function(c){return this.x>c.x&&this.y>c.y},gte:function(c){return this.x>=c.x&&this.y>=c.y},lerp:function(h,d){return new c(this.x+(h.x-this.x)*d,this.y+(h.y-this.y)*d)},
distanceFrom:function(c){var d=this.x-c.x;c=this.y-c.y;return Math.sqrt(d*d+c*c)},midPointFrom:function(h){return new c(this.x+(h.x-this.x)/2,this.y+(h.y-this.y)/2)},min:function(h){return new c(Math.min(this.x,h.x),Math.min(this.y,h.y))},max:function(h){return new c(Math.max(this.x,h.x),Math.max(this.y,h.y))},toString:function(){return this.x+","+this.y},setXY:function(c,d){this.x=c;this.y=d},setFromPoint:function(c){this.x=c.x;this.y=c.y},swap:function(c){var d=this.x,a=this.y;this.x=c.x;this.y=
c.y;c.x=d;c.y=a}})})("undefined"!==typeof k?k:this);(function(g){function c(d){this.status=d;this.points=[]}var h=g.fabric||(g.fabric={});h.Intersection?h.warn("fabric.Intersection is already defined"):(h.Intersection=c,h.Intersection.prototype={appendPoint:function(d){this.points.push(d)},appendPoints:function(d){this.points=this.points.concat(d)}},h.Intersection.intersectLineLine=function(d,a,b,f){var e,q=(f.x-b.x)*(d.y-b.y)-(f.y-b.y)*(d.x-b.x);e=(a.x-d.x)*(d.y-b.y)-(a.y-d.y)*(d.x-b.x);b=(f.y-b.y)*
(a.x-d.x)-(f.x-b.x)*(a.y-d.y);0!==b?(q/=b,e/=b,0<=q&&1>=q&&0<=e&&1>=e?(e=new c("Intersection"),e.points.push(new h.Point(d.x+q*(a.x-d.x),d.y+q*(a.y-d.y)))):e=new c):e=0===q||0===e?new c("Coincident"):new c("Parallel");return e},h.Intersection.intersectLinePolygon=function(d,a,b){for(var f=new c,e=b.length,h=0;h<e;h++){var g=c.intersectLineLine(d,a,b[h],b[(h+1)%e]);f.appendPoints(g.points)}0<f.points.length&&(f.status="Intersection");return f},h.Intersection.intersectPolygonPolygon=function(d,a){for(var b=
new c,f=d.length,e=0;e<f;e++){var h=c.intersectLinePolygon(d[e],d[(e+1)%f],a);b.appendPoints(h.points)}0<b.points.length&&(b.status="Intersection");return b},h.Intersection.intersectPolygonRectangle=function(d,a,b){var f=a.min(b),e=a.max(b);b=new h.Point(e.x,f.y);var q=new h.Point(f.x,e.y);a=c.intersectLinePolygon(f,b,d);b=c.intersectLinePolygon(b,e,d);e=c.intersectLinePolygon(e,q,d);d=c.intersectLinePolygon(q,f,d);f=new c;f.appendPoints(a.points);f.appendPoints(b.points);f.appendPoints(e.points);
f.appendPoints(d.points);0<f.points.length&&(f.status="Intersection");return f})})("undefined"!==typeof k?k:this);(function(g){function c(a){a?this._tryParsingColor(a):this.setSource([0,0,0,1])}function h(a,b,f){0>f&&(f+=1);1<f&&--f;return f<1/6?a+6*(b-a)*f:.5>f?b:f<2/3?a+(b-a)*(2/3-f)*6:a}var d=g.fabric||(g.fabric={});d.Color?d.warn("fabric.Color is already defined."):(d.Color=c,d.Color.prototype={_tryParsingColor:function(a){var b;a in c.colorNameMap&&(a=c.colorNameMap[a]);"transparent"===a?this.setSource([255,
255,255,0]):((b=c.sourceFromHex(a))||(b=c.sourceFromRgb(a)),b||(b=c.sourceFromHsl(a)),b&&this.setSource(b))},_rgbToHsl:function(a,b,f){a/=255;b/=255;f/=255;var e,c,h,g=d.util.array.max([a,b,f]);c=d.util.array.min([a,b,f]);h=(g+c)/2;if(g===c)e=c=0;else{var k=g-c;c=.5<h?k/(2-g-c):k/(g+c);switch(g){case a:e=(b-f)/k+(b<f?6:0);break;case b:e=(f-a)/k+2;break;case f:e=(a-b)/k+4}e/=6}return[Math.round(360*e),Math.round(100*c),Math.round(100*h)]},getSource:function(){return this._source},setSource:function(a){this._source=
a},toRgb:function(){var a=this.getSource();return"rgb("+a[0]+","+a[1]+","+a[2]+")"},toRgba:function(){var a=this.getSource();return"rgba("+a[0]+","+a[1]+","+a[2]+","+a[3]+")"},toHsl:function(){var a=this.getSource(),a=this._rgbToHsl(a[0],a[1],a[2]);return"hsl("+a[0]+","+a[1]+"%,"+a[2]+"%)"},toHsla:function(){var a=this.getSource(),b=this._rgbToHsl(a[0],a[1],a[2]);return"hsla("+b[0]+","+b[1]+"%,"+b[2]+"%,"+a[3]+")"},toHex:function(){var a=this.getSource(),b,f;b=a[0].toString(16);b=1===b.length?"0"+
b:b;f=a[1].toString(16);f=1===f.length?"0"+f:f;a=a[2].toString(16);a=1===a.length?"0"+a:a;return b.toUpperCase()+f.toUpperCase()+a.toUpperCase()},getAlpha:function(){return this.getSource()[3]},setAlpha:function(a){var b=this.getSource();b[3]=a;this.setSource(b);return this},toGrayscale:function(){var a=this.getSource(),b=parseInt((.3*a[0]+.59*a[1]+.11*a[2]).toFixed(0),10);this.setSource([b,b,b,a[3]]);return this},toBlackWhite:function(a){var b=this.getSource(),f=(.3*b[0]+.59*b[1]+.11*b[2]).toFixed(0),
b=b[3],f=Number(f)<Number(a||127)?0:255;this.setSource([f,f,f,b]);return this},overlayWith:function(a){a instanceof c||(a=new c(a));var b=[],f=this.getAlpha(),e=this.getSource();a=a.getSource();for(var d=0;3>d;d++)b.push(Math.round(.5*e[d]+.5*a[d]));b[3]=f;this.setSource(b);return this}},d.Color.reRGBa=/^rgba?\(\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,d.Color.reHSLa=/^hsla?\(\s*(\d{1,3})\s*,\s*(\d{1,3}\%)\s*,\s*(\d{1,3}\%)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,
d.Color.reHex=/^#?([0-9a-f]{6}|[0-9a-f]{3})$/i,d.Color.colorNameMap={aqua:"#00FFFF",black:"#000000",blue:"#0000FF",fuchsia:"#FF00FF",gray:"#808080",green:"#008000",lime:"#00FF00",maroon:"#800000",navy:"#000080",olive:"#808000",orange:"#FFA500",purple:"#800080",red:"#FF0000",silver:"#C0C0C0",teal:"#008080",white:"#FFFFFF",yellow:"#FFFF00"},d.Color.fromRgb=function(a){return c.fromSource(c.sourceFromRgb(a))},d.Color.sourceFromRgb=function(a){if(a=a.match(c.reRGBa)){var b=parseInt(a[1],10)/(/%$/.test(a[1])?
100:1)*(/%$/.test(a[1])?255:1),f=parseInt(a[2],10)/(/%$/.test(a[2])?100:1)*(/%$/.test(a[2])?255:1),e=parseInt(a[3],10)/(/%$/.test(a[3])?100:1)*(/%$/.test(a[3])?255:1);return[parseInt(b,10),parseInt(f,10),parseInt(e,10),a[4]?parseFloat(a[4]):1]}},d.Color.fromRgba=c.fromRgb,d.Color.fromHsl=function(a){return c.fromSource(c.sourceFromHsl(a))},d.Color.sourceFromHsl=function(a){if(a=a.match(c.reHSLa)){var b=(parseFloat(a[1])%360+360)%360/360,f=parseFloat(a[2])/(/%$/.test(a[2])?100:1),e=parseFloat(a[3])/
(/%$/.test(a[3])?100:1);if(0===f)e=f=b=e;else var d=.5>=e?e*(f+1):e+f-e*f,g=2*e-d,e=h(g,d,b+1/3),f=h(g,d,b),b=h(g,d,b-1/3);return[Math.round(255*e),Math.round(255*f),Math.round(255*b),a[4]?parseFloat(a[4]):1]}},d.Color.fromHsla=c.fromHsl,d.Color.fromHex=function(a){return c.fromSource(c.sourceFromHex(a))},d.Color.sourceFromHex=function(a){if(a.match(c.reHex)){var b=a.slice(a.indexOf("#")+1),f=3===b.length;a=f?b.charAt(0)+b.charAt(0):b.substring(0,2);var e=f?b.charAt(1)+b.charAt(1):b.substring(2,4),
b=f?b.charAt(2)+b.charAt(2):b.substring(4,6);return[parseInt(a,16),parseInt(e,16),parseInt(b,16),1]}},d.Color.fromSource=function(a){var b=new c;b.setSource(a);return b})})("undefined"!==typeof k?k:this);(function(){if(g.StaticCanvas)g.warn("fabric.StaticCanvas is already defined.");else{var k=g.util.object.extend,c=g.util.getElementOffset,h=g.util.removeFromArray,d=Error("Could not initialize `canvas` element");g.StaticCanvas=g.util.createClass({initialize:function(a,b){b||(b={});this._initStatic(a,
b);g.StaticCanvas.activeInstance=this},backgroundColor:"",backgroundImage:null,overlayColor:"",overlayImage:null,includeDefaultValues:!0,stateful:!0,renderOnAddRemove:!0,clipTo:null,controlsAboveOverlay:!1,allowTouchScrolling:!1,imageSmoothingEnabled:!0,preserveObjectStacking:!1,viewportTransform:[1,0,0,1,0,0],onBeforeScaleRotate:function(){},_initStatic:function(a,b){this._objects=[];this._createLowerCanvas(a);this._initOptions(b);this._setImageSmoothing();b.overlayImage&&this.setOverlayImage(b.overlayImage,
this.renderAll.bind(this));b.backgroundImage&&this.setBackgroundImage(b.backgroundImage,this.renderAll.bind(this));b.backgroundColor&&this.setBackgroundColor(b.backgroundColor,this.renderAll.bind(this));b.overlayColor&&this.setOverlayColor(b.overlayColor,this.renderAll.bind(this));this.calcOffset()},calcOffset:function(){this._offset=c(this.lowerCanvasEl);return this},setOverlayImage:function(a,b,f){return this.__setBgOverlayImage("overlayImage",a,b,f)},setBackgroundImage:function(a,b,f){return this.__setBgOverlayImage("backgroundImage",
a,b,f)},setOverlayColor:function(a,b){return this.__setBgOverlayColor("overlayColor",a,b)},setBackgroundColor:function(a,b){return this.__setBgOverlayColor("backgroundColor",a,b)},_setImageSmoothing:function(){var a=this.getContext();a.imageSmoothingEnabled=this.imageSmoothingEnabled;a.webkitImageSmoothingEnabled=this.imageSmoothingEnabled;a.mozImageSmoothingEnabled=this.imageSmoothingEnabled;a.msImageSmoothingEnabled=this.imageSmoothingEnabled;a.oImageSmoothingEnabled=this.imageSmoothingEnabled},
__setBgOverlayImage:function(a,b,f,e){"string"===typeof b?g.util.loadImage(b,function(b){this[a]=new g.Image(b,e);f&&f()},this,e&&e.crossOrigin):(e&&b.setOptions(e),this[a]=b,f&&f());return this},__setBgOverlayColor:function(a,b,f){if(b&&b.source){var e=this;g.util.loadImage(b.source,function(d){e[a]=new g.Pattern({source:d,repeat:b.repeat,offsetX:b.offsetX,offsetY:b.offsetY});f&&f()})}else this[a]=b,f&&f();return this},_createCanvasElement:function(){var a=g.document.createElement("canvas");a.style||
(a.style={});if(!a)throw d;this._initCanvasElement(a);return a},_initCanvasElement:function(a){g.util.createCanvasElement(a);if("undefined"===typeof a.getContext)throw d;},_initOptions:function(a){for(var b in a)this[b]=a[b];this.width=this.width||parseInt(this.lowerCanvasEl.width,10)||0;this.height=this.height||parseInt(this.lowerCanvasEl.height,10)||0;this.lowerCanvasEl.style&&(this.lowerCanvasEl.width=this.width,this.lowerCanvasEl.height=this.height,this.lowerCanvasEl.style.width=this.width+"px",
this.lowerCanvasEl.style.height=this.height+"px",this.viewportTransform=this.viewportTransform.slice())},_createLowerCanvas:function(a){this.lowerCanvasEl=g.util.getById(a)||this._createCanvasElement();this._initCanvasElement(this.lowerCanvasEl);g.util.addClass(this.lowerCanvasEl,"lower-canvas");this.interactive&&this._applyCanvasStyle(this.lowerCanvasEl);this.contextContainer=this.lowerCanvasEl.getContext("2d")},getWidth:function(){return this.width},getHeight:function(){return this.height},setWidth:function(a,
b){return this.setDimensions({width:a},b)},setHeight:function(a,b){return this.setDimensions({height:a},b)},setDimensions:function(a,b){var f;b=b||{};for(var e in a)f=a[e],b.cssOnly||(this._setBackstoreDimension(e,a[e]),f+="px"),b.backstoreOnly||this._setCssDimension(e,f);b.cssOnly||this.renderAll();this.calcOffset();return this},_setBackstoreDimension:function(a,b){this.lowerCanvasEl[a]=b;this.upperCanvasEl&&(this.upperCanvasEl[a]=b);this.cacheCanvasEl&&(this.cacheCanvasEl[a]=b);this[a]=b;return this},
_setCssDimension:function(a,b){this.lowerCanvasEl.style[a]=b;this.upperCanvasEl&&(this.upperCanvasEl.style[a]=b);this.wrapperEl&&(this.wrapperEl.style[a]=b);return this},getZoom:function(){return Math.sqrt(this.viewportTransform[0]*this.viewportTransform[3])},setViewportTransform:function(a){var b=this.getActiveGroup();this.viewportTransform=a;this.renderAll();a=0;for(var f=this._objects.length;a<f;a++)this._objects[a].setCoords();b&&b.setCoords();return this},zoomToPoint:function(a,b){var f=a;a=
g.util.transformPoint(a,g.util.invertTransform(this.viewportTransform));this.viewportTransform[0]=b;this.viewportTransform[3]=b;var e=g.util.transformPoint(a,this.viewportTransform);this.viewportTransform[4]+=f.x-e.x;this.viewportTransform[5]+=f.y-e.y;this.renderAll();f=0;for(e=this._objects.length;f<e;f++)this._objects[f].setCoords();return this},setZoom:function(a){this.zoomToPoint(new g.Point(0,0),a);return this},absolutePan:function(a){this.viewportTransform[4]=-a.x;this.viewportTransform[5]=
-a.y;this.renderAll();a=0;for(var b=this._objects.length;a<b;a++)this._objects[a].setCoords();return this},relativePan:function(a){return this.absolutePan(new g.Point(-a.x-this.viewportTransform[4],-a.y-this.viewportTransform[5]))},getElement:function(){return this.lowerCanvasEl},getActiveObject:function(){return null},getActiveGroup:function(){return null},_draw:function(a,b){if(b){a.save();var f=this.viewportTransform;a.transform(f[0],f[1],f[2],f[3],f[4],f[5]);this._shouldRenderObject(b)&&b.render(a);
a.restore();this.controlsAboveOverlay||b._renderControls(a)}},_shouldRenderObject:function(a){return a?a!==this.getActiveGroup()||!this.preserveObjectStacking:!1},_onObjectAdded:function(a){this.stateful&&a.setupState();a.canvas=this;a.setCoords();this.fire("object:added",{target:a});a.fire("added")},_onObjectRemoved:function(a){this.getActiveObject()===a&&(this.fire("before:selection:cleared",{target:a}),this._discardActiveObject(),this.fire("selection:cleared"));this.fire("object:removed",{target:a});
a.fire("removed")},clearContext:function(a){a.clearRect(0,0,this.width,this.height);return this},getContext:function(){return this.contextContainer},clear:function(){this._objects.length=0;this.discardActiveGroup&&this.discardActiveGroup();this.discardActiveObject&&this.discardActiveObject();this.clearContext(this.contextContainer);this.contextTop&&this.clearContext(this.contextTop);this.fire("canvas:cleared");this.renderAll();return this},renderAll:function(a){var b=this[!0===a&&this.interactive?
