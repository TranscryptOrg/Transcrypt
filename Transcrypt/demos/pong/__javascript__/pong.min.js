'use strict';function pong(){function Q(k,l,m){"undefined"==typeof l&&(l=k,k=0);"undefined"==typeof m&&(m=1);if(0<m&&k>=l||0>m&&k<=l)return[];for(var g=[];0<m?k<l:k>l;k+=m)g.push(k);return g}function V(k){if(null==k||"object"==typeof k)return k;var l={},m;for(m in obj)k.hasOwnProperty(m)&&(l[m]=k[m]);return l}function W(k){if(null==k||"object"==typeof k)return k;var l={},m;for(m in obj)k.hasOwnProperty(m)&&(l[m]=W(k[m]));return l}function y(k){k=k?[].slice.apply(k):[];k.__class__=y;return k}function w(k){k=
k?[].slice.apply(k):[];k.__class__=w;return k}function I(k){var l=[];if(k)for(var m=0;m<k.length;m++)l.add(k[m]);l.__class__=I;return l}function X(){keys=[];for(attrib in this)__normalattrib__(attrib)&&keys.push(key);return keys}function R(k){var l={};if(k)for(var m=0;m<k.length;m++){var g=k[m];l[g[0]]=g[1]}l.__class__=R;l.py_keys=X;return l}function J(k){return new String(k)}var p={},H=function(k,l,m){if(""!=l){l=l.split(".");for(var g=l.length,n=0;n<l.length;n++){if(!k.hasOwnProperty(l[n])){g=n;
...
{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(k));return l}});p.object=K;p.__pragma__=function(){};H(p,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(k){var l=D("__Envir__",[K],{get __init__(){return r(this,function(g){g.transpilerName="transcrypt";g.transpilerVersion="3.5.87";g.targetSubDir="__javascript__"})}}),m=l();k.__Envir__=l;k.__envir__=m}}});H(p,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(k){var l=D("Exception",
[K],{get __init__(){return r(this,function(g){var n=w([].slice.apply(arguments).slice(1));g.args=n})},get __repr__(){return r(this,function(g){return L(g.args)?"{}{}".format(g.__class__.__name__,Y(w(g.args))):"???"})},get __str__(){return r(this,function(g){return 1<L(g.args)?J(w(g.args)):L(g.args)?J(g.args[0]):"???"})}}),m=function(g,n,c){if("undefined"==typeof n||null!=n&&n.__class__==t)n=null;if("undefined"==typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&
...
typeof c||null!=c&&c.__class__==t)c=!1;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==t){var h=arguments[h--],d;for(d in h)switch(d){case "iterable":g=h[d];break;case "key":n=h[d];break;case "reverse":c=h[d]}}}d=V(g);m(d,n,c);return d}}}});H(p,"",O(p.org.transcrypt.__base__));var Z=p.__envir__;H(p,"",O(p.org.transcrypt.__standard__));var ea=p.__sort__;Z.executorName=Z.transpilerName;p.main={__file__:""};p.__except__=null;var t=function(k){k.__class__=t;k.constructor=
Object;return k};p.___kwargdict__=t;p.property=function(k,l){return{get:function(){return k(this)},set:function(k){l(this,k)},enumerable:!0}};p.__merge__=function(k,l){var m={},g;for(g in k)m[g]=k[g];for(g in l)m[g]=l[g];return m};var aa=function(){console.log([].slice.apply(arguments).join(" "))};p.print=aa;console.log.apply=function(){aa([].slice.apply(arguments).slice(1))};var G=function(k,l){return-1<l.indexOf(k)};p.__in__=G;var S=function(k){return k.startswith("__")&&k.endswith("__")||"constructor"==
k||k.startswith("py_")};p.__specialattrib__=S;var L=function(k){try{return k.length}catch(l){result=0;for(attrib in k)S(attrib)||result++;return result}};p.len=L;var ba={__name__:"bool"};p.bool=ba;var T=function(k){return k|0};T.__name__="int";p.int=T;var ca={__name__:"float"};p.float=ca;p.type=function(k){try{return k.__class__}catch(m){var l=typeof k;return"boolean"==l?ba:"number"==l?0==k%1?T:ca:l}};p.isinstance=function(k,l){function m(g){if(g==l)return!0;for(var n=0;n<g.__bases__.length;n++)if(m(g.__bases__[n],
l))return!0;return!1}return m(k.__class__)};var Y=function(k){try{return k.__repr__()}catch(c){try{return k.__str__()}catch(h){try{if(k.constructor==Object){var l="{",m=!1,g;for(g in k)if(!S(g)){var n=g.isnumeric()?g:"'"+g+"'";m?l+=", ":m=!0;try{l+=n+": "+k[g].__repr__()}catch(d){l+=n+": "+k[g].toString()}}return l+"}"}return"boolean"==typeof k?k.toString().capitalize():k.toString()}catch(d){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof k+">)"),"???"}}}};p.repr=Y;p.chr=
function(k){return String.fromCharCode(k)};var M=function(k){return k.charCodeAt(0)};p.org=M;var P=function(){var k=[].slice.call(arguments);return(0==k.length?[]:k.reduce(function(k,m){return k.length<m.length?k:m})).map(function(l,m){return k.map(function(g){return g[m]})})};p.zip=P;p.range=Q;p.enumerate=function(k){return P(Q(L(k)),k)};p.copy=V;p.deepcopy=W;p.list=y;Array.prototype.__class__=y;y.__name__="list";Array.prototype.__getslice__=function(k,l,m){0>k&&(k=this.length+1-k);null==l?l=this.length:
0>l&&(l=this.length+1-l);for(var g=[];k<l;k+=m)g.push(this[k]);return g};Array.prototype.__repr__=function(){if(this.__class__==I&&!this.length)return"set()";for(var k=this.__class__&&this.__class__!=y?this.__class__==w?"(":"{":"[",l=0;l<this.length;l++){l&&(k+=", ");try{k+=this[l].__repr__()}catch(m){k+=this[l].toString()}}this.__class__==w&&1==this.length&&(k+=",");return k+=this.__class__&&this.__class__!=y?this.__class__==w?")":"}":"]"};Array.prototype.__setslice__=function(k,l,m,g){0>k&&(k=this.length+
1-k);null==l?l=this.length:0>l&&(l=this.length+1-l);if(null==m)Array.prototype.splice.apply(this,[k,l-k].concat(g));else for(var n=0;k<l;k+=m)this[k]=g[n++]};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(k){this.push(k)};Array.prototype.clear=function(k){k.splice(0,k.length)};Array.prototype.extend=function(k){this.push.apply(this,k)};Array.prototype.py_sort=function(){ea.apply(null,[this].concat([].slice.apply(arguments)))};p.tuple=w;w.__name__="tuple";p.set=I;
I.__name__="set";Array.prototype.add=function(k){-1==this.indexOf(k)&&this.push(k)};Array.prototype.remove=function(k){k=this.indexOf(k);-1!=k&&this.splice(k,1)};p.__keys__=X;p.dict=R;R.__name__="dict";p.str=J;String.prototype.__class__=J;J.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};
...
"")};String.prototype.py_split=function(k,l){k||(k=" ");return this.split(k||/s+/,l)};String.prototype.startswith=function(k){return 0==this.indexOf(k)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};p.__matmul__=function(k,l){return"object"==typeof k&&"__matmul__"in k?k.__matmul__(l):l.__rmatmul__(k)};p.__mul__=function(k,l){return"object"==typeof k&&"__mul__"in k?k.__mul__(l):"object"==typeof l&&"__rmul__"in l?l.__rmul__(k):k*l};
p.__div__=function(k,l){return"object"==typeof k&&"__div__"in k?k.__div__(l):"object"==typeof l&&"__rdiv__"in l?l.__rdiv__(k):k/l};p.__add__=function(k,l){return"object"==typeof k&&"__add__"in k?k.__add__(l):"object"==typeof l&&"__radd__"in l?l.__radd__(k):k+l};p.__sub__=function(k,l){return"object"==typeof k&&"__sub__"in k?k.__sub__(l):"object"==typeof l&&"__rsub__"in l?l.__rsub__(k):k-l};p.__getitem__=function(k,l){return"object"==typeof k&&"__getitem__"in k?k.__getitem__(l):k[l]};p.__setitem__=
function(k,l,m){"object"==typeof k&&"__setitem__"in k?k.__setitem__(l,m):k[l]=m};H(p,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(k){var l=function(){var k={},g=g||{version:"1.5.0"};"undefined"!==typeof k&&(k.fabric=g);"undefined"!==typeof document&&"undefined"!==typeof window?(g.document=document,g.window=window,window.fabric=g):(g.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),g.window=g.document.createWindow?g.document.createWindow():g.document.parentWindow);
g.isTouchSupported="ontouchstart"in g.document.documentElement;g.isLikelyNode="undefined"!==typeof Buffer&&"undefined"===typeof window;g.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");g.DPI=96;g.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function k(a,b){this.__eventListeners[a]&&(b?g.util.removeFromArray(this.__eventListeners[a],b):this.__eventListeners[a].length=
0)}function c(a,b){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var f in a)this.on(f,a[f]);else this.__eventListeners[a]||(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function h(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var f in a)k.call(this,f,a[f]);else k.call(this,a,b);return this}}function d(a,b){if(this.__eventListeners){var f=this.__eventListeners[a];
...
this.getObjects().length},size:function(){return this.getObjects().length},contains:function(g){return-1<this.getObjects().indexOf(g)},complexity:function(){return this.getObjects().reduce(function(g,c){return g+=c.complexity?c.complexity():0},0)}};(function(k){var c=Math.sqrt,h=Math.atan2,d=Math.PI/180;g.util={removeFromArray:function(a,b){var f=a.indexOf(b);-1!==f&&a.splice(f,1);return a},getRandomInt:function(a,b){return Math.floor(Math.random()*(b-a+1))+a},degreesToRadians:function(a){return a*
...
b[5]+a[5]]},getFunctionBody:function(a){return(String(a).match(/function[^{]*\{([\s\S]*)\}/)||{})[1]},isTransparent:function(a,b,f,e){0<e&&(b=b>e?b-e:0,f=f>e?f-e:0);var d=!0;a=a.getImageData(b,f,2*e||1,2*e||1);b=3;for(f=a.data.length;b<f&&(d=0>=a.data[b],!1!==d);b+=4);return d}}})("undefined"!==typeof k?k:this);(function(){function k(f,b,d,g,n,l,fa){var U=e.call(arguments);if(a[U])return a[U];var F=Math.PI,B=fa*F/180,N=Math.sin(B),B=Math.cos(B),m=0,C=0;d=Math.abs(d);g=Math.abs(g);var z=-B*f*.5-N*
b*.5,p=-B*b*.5+N*f*.5,r=d*d,x=g*g,E=p*p,u=z*z,t=r*x-r*E-x*u,w=0;0>t?(r=Math.sqrt(1-t/(r*x)),d*=r,g*=r):w=(n===l?-1:1)*Math.sqrt(t/(r*E+x*u));E=w*d*p/g;u=-w*g*z/d;w=B*E-N*u+.5*f;r=N*E+B*u+.5*b;x=h(1,0,(z-E)/d,(p-u)/g);p=h((z-E)/d,(p-u)/g,(-z-E)/d,(-p-u)/g);0===l&&0<p?p-=2*F:1===l&&0>p&&(p+=2*F);F=Math.ceil(Math.abs(p/F*2));z=[];p/=F;E=8/3*Math.sin(p/4)*Math.sin(p/4)/Math.sin(p/2);u=x+p;for(t=0;t<F;t++)z[t]=c(x,u,B,N,d,g,w,r,E,m,C),m=z[t][4],C=z[t][5],x=u,u+=p;return a[U]=z}function c(f,a,d,c,h,g,k,
n,l,B,p){var m=e.call(arguments);if(b[m])return b[m];var C=Math.cos(f),z=Math.sin(f),r=Math.cos(a),t=Math.sin(a),x=d*h*r-c*g*t+k,w=c*h*r+d*g*t+n;b[m]=[B+l*(-d*h*z-c*g*C),p+l*(-c*h*z+d*g*C),x+l*(d*h*t+c*g*r),w+l*(c*h*t-d*g*r),x,w];return b[m]}function h(f,e,a,b){f=Math.atan2(e,f);a=Math.atan2(b,a);return a>=f?a-f:2*Math.PI-(f-a)}function d(a,b,d,c,h,g,k,n){var l=e.call(arguments);if(f[l])return f[l];var B=Math.sqrt,p=Math.min,m=Math.max,C=Math.abs,z=[],r=[[],[]],t,x,w,u,y;x=6*a-12*d+6*h;t=-3*a+9*d-
9*h+3*k;w=3*d-3*a;for(var D=0;2>D;++D)0<D&&(x=6*b-12*c+6*g,t=-3*b+9*c-9*g+3*n,w=3*c-3*b),1E-12>C(t)?1E-12>C(x)||(u=-w/x,0<u&&1>u&&z.push(u)):(u=x*x-4*w*t,0>u||(y=B(u),u=(-x+y)/(2*t),0<u&&1>u&&z.push(u),u=(-x-y)/(2*t),0<u&&1>u&&z.push(u)));for(C=B=z.length;B--;)u=z[B],x=1-u,t=x*x*x*a+3*x*x*u*d+3*x*u*u*h+u*u*u*k,r[0][B]=t,t=x*x*x*b+3*x*x*u*c+3*x*u*u*g+u*u*u*n,r[1][B]=t;r[0][C]=a;r[1][C]=b;r[0][C+1]=k;r[1][C+1]=n;p=[{x:p.apply(null,r[0]),y:p.apply(null,r[1])},{x:m.apply(null,r[0]),y:m.apply(null,r[1])}];
return f[l]=p}var a={},b={},f={},e=Array.prototype.join;g.util.drawArc=function(f,e,a,b){var d=[[],[],[],[]];b=k(b[5]-e,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var c=0,h=b.length;c<h;c++)d[c][0]=b[c][0]+e,d[c][1]=b[c][1]+a,d[c][2]=b[c][2]+e,d[c][3]=b[c][3]+a,d[c][4]=b[c][4]+e,d[c][5]=b[c][5]+a,f.bezierCurveTo.apply(f,d[c])};g.util.getBoundsOfArc=function(f,e,a,b,c,h,g,l,F){var p=0,m=0,r=[],C=[];a=k(l-f,F-e,a,b,h,g,c);b=[[],[]];c=0;for(h=a.length;c<h;c++)r=d(p,m,a[c][0],a[c][1],a[c][2],a[c][3],a[c][4],
a[c][5]),b[0].x=r[0].x+f,b[0].y=r[0].y+e,b[1].x=r[1].x+f,b[1].y=r[1].y+e,C.push(b[0]),C.push(b[1]),p=a[c][4],m=a[c][5];return C};g.util.getBoundsOfCurve=d})();(function(){function k(c,d,a){if(c&&0!==c.length){var b=c.length-1,f=d?c[b][d]:c[b];if(d)for(;b--;)a(c[b][d],f)&&(f=c[b][d]);else for(;b--;)a(c[b],f)&&(f=c[b]);return f}}var c=Array.prototype.slice;Array.prototype.indexOf||(Array.prototype.indexOf=function(c){if(void 0===this||null===this)throw new TypeError;var d=Object(this),a=d.length>>>
...
h?this:d,arguments)};h.prototype=this.prototype;f.prototype=new h;return f})})();(function(){function k(){}function c(f){var e=this.constructor.superclass.prototype[f];return 1<arguments.length?e.apply(this,h.call(arguments,1)):e.call(this)}var h=Array.prototype.slice,d=function(){},a=function(){for(var f in{toString:1})if("toString"===f)return!1;return!0}(),b=function(f,e,b){for(var d in e)d in f.prototype&&"function"===typeof f.prototype[d]&&-1<(e[d]+"").indexOf("callSuper")?f.prototype[d]=function(f){return function(){var a=
...
[];e&&(k.prototype=e.prototype,f.prototype=new k,e.subclasses.push(f));for(var g=0,A=a.length;g<A;g++)b(f,a[g],e);f.prototype.initialize||(f.prototype.initialize=d);f.prototype.constructor=f;f.prototype.callSuper=c;return f}})();(function(){function k(f){var e=Array.prototype.slice.call(arguments,1),a,b,d=e.length;for(b=0;b<d;b++)if(a=typeof f[e[b]],!/^(?:function|object|unknown)$/.test(a))return!1;return!0}function c(f,e){return function(b){e.call(a(f),b||g.window.event)}}function h(f,e){return function(a){if(A[f]&&
A[f][e])for(var b=A[f][e],d=0,c=b.length;d<c;d++)b[d].call(this,a||g.window.event)}}function d(f,e,a){var b="touchend"===f.type?"changedTouches":"touches";return f[b]&&f[b][0]?f[b][0][e]-(f[b][0][e]-f[b][0][a])||f[a]:f[a]}var a,b,f=function(){var f=0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+f++)}}();(function(){var f={};a=function(e){return f[e]};b=function(e,a){f[e]=a}})();var e=k(g.document.documentElement,"addEventListener","removeEventListener")&&k(g.window,"addEventListener",
"removeEventListener"),q=k(g.document.documentElement,"attachEvent","detachEvent")&&k(g.window,"attachEvent","detachEvent"),v={},A={};e?(e=function(f,e,a){f.addEventListener(e,a,!1)},q=function(f,e,a){f.removeEventListener(e,a,!1)}):q?(e=function(e,a,d){var h=f(e);b(h,e);v[h]||(v[h]={});v[h][a]||(v[h][a]=[]);d={handler:d,wrappedHandler:c(h,d)};v[h][a].push(d);e.attachEvent("on"+a,d.wrappedHandler)},q=function(e,a,b){var d=f(e),c;if(v[d]&&v[d][a])for(var h=0,q=v[d][a].length;h<q;h++)(c=v[d][a][h])&&
c.handler===b&&(e.detachEvent("on"+a,c.wrappedHandler),v[d][a][h]=null)}):(e=function(e,a,b){var d=f(e);A[d]||(A[d]={});if(!A[d][a]){A[d][a]=[];var c=e["on"+a];c&&A[d][a].push(c);e["on"+a]=h(d,a)}A[d][a].push(b)},q=function(e,a,b){e=f(e);if(A[e]&&A[e][a]){a=A[e][a];e=0;for(var d=a.length;e<d;e++)a[e]===b&&a.splice(e,1)}});g.util.addListener=e;g.util.removeListener=q;var da=function(f){return"unknown"!==typeof f.clientX?f.clientX:0},l=function(f){return"unknown"!==typeof f.clientY?f.clientY:0};g.isTouchSupported&&
(da=function(f){return d(f,"pageX","clientX")},l=function(f){return d(f,"pageY","clientY")});g.util.getPointer=function(f,e){f||(f=g.window.event);var a=g.util.getScrollLeftTop(f.target||("unknown"!==typeof f.srcElement?f.srcElement:null),e);return{x:da(f)+a.left,y:l(f)+a.top}};g.util.object.extend(g.util,g.Observable)})();(function(){var k=g.document.createElement("div"),c="string"===typeof k.style.filter,h=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,d=function(a){return a};"string"===typeof k.style.opacity?
...
e?"undefined"===typeof f.styleFloat?"cssFloat":"styleFloat":e]=b[e];return a}})();(function(){function k(a,f){var e=g.document.createElement(a),d;for(d in f)"class"===d?e.className=f[d]:"for"===d?e.htmlFor=f[d]:e.setAttribute(d,f[d]);return e}var c=Array.prototype.slice,h,d=function(a){return c.call(a,0)};try{h=d(g.document.childNodes)instanceof Array}catch(b){}h||(d=function(a){for(var f=Array(a.length),e=a.length;e--;)f[e]=a[e];return f});var a;a=g.document.defaultView&&g.document.defaultView.getComputedStyle?
...
"complete"!==this.readyState||(c=!1,f(e||g.window.event),d=d.onload=d.onreadystatechange=null)};d.src=a;e.appendChild(d)}})();g.util.getById=function(a){return"string"===typeof a?g.document.getElementById(a):a};g.util.toArray=d;g.util.makeElement=k;g.util.addClass=function(a,f){a&&-1===(" "+a.className+" ").indexOf(" "+f+" ")&&(a.className+=(a.className?" ":"")+f)};g.util.wrapElement=function(a,f,e){"string"===typeof f&&(f=k(f,e));a.parentNode&&a.parentNode.replaceChild(f,a);f.appendChild(a);return f};
g.util.getScrollLeftTop=function(a,f){var e,d,c=0,h=0,k=g.document.documentElement,n=g.document.body||{scrollLeft:0,scrollTop:0};for(d=a;a&&a.parentNode&&!e;)a=a.parentNode,1===a.nodeType&&"fixed"===g.util.getElementStyle(a,"position")&&(e=a),1===a.nodeType&&d!==f&&"absolute"===g.util.getElementStyle(a,"position")?h=c=0:a===g.document?(c=n.scrollLeft||k.scrollLeft||0,h=n.scrollTop||k.scrollTop||0):(c+=a.scrollLeft||0,h+=a.scrollTop||0);return{left:c,top:h}};g.util.getElementOffset=function(b){var f;
f=b&&b.ownerDocument;var e={left:0,top:0},d={left:0,top:0},c={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!f)return{left:0,top:0};for(var h in c)d[c[h]]+=parseInt(a(b,h),10)||0;f=f.documentElement;"undefined"!==typeof b.getBoundingClientRect&&(e=b.getBoundingClientRect());b=g.util.getScrollLeftTop(b,null);return{left:e.left+b.left-(f.clientLeft||0)+d.left,top:e.top+b.top-(f.clientTop||0)+d.top}};g.util.getElementStyle=a})();(function(){function k(d,a){return d+
...
(f(e),e.onreadystatechange=c)};"GET"===b&&(q=null,"string"===typeof a.parameters&&(d=k(d,a.parameters)));e.open(b,d,!0);"POST"!==b&&"PUT"!==b||e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(q);return e}})();g.log=function(){};g.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(k){"undefined"!==typeof console[k]&&"function"===typeof console[k].apply&&(g[k]=function(){return console[k].apply(console,arguments)})});(function(g){function c(c,
...
1<d&&this.setWidth(f).setHeight(e);A.scale(d,d);h.left&&(h.left*=d);h.top&&(h.top*=d);h.width?h.width*=d:1>d&&(h.width=f);h.height?h.height*=d:1>d&&(h.height=e);v?this._tempRemoveBordersControlsFromGroup(v):k&&this.deactivateAll&&this.deactivateAll();this.renderAll(!0);g=this.__toDataURL(g,c,h);this.width=a;this.height=b;A.scale(1/d,1/d);this.setWidth(a).setHeight(b);v?this._restoreBordersControlsOnGroup(v):k&&this.setActiveObject&&this.setActiveObject(k);this.contextTop&&this.clearContext(this.contextTop);
...
b)?f/b:0),q=Math.cos(e+c)*a,e=Math.sin(e+c)*a,a=Math.sin(c),c=Math.cos(c),v=this.getCenterPoint(),f=new g.Point(b,f),v=new g.Point(v.x-q,v.y-e),e=new g.Point(v.x+f.x*c,v.y+f.x*a),b=d(new g.Point(v.x-f.y*a,v.y+f.y*c)),q=d(new g.Point(e.x-f.y*a,e.y+f.y*c)),f=d(v),d=d(e),e=new g.Point((f.x+b.x)/2,(f.y+b.y)/2),v=new g.Point((d.x+f.x)/2,(d.y+f.y)/2),A=new g.Point((q.x+d.x)/2,(q.y+d.y)/2),l=new g.Point((q.x+b.x)/2,(q.y+b.y)/2),a=new g.Point(v.x+a*this.rotatingPointOffset,v.y-c*this.rotatingPointOffset);
this.oCoords={tl:f,tr:d,br:q,bl:b,ml:e,mt:v,mr:A,mb:l,mtr:a};this._setCornerCoords&&this._setCornerCoords();return this}})})();g.util.object.extend(g.Object.prototype,{sendToBack:function(){this.group?g.StaticCanvas.prototype.sendToBack.call(this.group,this):this.canvas.sendToBack(this);return this},bringToFront:function(){this.group?g.StaticCanvas.prototype.bringToFront.call(this.group,this):this.canvas.bringToFront(this);return this},sendBackwards:function(k){this.group?g.StaticCanvas.prototype.sendBackwards.call(this.group,
...
Math.floor(2))})},get orthoY(){return r(this,function(a,b){return a.scaleY(750-Math.floor(650)/Math.floor(2)-b)})},get keydown(){return r(this,function(a,b){a.keySet.add(b.keyCode)})},get keyup(){return r(this,function(a,b){a.keySet.remove(b.keyCode)})}}),f=l();p.Attribute=c;p.Ball=a;p.Game=l;p.Paddle=d;p.Scoreboard=b;p.Sprite=h;p.enter=m;p.esc=g;p.fieldHeight=650;p.game=f;p.orthoHeight=750;p.orthoWidth=1E3;p.space=n})();return p}window.pong=pong();
