...
Transcrypt is currently tested under Windows, Linux testing will be done during alpha, OS X probably later. So the installation procecure below is Windows-only, Linux will require some creativity or patience.
