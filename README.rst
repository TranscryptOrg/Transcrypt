...
- Seamless access to any JavaScript library had been favoured over including Python libraries. There are some exceptions to this rule, e.g. like math, random, itertools, time and turtle, and some more may follow, but in general the accent is on libraries that are relevant in the browser.
