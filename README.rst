...
- Since the standard libs are desktop-oriented, only a limited selection of standard libs have currently been chosen for inclusion in the Transcrypt. Use or encapsulate the JavaScript ones, that's part of the concept. Some additional standard libs may be ported in the future though.
