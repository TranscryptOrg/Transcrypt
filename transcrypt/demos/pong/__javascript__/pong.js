...
// ============ Source: D:/activ_tosh/geatec/transcrypt/transcrypt/modules/org/transcrypt/__javascript__/__core__.mod.js ============
...
// ============ Source: D:/activ_tosh/geatec/transcrypt/transcrypt/modules/org/transcrypt/__base__.py ============
...
/* 000007 */ 							self.transpiler_name = 'transcrypt';
/* 000008 */ 							self.transpiler_version = '3.5.142';
/* 000009 */ 							self.target_subdir = '__javascript__';
/* 000009 */ 						});}
/* 000009 */ 					});
/* 000011 */ 					var __envir__ = __Envir__ ();
/* 000011 */ 					__pragma__ ('<all>')
/* 000011 */ 						__all__.__Envir__ = __Envir__;
/* 000011 */ 						__all__.__envir__ = __envir__;
/* 000011 */ 					__pragma__ ('</all>')
/* 000011 */ 				}
/* 000011 */ 			}
...
// ============ Source: D:/activ_tosh/geatec/transcrypt/transcrypt/modules/org/transcrypt/__standard__.py ============
...
// ============ Source: D:/activ_tosh/geatec/transcrypt/transcrypt/modules/org/transcrypt/__javascript__/__builtin__.mod.js ============
...
// ============ Source: D:/activ_tosh/geatec/transcrypt/transcrypt/modules/com/fabricjs/__init__.py ============
...
// ============ Source: D:/activ_tosh/geatec/transcrypt/transcrypt/demos/pong/pong.py ============
...
/* 000077 */ 				Sprite.reset (self, __kwargdict__ ({x: (self.index ? Math.floor (orthoWidth) / Math.floor (2) - self.margin : Math.floor (-orthoWidth) / Math.floor (2) + self.margin), y: 0}));
/* 000077 */ 			});},
...
/* 000101 */ 				self.y = Math.max (Math.floor (self.height) / Math.floor (2) - Math.floor (fieldHeight) / Math.floor (2), Math.min (self.y, Math.floor (fieldHeight) / Math.floor (2) - Math.floor (self.height) / Math.floor (2)));
/* 000104 */ 				if ((self.y - Math.floor (self.height) / Math.floor (2) < self.game.ball.y && self.game.ball.y < self.y + Math.floor (self.height) / Math.floor (2)) && (self.index == 0 && self.game.ball.x < self.x || self.index == 1 && self.game.ball.x > self.x)) {
...
/* 000139 */ 				if (self.x < Math.floor (-orthoWidth) / Math.floor (2)) {
/* 000140 */ 					self.game.scored (1);
/* 000140 */ 				}
/* 000140 */ 				else {
/* 000141 */ 					if (self.x > Math.floor (orthoWidth) / Math.floor (2)) {
/* 000142 */ 						self.game.scored (0);
/* 000142 */ 					}
/* 000142 */ 				}
/* 000144 */ 				if (self.y > Math.floor (fieldHeight) / Math.floor (2)) {
/* 000145 */ 					self.y = Math.floor (fieldHeight) / Math.floor (2);
/* 000146 */ 					self.vY = -self.vY;
/* 000146 */ 				}
/* 000146 */ 				else {
/* 000147 */ 					if (self.y < Math.floor (-fieldHeight) / Math.floor (2)) {
/* 000148 */ 						self.y = Math.floor (-fieldHeight) / Math.floor (2);
/* 000149 */ 						self.vY = -self.vY;
/* 000149 */ 					}
/* 000149 */ 				}
/* 000149 */ 			});},
/* 000151 */ 			get speedUp () {return __get__ (this, function (self, bat) {
/* 000152 */ 				var factor = 1 + 0.15 * Math.pow (1 - Math.abs (self.y - bat.y) / Math.floor (bat.height) / Math.floor (2), 2);
...
/* 000165 */ 						__accu0__.append (new fabric.Text ('Player {}'.format (name), dict ({'fill': 'white', 'fontFamily': 'arial', 'fontSize': '30', 'left': self.game.orthoX (position * orthoWidth), 'top': self.game.orthoY (Math.floor (fieldHeight) / Math.floor (2) + self.nameShift)})));
/* 000165 */ 					}
/* 000165 */ 					return __accu0__;
/* 000165 */ 				} ();
/* 000170 */ 				self.hintLabel = new fabric.Text ('[spacebar] starts game, [enter] resets score', dict ({'fill': 'white', 'fontFamily': 'arial', 'fontSize': '12', 'left': self.game.orthoX (-7 / 16 * orthoWidth), 'top': self.game.orthoY (Math.floor (fieldHeight) / Math.floor (2) + self.hintShift)}));
/* 000175 */ 				self.image = new fabric.Line (list ([self.game.orthoX (Math.floor (-orthoWidth) / Math.floor (2)), self.game.orthoY (Math.floor (fieldHeight) / Math.floor (2)), self.game.orthoX (Math.floor (orthoWidth) / Math.floor (2)), self.game.orthoY (Math.floor (fieldHeight) / Math.floor (2))]), dict ({'stroke': 'white'}));
/* 000175 */ 			});},
...
/* 000190 */ 						__accu0__.append (new fabric.Text ('{}'.format (score), dict ({'fill': 'white', 'fontFamily': 'arial', 'fontSize': '30', 'left': self.game.orthoX (position * orthoWidth), 'top': self.game.orthoY (Math.floor (fieldHeight) / Math.floor (2) + self.nameShift)})));
/* 000190 */ 					}
...
/* 000269 */ 				return self.scaleX (x + Math.floor (orthoWidth) / Math.floor (2));
/* 000269 */ 			});},
/* 000271 */ 			get orthoY () {return __get__ (this, function (self, y) {
/* 000272 */ 				return self.scaleY (orthoHeight - Math.floor (fieldHeight) / Math.floor (2) - y);
/* 000272 */ 			});},
