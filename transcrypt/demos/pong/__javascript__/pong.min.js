...
a.reset()},"__init__")},get reset(){return q(this,function(a){a.commit()},"reset")},get predict(){return q(this,function(a){},"predict")},get interact(){return q(this,function(a){},"interact")},get commit(){return q(this,function(a){},"commit")}}),k=F("Sprite",[d],{get __init__(){return q(this,function(a,b,c,e){a.width=c;a.height=e;d.__init__(a,b)},"__init__")},get install(){return q(this,function(a){a.image=new e.Rect(C({width:a.game.scaleX(a.width),height:a.game.scaleY(a.height),originX:"center",
originY:"center",fill:"white"}))},"install")},get reset(){return q(this,function(a,b,c,e,g){if("undefined"==typeof b||null!=b&&b.__class__==u)b=0;if("undefined"==typeof c||null!=c&&c.__class__==u)c=0;if("undefined"==typeof e||null!=e&&e.__class__==u)e=0;if("undefined"==typeof g||null!=g&&g.__class__==u)g=0;if(arguments.length){var h=arguments.length-1;if(arguments[h]&&arguments[h].__class__==u){var h=arguments[h--],k;for(k in h)switch(k){case "self":a=h[k];break;case "vX":b=h[k];break;case "vY":c=
h[k];break;case "x":e=h[k];break;case "y":g=h[k]}}}a.vX=b;a.vY=c;a.x=e;a.y=g;d.reset(a)},"reset")},get predict(){return q(this,function(a){a.x+=a.vX*a.game.deltaT;a.y+=a.vY*a.game.deltaT},"predict")},get commit(){return q(this,function(a){a.image.left=a.game.orthoX(a.x);a.image.top=a.game.orthoY(a.y)},"commit")},get draw(){return q(this,function(a){a.game.canvas.add(a.image)},"draw")}}),c=F("Paddle",[k],{get __init__(){return q(this,function(a,b,c){a.index=c;k.__init__(a,b,a.width,a.height)},"__init__")},
get reset(){return q(this,function(a){k.reset(a,u({x:a.index?Math.floor(500)-a.margin:Math.floor(-500)+a.margin,y:0}))},"reset")},get predict(){return q(this,function(a){a.vY=0;a.index?J(P("K"),a.game.keySet)?a.vY=a.speed:J(P("M"),a.game.keySet)&&(a.vY=-a.speed):J(P("A"),a.game.keySet)?a.vY=a.speed:J(P("Z"),a.game.keySet)&&(a.vY=-a.speed);k.predict(a)},"predict")},get interact(){return q(this,function(a){a.y=Math.max(Math.floor(a.height/2)-Math.floor(325),Math.min(a.y,Math.floor(325)-Math.floor(a.height/
2)));a.y-Math.floor(a.height/2)<a.game.ball.y&&a.game.ball.y<a.y+Math.floor(a.height/2)&&(0==a.index&&a.game.ball.x<a.x||1==a.index&&a.game.ball.x>a.x)&&(a.game.ball.x=a.x,a.game.ball.vX=-a.game.ball.vX,a.game.ball.speedUp(a))},"interact")}});c.margin=30;c.width=10;c.height=100;c.speed=400;var a=F("Ball",[k],{get __init__(){return q(this,function(a,b){k.__init__(a,b,a.side,a.side)},"__init__")},get reset(){return q(this,function(a){var b=a.game.serviceIndex*Math.PI+(.5<Math.random()?1:-1)*Math.random()*
Math.atan(.65);k.reset(a,u({vX:a.speed*Math.cos(b),vY:a.speed*Math.sin(b)}))},"reset")},get predict(){return q(this,function(a){k.predict(a);a.x<Math.floor(-500)?a.game.scored(1):a.x>Math.floor(500)&&a.game.scored(0);a.y>Math.floor(325)?(a.y=Math.floor(325),a.vY=-a.vY):a.y<Math.floor(-325)&&(a.y=Math.floor(-325),a.vY=-a.vY)},"predict")},get speedUp(){return q(this,function(a,b){var c=1+.15*Math.pow(1-Math.abs(a.y-b.y)/Math.floor(b.height/2),2);Math.abs(a.vX)<3*a.speed&&(a.vX*=c,a.vY*=c)},"speedUp")}});
...
top:a.game.orthoY(Math.floor(325)+a.hintShift)}));a.image=new e.Line(H([a.game.orthoX(Math.floor(-500)),a.game.orthoY(Math.floor(325)),a.game.orthoX(Math.floor(500)),a.game.orthoY(Math.floor(325))]),C({stroke:"white"}))},"install")},get increment(){return q(this,function(a,b){a.scores[b]++},"increment")},get reset(){return q(this,function(a){a.scores=H([0,0]);d.reset(a)},"reset")},get commit(){return q(this,function(a){for(var b=[],c=S(a.scores,y([-.125,.375])),d=0;d<c.length;d++){var g=c[d],h=g[1];
b.append(new e.Text("{}".format(g[0]),C({fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*h),top:a.game.orthoY(Math.floor(325)+a.nameShift)})))}a.scoreLabels=b},"commit")},get draw(){return q(this,function(a){for(var b=S(a.playerLabels,a.scoreLabels),c=0;c<b.length;c++){var d=b[c],e=d[1];a.game.canvas.add(d[0]);a.game.canvas.add(e);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)},"draw")}});b.nameShift=75;b.hintShift=25;var l=F("Game",[N],{get __init__(){return q(this,
function(d){d.serviceIndex=.5<Math.random()?1:0;d.pause=!0;d.keySet=D();d.canvas=new e.Canvas("canvas",C({backgroundColor:"black",originX:"center",originY:"center"}));d.canvas.onWindowResize=d.resize;d.canvas.onWindowDraw=d.draw;d.canvas.lineWidth=2;d.canvas.clear();d.attributes=H([]);for(var g=[],h=0;2>h;h++)g.append(c(d,h));d.paddles=g;d.ball=a(d);d.scoreboard=b(d);window.setInterval(d.update,10);window.setInterval(d.draw,20);window.addEventListener("keydown",d.keydown);window.addEventListener("keyup",
d.keyup);d.time=+new Date},"__init__")},get update(){return q(this,function(a){var b=a.time;a.time=+new Date;a.deltaT=(a.time-b)/1E3;if(a.pause)J(t,a.keySet)?a.pause=!1:J(m,a.keySet)&&a.scoreboard.reset();else{for(var b=a.attributes,c=0;c<b.length;c++){var d=b[c];d.predict()}b=a.attributes;for(c=0;c<b.length;c++)d=b[c],d.interact();b=a.attributes;for(c=0;c<b.length;c++)d=b[c],d.commit()}},"update")},get scored(){return q(this,function(a,b){a.scoreboard.increment(b);a.serviceIndex=1-b;for(var c=a.paddles,
d=0;d<c.length;d++)c[d].reset();a.ball.reset();a.pause=!0},"scored")},get draw(){return q(this,function(a){a.canvas.clear();a=a.attributes;for(var b=0;b<a.length;b++)a[b].draw()},"draw")},get resize(){return q(this,function(a,b,c){},"resize")},get scaleX(){return q(this,function(a,b){return a.canvas.width/1E3*b},"scaleX")},get scaleY(){return q(this,function(a,b){return a.canvas.height/750*b},"scaleY")},get orthoX(){return q(this,function(a,b){return a.scaleX(b+Math.floor(500))},"orthoX")},get orthoY(){return q(this,
function(a,b){return a.scaleY(750-Math.floor(325)-b)},"orthoY")},get keydown(){return q(this,function(a,b){a.keySet.add(b.keyCode)},"keydown")},get keyup(){return q(this,function(a,b){a.keySet.remove(b.keyCode)},"keyup")}}),g=l();n.Attribute=d;n.Ball=a;n.Game=l;n.Paddle=c;n.Scoreboard=b;n.Sprite=k;n.enter=m;n.esc=h;n.fieldHeight=650;n.game=g;n.orthoHeight=750;n.orthoWidth=1E3;n.space=t})();return n}window.pong=pong();
