'use strict';function pong(){function X(e,l,m){"undefined"==typeof l&&(l=e,e=0);"undefined"==typeof m&&(m=1);if(0<m&&e>=l||0>m&&e<=l)return[];for(var h=[];0<m?e<l:e>l;e+=m)h.push(e);return h}function T(e){if(null==e||"object"==typeof e)return e;var l={},m;for(m in obj)e.hasOwnProperty(m)&&(l[m]=e[m]);return l}function Y(e){if(null==e||"object"==typeof e)return e;var l={},m;for(m in obj)e.hasOwnProperty(m)&&(l[m]=Y(e[m]));return l}function D(e){e=e?[].slice.apply(e):[];e.__class__=D;return e}function y(e){e=
e?[].slice.apply(e):[];e.__class__=y;return e}function F(e){var l=[];if(e)for(var m=0;m<e.length;m++)l.add(e[m]);l.__class__=F;return l}function Z(){var e=[],l;for(l in this)M(l)||e.push(l);return e}function aa(){var e=[],l;for(l in this)M(l)||e.push([l,this[l]]);return e}function ba(e){delete this[e]}function C(e){if(!e||e instanceof Array){var l={};if(e)for(var m=0;m<e.length;m++){var h=e[m];l[h[0]]=h[1]}}else l=e;Object.defineProperty(l,"__class__",{value:C,enumerable:!1,writable:!0});Object.defineProperty(l,
...
return e.__all__};n.__init__=Q;var q=function(e,l,m){return e&&(e.hasOwnProperty("__class__")||"string"==typeof e||e instanceof String)?(m&&Object.defineProperty(e,m,{value:function(){var h=[].slice.apply(arguments);return l.apply(null,[e].concat(h))},writable:!0,enumerable:!0,configurable:!0}),function(){var h=[].slice.apply(arguments);return l.apply(null,[e].concat(h))}):l};n.__get__=q;var G=function(e,l,m){for(var h=function(){var a=[].slice.apply(arguments);return h.__new__(a)},t=l.length-1;0<=
t;t--){var d=l[t],k;for(k in d){var c=Object.getOwnPropertyDescriptor(d,k);Object.defineProperty(h,k,c)}}h.__name__=e;h.__bases__=l;for(k in m)c=Object.getOwnPropertyDescriptor(m,k),Object.defineProperty(h,k,c);return h};n.__class__=G;var N=n.__class__("object",[],{__init__:function(e){},__name__:"object",__bases__:[],__new__:function(e){var l=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[l].concat(e));return l}});n.object=N;n.__pragma__=function(){};L(n,"org.transcrypt.__base__",
{__all__:{__inited__:!1,__init__:function(e){var l=G("__Envir__",[N],{get __init__(){return q(this,function(h){h.transpiler_name="transcrypt";h.transpiler_version="3.5.132";h.target_subdir="__javascript__"})}}),m=l();e.__Envir__=l;e.__envir__=m}}});L(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(e){var l=G("Exception",[N],{get __init__(){return q(this,function(h){var d=y([].slice.apply(arguments).slice(1));h.args=d})},get __repr__(){return q(this,function(h){return O(h.args)?
"{}{}".format(h.__class__.__name__,ca(y(h.args))):"???"})},get __str__(){return q(this,function(h){return 1<O(h.args)?K(y(h.args)):O(h.args)?K(h.args[0]):"???"})}}),m=G("ValueError",[l],{}),h=function(h,d,k){if("undefined"==typeof d||null!=d&&d.__class__==u)d=null;if("undefined"==typeof k||null!=k&&k.__class__==u)k=!1;if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].__class__==u){var c=arguments[c--],a;for(a in c)switch(a){case "iterable":h=c[a];break;case "key":d=c[a];
break;case "reverse":k=c[a]}}}d?h.sort(function(a,g){if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].__class__==u){var f=arguments[f--],c;for(c in f)switch(c){case "a":a=f[c];break;case "b":g=f[c]}}}return d(a)>d(g)}):h.sort();k&&h.reverse()};e.Exception=l;e.ValueError=m;e.__sort__=h;e.sorted=function(e,d,k){if("undefined"==typeof d||null!=d&&d.__class__==u)d=null;if("undefined"==typeof k||null!=k&&k.__class__==u)k=!1;if(arguments.length){var c=arguments.length-1;if(arguments[c]&&
arguments[c].__class__==u){var c=arguments[c--],a;for(a in c)switch(a){case "iterable":e=c[a];break;case "key":d=c[a];break;case "reverse":k=c[a]}}}a=U(e)==C?T(e.py_keys()):T(e);h(a,d,k);return a}}}});L(n,"",Q(n.org.transcrypt.__base__));var da=n.__envir__;L(n,"",Q(n.org.transcrypt.__standard__));var ga=n.__sort__;da.executor_name=da.transpiler_name;n.main={__file__:""};n.__except__=null;var u=function(e){e.__class__=u;e.constructor=Object;return e};n.___kwargdict__=u;n.property=function(e,l){l||
(l=function(){});return{get:function(){return e(this)},set:function(e){l(this,e)},enumerable:!0}};n.__merge__=function(e,l){var m={},h;for(h in e)m[h]=e[h];for(h in l)m[h]=l[h];return m};var ea=function(){for(var e=[].slice.apply(arguments),l="",m=0;m<e.length;m++)l+=K(e[m])+" ";console.log(l)};n.print=ea;console.log.apply=function(){ea([].slice.apply(arguments).slice(1))};var J=function(e,l){return U(l)==C?-1<l.py_keys().indexOf(e):-1<l.indexOf(e)};n.__in__=J;var M=function(e){return e.startswith("__")&&
e.endswith("__")||"constructor"==e||e.startswith("py_")};n.__specialattrib__=M;var O=function(e){try{return e.length}catch(m){var l=0;for(attrib in e)M(attrib)||l++;return l}};n.len=O;var fa={__name__:"bool"};n.bool=fa;var R=function(e){if(isNaN(e))throw"ValueError";return+e};R.__name__="float";n.float=R;var V=function(e){return R(e)|0};V.__name__="int";n.int=V;var U=function(e){try{return e.__class__}catch(m){var l=typeof e;return"boolean"==l?fa:"number"==l?0==e%1?V:R:l}};n.type=U;n.isinstance=function(e,
l){function m(h){if(h==l)return!0;for(var e=0;e<h.__bases__.length;e++)if(m(h.__bases__[e],l))return!0;return!1}return m(e.__class__)};var ca=function(e){try{return e.__repr__()}catch(d){try{return e.__str__()}catch(k){try{if(e.constructor==Object){var l="{",m=!1,h;for(h in e)if(!M(h)){var t=h.isnumeric()?h:"'"+h+"'";m?l+=", ":m=!0;try{l+=t+": "+e[h].__repr__()}catch(c){l+=t+": "+e[h].toString()}}return l+"}"}return"boolean"==typeof e?e.toString().capitalize():e.toString()}catch(c){return console.log("ERROR: Could not evaluate repr (<object of type "+
typeof e+">)"),"???"}}}};n.repr=ca;n.chr=function(e){return String.fromCharCode(e)};var P=function(e){return e.charCodeAt(0)};n.org=P;var S=function(){var e=[].slice.call(arguments);return(0==e.length?[]:e.reduce(function(e,m){return e.length<m.length?e:m})).map(function(l,m){return e.map(function(h){return h[m]})})};n.zip=S;n.range=X;n.enumerate=function(e){return S(X(O(e)),e)};n.copy=T;n.deepcopy=Y;n.list=D;Array.prototype.__class__=D;D.__name__="list";Array.prototype.__getslice__=function(e,l,
m){0>e&&(e=this.length+e);null==l?l=this.length:0>l&&(l=this.length+l);for(var h=D([]);e<l;e+=m)h.push(this[e]);return h};Array.prototype.__setslice__=function(e,l,m,h){0>e&&(e=this.length+e);null==l?l=this.length:0>l&&(l=this.length+l);if(null==m)Array.prototype.splice.apply(this,[e,l-e].concat(h));else for(var t=0;e<l;e+=m)this[e]=h[t++]};Array.prototype.__repr__=function(){if(this.__class__==F&&!this.length)return"set()";for(var e=this.__class__&&this.__class__!=D?this.__class__==y?"(":"{":"[",
l=0;l<this.length;l++){l&&(e+=", ");try{e+=this[l].__repr__()}catch(m){e+=this[l].toString()}}this.__class__==y&&1==this.length&&(e+=",");return e+=this.__class__&&this.__class__!=D?this.__class__==y?")":"}":"]"};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=function(e){this.push(e)};Array.prototype.clear=function(){this.length=0};Array.prototype.extend=function(e){this.push.apply(this,e)};Array.prototype.insert=function(e,l){this.splice(e,0,l)};Array.prototype.remove=function(e){e=
this.indexOf(e);if(-1==e)throw"KeyError";this.splice(e,1)};Array.prototype.py_pop=function(e){return void 0==e?this.pop():this.splice(e,1)[0]};Array.prototype.py_sort=function(){ga.apply(null,[this].concat([].slice.apply(arguments)))};n.tuple=y;y.__name__="tuple";n.set=F;F.__name__="set";Array.prototype.__bindexOf__=function(e){e+="";for(var l=0,m=this.length-1;l<=m;){var h=(l+m)/2|0,t=this[h]+"";if(t<e)l=h+1;else if(t>e)m=h-1;else return h}return-1};Array.prototype.add=function(e){-1==this.indexOf(e)&&
this.push(e)};Array.prototype.discard=function(e){e=this.indexOf(e);-1!=e&&this.splice(e,1)};Array.prototype.isdisjoint=function(e){this.sort();for(var l=0;l<e.length;l++)if(-1!=this.__bindexOf__(e[l]))return!1;return!0};Array.prototype.issuperset=function(e){this.sort();for(var l=0;l<e.length;l++)if(-1==this.__bindexOf__(e[l]))return!1;return!0};Array.prototype.issubset=function(e){return F(e.slice()).issuperset(this)};Array.prototype.union=function(e){for(var l=F(this.slice().sort()),m=0;m<e.length;m++)-1==
l.__bindexOf__(e[m])&&l.push(e[m]);return l};Array.prototype.intersection=function(e){this.sort();for(var l=F(),m=0;m<e.length;m++)-1!=this.__bindexOf__(e[m])&&l.push(e[m]);return l};Array.prototype.difference=function(e){e=F(e.slice().sort());for(var l=F(),m=0;m<this.length;m++)-1==e.__bindexOf__(this[m])&&l.push(this[m]);return l};Array.prototype.symmetric_difference=function(e){return this.union(e).difference(this.intersection(e))};Array.prototype.update=function(){var e=[].concat.apply(this.slice(),
arguments).sort();this.clear();for(var l=0;l<e.length;l++)e[l]!=e[l-1]&&this.push(e[l])};n.__keys__=Z;n.__items__=aa;n.__del__=ba;n.dict=C;C.__name__="dict";n.str=K;String.prototype.__class__=K;K.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(e){return""==
e||this.slice(-e.length)==e};String.prototype.find=function(e,l){return this.indexOf(e,l)};Object.defineProperty(String.prototype,"format",{get:function(){return q(this,function(e){var l=y([].slice.apply(arguments).slice(1)),m=0;return e.replace(/\{(\w*)\}/g,function(h,e){""==e&&(e=m++);if(e==+e)return"undefined"==l[e]?h:l[e];for(var d=0;d<l.length;d++)if("object"==typeof l[d]&&"undefined"!=typeof l[d][e])return l[d][e];return h})})},enumerable:!0});String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&
isFinite(this)};String.prototype.join=function(e){return e.join(this)};String.prototype.lower=function(){return this.toLowerCase()};String.prototype.py_replace=function(e,l,m){return this.split(e,m).join(l)};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(e,l){return this.lastIndexOf(e,l)};String.prototype.rsplit=function(e,l){var m=this.split(e||/s+/);return l?[m.slice(0,-l).join(e)].concat(m.slice(-l)):m};String.prototype.rstrip=function(){return this.replace(/\s*$/g,
"")};String.prototype.py_split=function(e,l){e||(e=" ");return this.split(e||/s+/,l)};String.prototype.startswith=function(e){return 0==this.indexOf(e)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};n.__matmul__=function(e,l){return"object"==typeof e&&"__matmul__"in e?e.__matmul__(l):l.__rmatmul__(e)};n.__mul__=function(e,l){return"object"==typeof e&&"__mul__"in e?e.__mul__(l):"object"==typeof l&&"__rmul__"in l?l.__rmul__(e):e*l};
n.__div__=function(e,l){return"object"==typeof e&&"__div__"in e?e.__div__(l):"object"==typeof l&&"__rdiv__"in l?l.__rdiv__(e):e/l};n.__add__=function(e,l){return"object"==typeof e&&"__add__"in e?e.__add__(l):"object"==typeof l&&"__radd__"in l?l.__radd__(e):e+l};n.__sub__=function(e,l){return"object"==typeof e&&"__sub__"in e?e.__sub__(l):"object"==typeof l&&"__rsub__"in l?l.__rsub__(e):e-l};n.__getitem__=function(e,l){return"object"==typeof e&&"__getitem__"in e?e.__getitem__(l):e[l]};n.__setitem__=
function(e,l,m){"object"==typeof e&&"__setitem__"in e?e.__setitem__(l,m):e[l]=m};n.__getslice__=function(e,l,m,h){return"object"==typeof e&&"__getitem__"in e?e.__getitem__([l,m,h]):e.__getslice__(l,m,h)};n.__setslice__=function(e,l,m,h,t){"object"==typeof e&&"__setitem__"in e?e.__setitem__([l,m,h],t):e.__setslice__(l,m,h,t)};n.__call__=function(){var e=[].slice.apply(arguments);return"object"==typeof e[0]&&"__call__"in e[0]?e[0].__call__.apply(null,e.slice(1)):e[0].apply(null,e.slice(1))};L(n,"com.fabricjs",
{__all__:{__inited__:!1,__init__:function(e){var l=function(){var e={},h=h||{version:"1.5.0"};"undefined"!==typeof e&&(e.fabric=h);"undefined"!==typeof document&&"undefined"!==typeof window?(h.document=document,h.window=window,window.fabric=h):(h.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),h.window=h.document.createWindow?h.document.createWindow():h.document.parentWindow);h.isTouchSupported="ontouchstart"in h.document.documentElement;h.isLikelyNode="undefined"!==
...
if(1===arguments.length)for(var g in a)this.on(g,a[g]);else this.__eventListeners[a]||(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function k(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var g in a)e.call(this,g,a[g]);else e.call(this,a,b);return this}}function c(a,b){if(this.__eventListeners){var g=this.__eventListeners[a];if(g){for(var f=0,c=g.length;f<c;f++)g[f].call(this,
b||{});return this}}}h.Observable={observe:d,stopObserving:k,fire:c,on:d,off:k,trigger:c}})();h.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var e=0,d=arguments.length;e<d;e++)this._onObjectAdded(arguments[e]);this.renderOnAddRemove&&this.renderAll();return this},insertAt:function(e,d,k){var c=this.getObjects();k?c[d]=e:c.splice(d,0,e);this._onObjectAdded(e);this.renderOnAddRemove&&this.renderAll();return this},remove:function(){for(var e=this.getObjects(),d,k=
0,c=arguments.length;k<c;k++)d=e.indexOf(arguments[k]),-1!==d&&(e.splice(d,1),this._onObjectRemoved(arguments[k]));this.renderOnAddRemove&&this.renderAll();return this},forEachObject:function(e,d){for(var k=this.getObjects(),c=k.length;c--;)e.call(d,k[c],c,k);return this},getObjects:function(e){return"undefined"===typeof e?this._objects:this._objects.filter(function(d){return d.type===e})},item:function(e){return this.getObjects()[e]},isEmpty:function(){return 0===this.getObjects().length},size:function(){return this.getObjects().length},
contains:function(e){return-1<this.getObjects().indexOf(e)},complexity:function(){return this.getObjects().reduce(function(e,d){return e+=d.complexity?d.complexity():0},0)}};(function(e){var d=Math.sqrt,k=Math.atan2,c=Math.PI/180;h.util={removeFromArray:function(a,b){var g=a.indexOf(b);-1!==g&&a.splice(g,1);return a},getRandomInt:function(a,b){return Math.floor(Math.random()*(b-a+1))+a},degreesToRadians:function(a){return a*c},radiansToDegrees:function(a){return a/c},rotatePoint:function(a,b,g){var f=
Math.sin(g);g=Math.cos(g);a.subtractEquals(b);return(new h.Point(a.x*g-a.y*f,a.x*f+a.y*g)).addEquals(b)},transformPoint:function(a,b,g){return g?new h.Point(b[0]*a.x+b[2]*a.y,b[1]*a.x+b[3]*a.y):new h.Point(b[0]*a.x+b[2]*a.y+b[4],b[1]*a.x+b[3]*a.y+b[5])},invertTransform:function(a){var b=a.slice(),b=1/(a[0]*a[3]-a[1]*a[2]),b=[b*a[3],-b*a[1],-b*a[2],b*a[0],0,0];a=h.util.transformPoint({x:a[4],y:a[5]},b);b[4]=-a.x;b[5]=-a.y;return b},toFixed:function(a,b){return parseFloat(Number(a).toFixed(b))},parseUnit:function(a,
b){var g=/\D{0,2}$/.exec(a),f=parseFloat(a);b||(b=h.Text.DEFAULT_SVG_FONT_SIZE);switch(g[0]){case "mm":return f*h.DPI/25.4;case "cm":return f*h.DPI/2.54;case "in":return f*h.DPI;case "pt":return f*h.DPI/72;case "pc":return f*h.DPI/72*12;case "em":return f*b;default:return f}},falseFunction:function(){return!1},getKlass:function(a,b){a=h.util.string.camelize(a.charAt(0).toUpperCase()+a.slice(1));return h.util.resolveNamespace(b)[a]},resolveNamespace:function(a){if(!a)return h;a=a.split(".");for(var b=
a.length,g=e||h.window,f=0;f<b;++f)g=g[a[f]];return g},loadImage:function(a,b,g,f){if(a){var c=h.util.createImage();c.onload=function(){b&&b.call(g,c);c=c.onload=c.onerror=null};c.onerror=function(){h.log("Error loading "+c.src);b&&b.call(g,null,!0);c=c.onload=c.onerror=null};0!==a.indexOf("data")&&"undefined"!==typeof f&&(c.crossOrigin=f);c.src=a}else b&&b.call(g,a)},enlivenObjects:function(a,b,g,f){function c(){++k===e&&b&&b(d)}a=a||[];var d=[],k=0,e=a.length;e?a.forEach(function(a,b){if(a&&a.type){var k=
h.util.getKlass(a.type,g);k.async?k.fromObject(a,function(g,k){k||(d[b]=g,f&&f(a,d[b]));c()}):(d[b]=k.fromObject(a),f&&f(a,d[b]),c())}else c()}):b&&b(d)},groupSVGElements:function(a,b,g){a=new h.PathGroup(a,b);"undefined"!==typeof g&&a.setSourcePath(g);return a},populateWithProperties:function(a,b,g){if(g&&"[object Array]"===Object.prototype.toString.call(g))for(var f=0,c=g.length;f<c;f++)g[f]in a&&(b[g[f]]=a[g[f]])},drawDashedLine:function(a,b,g,f,c,w){f-=b;var e=c-g;c=d(f*f+e*e);f=k(e,f);var e=
w.length,h=0,t=!0;a.save();a.translate(b,g);a.moveTo(0,0);a.rotate(f);for(b=0;c>b;)b+=w[h++%e],b>c&&(b=c),a[t?"lineTo":"moveTo"](b,0),t=!t;a.restore()},createCanvasElement:function(a){a||(a=h.document.createElement("canvas"));a.getContext||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(a);return a},createImage:function(){return h.isLikelyNode?new (require("canvas").Image):h.document.createElement("img")},createAccessors:function(a){a=a.prototype;for(var b=a.stateProperties.length;b--;){var g=
a.stateProperties[b],f=g.charAt(0).toUpperCase()+g.slice(1),c="set"+f,f="get"+f;a[f]||(a[f]=new Function('return this.get("'+g+'")'));a[c]||(a[c]=new Function("value",'return this.set("'+g+'", value)'))}},clipContext:function(a,b){b.save();b.beginPath();a.clipTo(b);b.clip()},multiplyTransformMatrices:function(a,b){return[a[0]*b[0]+a[2]*b[1],a[1]*b[0]+a[3]*b[1],a[0]*b[2]+a[2]*b[3],a[1]*b[2]+a[3]*b[3],a[0]*b[4]+a[2]*b[5]+a[4],a[1]*b[4]+a[3]*b[5]+a[5]]},getFunctionBody:function(a){return(String(a).match(/function[^{]*\{([\s\S]*)\}/)||
{})[1]},isTransparent:function(a,b,g,f){0<f&&(b=b>f?b-f:0,g=g>f?g-f:0);var c=!0;a=a.getImageData(b,g,2*f||1,2*f||1);b=3;for(g=a.data.length;b<g&&(c=0>=a.data[b],!1!==c);b+=4);return c}}})("undefined"!==typeof e?e:this);(function(){function e(g,b,c,h,t,l,ha){var W=f.call(arguments);if(a[W])return a[W];var I=Math.PI,m=ha*I/180,E=Math.sin(m),m=Math.cos(m),n=0,B=0;c=Math.abs(c);h=Math.abs(h);var r=-m*g*.5-E*b*.5,z=-m*b*.5+E*g*.5,q=c*c,x=h*h,H=z*z,v=r*r,u=q*x-q*H-x*v,y=0;0>u?(q=Math.sqrt(1-u/(q*x)),c*=
q,h*=q):y=(t===l?-1:1)*Math.sqrt(u/(q*H+x*v));H=y*c*z/h;v=-y*h*r/c;y=m*H-E*v+.5*g;q=E*H+m*v+.5*b;x=k(1,0,(r-H)/c,(z-v)/h);z=k((r-H)/c,(z-v)/h,(-r-H)/c,(-z-v)/h);0===l&&0<z?z-=2*I:1===l&&0>z&&(z+=2*I);I=Math.ceil(Math.abs(z/I*2));r=[];z/=I;H=8/3*Math.sin(z/4)*Math.sin(z/4)/Math.sin(z/2);v=x+z;for(u=0;u<I;u++)r[u]=d(x,v,m,E,c,h,y,q,H,n,B),n=r[u][4],B=r[u][5],x=v,v+=z;return a[W]=r}function d(g,a,c,d,k,e,h,t,l,m,E){var n=f.call(arguments);if(b[n])return b[n];var B=Math.cos(g),r=Math.sin(g),q=Math.cos(a),
u=Math.sin(a),x=c*k*q-d*e*u+h,y=d*k*q+c*e*u+t;b[n]=[m+l*(-c*k*r-d*e*B),E+l*(-d*k*r+c*e*B),x+l*(c*k*u+d*e*q),y+l*(d*k*u-c*e*q),x,y];return b[n]}function k(g,f,a,b){g=Math.atan2(f,g);a=Math.atan2(b,a);return a>=g?a-g:2*Math.PI-(g-a)}function c(a,b,c,d,k,e,h,t){var l=f.call(arguments);if(g[l])return g[l];var m=Math.sqrt,E=Math.min,n=Math.max,B=Math.abs,r=[],q=[[],[]],u,x,y,v,C;x=6*a-12*c+6*k;u=-3*a+9*c-9*k+3*h;y=3*c-3*a;for(var D=0;2>D;++D)0<D&&(x=6*b-12*d+6*e,u=-3*b+9*d-9*e+3*t,y=3*d-3*b),1E-12>B(u)?
1E-12>B(x)||(v=-y/x,0<v&&1>v&&r.push(v)):(v=x*x-4*y*u,0>v||(C=m(v),v=(-x+C)/(2*u),0<v&&1>v&&r.push(v),v=(-x-C)/(2*u),0<v&&1>v&&r.push(v)));for(B=m=r.length;m--;)v=r[m],x=1-v,u=x*x*x*a+3*x*x*v*c+3*x*v*v*k+v*v*v*h,q[0][m]=u,u=x*x*x*b+3*x*x*v*d+3*x*v*v*e+v*v*v*t,q[1][m]=u;q[0][B]=a;q[1][B]=b;q[0][B+1]=h;q[1][B+1]=t;E=[{x:E.apply(null,q[0]),y:E.apply(null,q[1])},{x:n.apply(null,q[0]),y:n.apply(null,q[1])}];return g[l]=E}var a={},b={},g={},f=Array.prototype.join;h.util.drawArc=function(g,f,a,b){var c=
[[],[],[],[]];b=e(b[5]-f,b[6]-a,b[0],b[1],b[3],b[4],b[2]);for(var d=0,k=b.length;d<k;d++)c[d][0]=b[d][0]+f,c[d][1]=b[d][1]+a,c[d][2]=b[d][2]+f,c[d][3]=b[d][3]+a,c[d][4]=b[d][4]+f,c[d][5]=b[d][5]+a,g.bezierCurveTo.apply(g,c[d])};h.util.getBoundsOfArc=function(g,f,a,b,d,k,h,l,I){var m=0,n=0,q=[],B=[];a=e(l-g,I-f,a,b,k,h,d);b=[[],[]];d=0;for(k=a.length;d<k;d++)q=c(m,n,a[d][0],a[d][1],a[d][2],a[d][3],a[d][4],a[d][5]),b[0].x=q[0].x+g,b[0].y=q[0].y+f,b[1].x=q[1].x+g,b[1].y=q[1].y+f,B.push(b[0]),B.push(b[1]),
m=a[d][4],n=a[d][5];return B};h.util.getBoundsOfCurve=c})();(function(){function e(d,c,a){if(d&&0!==d.length){var b=d.length-1,g=c?d[b][c]:d[b];if(c)for(;b--;)a(d[b][c],g)&&(g=d[b][c]);else for(;b--;)a(d[b],g)&&(g=d[b]);return g}}var d=Array.prototype.slice;Array.prototype.indexOf||(Array.prototype.indexOf=function(d){if(void 0===this||null===this)throw new TypeError;var c=Object(this),a=c.length>>>0;if(0===a)return-1;var b=0;0<arguments.length&&(b=Number(arguments[1]),b!==b?b=0:0!==b&&b!==Number.POSITIVE_INFINITY&&
...
function(d,c){for(var a=0,b=this.length>>>0;a<b;a++)if(a in this&&!d.call(c,this[a],a,this))return!1;return!0});Array.prototype.some||(Array.prototype.some=function(d,c){for(var a=0,b=this.length>>>0;a<b;a++)if(a in this&&d.call(c,this[a],a,this))return!0;return!1});Array.prototype.filter||(Array.prototype.filter=function(d,c){for(var a=[],b,g=0,f=this.length>>>0;g<f;g++)g in this&&(b=this[g],d.call(c,b,g,this)&&a.push(b));return a});Array.prototype.reduce||(Array.prototype.reduce=function(d){var c=
this.length>>>0,a=0,b;if(1<arguments.length)b=arguments[1];else{do{if(a in this){b=this[a++];break}if(++a>=c)throw new TypeError;}while(1)}for(;a<c;a++)a in this&&(b=d.call(null,b,this[a],a,this));return b});h.util.array={invoke:function(k,c){for(var a=d.call(arguments,2),b=[],g=0,f=k.length;g<f;g++)b[g]=a.length?k[g][c].apply(k[g],a):k[g][c].call(k[g]);return b},min:function(d,c){return e(d,c,function(a,b){return a<b})},max:function(d,c){return e(d,c,function(a,b){return a>=b})}}})();(function(){function e(d,
k){for(var c in k)d[c]=k[c];return d}h.util.object={extend:e,clone:function(d){return e({},d)}}})();(function(){String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});h.util.string={camelize:function(e){return e.replace(/-+(.)?/g,function(d,k){return k?k.toUpperCase():""})},capitalize:function(e,d){return e.charAt(0).toUpperCase()+(d?e.slice(1):e.slice(1).toLowerCase())},escapeXml:function(e){return e.replace(/&/g,"&amp;").replace(/"/g,
"&quot;").replace(/'/g,"&apos;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}})();(function(){var e=Array.prototype.slice,d=Function.prototype.apply,k=function(){};Function.prototype.bind||(Function.prototype.bind=function(c){var a=this,b=e.call(arguments,1),g;g=b.length?function(){return d.call(a,this instanceof k?this:c,b.concat(e.call(arguments)))}:function(){return d.call(a,this instanceof k?this:c,arguments)};k.prototype=this.prototype;g.prototype=new k;return g})})();(function(){function e(){}
function d(g){var f=this.constructor.superclass.prototype[g];return 1<arguments.length?f.apply(this,k.call(arguments,1)):f.call(this)}var k=Array.prototype.slice,c=function(){},a=function(){for(var g in{toString:1})if("toString"===g)return!1;return!0}(),b=function(g,f,b){for(var c in f)c in g.prototype&&"function"===typeof g.prototype[c]&&-1<(f[c]+"").indexOf("callSuper")?g.prototype[c]=function(g){return function(){var a=this.constructor.superclass;this.constructor.superclass=b;var c=f[g].apply(this,
arguments);this.constructor.superclass=a;if("initialize"!==g)return c}}(c):g.prototype[c]=f[c],a&&(f.toString!==Object.prototype.toString&&(g.prototype.toString=f.toString),f.valueOf!==Object.prototype.valueOf&&(g.prototype.valueOf=f.valueOf))};h.util.createClass=function(){function g(){this.initialize.apply(this,arguments)}var f=null,a=k.call(arguments,0);"function"===typeof a[0]&&(f=a.shift());g.superclass=f;g.subclasses=[];f&&(e.prototype=f.prototype,g.prototype=new e,f.subclasses.push(g));for(var h=
0,A=a.length;h<A;h++)b(g,a[h],f);g.prototype.initialize||(g.prototype.initialize=c);g.prototype.constructor=g;g.prototype.callSuper=d;return g}})();(function(){function e(g){var f=Array.prototype.slice.call(arguments,1),a,b,c=f.length;for(b=0;b<c;b++)if(a=typeof g[f[b]],!/^(?:function|object|unknown)$/.test(a))return!1;return!0}function d(g,f){return function(b){f.call(a(g),b||h.window.event)}}function k(g,f){return function(a){if(A[g]&&A[g][f])for(var b=A[g][f],c=0,d=b.length;c<d;c++)b[c].call(this,
a||h.window.event)}}function c(g,f,a){var b="touchend"===g.type?"changedTouches":"touches";return g[b]&&g[b][0]?g[b][0][f]-(g[b][0][f]-g[b][0][a])||g[a]:g[a]}var a,b,g=function(){var g=0;return function(f){return f.__uniqueID||(f.__uniqueID="uniqueID__"+g++)}}();(function(){var g={};a=function(f){return g[f]};b=function(f,a){g[f]=a}})();var f=e(h.document.documentElement,"addEventListener","removeEventListener")&&e(h.window,"addEventListener","removeEventListener"),p=e(h.document.documentElement,
"attachEvent","detachEvent")&&e(h.window,"attachEvent","detachEvent"),w={},A={};f?(f=function(g,f,a){g.addEventListener(f,a,!1)},p=function(g,f,a){g.removeEventListener(f,a,!1)}):p?(f=function(f,a,c){var k=g(f);b(k,f);w[k]||(w[k]={});w[k][a]||(w[k][a]=[]);c={handler:c,wrappedHandler:d(k,c)};w[k][a].push(c);f.attachEvent("on"+a,c.wrappedHandler)},p=function(f,a,b){var c=g(f),d;if(w[c]&&w[c][a])for(var k=0,p=w[c][a].length;k<p;k++)(d=w[c][a][k])&&d.handler===b&&(f.detachEvent("on"+a,d.wrappedHandler),
w[c][a][k]=null)}):(f=function(f,a,b){var c=g(f);A[c]||(A[c]={});if(!A[c][a]){A[c][a]=[];var d=f["on"+a];d&&A[c][a].push(d);f["on"+a]=k(c,a)}A[c][a].push(b)},p=function(f,a,b){f=g(f);if(A[f]&&A[f][a]){a=A[f][a];f=0;for(var c=a.length;f<c;f++)a[f]===b&&a.splice(f,1)}});h.util.addListener=f;h.util.removeListener=p;var l=function(g){return"unknown"!==typeof g.clientX?g.clientX:0},m=function(g){return"unknown"!==typeof g.clientY?g.clientY:0};h.isTouchSupported&&(l=function(g){return c(g,"pageX","clientX")},
m=function(g){return c(g,"pageY","clientY")});h.util.getPointer=function(g,f){g||(g=h.window.event);var a=h.util.getScrollLeftTop(g.target||("unknown"!==typeof g.srcElement?g.srcElement:null),f);return{x:l(g)+a.left,y:m(g)+a.top}};h.util.object.extend(h.util,h.Observable)})();(function(){var e=h.document.createElement("div"),d="string"===typeof e.style.filter,k=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,c=function(a){return a};"string"===typeof e.style.opacity?c=function(a,b){a.style.opacity=b;return a}:
d&&(c=function(a,b){var g=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&(g.zoom=1);k.test(g.filter)?g.filter=g.filter.replace(k,.9999<=b?"":"alpha(opacity="+100*b+")"):g.filter+=" alpha(opacity="+100*b+")";return a});h.util.setStyle=function(a,b){var g=a.style;if(!g)return a;if("string"===typeof b)return a.style.cssText+=";"+b,-1<b.indexOf("opacity")?c(a,b.match(/opacity:\s*(\d?\.?\d*)/)[1]):a;for(var f in b)"opacity"===f?c(a,b[f]):g["float"===f||"cssFloat"===f?"undefined"===typeof g.styleFloat?
"cssFloat":"styleFloat":f]=b[f];return a}})();(function(){function e(a,g){var f=h.document.createElement(a),c;for(c in g)"class"===c?f.className=g[c]:"for"===c?f.htmlFor=g[c]:f.setAttribute(c,g[c]);return f}var d=Array.prototype.slice,k,c=function(a){return d.call(a,0)};try{k=c(h.document.childNodes)instanceof Array}catch(b){}k||(c=function(a){for(var g=Array(a.length),f=a.length;f--;)g[f]=a[f];return g});var a;a=h.document.defaultView&&h.document.defaultView.getComputedStyle?function(a,g){var f=
h.document.defaultView.getComputedStyle(a,null);return f?f[g]:void 0}:function(a,g){var f=a.style[g];!f&&a.currentStyle&&(f=a.currentStyle[g]);return f};(function(){var a=h.document.documentElement.style,g="userSelect"in a?"userSelect":"MozUserSelect"in a?"MozUserSelect":"WebkitUserSelect"in a?"WebkitUserSelect":"KhtmlUserSelect"in a?"KhtmlUserSelect":"";h.util.makeElementUnselectable=function(f){"undefined"!==typeof f.onselectstart&&(f.onselectstart=h.util.falseFunction);g?f.style[g]="none":"string"===
typeof f.unselectable&&(f.unselectable="on");return f};h.util.makeElementSelectable=function(f){"undefined"!==typeof f.onselectstart&&(f.onselectstart=null);g?f.style[g]="":"string"===typeof f.unselectable&&(f.unselectable="");return f}})();(function(){h.util.getScript=function(a,g){var f=h.document.getElementsByTagName("head")[0],c=h.document.createElement("script"),d=!0;c.onload=c.onreadystatechange=function(f){!d||"string"===typeof this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||
(d=!1,g(f||h.window.event),c=c.onload=c.onreadystatechange=null)};c.src=a;f.appendChild(c)}})();h.util.getById=function(a){return"string"===typeof a?h.document.getElementById(a):a};h.util.toArray=c;h.util.makeElement=e;h.util.addClass=function(a,g){a&&-1===(" "+a.className+" ").indexOf(" "+g+" ")&&(a.className+=(a.className?" ":"")+g)};h.util.wrapElement=function(a,g,f){"string"===typeof g&&(g=e(g,f));a.parentNode&&a.parentNode.replaceChild(g,a);g.appendChild(a);return g};h.util.getScrollLeftTop=
function(a,g){var f,c,d=0,k=0,e=h.document.documentElement,l=h.document.body||{scrollLeft:0,scrollTop:0};for(c=a;a&&a.parentNode&&!f;)a=a.parentNode,1===a.nodeType&&"fixed"===h.util.getElementStyle(a,"position")&&(f=a),1===a.nodeType&&c!==g&&"absolute"===h.util.getElementStyle(a,"position")?k=d=0:a===h.document?(d=l.scrollLeft||e.scrollLeft||0,k=l.scrollTop||e.scrollTop||0):(d+=a.scrollLeft||0,k+=a.scrollTop||0);return{left:d,top:k}};h.util.getElementOffset=function(b){var g;g=b&&b.ownerDocument;
var f={left:0,top:0},c={left:0,top:0},d={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!g)return{left:0,top:0};for(var k in d)c[d[k]]+=parseInt(a(b,k),10)||0;g=g.documentElement;"undefined"!==typeof b.getBoundingClientRect&&(f=b.getBoundingClientRect());b=h.util.getScrollLeftTop(b,null);return{left:f.left+b.left-(g.clientLeft||0)+c.left,top:f.top+b.top-(g.clientTop||0)+c.top}};h.util.getElementStyle=a})();(function(){function e(c,a){return c+(/\?/.test(c)?"&":
"?")+a}function d(){}var k=function(){for(var c=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},function(){return new XMLHttpRequest}],a=c.length;a--;)try{if(c[a]())return c[a]}catch(b){}}();h.util.request=function(c,a){a||(a={});var b=a.method?a.method.toUpperCase():"GET",g=a.onComplete||function(){},f=k(),p;f.onreadystatechange=function(){4===f.readyState&&(g(f),f.onreadystatechange=
d)};"GET"===b&&(p=null,"string"===typeof a.parameters&&(c=e(c,a.parameters)));f.open(b,c,!0);"POST"!==b&&"PUT"!==b||f.setRequestHeader("Content-Type","application/x-www-form-urlencoded");f.send(p);return f}})();h.log=function(){};h.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(e){"undefined"!==typeof console[e]&&"function"===typeof console[e].apply&&(h[e]=function(){return console[e].apply(console,arguments)})});(function(e){function d(d,c){this.x=d;this.y=c}e=e.fabric||
(e.fabric={});e.Point?e.warn("fabric.Point is already defined"):(e.Point=d,d.prototype={constructor:d,add:function(k){return new d(this.x+k.x,this.y+k.y)},addEquals:function(d){this.x+=d.x;this.y+=d.y;return this},scalarAdd:function(k){return new d(this.x+k,this.y+k)},scalarAddEquals:function(d){this.x+=d;this.y+=d;return this},subtract:function(k){return new d(this.x-k.x,this.y-k.y)},subtractEquals:function(d){this.x-=d.x;this.y-=d.y;return this},scalarSubtract:function(k){return new d(this.x-k,
...
d.x;this.y=d.y},swap:function(d){var c=this.x,a=this.y;this.x=d.x;this.y=d.y;d.x=c;d.y=a}})})("undefined"!==typeof e?e:this);(function(e){function d(c){this.status=c;this.points=[]}var k=e.fabric||(e.fabric={});k.Intersection?k.warn("fabric.Intersection is already defined"):(k.Intersection=d,k.Intersection.prototype={appendPoint:function(c){this.points.push(c)},appendPoints:function(c){this.points=this.points.concat(c)}},k.Intersection.intersectLineLine=function(c,a,b,g){var f,p=(g.x-b.x)*(c.y-b.y)-
(g.y-b.y)*(c.x-b.x);f=(a.x-c.x)*(c.y-b.y)-(a.y-c.y)*(c.x-b.x);b=(g.y-b.y)*(a.x-c.x)-(g.x-b.x)*(a.y-c.y);0!==b?(p/=b,f/=b,0<=p&&1>=p&&0<=f&&1>=f?(f=new d("Intersection"),f.points.push(new k.Point(c.x+p*(a.x-c.x),c.y+p*(a.y-c.y)))):f=new d):f=0===p||0===f?new d("Coincident"):new d("Parallel");return f},k.Intersection.intersectLinePolygon=function(c,a,b){for(var g=new d,f=b.length,k=0;k<f;k++){var e=d.intersectLineLine(c,a,b[k],b[(k+1)%f]);g.appendPoints(e.points)}0<g.points.length&&(g.status="Intersection");
return g},k.Intersection.intersectPolygonPolygon=function(c,a){for(var b=new d,g=c.length,f=0;f<g;f++){var k=d.intersectLinePolygon(c[f],c[(f+1)%g],a);b.appendPoints(k.points)}0<b.points.length&&(b.status="Intersection");return b},k.Intersection.intersectPolygonRectangle=function(c,a,b){var g=a.min(b),f=a.max(b);b=new k.Point(f.x,g.y);var p=new k.Point(g.x,f.y);a=d.intersectLinePolygon(g,b,c);b=d.intersectLinePolygon(b,f,c);f=d.intersectLinePolygon(f,p,c);c=d.intersectLinePolygon(p,g,c);g=new d;g.appendPoints(a.points);
g.appendPoints(b.points);g.appendPoints(f.points);g.appendPoints(c.points);0<g.points.length&&(g.status="Intersection");return g})})("undefined"!==typeof e?e:this);(function(e){function d(a){a?this._tryParsingColor(a):this.setSource([0,0,0,1])}function k(a,b,g){0>g&&(g+=1);1<g&&--g;return g<1/6?a+6*(b-a)*g:.5>g?b:g<2/3?a+(b-a)*(2/3-g)*6:a}var c=e.fabric||(e.fabric={});c.Color?c.warn("fabric.Color is already defined."):(c.Color=d,c.Color.prototype={_tryParsingColor:function(a){var b;a in d.colorNameMap&&
(a=d.colorNameMap[a]);"transparent"===a?this.setSource([255,255,255,0]):((b=d.sourceFromHex(a))||(b=d.sourceFromRgb(a)),b||(b=d.sourceFromHsl(a)),b&&this.setSource(b))},_rgbToHsl:function(a,b,g){a/=255;b/=255;g/=255;var f,d,k,e=c.util.array.max([a,b,g]);d=c.util.array.min([a,b,g]);k=(e+d)/2;if(e===d)f=d=0;else{var h=e-d;d=.5<k?h/(2-e-d):h/(e+d);switch(e){case a:f=(b-g)/h+(b<g?6:0);break;case b:f=(g-a)/h+2;break;case g:f=(a-b)/h+4}f/=6}return[Math.round(360*f),Math.round(100*d),Math.round(100*k)]},
...
(a.vX*=c,a.vY*=c)})}});a.side=8;a.speed=300;var b=G("Scoreboard",[d],{get install(){return q(this,function(a){for(var b=[],c=y([y(["AZ keys:",-.4375]),y(["KM keys:",.0625])]),d=0;d<c.length;d++){var g=c[d],h=g[1];b.append(new e.Text("Player {}".format(g[0]),C({fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*h),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.nameShift)})))}a.playerLabels=b;a.hintLabel=new e.Text("[spacebar] starts game, [enter] resets score",C({fill:"white",
fontFamily:"arial",fontSize:"12",left:a.game.orthoX(-437.5),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.hintShift)}));a.image=new e.Line(D([a.game.orthoX(Math.floor(-1E3)/Math.floor(2)),a.game.orthoY(Math.floor(650)/Math.floor(2)),a.game.orthoX(Math.floor(1E3)/Math.floor(2)),a.game.orthoY(Math.floor(650)/Math.floor(2))]),C({stroke:"white"}))})},get increment(){return q(this,function(a,b){a.scores[b]++})},get reset(){return q(this,function(a){a.scores=D([0,0]);d.reset(a)})},get commit(){return q(this,
function(a){for(var b=[],c=S(a.scores,y([-.125,.375])),d=0;d<c.length;d++){var g=c[d],h=g[1];b.append(new e.Text("{}".format(g[0]),C({fill:"white",fontFamily:"arial",fontSize:"30",left:a.game.orthoX(1E3*h),top:a.game.orthoY(Math.floor(650)/Math.floor(2)+a.nameShift)})))}a.scoreLabels=b})},get draw(){return q(this,function(a){for(var b=S(a.playerLabels,a.scoreLabels),c=0;c<b.length;c++){var d=b[c],e=d[1];a.game.canvas.add(d[0]);a.game.canvas.add(e);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)})}});
b.nameShift=75;b.hintShift=25;var l=G("Game",[N],{get __init__(){return q(this,function(d){d.serviceIndex=.5<Math.random()?1:0;d.pause=!0;d.keySet=F();d.canvas=new e.Canvas("canvas",C({backgroundColor:"black",originX:"center",originY:"center"}));d.canvas.onWindowResize=d.resize;d.canvas.onWindowDraw=d.draw;d.canvas.lineWidth=2;d.canvas.clear();d.attributes=D([]);for(var g=[],h=0;2>h;h++)g.append(c(d,h));d.paddles=g;d.ball=a(d);d.scoreboard=b(d);window.setInterval(d.update,10);window.setInterval(d.draw,
