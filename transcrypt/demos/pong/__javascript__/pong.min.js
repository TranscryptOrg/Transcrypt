...
'use strict';var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(l,x,v){l!=Array.prototype&&l!=Object.prototype&&(l[x]=v.value)};$jscomp.getGlobal=function(l){return"undefined"!=typeof window&&window===l?l:"undefined"!=typeof global&&null!=global?global:l};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;$jscomp.Symbol=function(l){return $jscomp.SYMBOL_PREFIX+(l||"")+$jscomp.symbolCounter_++};
$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var l=$jscomp.global.Symbol.iterator;l||(l=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator"));"function"!=typeof Array.prototype[l]&&$jscomp.defineProperty(Array.prototype,l,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}});$jscomp.initSymbolIterator=function(){}};$jscomp.arrayIterator=function(l){var x=0;return $jscomp.iteratorPrototype(function(){return x<l.length?{done:!1,value:l[x++]}:{done:!0}})};
$jscomp.iteratorPrototype=function(l){$jscomp.initSymbolIterator();l={next:l};l[$jscomp.global.Symbol.iterator]=function(){return this};return l};$jscomp.makeIterator=function(l){$jscomp.initSymbolIterator();$jscomp.initSymbol();$jscomp.initSymbolIterator();var x=l[Symbol.iterator];return x?x.call(l):$jscomp.arrayIterator(l)};
$jscomp.polyfill=function(l,x,v,y){if(x){v=$jscomp.global;l=l.split(".");for(y=0;y<l.length-1;y++){var J=l[y];J in v||(v[J]={});v=v[J]}l=l[l.length-1];y=v[l];x=x(y);x!=y&&null!=x&&$jscomp.defineProperty(v,l,{configurable:!0,writable:!0,value:x})}};$jscomp.polyfill("Object.getOwnPropertySymbols",function(l){return l?l:function(){return[]}},"es6","es5");
$jscomp.polyfill("Array.from",function(l){return l?l:function(l,v,y){$jscomp.initSymbolIterator();v=null!=v?v:function(l){return l};var x=[],M=l[Symbol.iterator];if("function"==typeof M)for(l=M.call(l);!(M=l.next()).done;)x.push(v.call(y,M.value));else{M=l.length;for(var G=0;G<M;G++)x.push(v.call(y,l[G]))}return x}},"es6","es3");
$jscomp.iteratorFromArray=function(l,x){$jscomp.initSymbolIterator();l instanceof String&&(l+="");var v=0,y={next:function(){if(v<l.length){var J=v++;return{value:x(J,l[J]),done:!1}}y.next=function(){return{done:!0,value:void 0}};return y.next()}};y[Symbol.iterator]=function(){return y};return y};$jscomp.polyfill("Array.prototype.keys",function(l){return l?l:function(){return $jscomp.iteratorFromArray(this,function(l){return l})}},"es6","es3");
$jscomp.checkStringArgs=function(l,x,v){if(null==l)throw new TypeError("The 'this' value for String.prototype."+v+" must not be null or undefined");if(x instanceof RegExp)throw new TypeError("First argument to String.prototype."+v+" must not be a regular expression");return l+""};
$jscomp.polyfill("String.prototype.repeat",function(l){return l?l:function(l){var v=$jscomp.checkStringArgs(this,null,"repeat");if(0>l||1342177279<l)throw new RangeError("Invalid count value");l|=0;for(var y="";l;)if(l&1&&(y+=v),l>>>=1)v+=v;return y}},"es6","es3");
$jscomp.polyfill("Array.prototype.fill",function(l){return l?l:function(l,v,y){var x=this.length||0;0>v&&(v=Math.max(0,x+v));if(null==y||y>x)y=x;y=Number(y);0>y&&(y=Math.max(0,x+y));for(v=Number(v||0);v<y;v++)this[v]=l;return this}},"es6","es3");
function pong(){function l(b){return 0<=["boolean","number"].indexOf(typeof b)||b instanceof Function||Q(b)?b:!1}function x(b){this.iterable=b;this.index=0}function v(b){this.iterable=b;this.index=0}function y(b,a,m){void 0==a&&(a=b,b=0);void 0==m&&(m=1);if(0<m&&b>=a||0>m&&b<=a)return[];for(var q=[];0<m?b<a:b>a;b+=m)q.push(b);return q}function J(b){if(null==b||"object"==typeof b)return b;var a={},m;for(m in obj)b.hasOwnProperty(m)&&(a[m]=b[m]);return a}function M(b){if(null==b||"object"==typeof b)return b;
var a={},m;for(m in obj)b.hasOwnProperty(m)&&(a[m]=M(b[m]));return a}function G(b){return b?Array.from(b):[]}function B(b){b=b?[].slice.apply(b):[];b.__class__=B;return b}function K(b){var a=[];if(b)for(var m=0;m<b.length;m++)a.add(b[m]);a.__class__=K;return a}function L(b){try{return b.__str__()}catch(a){try{return V(b)}catch(m){return String(b)}}}function fa(){var b=[],a;for(a in this)R(a)||b.push(a);return b}function ha(){var b=[],a;for(a in this)R(a)||b.push([a,this[a]]);return b}function ia(b){delete this[b]}
function ja(){for(var b in this)delete this[b]}function ka(b,a){b=this[b];return void 0==b?void 0==a?null:a:b}function la(b,a){var m=this[b];if(void 0!=m)return m;a=void 0==a?null:a;return this[b]=a}function ma(b,a){var m=this[b];if(void 0!=m)return delete this[b],m;if(void 0===a)throw ea(b,Error());return a}function na(){var b=Object.keys(this)[0];if(null==b)throw ea(b,Error());var a=B([b,this[b]]);delete this[b];return a}function oa(b){for(var a in b)this[a]=b[a]}function pa(){var b=[],a;for(a in this)R(a)||
b.push(this[a]);return b}function qa(b){return this[b]}function ra(b,a){this[b]=a}function D(b){var a={};if(!b||b instanceof Array){if(b)for(var m=0;m<b.length;m++){var q=b[m];if(!(q instanceof Array)||2!=q.length)throw X("dict update sequence element #"+m+" has length "+q.length+"; 2 is required",Error());var r=q[0];q=q[1];!(b instanceof Array)&&b instanceof Object&&(W(b,D)||(q=D(q)));a[r]=q}}else if(W(b,D))for(q=b.py_keys(),m=0;m<q.length;m++)r=q[m],a[r]=b[r];else if(b instanceof Object)a=b;else throw X("Invalid type of object for dict creation",
Error());E(a,"__class__",{value:D,enumerable:!1,writable:!0});E(a,"py_keys",{value:fa,enumerable:!1});E(a,"__iter__",{value:function(){new x(this.py_keys())},enumerable:!1});$jscomp.initSymbol();$jscomp.initSymbolIterator();E(a,Symbol.iterator,{value:function(){new v(this.py_keys())},enumerable:!1});E(a,"py_items",{value:ha,enumerable:!1});E(a,"py_del",{value:ia,enumerable:!1});E(a,"py_clear",{value:ja,enumerable:!1});E(a,"py_get",{value:ka,enumerable:!1});E(a,"py_setdefault",{value:la,enumerable:!1});
E(a,"py_pop",{value:ma,enumerable:!1});E(a,"py_popitem",{value:na,enumerable:!1});E(a,"py_update",{value:oa,enumerable:!1});E(a,"py_values",{value:pa,enumerable:!1});E(a,"__getitem__",{value:qa,enumerable:!1});E(a,"__setitem__",{value:ra,enumerable:!1});return a}var n={},S=function(b,a,m){if(""!=a){a=a.split(".");for(var q=a.length,r=0;r<a.length;r++){if(!b.hasOwnProperty(a[r])){q=r;break}b=b[a[r]]}for(r=q;r<a.length;r++)b[a[r]]={},b=b[a[r]]}for(var h in m)b[h]=m[h]};n.__nest__=S;var Y=function(b){b.__inited__||
(b.__all__.__init__(b.__all__),b.__inited__=!0);return b.__all__};n.__init__=Y;var t=function(b,a,m){return b&&(b.hasOwnProperty("__class__")||"string"==typeof b||b instanceof String)?(m&&Object.defineProperty(b,m,{value:function(){var q=[].slice.apply(arguments);return a.apply(null,[b].concat(q))},writable:!0,enumerable:!0,configurable:!0}),function(){var q=[].slice.apply(arguments);return a.apply(null,[b].concat(q))}):a};n.__get__=t;var O={__name__:"type",__bases__:[],__new__:function(b,a,m,q){for(var r,
h,k=function(){var d=[].slice.apply(arguments);return k.__new__(d)},g=m.length-1;0<=g;g--){var c=m[g],f;for(f in c)r=Object.getOwnPropertyDescriptor(c,f),Object.defineProperty(k,f,r);var e=$jscomp.makeIterator(Object.getOwnPropertySymbols(c));for(r=e.next();!r.done;r=e.next())h=r.value,r=Object.getOwnPropertyDescriptor(c,h),Object.defineProperty(k,h,r)}k.__metaclass__=b;k.__name__=a;k.__bases__=m;for(f in q)r=Object.getOwnPropertyDescriptor(q,f),Object.defineProperty(k,f,r);b=$jscomp.makeIterator(Object.getOwnPropertySymbols(q));
for(r=b.next();!r.done;r=b.next())h=r.value,r=Object.getOwnPropertyDescriptor(q,h),Object.defineProperty(k,h,r);return k}};O.__metaclass__=O;n.py_metatype=O;var T={__init__:function(b){},__metaclass__:O,__name__:"object",__bases__:[],__new__:function(b){var a=Object.create(this,{__class__:{value:this,enumerable:!0}});if("__getattr__"in this||"__setattr__"in this)a=new Proxy(a,{get:function(b,a){var q=b[a];return void 0==q?b.__getattr__(a):q},set:function(b,a,r){try{b.__setattr__(a,r)}catch(h){b[a]=
r}return!0}});this.__init__.apply(null,[a].concat(b));return a}};n.object=T;var A=function(b,a,m,q){void 0==q&&(q=a[0].__metaclass__);return q.__new__(q,b,a,m)};n.__class__=A;n.__pragma__=function(){};S(n,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(b){var a=A("__Envir__",[T],{get __init__(){return t(this,function(b){b.interpreter_name="python";b.transpiler_name="transcrypt";b.transpiler_version="3.6.30";b.target_subdir="__javascript__"})}}),m=a();b.__Envir__=a;b.__envir__=
m}}});S(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(b){var a=A("Exception",[T],{get __init__(){return t(this,function(d){var e=D();if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){var f=arguments[c--],b;for(b in f)switch(b){case "self":d=f[b];break;default:e[b]=f[b]}delete e.__kwargtrans__}c=B([].slice.apply(arguments).slice(1,c+1))}else c=B();d.__args__=c;try{d.stack=e.error.stack}catch(wa){d.stack="No stack trace available"}})},
get __repr__(){return t(this,function(d){return Q(d.__args__)?"{}{}".format(d.__class__.__name__,V(B(d.__args__))):"{}()".format(d.__class__.__name__)})},get __str__(){return t(this,function(d){return 1<Q(d.__args__)?L(B(d.__args__)):Q(d.__args__)?L(d.__args__[0]):""})}}),m=A("IterableError",[a],{get __init__(){return t(this,function(d,e){a.__init__(d,"Can't iterate over non-iterable",I({error:e}))})}}),q=A("StopIteration",[a],{get __init__(){return t(this,function(d,e){a.__init__(d,"Iterator exhausted",
I({error:e}))})}}),r=A("ValueError",[a],{get __init__(){return t(this,function(d,e){a.__init__(d,"Erroneous value",I({error:e}))})}}),h=A("KeyError",[a],{get __init__(){return t(this,function(d,e){a.__init__(d,"Invalid key",I({error:e}))})}}),k=A("AssertionError",[a],{get __init__(){return t(this,function(d,e,c){e?a.__init__(d,e,I({error:c})):a.__init__(d,I({error:c}))})}}),g=A("NotImplementedError",[a],{get __init__(){return t(this,function(d,e,c){a.__init__(d,e,I({error:c}))})}}),c=A("IndexError",
[a],{get __init__(){return t(this,function(d,e,c){a.__init__(d,e,I({error:c}))})}}),f=A("AttributeError",[a],{get __init__(){return t(this,function(d,e,c){a.__init__(d,e,I({error:c}))})}}),e=A("Warning",[a],{}),d=A("UserWarning",[e],{}),p=A("DeprecationWarning",[e],{}),u=A("RuntimeWarning",[e],{}),w=function(d,e,c){if("undefined"==typeof e||null!=e&&e.hasOwnProperty("__kwargtrans__"))e=null;if("undefined"==typeof c||null!=c&&c.hasOwnProperty("__kwargtrans__"))c=!1;if(arguments.length){var f=arguments.length-
1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__")){f=arguments[f--];for(var b in f)switch(b){case "iterable":d=f[b];break;case "key":e=f[b];break;case "reverse":c=f[b]}}}e?d.sort(function(d,c){if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__")){f=arguments[f--];for(var b in f)switch(b){case "a":d=f[b];break;case "b":c=f[b]}}}return e(d)>e(c)?1:-1}):d.sort();c&&d.reverse()},C=A("__Terminal__",[T],{get __init__(){return t(this,
function(d){d.buffer="";try{d.element=document.getElementById("__terminal__")}catch(F){d.element=null}d.element&&(d.element.style.overflowX="auto",d.element.style.boxSizing="border-box",d.element.style.padding="5px",d.element.innerHTML="_")})},get print(){return t(this,function(d){var e=" ";var c="\n";if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__")){var b=arguments[f--],g;for(g in b)switch(g){case "self":d=b[g];break;case "sep":e=b[g];break;
case "end":c=b[g]}}var h=B([].slice.apply(arguments).slice(1,f+1))}else h=B();d.buffer="{}{}{}".format(d.buffer,e.join(function(){for(var d=[],e=$jscomp.makeIterator(h),c=e.next();!c.done;c=e.next())d.append(L(c.value));return d}()),c).__getslice__(-4096,null,1);d.element?(d.element.innerHTML=d.buffer.py_replace("\n","<br>"),d.element.scrollTop=d.element.scrollHeight):console.log(e.join(function(){for(var d=[],e=$jscomp.makeIterator(h),c=e.next();!c.done;c=e.next())d.append(L(c.value));return d}()))})},
get input(){return t(this,function(d,e){if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){c=arguments[c--];for(var f in c)switch(f){case "self":d=c[f];break;case "question":e=c[f]}}}d.print("{}".format(e),I({end:""}));f=window.prompt("\n".join(d.buffer.py_split("\n").__getslice__(-16,null,1)));d.print(f);return f})}}),z=C();b.AssertionError=k;b.AttributeError=f;b.DeprecationWarning=p;b.Exception=a;b.IndexError=c;b.IterableError=m;b.KeyError=
h;b.NotImplementedError=g;b.RuntimeWarning=u;b.StopIteration=q;b.UserWarning=d;b.ValueError=r;b.Warning=e;b.__Terminal__=C;b.__sort__=w;b.__terminal__=z;b.filter=function(d,e){null==d&&(d=P);var c=[];e=$jscomp.makeIterator(e);for(var f=e.next();!f.done;f=e.next())f=f.value,d(f)&&c.append(f);return c};b.map=function(d,e){var c=[];e=$jscomp.makeIterator(e);for(var f=e.next();!f.done;f=e.next())c.append(d(f.value));return c};b.sorted=function(d,e,c){if("undefined"==typeof e||null!=e&&e.hasOwnProperty("__kwargtrans__"))e=
null;if("undefined"==typeof c||null!=c&&c.hasOwnProperty("__kwargtrans__"))c=!1;if(arguments.length){var f=arguments.length-1;if(arguments[f]&&arguments[f].hasOwnProperty("__kwargtrans__"))for(b in f=arguments[f--],f)switch(b){case "iterable":d=f[b];break;case "key":e=f[b];break;case "reverse":c=f[b]}}var b=Z(d)==D?J(d.py_keys()):J(d);w(b,e,c);return b}}}});n.__call__=function(){var b=[].slice.apply(arguments);return"object"==typeof b[0]&&"__call__"in b[0]?b[0].__call__.apply(b[1],b.slice(2)):b[0].apply(b[1],
b.slice(2))};S(n,"",Y(n.org.transcrypt.__base__));O=n.__envir__;S(n,"",Y(n.org.transcrypt.__standard__));var sa=n.Exception,ta=n.StopIteration,X=n.ValueError,ea=n.KeyError,ua=n.AssertionError,va=n.__sort__;n.print=n.__terminal__.print;n.input=n.__terminal__.input;O.executor_name=O.transpiler_name;n.main={__file__:""};n.__except__=null;var I=function(b){b.__kwargtrans__=null;b.constructor=Object;return b};n.__kwargtrans__=I;n.__globals__=function(b){return W(b,D)?b:D(b)};n.__super__=function(b,a){b=
$jscomp.makeIterator(b.__bases__);for(var m=b.next();!m.done;m=b.next())if(m=m.value,a in m)return m[a];throw new sa("Superclass method not found");};n.property=function(b,a){a||(a=function(){});return{get:function(){return b(this)},set:function(b){a(this,b)},enumerable:!0}};var E=function(b,a,m){b.hasOwnProperty(a)||Object.defineProperty(b,a,m)};n.__setProperty__=E;n.assert=function(b,a){if(!b)throw ua(a,Error());};n.__merge__=function(b,a){var m={},q;for(q in b)m[q]=b[q];for(q in a)m[q]=a[q];return m};
n.dir=function(b){var a=[],m;for(m in b)a.push(m);a.sort();return a};n.setattr=function(b,a,m){b[a]=m};n.getattr=function(b,a){return b[a]};n.hasattr=function(b,a){try{return a in b}catch(m){return!1}};n.delattr=function(b,a){delete b[a]};n.__in__=function(b,a){return Z(a)==D?a.hasOwnProperty(b):a.indexOf?-1<a.indexOf(b):a.hasOwnProperty(b)};var R=function(b){return b.startswith("__")&&b.endswith("__")||"constructor"==b||b.startswith("py_")};n.__specialattrib__=R;var Q=function(b){if(b){var a=b.length;
if(void 0==a){a=0;for(var m in b)R(m)||a++}return a}return 0};n.len=Q;n.__t__=l;var P=function(b){return!!l(b)};P.__name__="bool";n.bool=P;var aa=function(b){if("inf"==b)return Infinity;if("-inf"==b)return-Infinity;if(isNaN(parseFloat(b)))throw X(Error());return+b};aa.__name__="float";n.float=aa;var ba=function(b){return aa(b)|0};ba.__name__="int";n.int=ba;var Z=function(b){var a=typeof b;if("object"==a)try{return b.__class__}catch(m){return a}else return"boolean"==a?P:"string"==a?L:"number"==a?0==
b%1?ba:aa:null};n.py_typeof=Z;var W=function(b,a){function m(b){if(b==a)return!0;for(var h=0;h<b.__bases__.length;h++)if(m(b.__bases__[h],a))return!0;return!1}if(a instanceof Array){for(var q=$jscomp.makeIterator(a),r=q.next();!r.done;r=q.next())if(W(b,r.value))return!0;return!1}try{return"__class__"in b?m(b.__class__):b instanceof a}catch(h){return b=Z(b),b==a||b==P&&a==ba}};n.isinstance=W;n.callable=function(b){return"object"==typeof b&&"__call__"in b?!0:"function"===typeof b};var V=function(b){try{return b.__repr__()}catch(h){try{return b.__str__()}catch(k){try{if(null==
b)return"None";if(b.constructor==Object){var a="{",m=!1,q;for(q in b)if(!R(q)){var r=q.isnumeric()?q:"'"+q+"'";m?a+=", ":m=!0;a+=r+": "+V(b[q])}return a+"}"}return"boolean"==typeof b?b.toString().capitalize():b.toString()}catch(g){return console.log("ERROR: Could not evaluate repr (<object of type "+typeof b+">)"),console.log(g),"???"}}}};n.repr=V;n.chr=function(b){return String.fromCharCode(b)};var U=function(b){return b.charCodeAt(0)};n.ord=U;n.max=Math.max;n.min=Math.min;n.abs=Math.abs;n.round=
function(b,a){if(a){var m=Math.pow(10,a);b*=m}var q=Math.round(b);.5==q-b&&q%2&&--q;a&&(q/=m);return q};x.prototype.__next__=function(){if(this.index<this.iterable.length)return this.iterable[this.index++];throw ta(Error());};v.prototype.next=function(){return this.index<this.iterable.py_keys.length?{value:this.index++,done:!1}:{value:void 0,done:!0}};n.py_reversed=function(b){b=b.slice();b.reverse();return b};var ca=function(){for(var b=[].slice.call(arguments),a=0;a<b.length;a++)"string"==typeof b[a]&&
(b[a]=b[a].split(""));return(0==b.length?[]:b.reduce(function(b,a){return b.length<a.length?b:a})).map(function(a,q){return b.map(function(b){return b[q]})})};n.zip=ca;n.range=y;n.any=function(b){b=$jscomp.makeIterator(b);for(var a=b.next();!a.done;a=b.next())if(P(a.value))return!0;return!1};n.all=function(b){b=$jscomp.makeIterator(b);for(var a=b.next();!a.done;a=b.next())if(!P(a.value))return!1;return!0};n.sum=function(b){var a=0;b=$jscomp.makeIterator(b);for(var m=b.next();!m.done;m=b.next())a+=
m.value;return a};n.enumerate=function(b){return ca(y(Q(b)),b)};n.copy=J;n.deepcopy=M;n.list=G;Array.prototype.__class__=G;G.__name__="list";Array.prototype.__iter__=function(){return new x(this)};Array.prototype.__getslice__=function(b,a,m){0>b&&(b=this.length+b);null==a?a=this.length:0>a?a=this.length+a:a>this.length&&(a=this.length);for(var q=G([]);b<a;b+=m)q.push(this[b]);return q};Array.prototype.__setslice__=function(b,a,m,q){0>b&&(b=this.length+b);null==a?a=this.length:0>a&&(a=this.length+
a);if(null==m)Array.prototype.splice.apply(this,[b,a-b].concat(q));else for(var r=0;b<a;b+=m)this[b]=q[r++]};Array.prototype.__repr__=function(){if(this.__class__==K&&!this.length)return"set()";for(var b=this.__class__&&this.__class__!=G?this.__class__==B?"(":"{":"[",a=0;a<this.length;a++)a&&(b+=", "),b+=V(this[a]);this.__class__==B&&1==this.length&&(b+=",");return b+=this.__class__&&this.__class__!=G?this.__class__==B?")":"}":"]"};Array.prototype.__str__=Array.prototype.__repr__;Array.prototype.append=
function(b){this.push(b)};Array.prototype.clear=function(){this.length=0};Array.prototype.extend=function(b){this.push.apply(this,b)};Array.prototype.insert=function(b,a){this.splice(b,0,a)};Array.prototype.remove=function(b){b=this.indexOf(b);if(-1==b)throw X(Error());this.splice(b,1)};Array.prototype.index=function(b){return this.indexOf(b)};Array.prototype.py_pop=function(b){return void 0==b?this.pop():this.splice(b,1)[0]};Array.prototype.py_sort=function(){va.apply(null,[this].concat([].slice.apply(arguments)))};
Array.prototype.__add__=function(b){return G(this.concat(b))};Array.prototype.__mul__=function(b){for(var a=this,m=1;m<b;m++)a=a.concat(this);return a};Array.prototype.__rmul__=Array.prototype.__mul__;n.tuple=B;B.__name__="tuple";n.set=K;K.__name__="set";Array.prototype.__bindexOf__=function(b){b+="";for(var a=0,m=this.length-1;a<=m;){var q=(a+m)/2|0,r=this[q]+"";if(r<b)a=q+1;else if(r>b)m=q-1;else return q}return-1};Array.prototype.add=function(b){-1==this.indexOf(b)&&this.push(b)};Array.prototype.discard=
function(b){b=this.indexOf(b);-1!=b&&this.splice(b,1)};Array.prototype.isdisjoint=function(b){this.sort();for(var a=0;a<b.length;a++)if(-1!=this.__bindexOf__(b[a]))return!1;return!0};Array.prototype.issuperset=function(b){this.sort();for(var a=0;a<b.length;a++)if(-1==this.__bindexOf__(b[a]))return!1;return!0};Array.prototype.issubset=function(b){return K(b.slice()).issuperset(this)};Array.prototype.union=function(b){for(var a=K(this.slice().sort()),m=0;m<b.length;m++)-1==a.__bindexOf__(b[m])&&a.push(b[m]);
return a};Array.prototype.intersection=function(b){this.sort();for(var a=K(),m=0;m<b.length;m++)-1!=this.__bindexOf__(b[m])&&a.push(b[m]);return a};Array.prototype.difference=function(b){b=K(b.slice().sort());for(var a=K(),m=0;m<this.length;m++)-1==b.__bindexOf__(this[m])&&a.push(this[m]);return a};Array.prototype.symmetric_difference=function(b){return this.union(b).difference(this.intersection(b))};Array.prototype.py_update=function(){var b=[].concat.apply(this.slice(),arguments).sort();this.clear();
for(var a=0;a<b.length;a++)b[a]!=b[a-1]&&this.push(b[a])};Array.prototype.__eq__=function(b){if(this.length!=b.length)return!1;this.__class__==K&&(this.sort(),b.sort());for(var a=0;a<this.length;a++)if(this[a]!=b[a])return!1;return!0};Array.prototype.__ne__=function(b){return!this.__eq__(b)};Array.prototype.__le__=function(b){return this.issubset(b)};Array.prototype.__ge__=function(b){return this.issuperset(b)};Array.prototype.__lt__=function(b){return this.issubset(b)&&!this.issuperset(b)};Array.prototype.__gt__=
function(b){return this.issuperset(b)&&!this.issubset(b)};n.str=L;String.prototype.__class__=L;L.__name__="str";String.prototype.__iter__=function(){new x(this)};String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').py_replace("\t","\\t").py_replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(b){return""==b||this.slice(-b.length)==
b};String.prototype.find=function(b,a){return this.indexOf(b,a)};String.prototype.__getslice__=function(b,a,m){0>b&&(b=this.length+b);null==a?a=this.length:0>a&&(a=this.length+a);var q="";if(1==m)q=this.substring(b,a);else for(;b<a;b+=m)q=q.concat(this.charAt(b));return q};E(String.prototype,"format",{get:function(){return t(this,function(b){var a=B([].slice.apply(arguments).slice(1)),m=0;return b.replace(/\{(\w*)\}/g,function(b,r){""==r&&(r=m++);if(r==+r)return void 0==a[r]?b:L(a[r]);for(var h=0;h<
a.length;h++)if("object"==typeof a[h]&&void 0!=a[h][r])return L(a[h][r]);return b})})},enumerable:!0});String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(b){b=Array.from(b);return b.join(this)};String.prototype.lower=function(){return this.toLowerCase()};String.prototype.py_replace=function(b,a,m){return this.split(b,m).join(a)};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(b,a){return this.lastIndexOf(b,
a)};String.prototype.rsplit=function(b,a){if(void 0==b||null==b){b=/\s+/;var m=this.strip()}else m=this;if(void 0==a||-1==a)return m.split(b);m=m.split(b);return a<m.length?(a=m.length-a,[m.slice(0,a).join(b)].concat(m.slice(a))):m};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.py_split=function(b,a){if(void 0==b||null==b){b=/\s+/;var m=this.strip()}else m=this;if(void 0==a||-1==a)return m.split(b);m=m.split(b);return a<m.length?m.slice(0,a).concat([m.slice(a).join(b)]):
m};String.prototype.startswith=function(b){return 0==this.indexOf(b)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};String.prototype.__mul__=function(b){for(var a=this,m=1;m<b;m++)a+=this;return a};String.prototype.__rmul__=String.prototype.__mul__;n.dict=D;D.__name__="dict";E(Function.prototype,"__setdoc__",{value:function(b){this.__doc__=b;return this},enumerable:!1});n.__neg__=function(b){return"object"==typeof b&&"__neg__"in
b?b.__neg__():-b};n.__matmul__=function(b,a){return b.__matmul__(a)};n.pow=function(b,a){return"object"==typeof b&&"__pow__"in b?b.__pow__(a):"object"==typeof a&&"__rpow__"in a?a.__rpow__(b):Math.pow(b,a)};n.__jsmod__=function(b,a){return"object"==typeof b&&"__mod__"in b?b.__mod__(a):"object"==typeof a&&"__rpow__"in a?a.__rmod__(b):b%a};n.mod=function(b,a){return"object"==typeof b&&"__mod__"in b?b.__mod__(a):"object"==typeof a&&"__rpow__"in a?a.__rmod__(b):(b%a+a)%a};n.__mul__=function(b,a){return"object"==
typeof b&&"__mul__"in b?b.__mul__(a):"object"==typeof a&&"__rmul__"in a?a.__rmul__(b):"string"==typeof b?b.__mul__(a):"string"==typeof a?a.__rmul__(b):b*a};n.__div__=function(b,a){return"object"==typeof b&&"__div__"in b?b.__div__(a):"object"==typeof a&&"__rdiv__"in a?a.__rdiv__(b):b/a};n.__add__=function(b,a){return"object"==typeof b&&"__add__"in b?b.__add__(a):"object"==typeof a&&"__radd__"in a?a.__radd__(b):b+a};n.__sub__=function(b,a){return"object"==typeof b&&"__sub__"in b?b.__sub__(a):"object"==
...
"__rand__"in a?a.__rand__(b):b&a};n.__getitem__=function(b,a){return"object"==typeof b&&"__getitem__"in b?b.__getitem__(a):b[a]};n.__setitem__=function(b,a,m){"object"==typeof b&&"__setitem__"in b?b.__setitem__(a,m):b[a]=m};n.__getslice__=function(b,a,m,q){return"object"==typeof b&&"__getitem__"in b?b.__getitem__([a,m,q]):b.__getslice__(a,m,q)};n.__setslice__=function(b,a,m,q,r){"object"==typeof b&&"__setitem__"in b?b.__setitem__([a,m,q],r):b.__setslice__(a,m,q,r)};S(n,"com.fabricjs",{__all__:{__inited__:!1,
__init__:function(b){var a=function(){var b={},a=a||{version:"1.5.0"};"undefined"!==typeof b&&(b.fabric=a);"undefined"!==typeof document&&"undefined"!==typeof window?(a.document=document,a.window=window,window.fabric=a):(a.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),a.window=a.document.createWindow?a.document.createWindow():a.document.parentWindow);a.isTouchSupported="ontouchstart"in a.document.documentElement;a.isLikelyNode="undefined"!==typeof Buffer&&
"undefined"===typeof window;a.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");a.DPI=96;a.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function b(c,f){this.__eventListeners[c]&&(f?a.util.removeFromArray(this.__eventListeners[c],f):this.__eventListeners[c].length=0)}function h(c,f){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var e in c)this.on(e,
c[e]);else this.__eventListeners[c]||(this.__eventListeners[c]=[]),this.__eventListeners[c].push(f);return this}function k(c,f){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var e in c)b.call(this,e,c[e]);else b.call(this,c,f);return this}}function g(c,f){if(this.__eventListeners&&(c=this.__eventListeners[c])){for(var e=0,d=c.length;e<d;e++)c[e].call(this,f||{});return this}}a.Observable={observe:h,stopObserving:k,
fire:g,on:h,off:k,trigger:g}})();a.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var a=0,b=arguments.length;a<b;a++)this._onObjectAdded(arguments[a]);this.renderOnAddRemove&&this.renderAll();return this},insertAt:function(a,b,k){var g=this.getObjects();k?g[b]=a:g.splice(b,0,a);this._onObjectAdded(a);this.renderOnAddRemove&&this.renderAll();return this},remove:function(){for(var a=this.getObjects(),b,k=0,g=arguments.length;k<g;k++)b=a.indexOf(arguments[k]),-1!==b&&
(a.splice(b,1),this._onObjectRemoved(arguments[k]));this.renderOnAddRemove&&this.renderAll();return this},forEachObject:function(a,b){for(var h=this.getObjects(),g=h.length;g--;)a.call(b,h[g],g,h);return this},getObjects:function(a){return"undefined"===typeof a?this._objects:this._objects.filter(function(b){return b.type===a})},item:function(a){return this.getObjects()[a]},isEmpty:function(){return 0===this.getObjects().length},size:function(){return this.getObjects().length},contains:function(a){return-1<
this.getObjects().indexOf(a)},complexity:function(){return this.getObjects().reduce(function(a,b){return a+=b.complexity?b.complexity():0},0)}};(function(b){var h=Math.sqrt,k=Math.atan2,g=Math.PI/180;a.util={removeFromArray:function(c,f){f=c.indexOf(f);-1!==f&&c.splice(f,1);return c},getRandomInt:function(c,f){return Math.floor(Math.random()*(f-c+1))+c},degreesToRadians:function(c){return c*g},radiansToDegrees:function(c){return c/g},rotatePoint:function(c,f,e){var d=Math.sin(e);e=Math.cos(e);c.subtractEquals(f);
return(new a.Point(c.x*e-c.y*d,c.x*d+c.y*e)).addEquals(f)},transformPoint:function(c,f,e){return e?new a.Point(f[0]*c.x+f[2]*c.y,f[1]*c.x+f[3]*c.y):new a.Point(f[0]*c.x+f[2]*c.y+f[4],f[1]*c.x+f[3]*c.y+f[5])},invertTransform:function(c){c.slice();var f=1/(c[0]*c[3]-c[1]*c[2]);f=[f*c[3],-f*c[1],-f*c[2],f*c[0],0,0];c=a.util.transformPoint({x:c[4],y:c[5]},f);f[4]=-c.x;f[5]=-c.y;return f},toFixed:function(c,f){return parseFloat(Number(c).toFixed(f))},parseUnit:function(c,f){var e=/\D{0,2}$/.exec(c);c=
parseFloat(c);f||(f=a.Text.DEFAULT_SVG_FONT_SIZE);switch(e[0]){case "mm":return c*a.DPI/25.4;case "cm":return c*a.DPI/2.54;case "in":return c*a.DPI;case "pt":return c*a.DPI/72;case "pc":return c*a.DPI/72*12;case "em":return c*f;default:return c}},falseFunction:function(){return!1},getKlass:function(c,f){c=a.util.string.camelize(c.charAt(0).toUpperCase()+c.slice(1));return a.util.resolveNamespace(f)[c]},resolveNamespace:function(c){if(!c)return a;c=c.split(".");for(var f=c.length,e=b||a.window,d=0;d<
f;++d)e=e[c[d]];return e},loadImage:function(c,f,e,d){if(c){var b=a.util.createImage();b.onload=function(){f&&f.call(e,b);b=b.onload=b.onerror=null};b.onerror=function(){a.log("Error loading "+b.src);f&&f.call(e,null,!0);b=b.onload=b.onerror=null};0!==c.indexOf("data")&&"undefined"!==typeof d&&(b.crossOrigin=d);b.src=c}else f&&f.call(e,c)},enlivenObjects:function(c,f,e,d){function b(){++h===k&&f&&f(g)}c=c||[];var g=[],h=0,k=c.length;k?c.forEach(function(c,f){if(c&&c.type){var h=a.util.getKlass(c.type,
e);h.async?h.fromObject(c,function(e,a){a||(g[f]=e,d&&d(c,g[f]));b()}):(g[f]=h.fromObject(c),d&&d(c,g[f]),b())}else b()}):f&&f(g)},groupSVGElements:function(c,f,e){c=new a.PathGroup(c,f);"undefined"!==typeof e&&c.setSourcePath(e);return c},populateWithProperties:function(c,f,e){if(e&&"[object Array]"===Object.prototype.toString.call(e))for(var d=0,a=e.length;d<a;d++)e[d]in c&&(f[e[d]]=c[e[d]])},drawDashedLine:function(c,f,e,d,a,b){d-=f;var g=a-e;a=h(d*d+g*g);d=k(g,d);g=b.length;var p=0,u=!0;c.save();
c.translate(f,e);c.moveTo(0,0);c.rotate(d);for(f=0;a>f;)f+=b[p++%g],f>a&&(f=a),c[u?"lineTo":"moveTo"](f,0),u=!u;c.restore()},createCanvasElement:function(c){c||(c=a.document.createElement("canvas"));c.getContext||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(c);return c},createImage:function(){return a.isLikelyNode?new (require("canvas").Image):a.document.createElement("img")},createAccessors:function(c){c=c.prototype;for(var f=c.stateProperties.length;f--;){var e=c.stateProperties[f],
d=e.charAt(0).toUpperCase()+e.slice(1),a="set"+d;d="get"+d;c[d]||(c[d]=new Function('return this.get("'+e+'")'));c[a]||(c[a]=new Function("value",'return this.set("'+e+'", value)'))}},clipContext:function(c,f){f.save();f.beginPath();c.clipTo(f);f.clip()},multiplyTransformMatrices:function(c,f){return[c[0]*f[0]+c[2]*f[1],c[1]*f[0]+c[3]*f[1],c[0]*f[2]+c[2]*f[3],c[1]*f[2]+c[3]*f[3],c[0]*f[4]+c[2]*f[5]+c[4],c[1]*f[4]+c[3]*f[5]+c[5]]},getFunctionBody:function(c){return(String(c).match(/function[^{]*\{([\s\S]*)\}/)||
{})[1]},isTransparent:function(c,f,e,d){0<d&&(f=f>d?f-d:0,e=e>d?e-d:0);var a=!0;c=c.getImageData(f,e,2*d||1,2*d||1);f=3;for(e=c.data.length;f<e&&(a=0>=c.data[f],!1!==a);f+=4);return a}}})("undefined"!==typeof b?b:this);(function(){function b(e,f,a,b,g,r,m){var p=d.call(arguments);if(c[p])return c[p];var u=Math.PI,w=m*u/180,C=Math.sin(w);w=Math.cos(w);var H=0,F=0;a=Math.abs(a);b=Math.abs(b);var z=-w*e*.5-C*f*.5,n=-w*f*.5+C*e*.5,q=a*a,l=b*b,t=n*n,v=z*z,N=q*l-q*t-l*v,x=0;0>N?(q=Math.sqrt(1-N/(q*l)),
a*=q,b*=q):x=(g===r?-1:1)*Math.sqrt(N/(q*t+l*v));t=x*a*n/b;v=-x*b*z/a;x=w*t-C*v+.5*e;q=C*t+w*v+.5*f;l=k(1,0,(z-t)/a,(n-v)/b);n=k((z-t)/a,(n-v)/b,(-z-t)/a,(-n-v)/b);0===r&&0<n?n-=2*u:1===r&&0>n&&(n+=2*u);u=Math.ceil(Math.abs(n/u*2));z=[];n/=u;t=8/3*Math.sin(n/4)*Math.sin(n/4)/Math.sin(n/2);v=l+n;for(N=0;N<u;N++)z[N]=h(l,v,w,C,a,b,x,q,t,H,F),H=z[N][4],F=z[N][5],l=v,v+=n;return c[p]=z}function h(e,c,a,b,g,h,k,r,m,n,q){var p=d.call(arguments);if(f[p])return f[p];var u=Math.cos(e),w=Math.sin(e),C=Math.cos(c),
H=Math.sin(c),F=a*g*C-b*h*H+k,z=b*g*C+a*h*H+r;f[p]=[n+m*(-a*g*w-b*h*u),q+m*(-b*g*w+a*h*u),F+m*(a*g*H+b*h*C),z+m*(b*g*H-a*h*C),F,z];return f[p]}function k(d,e,c,f){d=Math.atan2(e,d);c=Math.atan2(f,c);return c>=d?c-d:2*Math.PI-(d-c)}function g(c,f,a,b,g,h,k,r){var p=d.call(arguments);if(e[p])return e[p];var u=Math.sqrt,w=Math.min,C=Math.max,H=Math.abs,m=[],F=[[],[]];var n=6*c-12*a+6*g;var z=-3*c+9*a-9*g+3*k;var da=3*a-3*c;for(var q=0;2>q;++q)if(0<q&&(n=6*f-12*b+6*h,z=-3*f+9*b-9*h+3*r,da=3*b-3*f),1E-12>
H(z)){if(!(1E-12>H(n))){var l=-da/n;0<l&&1>l&&m.push(l)}}else if(l=n*n-4*da*z,!(0>l)){var t=u(l);l=(-n+t)/(2*z);0<l&&1>l&&m.push(l);l=(-n-t)/(2*z);0<l&&1>l&&m.push(l)}for(H=u=m.length;u--;)l=m[u],n=1-l,z=n*n*n*c+3*n*n*l*a+3*n*l*l*g+l*l*l*k,F[0][u]=z,z=n*n*n*f+3*n*n*l*b+3*n*l*l*h+l*l*l*r,F[1][u]=z;F[0][H]=c;F[1][H]=f;F[0][H+1]=k;F[1][H+1]=r;w=[{x:w.apply(null,F[0]),y:w.apply(null,F[1])},{x:C.apply(null,F[0]),y:C.apply(null,F[1])}];return e[p]=w}var c={},f={},e={},d=Array.prototype.join;a.util.drawArc=
function(d,e,c,f){var a=[[],[],[],[]];f=b(f[5]-e,f[6]-c,f[0],f[1],f[3],f[4],f[2]);for(var g=0,h=f.length;g<h;g++)a[g][0]=f[g][0]+e,a[g][1]=f[g][1]+c,a[g][2]=f[g][2]+e,a[g][3]=f[g][3]+c,a[g][4]=f[g][4]+e,a[g][5]=f[g][5]+c,d.bezierCurveTo.apply(d,a[g])};a.util.getBoundsOfArc=function(d,e,c,f,a,h,k,r,m){var p=0,u=0,w=[];c=b(r-d,m-e,c,f,h,k,a);f=[[],[]];a=0;for(h=c.length;a<h;a++)p=g(p,u,c[a][0],c[a][1],c[a][2],c[a][3],c[a][4],c[a][5]),f[0].x=p[0].x+d,f[0].y=p[0].y+e,f[1].x=p[1].x+d,f[1].y=p[1].y+e,w.push(f[0]),
w.push(f[1]),p=c[a][4],u=c[a][5];return w};a.util.getBoundsOfCurve=g})();(function(){function b(a,b,c){if(a&&0!==a.length){var f=a.length-1,e=b?a[f][b]:a[f];if(b)for(;f--;)c(a[f][b],e)&&(e=a[f][b]);else for(;f--;)c(a[f],e)&&(e=a[f]);return e}}var h=Array.prototype.slice;Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(void 0===this||null===this)throw new TypeError;var b=Object(this),c=b.length>>>0;if(0===c)return-1;var f=0;0<arguments.length&&(f=Number(arguments[1]),f!==f?f=0:0!==
...
function(a){var b=this.length>>>0,c=0;if(1<arguments.length)var f=arguments[1];else{do{if(c in this){f=this[c++];break}if(++c>=b)throw new TypeError;}while(1)}for(;c<b;c++)c in this&&(f=a.call(null,f,this[c],c,this));return f});a.util.array={invoke:function(a,b){for(var c=h.call(arguments,2),f=[],e=0,d=a.length;e<d;e++)f[e]=c.length?a[e][b].apply(a[e],c):a[e][b].call(a[e]);return f},min:function(a,g){return b(a,g,function(c,f){return c<f})},max:function(a,g){return b(a,g,function(c,f){return c>=f})}}})();
(function(){function b(a,b){for(var g in b)a[g]=b[g];return a}a.util.object={extend:b,clone:function(a){return b({},a)}}})();(function(){String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});a.util.string={camelize:function(a){return a.replace(/-+(.)?/g,function(a,b){return b?b.toUpperCase():""})},capitalize:function(a,b){return a.charAt(0).toUpperCase()+(b?a.slice(1):a.slice(1).toLowerCase())},escapeXml:function(a){return a.replace(/&/g,
...
(function(){function b(){}function h(e){var d=this.constructor.superclass.prototype[e];return 1<arguments.length?d.apply(this,k.call(arguments,1)):d.call(this)}var k=Array.prototype.slice,g=function(){},c=function(){for(var e in{toString:1})if("toString"===e)return!1;return!0}(),f=function(e,d,f){for(var a in d)a in e.prototype&&"function"===typeof e.prototype[a]&&-1<(d[a]+"").indexOf("callSuper")?e.prototype[a]=function(e){return function(){var c=this.constructor.superclass;this.constructor.superclass=
f;var a=d[e].apply(this,arguments);this.constructor.superclass=c;if("initialize"!==e)return a}}(a):e.prototype[a]=d[a],c&&(d.toString!==Object.prototype.toString&&(e.prototype.toString=d.toString),d.valueOf!==Object.prototype.valueOf&&(e.prototype.valueOf=d.valueOf))};a.util.createClass=function(){function e(){this.initialize.apply(this,arguments)}var d=null,c=k.call(arguments,0);"function"===typeof c[0]&&(d=c.shift());e.superclass=d;e.subclasses=[];d&&(b.prototype=d.prototype,e.prototype=new b,d.subclasses.push(e));
for(var a=0,r=c.length;a<r;a++)f(e,c[a],d);e.prototype.initialize||(e.prototype.initialize=g);e.prototype.constructor=e;e.prototype.callSuper=h;return e}})();(function(){function b(d){var e=Array.prototype.slice.call(arguments,1),c,f=e.length;for(c=0;c<f;c++){var a=typeof d[e[c]];if(!/^(?:function|object|unknown)$/.test(a))return!1}return!0}function h(d,e){return function(f){e.call(c(d),f||a.window.event)}}function k(d,e){return function(c){if(w[d]&&w[d][e])for(var f=w[d][e],b=0,g=f.length;b<g;b++)f[b].call(this,
c||a.window.event)}}function g(d,e,c){var f="touchend"===d.type?"changedTouches":"touches";return d[f]&&d[f][0]?d[f][0][e]-(d[f][0][e]-d[f][0][c])||d[c]:d[c]}var c,f,e=function(){var d=0;return function(e){return e.__uniqueID||(e.__uniqueID="uniqueID__"+d++)}}();(function(){var d={};c=function(e){return d[e]};f=function(e,c){d[e]=c}})();var d=b(a.document.documentElement,"addEventListener","removeEventListener")&&b(a.window,"addEventListener","removeEventListener"),p=b(a.document.documentElement,
"attachEvent","detachEvent")&&b(a.window,"attachEvent","detachEvent"),u={},w={};d?(d=function(d,e,c){d.addEventListener(e,c,!1)},p=function(d,e,c){d.removeEventListener(e,c,!1)}):p?(d=function(d,c,a){var b=e(d);f(b,d);u[b]||(u[b]={});u[b][c]||(u[b][c]=[]);a={handler:a,wrappedHandler:h(b,a)};u[b][c].push(a);d.attachEvent("on"+c,a.wrappedHandler)},p=function(d,c,f){var a=e(d),b;if(u[a]&&u[a][c])for(var g=0,h=u[a][c].length;g<h;g++)(b=u[a][c][g])&&b.handler===f&&(d.detachEvent("on"+c,b.wrappedHandler),
u[a][c][g]=null)}):(d=function(d,c,f){var a=e(d);w[a]||(w[a]={});if(!w[a][c]){w[a][c]=[];var b=d["on"+c];b&&w[a][c].push(b);d["on"+c]=k(a,c)}w[a][c].push(f)},p=function(d,c,f){d=e(d);if(w[d]&&w[d][c]){c=w[d][c];d=0;for(var a=c.length;d<a;d++)c[d]===f&&c.splice(d,1)}});a.util.addListener=d;a.util.removeListener=p;var C=function(d){return"unknown"!==typeof d.clientX?d.clientX:0},m=function(d){return"unknown"!==typeof d.clientY?d.clientY:0};a.isTouchSupported&&(C=function(d){return g(d,"pageX","clientX")},
m=function(d){return g(d,"pageY","clientY")});a.util.getPointer=function(d,e){d||(d=a.window.event);e=a.util.getScrollLeftTop(d.target||("unknown"!==typeof d.srcElement?d.srcElement:null),e);return{x:C(d)+e.left,y:m(d)+e.top}};a.util.object.extend(a.util,a.Observable)})();(function(){var b=a.document.createElement("div"),h="string"===typeof b.style.filter,k=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,g=function(c){return c};"string"===typeof b.style.opacity?g=function(c,f){c.style.opacity=f;return c}:
h&&(g=function(c,f){var e=c.style;c.currentStyle&&!c.currentStyle.hasLayout&&(e.zoom=1);k.test(e.filter)?e.filter=e.filter.replace(k,.9999<=f?"":"alpha(opacity="+100*f+")"):e.filter+=" alpha(opacity="+100*f+")";return c});a.util.setStyle=function(c,f){var e=c.style;if(!e)return c;if("string"===typeof f)return c.style.cssText+=";"+f,-1<f.indexOf("opacity")?g(c,f.match(/opacity:\s*(\d?\.?\d*)/)[1]):c;for(var d in f)"opacity"===d?g(c,f[d]):e["float"===d||"cssFloat"===d?"undefined"===typeof e.styleFloat?
"cssFloat":"styleFloat":d]=f[d];return c}})();(function(){function b(c,e){c=a.document.createElement(c);for(var d in e)"class"===d?c.className=e[d]:"for"===d?c.htmlFor=e[d]:c.setAttribute(d,e[d]);return c}var h=Array.prototype.slice,k=function(c){return h.call(c,0)};try{var g=k(a.document.childNodes)instanceof Array}catch(f){}g||(k=function(c){for(var e=Array(c.length),d=c.length;d--;)e[d]=c[d];return e});var c=a.document.defaultView&&a.document.defaultView.getComputedStyle?function(c,e){return(c=
a.document.defaultView.getComputedStyle(c,null))?c[e]:void 0}:function(c,e){var d=c.style[e];!d&&c.currentStyle&&(d=c.currentStyle[e]);return d};(function(){var c=a.document.documentElement.style,e="userSelect"in c?"userSelect":"MozUserSelect"in c?"MozUserSelect":"WebkitUserSelect"in c?"WebkitUserSelect":"KhtmlUserSelect"in c?"KhtmlUserSelect":"";a.util.makeElementUnselectable=function(d){"undefined"!==typeof d.onselectstart&&(d.onselectstart=a.util.falseFunction);e?d.style[e]="none":"string"===typeof d.unselectable&&
(d.unselectable="on");return d};a.util.makeElementSelectable=function(d){"undefined"!==typeof d.onselectstart&&(d.onselectstart=null);e?d.style[e]="":"string"===typeof d.unselectable&&(d.unselectable="");return d}})();(function(){a.util.getScript=function(c,e){var d=a.document.getElementsByTagName("head")[0],f=a.document.createElement("script"),b=!0;f.onload=f.onreadystatechange=function(d){!b||"string"===typeof this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||(b=!1,e(d||
a.window.event),f=f.onload=f.onreadystatechange=null)};f.src=c;d.appendChild(f)}})();a.util.getById=function(c){return"string"===typeof c?a.document.getElementById(c):c};a.util.toArray=k;a.util.makeElement=b;a.util.addClass=function(c,e){c&&-1===(" "+c.className+" ").indexOf(" "+e+" ")&&(c.className+=(c.className?" ":"")+e)};a.util.wrapElement=function(c,e,d){"string"===typeof e&&(e=b(e,d));c.parentNode&&c.parentNode.replaceChild(e,c);e.appendChild(c);return e};a.util.getScrollLeftTop=function(c,
e){var d,f,b=0,g=0,h=a.document.documentElement,k=a.document.body||{scrollLeft:0,scrollTop:0};for(f=c;c&&c.parentNode&&!d;)c=c.parentNode,1===c.nodeType&&"fixed"===a.util.getElementStyle(c,"position")&&(d=c),1===c.nodeType&&f!==e&&"absolute"===a.util.getElementStyle(c,"position")?g=b=0:c===a.document?(b=k.scrollLeft||h.scrollLeft||0,g=k.scrollTop||h.scrollTop||0):(b+=c.scrollLeft||0,g+=c.scrollTop||0);return{left:b,top:g}};a.util.getElementOffset=function(f){var e=f&&f.ownerDocument;var d={left:0,
top:0},b={left:0,top:0},g={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!e)return{left:0,top:0};for(var h in g)b[g[h]]+=parseInt(c(f,h),10)||0;e=e.documentElement;"undefined"!==typeof f.getBoundingClientRect&&(d=f.getBoundingClientRect());f=a.util.getScrollLeftTop(f,null);return{left:d.left+f.left-(e.clientLeft||0)+b.left,top:d.top+f.top-(e.clientTop||0)+b.top}};a.util.getElementStyle=c})();(function(){function b(a,c){return a+(/\?/.test(a)?"&":"?")+c}function h(){}
var k=function(){for(var a=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},function(){return new XMLHttpRequest}],c=a.length;c--;)try{if(a[c]())return a[c]}catch(f){}}();a.util.request=function(a,c){c||(c={});var f=c.method?c.method.toUpperCase():"GET",e=c.onComplete||function(){},d=k();d.onreadystatechange=function(){4===d.readyState&&(e(d),d.onreadystatechange=h)};if("GET"===
f){var g=null;"string"===typeof c.parameters&&(a=b(a,c.parameters))}d.open(f,a,!0);"POST"!==f&&"PUT"!==f||d.setRequestHeader("Content-Type","application/x-www-form-urlencoded");d.send(g);return d}})();a.log=function(){};a.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(b){"undefined"!==typeof console[b]&&"function"===typeof console[b].apply&&(a[b]=function(){return console[b].apply(console,arguments)})});(function(a){function b(a,b){this.x=a;this.y=b}a=a.fabric||(a.fabric=
...
a.x;this.y=a.y},swap:function(a){var b=this.x,c=this.y;this.x=a.x;this.y=a.y;a.x=b;a.y=c}})})("undefined"!==typeof b?b:this);(function(a){function b(a){this.status=a;this.points=[]}var k=a.fabric||(a.fabric={});k.Intersection?k.warn("fabric.Intersection is already defined"):(k.Intersection=b,k.Intersection.prototype={appendPoint:function(a){this.points.push(a)},appendPoints:function(a){this.points=this.points.concat(a)}},k.Intersection.intersectLineLine=function(a,c,f,e){var d=(e.x-f.x)*(a.y-f.y)-
...
e.appendPoints(f.points);e.appendPoints(d.points);e.appendPoints(a.points);0<e.points.length&&(e.status="Intersection");return e})})("undefined"!==typeof b?b:this);(function(a){function b(c){c?this._tryParsingColor(c):this.setSource([0,0,0,1])}function k(c,a,e){0>e&&(e+=1);1<e&&--e;return e<1/6?c+6*(a-c)*e:.5>e?a:e<2/3?c+(a-c)*(2/3-e)*6:c}var g=a.fabric||(a.fabric={});g.Color?g.warn("fabric.Color is already defined."):(g.Color=b,g.Color.prototype={_tryParsingColor:function(c){var a;c in b.colorNameMap&&
(c=b.colorNameMap[c]);"transparent"===c?this.setSource([255,255,255,0]):((a=b.sourceFromHex(c))||(a=b.sourceFromRgb(c)),a||(a=b.sourceFromHsl(c)),a&&this.setSource(a))},_rgbToHsl:function(c,a,e){c/=255;a/=255;e/=255;var d=g.util.array.max([c,a,e]);var b=g.util.array.min([c,a,e]);var f=(d+b)/2;if(d===b)var h=b=0;else{var k=d-b;b=.5<f?k/(2-d-b):k/(d+b);switch(d){case c:h=(a-e)/k+(a<e?6:0);break;case a:h=(e-c)/k+2;break;case e:h=(c-a)/k+4}h/=6}return[Math.round(360*h),Math.round(100*b),Math.round(100*
f)]},getSource:function(){return this._source},setSource:function(c){this._source=c},toRgb:function(){var c=this.getSource();return"rgb("+c[0]+","+c[1]+","+c[2]+")"},toRgba:function(){var c=this.getSource();return"rgba("+c[0]+","+c[1]+","+c[2]+","+c[3]+")"},toHsl:function(){var c=this.getSource();c=this._rgbToHsl(c[0],c[1],c[2]);return"hsl("+c[0]+","+c[1]+"%,"+c[2]+"%)"},toHsla:function(){var c=this.getSource(),a=this._rgbToHsl(c[0],c[1],c[2]);return"hsla("+a[0]+","+a[1]+"%,"+a[2]+"%,"+c[3]+")"},
toHex:function(){var c=this.getSource();var a=c[0].toString(16);a=1===a.length?"0"+a:a;var e=c[1].toString(16);e=1===e.length?"0"+e:e;c=c[2].toString(16);c=1===c.length?"0"+c:c;return a.toUpperCase()+e.toUpperCase()+c.toUpperCase()},getAlpha:function(){return this.getSource()[3]},setAlpha:function(c){var a=this.getSource();a[3]=c;this.setSource(a);return this},toGrayscale:function(){var c=this.getSource(),a=parseInt((.3*c[0]+.59*c[1]+.11*c[2]).toFixed(0),10);this.setSource([a,a,a,c[3]]);return this},
toBlackWhite:function(c){var a=this.getSource(),e=(.3*a[0]+.59*a[1]+.11*a[2]).toFixed(0);a=a[3];e=Number(e)<Number(c||127)?0:255;this.setSource([e,e,e,a]);return this},overlayWith:function(c){c instanceof b||(c=new b(c));var a=[],e=this.getAlpha(),d=this.getSource();c=c.getSource();for(var g=0;3>g;g++)a.push(Math.round(.5*d[g]+.5*c[g]));a[3]=e;this.setSource(a);return this}},g.Color.reRGBa=/^rgba?\(\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*,\s*(\d{1,3}(?:\.\d+)?\%?)\s*(?:\s*,\s*(\d+(?:\.\d+)?)\s*)?\)$/,
...
g.Color.sourceFromRgb=function(c){if(c=c.match(b.reRGBa)){var a=parseInt(c[1],10)/(/%$/.test(c[1])?100:1)*(/%$/.test(c[1])?255:1),e=parseInt(c[2],10)/(/%$/.test(c[2])?100:1)*(/%$/.test(c[2])?255:1),d=parseInt(c[3],10)/(/%$/.test(c[3])?100:1)*(/%$/.test(c[3])?255:1);return[parseInt(a,10),parseInt(e,10),parseInt(d,10),c[4]?parseFloat(c[4]):1]}},g.Color.fromRgba=b.fromRgb,g.Color.fromHsl=function(c){return b.fromSource(b.sourceFromHsl(c))},g.Color.sourceFromHsl=function(c){if(c=c.match(b.reHSLa)){var a=
(parseFloat(c[1])%360+360)%360/360,e=parseFloat(c[2])/(/%$/.test(c[2])?100:1),d=parseFloat(c[3])/(/%$/.test(c[3])?100:1);if(0===e)d=e=a=d;else{var g=.5>=d?d*(e+1):d+e-d*e,h=2*d-g;d=k(h,g,a+1/3);e=k(h,g,a);a=k(h,g,a-1/3)}return[Math.round(255*d),Math.round(255*e),Math.round(255*a),c[4]?parseFloat(c[4]):1]}},g.Color.fromHsla=b.fromHsl,g.Color.fromHex=function(c){return b.fromSource(b.sourceFromHex(c))},g.Color.sourceFromHex=function(c){if(c.match(b.reHex)){var a=c.slice(c.indexOf("#")+1),e=3===a.length;
c=e?a.charAt(0)+a.charAt(0):a.substring(0,2);var d=e?a.charAt(1)+a.charAt(1):a.substring(2,4);a=e?a.charAt(2)+a.charAt(2):a.substring(4,6);return[parseInt(c,16),parseInt(d,16),parseInt(a,16),1]}},g.Color.fromSource=function(c){var a=new b;a.setSource(c);return a})})("undefined"!==typeof b?b:this);(function(){if(a.StaticCanvas)a.warn("fabric.StaticCanvas is already defined.");else{var b=a.util.object.extend,h=a.util.getElementOffset,k=a.util.removeFromArray,g=Error("Could not initialize `canvas` element");
...
this._initOptions(a);this._setImageSmoothing();a.overlayImage&&this.setOverlayImage(a.overlayImage,this.renderAll.bind(this));a.backgroundImage&&this.setBackgroundImage(a.backgroundImage,this.renderAll.bind(this));a.backgroundColor&&this.setBackgroundColor(a.backgroundColor,this.renderAll.bind(this));a.overlayColor&&this.setOverlayColor(a.overlayColor,this.renderAll.bind(this));this.calcOffset()},calcOffset:function(){this._offset=h(this.lowerCanvasEl);return this},setOverlayImage:function(c,a,e){return this.__setBgOverlayImage("overlayImage",
c,a,e)},setBackgroundImage:function(c,a,e){return this.__setBgOverlayImage("backgroundImage",c,a,e)},setOverlayColor:function(c,a){return this.__setBgOverlayColor("overlayColor",c,a)},setBackgroundColor:function(c,a){return this.__setBgOverlayColor("backgroundColor",c,a)},_setImageSmoothing:function(){var c=this.getContext();c.imageSmoothingEnabled=this.imageSmoothingEnabled;c.webkitImageSmoothingEnabled=this.imageSmoothingEnabled;c.mozImageSmoothingEnabled=this.imageSmoothingEnabled;c.msImageSmoothingEnabled=
this.imageSmoothingEnabled;c.oImageSmoothingEnabled=this.imageSmoothingEnabled},__setBgOverlayImage:function(c,b,e,d){"string"===typeof b?a.util.loadImage(b,function(b){this[c]=new a.Image(b,d);e&&e()},this,d&&d.crossOrigin):(d&&b.setOptions(d),this[c]=b,e&&e());return this},__setBgOverlayColor:function(c,b,e){if(b&&b.source){var d=this;a.util.loadImage(b.source,function(f){d[c]=new a.Pattern({source:f,repeat:b.repeat,offsetX:b.offsetX,offsetY:b.offsetY});e&&e()})}else this[c]=b,e&&e();return this},
...
getWidth:function(){return this.width},getHeight:function(){return this.height},setWidth:function(c,a){return this.setDimensions({width:c},a)},setHeight:function(c,a){return this.setDimensions({height:c},a)},setDimensions:function(c,a){a=a||{};for(var e in c){var d=c[e];a.cssOnly||(this._setBackstoreDimension(e,c[e]),d+="px");a.backstoreOnly||this._setCssDimension(e,d)}a.cssOnly||this.renderAll();this.calcOffset();return this},_setBackstoreDimension:function(c,a){this.lowerCanvasEl[c]=a;this.upperCanvasEl&&
(this.upperCanvasEl[c]=a);this.cacheCanvasEl&&(this.cacheCanvasEl[c]=a);this[c]=a;return this},_setCssDimension:function(c,a){this.lowerCanvasEl.style[c]=a;this.upperCanvasEl&&(this.upperCanvasEl.style[c]=a);this.wrapperEl&&(this.wrapperEl.style[c]=a);return this},getZoom:function(){return Math.sqrt(this.viewportTransform[0]*this.viewportTransform[3])},setViewportTransform:function(c){var a=this.getActiveGroup();this.viewportTransform=c;this.renderAll();c=0;for(var e=this._objects.length;c<e;c++)this._objects[c].setCoords();
a&&a.setCoords();return this},zoomToPoint:function(c,b){var e=c;c=a.util.transformPoint(c,a.util.invertTransform(this.viewportTransform));this.viewportTransform[0]=b;this.viewportTransform[3]=b;c=a.util.transformPoint(c,this.viewportTransform);this.viewportTransform[4]+=e.x-c.x;this.viewportTransform[5]+=e.y-c.y;this.renderAll();e=0;for(c=this._objects.length;e<c;e++)this._objects[e].setCoords();return this},setZoom:function(c){this.zoomToPoint(new a.Point(0,0),c);return this},absolutePan:function(c){this.viewportTransform[4]=
-c.x;this.viewportTransform[5]=-c.y;this.renderAll();c=0;for(var a=this._objects.length;c<a;c++)this._objects[c].setCoords();return this},relativePan:function(c){return this.absolutePan(new a.Point(-c.x-this.viewportTransform[4],-c.y-this.viewportTransform[5]))},getElement:function(){return this.lowerCanvasEl},getActiveObject:function(){return null},getActiveGroup:function(){return null},_draw:function(c,a){if(a){c.save();var e=this.viewportTransform;c.transform(e[0],e[1],e[2],e[3],e[4],e[5]);this._shouldRenderObject(a)&&
a.render(c);c.restore();this.controlsAboveOverlay||a._renderControls(c)}},_shouldRenderObject:function(c){return c?c!==this.getActiveGroup()||!this.preserveObjectStacking:!1},_onObjectAdded:function(c){this.stateful&&c.setupState();c.canvas=this;c.setCoords();this.fire("object:added",{target:c});c.fire("added")},_onObjectRemoved:function(c){this.getActiveObject()===c&&(this.fire("before:selection:cleared",{target:c}),this._discardActiveObject(),this.fire("selection:cleared"));this.fire("object:removed",
{target:c});c.fire("removed")},clearContext:function(c){c.clearRect(0,0,this.width,this.height);return this},getContext:function(){return this.contextContainer},clear:function(){this._objects.length=0;this.discardActiveGroup&&this.discardActiveGroup();this.discardActiveObject&&this.discardActiveObject();this.clearContext(this.contextContainer);this.contextTop&&this.clearContext(this.contextTop);this.fire("canvas:cleared");this.renderAll();return this},renderAll:function(c){var b=this[!0===c&&this.interactive?
"contextTop":"contextContainer"],e=this.getActiveGroup();this.contextTop&&this.selection&&!this._groupSelector&&this.clearContext(this.contextTop);c||this.clearContext(b);this.fire("before:render");this.clipTo&&a.util.clipContext(this,b);this._renderBackground(b);this._renderObjects(b,e);this._renderActiveGroup(b,e);this.clipTo&&b.restore();this._renderOverlay(b);this.controlsAboveOverlay&&this.interactive&&this.drawControls(b);this.fire("after:render");return this},_renderObjects:function(c,a){var e;
if(!a||this.preserveObjectStacking){var d=0;for(e=this._objects.length;d<e;++d)this._draw(c,this._objects[d])}else for(d=0,e=this._objects.length;d<e;++d)this._objects[d]&&!a.contains(this._objects[d])&&this._draw(c,this._objects[d])},_renderActiveGroup:function(c,a){if(a){var e=[];this.forEachObject(function(d){a.contains(d)&&e.push(d)});a._set("objects",e);this._draw(c,a)}},_renderBackground:function(c){this.backgroundColor&&(c.fillStyle=this.backgroundColor.toLive?this.backgroundColor.toLive(c):
this.backgroundColor,c.fillRect(this.backgroundColor.offsetX||0,this.backgroundColor.offsetY||0,this.width,this.height));this.backgroundImage&&this._draw(c,this.backgroundImage)},_renderOverlay:function(c){this.overlayColor&&(c.fillStyle=this.overlayColor.toLive?this.overlayColor.toLive(c):this.overlayColor,c.fillRect(this.overlayColor.offsetX||0,this.overlayColor.offsetY||0,this.width,this.height));this.overlayImage&&this._draw(c,this.overlayImage)},renderTop:function(){var c=this.contextTop||this.contextContainer;
this.clearContext(c);this.selection&&this._groupSelector&&this._drawSelection();var a=this.getActiveGroup();a&&a.render(c);this._renderOverlay(c);this.fire("after:render");return this},getCenter:function(){return{top:this.getHeight()/2,left:this.getWidth()/2}},centerObjectH:function(c){this._centerObject(c,new a.Point(this.getCenter().left,c.getCenterPoint().y));this.renderAll();return this},centerObjectV:function(c){this._centerObject(c,new a.Point(c.getCenterPoint().x,this.getCenter().top));this.renderAll();
return this},centerObject:function(c){var b=this.getCenter();this._centerObject(c,new a.Point(b.left,b.top));this.renderAll();return this},_centerObject:function(c,a){c.setPositionByOrigin(a,"center","center");return this},toDatalessJSON:function(c){return this.toDatalessObject(c)},toObject:function(c){return this._toObjectMethod("toObject",c)},toDatalessObject:function(c){return this._toObjectMethod("toDatalessObject",c)},_toObjectMethod:function(c,f){c={objects:this._toObjects(c,f)};b(c,this.__serializeBgOverlay());
a.util.populateWithProperties(this,c,f);return c},_toObjects:function(c,a){return this.getObjects().map(function(e){return this._toObject(e,c,a)},this)},_toObject:function(c,a,e){if(!this.includeDefaultValues){var d=c.includeDefaultValues;c.includeDefaultValues=!1}var b=this._realizeGroupTransformOnObject(c);a=c[a](e);this.includeDefaultValues||(c.includeDefaultValues=d);this._unwindGroupTransformOnObject(c,b);return a},_realizeGroupTransformOnObject:function(c){var a="angle flipX flipY height left scaleX scaleY top width".split(" ");
if(c.group&&c.group===this.getActiveGroup()){var e={};a.forEach(function(d){e[d]=c[d]});this.getActiveGroup().realizeTransform(c);return e}return null},_unwindGroupTransformOnObject:function(c,a){a&&c.set(a)},__serializeBgOverlay:function(){var a={background:this.backgroundColor&&this.backgroundColor.toObject?this.backgroundColor.toObject():this.backgroundColor};this.overlayColor&&(a.overlay=this.overlayColor.toObject?this.overlayColor.toObject():this.overlayColor);this.backgroundImage&&(a.backgroundImage=
this.backgroundImage.toObject());this.overlayImage&&(a.overlayImage=this.overlayImage.toObject());return a},svgViewportTransformation:!0,toSVG:function(a,b){a||(a={});var c=[];this._setSVGPreamble(c,a);this._setSVGHeader(c,a);this._setSVGBgOverlayColor(c,"backgroundColor");this._setSVGBgOverlayImage(c,"backgroundImage");this._setSVGObjects(c,b);this._setSVGBgOverlayColor(c,"overlayColor");this._setSVGBgOverlayImage(c,"overlayImage");c.push("</svg>");return c.join("")},_setSVGPreamble:function(a,b){b.suppressPreamble||
a.push('<?xml version="1.0" encoding="',b.encoding||"UTF-8",'" standalone="no" ?>','<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" ','"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n')},_setSVGHeader:function(c,b){if(b.viewBox){var e=b.viewBox.width;var d=b.viewBox.height}else if(e=this.width,d=this.height,!this.svgViewportTransformation){var f=this.viewportTransform;e/=f[0];d/=f[3]}c.push("<svg ",'xmlns="http://www.w3.org/2000/svg" ','xmlns:xlink="http://www.w3.org/1999/xlink" ','version="1.1" ',
'width="',e,'" ','height="',d,'" ',this.backgroundColor&&!this.backgroundColor.toLive?'style="background-color: '+this.backgroundColor+'" ':null,b.viewBox?'viewBox="'+b.viewBox.x+" "+b.viewBox.y+" "+b.viewBox.width+" "+b.viewBox.height+'" ':null,'xml:space="preserve">',"<desc>Created with Fabric.js ",a.version,"</desc>","<defs>",a.createSVGFontFacesMarkup(this.getObjects()),a.createSVGRefElementsMarkup(this),"</defs>")},_setSVGObjects:function(a,b){for(var c=0,d=this.getObjects(),f=d.length;c<f;c++){var g=
d[c],h=this._realizeGroupTransformOnObject(g);a.push(g.toSVG(b));this._unwindGroupTransformOnObject(g,h)}},_setSVGBgOverlayImage:function(a,b){this[b]&&this[b].toSVG&&a.push(this[b].toSVG())},_setSVGBgOverlayColor:function(a,b){this[b]&&this[b].source?a.push('<rect x="',this[b].offsetX,'" y="',this[b].offsetY,'" ','width="',"repeat-y"===this[b].repeat||"no-repeat"===this[b].repeat?this[b].source.width:this.width,'" height="',"repeat-x"===this[b].repeat||"no-repeat"===this[b].repeat?this[b].source.height:
this.height,'" fill="url(#'+b+'Pattern)"',"></rect>"):this[b]&&"overlayColor"===b&&a.push('<rect x="0" y="0" ','width="',this.width,'" height="',this.height,'" fill="',this[b],'"',"></rect>")},sendToBack:function(a){k(this._objects,a);this._objects.unshift(a);return this.renderAll&&this.renderAll()},bringToFront:function(a){k(this._objects,a);this._objects.push(a);return this.renderAll&&this.renderAll()},sendBackwards:function(a,b){var c=this._objects.indexOf(a);0!==c&&(b=this._findNewLowerIndex(a,
c,b),k(this._objects,a),this._objects.splice(b,0,a),this.renderAll&&this.renderAll());return this},_findNewLowerIndex:function(a,b,e){if(e)for(e=b,--b;0<=b;--b){if(a.intersectsWithObject(this._objects[b])||a.isContainedWithinObject(this._objects[b])||this._objects[b].isContainedWithinObject(a)){e=b;break}}else e=b-1;return e},bringForward:function(a,b){var c=this._objects.indexOf(a);c!==this._objects.length-1&&(b=this._findNewUpperIndex(a,c,b),k(this._objects,a),this._objects.splice(b,0,a),this.renderAll&&
...
this.complexity()+"): { objects: "+this.getObjects().length+" }>"}});b(a.StaticCanvas.prototype,a.Observable);b(a.StaticCanvas.prototype,a.Collection);b(a.StaticCanvas.prototype,a.DataURLExporter);b(a.StaticCanvas,{EMPTY_JSON:'{"objects": [], "background": "white"}',supports:function(c){var b=a.util.createCanvasElement();if(!b||!b.getContext)return null;var e=b.getContext("2d");if(!e)return null;switch(c){case "getImageData":return"undefined"!==typeof e.getImageData;case "setLineDash":return"undefined"!==
typeof e.setLineDash;case "toDataURL":return"undefined"!==typeof b.toDataURL;case "toDataURLWithQuality":try{return b.toDataURL("image/jpeg",0),!0}catch(d){}return!1;default:return null}}});a.StaticCanvas.prototype.toJSON=a.StaticCanvas.prototype.toObject}})();(function(){var b=a.util.getPointer,h=a.util.degreesToRadians,k=a.util.radiansToDegrees,g=Math.atan2,c=Math.abs;a.Canvas=a.util.createClass(a.StaticCanvas,{initialize:function(c,d){d||(d={});this._initStatic(c,d);this._initInteractive();this._createCacheCanvas();
...
-1:1),"center"!==d.originY&&(d.mouseYSign="bottom"===d.originY?-1:1),d.originX="center",d.originY="center"):(d.originX=d.original.originX,d.originY=d.original.originY)},containsPoint:function(a,d){a=this.getPointer(a,!0);var c=this._normalizePointer(d,a);return d.containsPoint(c)||d._findTargetCorner(a)},_normalizePointer:function(c,d){var e=this.getActiveGroup(),b=d.x;d=d.y;e&&"group"!==c.type&&e.contains(c)&&(c=new a.Point(e.left,e.top),c=a.util.transformPoint(c,this.viewportTransform,!0),b-=c.x,
d-=c.y);return{x:b,y:d}},isTargetTransparent:function(c,d,b){var e=c.hasBorders,f=c.transparentCorners;c.hasBorders=c.transparentCorners=!1;this._draw(this.contextCache,c);c.hasBorders=e;c.transparentCorners=f;c=a.util.isTransparent(this.contextCache,d,b,this.targetFindTolerance);this.clearContext(this.contextCache);return c},_shouldClearSelection:function(a,d){var c=this.getActiveGroup(),e=this.getActiveObject();return!d||d&&c&&!c.contains(d)&&c!==d&&!a.shiftKey||d&&!d.evented||d&&!d.selectable&&
e&&e!==d},_shouldCenterTransform:function(a,d){if(d){var c=this._currentTransform,e;"scale"===c.action||"scaleX"===c.action||"scaleY"===c.action?e=this.centeredScaling||d.centeredScaling:"rotate"===c.action&&(e=this.centeredRotation||d.centeredRotation);return e?!a.altKey:a.altKey}},_getOriginFromCorner:function(a,d){a={x:a.originX,y:a.originY};if("ml"===d||"tl"===d||"bl"===d)a.x="right";else if("mr"===d||"tr"===d||"br"===d)a.x="left";if("tl"===d||"mt"===d||"tr"===d)a.y="bottom";else if("bl"===d||
"mb"===d||"br"===d)a.y="top";return a},_getActionFromCorner:function(a,d){a="drag";d&&(a="ml"===d||"mr"===d?"scaleX":"mt"===d||"mb"===d?"scaleY":"mtr"===d?"rotate":"scale");return a},_setupCurrentTransform:function(a,d){if(d){var c=this.getPointer(a),e=d._findTargetCorner(this.getPointer(a,!0)),b=this._getActionFromCorner(d,e);e=this._getOriginFromCorner(d,e);this._currentTransform={target:d,action:b,scaleX:d.scaleX,scaleY:d.scaleY,offsetX:c.x-d.left,offsetY:c.y-d.top,originX:e.x,originY:e.y,ex:c.x,
ey:c.y,left:d.left,top:d.top,theta:h(d.angle),width:d.width*d.scaleX,mouseXSign:1,mouseYSign:1};this._currentTransform.original={left:d.left,top:d.top,scaleX:d.scaleX,scaleY:d.scaleY,originX:e.x,originY:e.y};this._resetCurrentTransform(a)}},_translateObject:function(a,d){var c=this._currentTransform.target;c.get("lockMovementX")||c.set("left",a-this._currentTransform.offsetX);c.get("lockMovementY")||c.set("top",d-this._currentTransform.offsetY)},_scaleObject:function(c,d,b){var e=this._currentTransform,
f=e.target,g=f.get("lockScalingX"),h=f.get("lockScalingY"),k=f.get("lockScalingFlip");if(!g||!h){var p=f.translateToOriginPoint(f.getCenterPoint(),e.originX,e.originY);c=f.toLocalPoint(new a.Point(c,d),e.originX,e.originY);this._setLocalMouse(c,e);this._setObjectScale(c,e,g,h,b,k);f.setPositionByOrigin(p,e.originX,e.originY)}},_setObjectScale:function(a,d,c,b,f,g){var e=d.target,h=!1,k=!1,p=e.stroke?e.strokeWidth:0;d.newScaleX=a.x/(e.width+p/2);d.newScaleY=a.y/(e.height+p/2);g&&0>=d.newScaleX&&d.newScaleX<
e.scaleX&&(h=!0);g&&0>=d.newScaleY&&d.newScaleY<e.scaleY&&(k=!0);"equally"!==f||c||b?f?"x"!==f||e.get("lockUniScaling")?"y"!==f||e.get("lockUniScaling")||k||b||e.set("scaleY",d.newScaleY):h||c||e.set("scaleX",d.newScaleX):(h||c||e.set("scaleX",d.newScaleX),k||b||e.set("scaleY",d.newScaleY)):h||k||this._scaleObjectEqually(a,e,d);h||k||this._flipObject(d,f)},_scaleObjectEqually:function(a,d,c){a=a.y+a.x;var e=d.stroke?d.strokeWidth:0;e=(d.height+e/2)*c.original.scaleY+(d.width+e/2)*c.original.scaleX;
c.newScaleX=c.original.scaleX*a/e;c.newScaleY=c.original.scaleY*a/e;d.set("scaleX",c.newScaleX);d.set("scaleY",c.newScaleY)},_flipObject:function(a,d){0>a.newScaleX&&"y"!==d&&("left"===a.originX?a.originX="right":"right"===a.originX&&(a.originX="left"));0>a.newScaleY&&"x"!==d&&("top"===a.originY?a.originY="bottom":"bottom"===a.originY&&(a.originY="top"))},_setLocalMouse:function(a,d){var e=d.target;"right"===d.originX?a.x*=-1:"center"===d.originX&&(a.x=2*a.x*d.mouseXSign,0>a.x&&(d.mouseXSign=-d.mouseXSign));
"bottom"===d.originY?a.y*=-1:"center"===d.originY&&(a.y=2*a.y*d.mouseYSign,0>a.y&&(d.mouseYSign=-d.mouseYSign));c(a.x)>e.padding?a.x=0>a.x?a.x+e.padding:a.x-e.padding:a.x=0;c(a.y)>e.padding?a.y=0>a.y?a.y+e.padding:a.y-e.padding:a.y=0},_rotateObject:function(a,d){var c=this._currentTransform;if(!c.target.get("lockRotation")){var e=g(c.ey-c.top,c.ex-c.left);a=g(d-c.top,a-c.left);e=k(a-e+c.theta);0>e&&(e=360+e);c.target.angle=e%360}},setCursor:function(a){this.upperCanvasEl.style.cursor=a},_resetObjectTransform:function(a){a.scaleX=
1;a.scaleY=1;a.setAngle(0)},_drawSelection:function(){var e=this.contextTop,d=this._groupSelector,b=d.left,f=d.top,g=c(b),h=c(f);e.fillStyle=this.selectionColor;e.fillRect(d.ex-(0<b?0:-b),d.ey-(0<f?0:-f),g,h);e.lineWidth=this.selectionLineWidth;e.strokeStyle=this.selectionBorderColor;1<this.selectionDashArray.length?(b=d.ex+.5-(0<b?0:g),d=d.ey+.5-(0<f?0:h),e.beginPath(),a.util.drawDashedLine(e,b,d,b+g,d,this.selectionDashArray),a.util.drawDashedLine(e,b,d+h-1,b+g,d+h-1,this.selectionDashArray),a.util.drawDashedLine(e,
b,d,b,d+h,this.selectionDashArray),a.util.drawDashedLine(e,b+g-1,d,b+g-1,d+h,this.selectionDashArray),e.closePath(),e.stroke()):e.strokeRect(d.ex+.5-(0<b?0:g),d.ey+.5-(0<f?0:h),g,h)},_isLastRenderedObject:function(a){return this.controlsAboveOverlay&&this.lastRenderedObjectWithControlsAboveOverlay&&this.lastRenderedObjectWithControlsAboveOverlay.visible&&this.containsPoint(a,this.lastRenderedObjectWithControlsAboveOverlay)&&this.lastRenderedObjectWithControlsAboveOverlay._findTargetCorner(this.getPointer(a,
!0))},findTarget:function(a,d){if(!this.skipTargetFind){if(this._isLastRenderedObject(a))return this.lastRenderedObjectWithControlsAboveOverlay;var c=this.getActiveGroup();if(c&&!d&&this.containsPoint(a,c))return c;a=this._searchPossibleTargets(a);this._fireOverOutEvents(a);return a}},_fireOverOutEvents:function(a){a?this._hoveredTarget!==a&&(this.fire("mouse:over",{target:a}),a.fire("mouseover"),this._hoveredTarget&&(this.fire("mouse:out",{target:this._hoveredTarget}),this._hoveredTarget.fire("mouseout")),
this._hoveredTarget=a):this._hoveredTarget&&(this.fire("mouse:out",{target:this._hoveredTarget}),this._hoveredTarget.fire("mouseout"),this._hoveredTarget=null)},_checkTarget:function(a,d,c){if(d&&d.visible&&d.evented&&this.containsPoint(a,d)&&(!this.perPixelTargetFind&&!d.perPixelTargetFind||d.isEditing||!this.isTargetTransparent(d,c.x,c.y)))return!0},_searchPossibleTargets:function(a){for(var d,c=this.getPointer(a,!0),e=this._objects.length;e--;)if(!this._objects[e].group&&this._checkTarget(a,this._objects[e],
c)){this.relatedTarget=this._objects[e];d=this._objects[e];break}return d},getPointer:function(c,d,f){f||(f=this.upperCanvasEl);c=b(c,f);var e=f.getBoundingClientRect(),g=e.width||0,h=e.height||0;g&&h||("top"in e&&"bottom"in e&&(h=Math.abs(e.top-e.bottom)),"right"in e&&"left"in e&&(g=Math.abs(e.right-e.left)));this.calcOffset();c.x-=this._offset.left;c.y-=this._offset.top;d||(c=a.util.transformPoint(c,a.util.invertTransform(this.viewportTransform)));0===g||0===h?f=d=1:(d=f.width/g,f=f.height/h);return{x:c.x*
d,y:c.y*f}},_createUpperCanvas:function(){var c=this.lowerCanvasEl.className.replace(/\s*lower-canvas\s*/,"");this.upperCanvasEl=this._createCanvasElement();a.util.addClass(this.upperCanvasEl,"upper-canvas "+c);this.wrapperEl.appendChild(this.upperCanvasEl);this._copyCanvasStyle(this.lowerCanvasEl,this.upperCanvasEl);this._applyCanvasStyle(this.upperCanvasEl);this.contextTop=this.upperCanvasEl.getContext("2d")},_createCacheCanvas:function(){this.cacheCanvasEl=this._createCanvasElement();this.cacheCanvasEl.setAttribute("width",
this.width);this.cacheCanvasEl.setAttribute("height",this.height);this.contextCache=this.cacheCanvasEl.getContext("2d")},_initWrapperElement:function(){this.wrapperEl=a.util.wrapElement(this.lowerCanvasEl,"div",{"class":this.containerClass});a.util.setStyle(this.wrapperEl,{width:this.getWidth()+"px",height:this.getHeight()+"px",position:"relative"});a.util.makeElementUnselectable(this.wrapperEl)},_applyCanvasStyle:function(c){var d=this.getWidth()||c.width,e=this.getHeight()||c.height;a.util.setStyle(c,
{position:"absolute",width:d+"px",height:e+"px",left:0,top:0});c.width=d;c.height=e;a.util.makeElementUnselectable(c)},_copyCanvasStyle:function(a,d){d.style.cssText=a.style.cssText},getSelectionContext:function(){return this.contextTop},getSelectionElement:function(){return this.upperCanvasEl},_setActiveObject:function(a){this._activeObject&&this._activeObject.set("active",!1);this._activeObject=a;a.set("active",!0)},setActiveObject:function(a,d){this._setActiveObject(a);this.renderAll();this.fire("object:selected",
...
{target:a,e:d}),a.fire("selected",{e:d}));return this},getActiveGroup:function(){return this._activeGroup},_discardActiveGroup:function(){var a=this.getActiveGroup();a&&a.destroy();this.setActiveGroup(null)},discardActiveGroup:function(a){this._discardActiveGroup();this.fire("selection:cleared",{e:a});return this},deactivateAll:function(){for(var a=this.getObjects(),d=0,c=a.length;d<c;d++)a[d].set("active",!1);this._discardActiveGroup();this._discardActiveObject();return this},deactivateAllWithDispatch:function(a){var d=
this.getActiveGroup()||this.getActiveObject();d&&this.fire("before:selection:cleared",{target:d,e:a});this.deactivateAll();d&&this.fire("selection:cleared",{e:a});return this},drawControls:function(a){var d=this.getActiveGroup();d?this._drawGroupControls(a,d):this._drawObjectsControls(a)},_drawGroupControls:function(a,d){d._renderControls(a)},_drawObjectsControls:function(a){for(var d=0,c=this._objects.length;d<c;++d)this._objects[d]&&this._objects[d].active&&(this._objects[d]._renderControls(a),
this.lastRenderedObjectWithControlsAboveOverlay=this._objects[d])}});for(var f in a.StaticCanvas)"prototype"!==f&&(a.Canvas[f]=a.StaticCanvas[f]);a.isTouchSupported&&(a.Canvas.prototype._setCursorFromEvent=function(){});a.Element=a.Canvas})();(function(){var b={mt:0,tr:1,mr:2,br:3,mb:4,bl:5,ml:6,tl:7},h=a.util.addListener,k=a.util.removeListener;a.util.object.extend(a.Canvas.prototype,{cursorMap:"n-resize ne-resize e-resize se-resize s-resize sw-resize w-resize nw-resize".split(" "),_initEventListeners:function(){this._bindEvents();
...
return new a.Group(b,{canvas:this})},_groupSelectedObjects:function(b){var h=this._collectObjects();1===h.length?this.setActiveObject(h[0],b):1<h.length&&(h=new a.Group(h.reverse(),{canvas:this}),h.addWithUpdate(),this.setActiveGroup(h,b),h.saveCoords(),this.fire("selection:created",{target:h}),this.renderAll())},_collectObjects:function(){var k=[];var g=this._groupSelector.ex;var c=this._groupSelector.ey,f=g+this._groupSelector.left,e=c+this._groupSelector.top,d=new a.Point(b(g,f),b(c,e)),p=new a.Point(h(g,
f),h(c,e));c=g===f&&c===e;for(f=this._objects.length;f--&&!((g=this._objects[f])&&g.selectable&&g.visible&&(g.intersectsWithRect(d,p)||g.isContainedWithinRect(d,p)||g.containsPoint(d)||g.containsPoint(p))&&(g.set("active",!0),k.push(g),c)););return k},_maybeGroupObjects:function(a){this.selection&&this._groupSelector&&this._groupSelectedObjects(a);if(a=this.getActiveGroup())a.setObjectsCoords().setCoords(),a.isMoving=!1,this.setCursor(this.defaultCursor);this._currentTransform=this._groupSelector=
...
b,h):(k||g).toDataURL("image/"+b);this.contextTop&&this.clearContext(this.contextTop);this.renderAll();return b},__getCroppedCanvas:function(b,h){if("left"in h||"top"in h||"width"in h||"height"in h){var k=a.util.createCanvasElement();var g=k.getContext("2d");k.width=h.width||this.width;k.height=h.height||this.height;g.drawImage(b,-h.left||0,-h.top||0)}return k},__toDataURLWithMultiplier:function(a,b,k,g){var c=this.getWidth(),f=this.getHeight(),e=c*g,d=f*g,h=this.getActiveObject(),u=this.getActiveGroup(),
w=this.contextTop||this.contextContainer;1<g&&this.setWidth(e).setHeight(d);w.scale(g,g);k.left&&(k.left*=g);k.top&&(k.top*=g);k.width?k.width*=g:1>g&&(k.width=e);k.height?k.height*=g:1>g&&(k.height=d);u?this._tempRemoveBordersControlsFromGroup(u):h&&this.deactivateAll&&this.deactivateAll();this.renderAll(!0);a=this.__toDataURL(a,b,k);this.width=c;this.height=f;w.scale(1/g,1/g);this.setWidth(c).setHeight(f);u?this._restoreBordersControlsOnGroup(u):h&&this.setActiveObject&&this.setActiveObject(h);
...
d*this.scaleX;a.shadowOffsetY=this.shadow.offsetY*c*this.scaleY}},_removeShadow:function(a){this.shadow&&(a.shadowColor="",a.shadowBlur=a.shadowOffsetX=a.shadowOffsetY=0)},_renderFill:function(a){this.fill&&(a.save(),this.fill.gradientTransform&&a.transform.apply(a,this.fill.gradientTransform),this.fill.toLive&&a.translate(-this.width/2+this.fill.offsetX||0,-this.height/2+this.fill.offsetY||0),"evenodd"===this.fillRule?a.fill("evenodd"):a.fill(),a.restore(),this.shadow&&!this.shadow.affectStroke&&
...
c.coords={x1:d.x1,y1:d.y1,x2:d.x2,y2:d.y2};if(d.r1||d.r2)c.coords.r1=d.r1,c.coords.r2=d.r2;for(var e in d.colorStops){var f=new b.Color(d.colorStops[e]);c.colorStops.push({offset:e,color:f.toRgb(),opacity:f.getAlpha()})}return this.set(a,b.Gradient.forObject(this,c))},setPatternFill:function(a){return this.set("fill",new b.Pattern(a))},setShadow:function(a){return this.set("shadow",a?new b.Shadow(a):null)},setColor:function(a){this.set("fill",a);return this},setAngle:function(a){var d=("center"!==
this.originX||"center"!==this.originY)&&this.centeredRotation;d&&this._setOriginToCenter();this.set("angle",a);d&&this._resetOrigin();return this},centerH:function(){this.canvas.centerObjectH(this);return this},centerV:function(){this.canvas.centerObjectV(this);return this},center:function(){this.canvas.centerObject(this);return this},remove:function(){this.canvas.remove(this);return this},getLocalPointer:function(a,d){d=d||this.canvas.getPointer(a);a=this.translateToOriginPoint(this.getCenterPoint(),
"left","top");return{x:d.x-a.x,y:d.y-a.y}},_setupCompositeOperation:function(a){this.globalCompositeOperation&&(this._prevGlobalCompositeOperation=a.globalCompositeOperation,a.globalCompositeOperation=this.globalCompositeOperation)},_restoreCompositeOperation:function(a){this.globalCompositeOperation&&this._prevGlobalCompositeOperation&&(a.globalCompositeOperation=this._prevGlobalCompositeOperation)}}),b.util.createAccessors(b.Object),b.Object.prototype.rotate=b.Object.prototype.setAngle,a(b.Object.prototype,
b.Observable),b.Object.NUM_FRACTION_DIGITS=2,b.Object.__uid=0)})("undefined"!==typeof b?b:this);(function(){var b=a.util.degreesToRadians;a.util.object.extend(a.Object.prototype,{translateToCenterPoint:function(h,k,g){var c=h.x,f=h.y,e=this.stroke?this.strokeWidth:0;"left"===k?c=h.x+(this.getWidth()+e*this.scaleX)/2:"right"===k&&(c=h.x-(this.getWidth()+e*this.scaleX)/2);"top"===g?f=h.y+(this.getHeight()+e*this.scaleY)/2:"bottom"===g&&(f=h.y-(this.getHeight()+e*this.scaleY)/2);return a.util.rotatePoint(new a.Point(c,
f),h,b(this.angle))},translateToOriginPoint:function(h,k,g){var c=h.x,f=h.y,e=this.stroke?this.strokeWidth:0;"left"===k?c=h.x-(this.getWidth()+e*this.scaleX)/2:"right"===k&&(c=h.x+(this.getWidth()+e*this.scaleX)/2);"top"===g?f=h.y-(this.getHeight()+e*this.scaleY)/2:"bottom"===g&&(f=h.y+(this.getHeight()+e*this.scaleY)/2);return a.util.rotatePoint(new a.Point(c,f),h,b(this.angle))},getCenterPoint:function(){var b=new a.Point(this.left,this.top);return this.translateToCenterPoint(b,this.originX,this.originY)},
getPointByOrigin:function(a,b){var h=this.getCenterPoint();return this.translateToOriginPoint(h,a,b)},toLocalPoint:function(h,k,g){var c=this.getCenterPoint(),f=this.stroke?this.strokeWidth:0;k&&g?(k="left"===k?c.x-(this.getWidth()+f*this.scaleX)/2:"right"===k?c.x+(this.getWidth()+f*this.scaleX)/2:c.x,g="top"===g?c.y-(this.getHeight()+f*this.scaleY)/2:"bottom"===g?c.y+(this.getHeight()+f*this.scaleY)/2:c.y):(k=this.left,g=this.top);return a.util.rotatePoint(new a.Point(h.x,h.y),c,-b(this.angle)).subtractEquals(new a.Point(k,
g))},setPositionByOrigin:function(a,b,g){a=this.translateToCenterPoint(a,b,g);a=this.translateToOriginPoint(a,this.originX,this.originY);this.set("left",a.x);this.set("top",a.y)},adjustPosition:function(a){var h=b(this.angle),g=this.getWidth()/2,c=Math.cos(h)*g;g*=Math.sin(h);var f=this.getWidth(),e=Math.cos(h)*f;h=Math.sin(h)*f;"center"===this.originX&&"left"===a||"right"===this.originX&&"center"===a?(this.left-=c,this.top-=g):"left"===this.originX&&"center"===a||"center"===this.originX&&"right"===
a?(this.left+=c,this.top+=g):"left"===this.originX&&"right"===a?(this.left+=e,this.top+=h):"right"===this.originX&&"left"===a&&(this.left-=e,this.top-=h);this.setCoords();this.originX=a},_setOriginToCenter:function(){this._originalOriginX=this.originX;this._originalOriginY=this.originY;var a=this.getCenterPoint();this.originY=this.originX="center";this.left=a.x;this.top=a.y},_resetOrigin:function(){var a=this.translateToOriginPoint(this.getCenterPoint(),this._originalOriginX,this._originalOriginY);
this.originX=this._originalOriginX;this.originY=this._originalOriginY;this.left=a.x;this.top=a.y;this._originalOriginY=this._originalOriginX=null},_getLeftTopCoords:function(){return this.translateToOriginPoint(this.getCenterPoint(),"left","center")}})})();(function(){var b=a.util.degreesToRadians;a.util.object.extend(a.Object.prototype,{oCoords:null,intersectsWithRect:function(b,k){var h=this.oCoords,c=new a.Point(h.tl.x,h.tl.y),f=new a.Point(h.tr.x,h.tr.y),e=new a.Point(h.bl.x,h.bl.y);h=new a.Point(h.br.x,
h.br.y);return"Intersection"===a.Intersection.intersectPolygonRectangle([c,f,h,e],b,k).status},intersectsWithObject:function(b){function h(c){return{tl:new a.Point(c.tl.x,c.tl.y),tr:new a.Point(c.tr.x,c.tr.y),bl:new a.Point(c.bl.x,c.bl.y),br:new a.Point(c.br.x,c.br.y)}}var g=h(this.oCoords);b=h(b.oCoords);return"Intersection"===a.Intersection.intersectPolygonPolygon([g.tl,g.tr,g.br,g.bl],[b.tl,b.tr,b.br,b.bl]).status},isContainedWithinObject:function(b){var h=b.getBoundingRect();b=new a.Point(h.left,
...
0>a&&(this.flipX=!this.flipX,this.flipY=!this.flipY,a*=-1);this.scaleY=this.scaleX=a;this.setCoords();return this},scaleToWidth:function(a){var b=this.getBoundingRectWidth()/this.getWidth();return this.scale(a/this.width/b)},scaleToHeight:function(a){var b=this.getBoundingRectHeight()/this.getHeight();return this.scale(a/this.height/b)},setCoords:function(){var h=b(this.angle),k=this.getViewportTransform(),g=this._calculateCurrentDimensions(!1),c=g.x,f=g.y;0>c&&(c=Math.abs(c));g=Math.sqrt(Math.pow(c/
2,2)+Math.pow(f/2,2));var e=Math.atan(isFinite(f/c)?f/c:0),d=Math.cos(e+h)*g;e=Math.sin(e+h)*g;g=Math.sin(h);h=Math.cos(h);var p=this.getCenterPoint();f=new a.Point(c,f);p=new a.Point(p.x-d,p.y-e);e=new a.Point(p.x+f.x*h,p.y+f.x*g);c=a.util.transformPoint(new a.Point(p.x-f.y*g,p.y+f.y*h),k);d=a.util.transformPoint(new a.Point(e.x-f.y*g,e.y+f.y*h),k);f=a.util.transformPoint(p,k);k=a.util.transformPoint(e,k);e=new a.Point((f.x+c.x)/2,(f.y+c.y)/2);p=new a.Point((k.x+f.x)/2,(k.y+f.y)/2);var u=new a.Point((d.x+
k.x)/2,(d.y+k.y)/2),w=new a.Point((d.x+c.x)/2,(d.y+c.y)/2);g=new a.Point(p.x+g*this.rotatingPointOffset,p.y-h*this.rotatingPointOffset);this.oCoords={tl:f,tr:k,br:d,bl:c,ml:e,mt:p,mr:u,mb:w,mtr:g};this._setCornerCoords&&this._setCornerCoords();return this}})})();a.util.object.extend(a.Object.prototype,{sendToBack:function(){this.group?a.StaticCanvas.prototype.sendToBack.call(this.group,this):this.canvas.sendToBack(this);return this},bringToFront:function(){this.group?a.StaticCanvas.prototype.bringToFront.call(this.group,
...
b.SHARED_ATTRIBUTES.concat(),b.Polygon.fromElement=function(a,d){if(!a)return null;d||(d={});var c=b.parsePointsAttribute(a.getAttribute("points"));a=b.parseAttributes(a,b.Polygon.ATTRIBUTE_NAMES);return new b.Polygon(c,k(a,d))},b.Polygon.fromObject=function(a){return new b.Polygon(a.points,a,!0)})})("undefined"!==typeof b?b:this);(function(a){var b=a.fabric||(a.fabric={}),k=b.util.array.min,g=b.util.array.max,c=b.util.object.extend,f=Object.prototype.toString,e=b.util.drawArc,d={m:2,l:2,h:1,v:1,
c:6,s:4,q:4,t:2,a:7},p={m:"l",M:"L"};b.Path?b.warn("fabric.Path is already defined"):(b.Path=b.util.createClass(b.Object,{type:"path",path:null,minX:0,minY:0,initialize:function(a,b){b=b||{};this.setOptions(b);if(!a)throw Error("`path` argument is required");var d="[object Array]"===f.call(a);if(this.path=d?a:a.match&&a.match(/[mzlhvcsqta][^mzlhvcsqta]*/gi))d||(this.path=this._parsePath()),this._setPositionDimensions(),b.sourcePath&&this.setSourcePath(b.sourcePath)},_setPositionDimensions:function(){var a=
this._parseDimensions();this.minX=a.left;this.minY=a.top;this.width=a.width;this.height=a.height;a.left+="center"===this.originX?this.width/2:"right"===this.originX?this.width:0;a.top+="center"===this.originY?this.height/2:"bottom"===this.originY?this.height:0;this.top=this.top||a.top;this.left=this.left||a.left;this.pathOffset=this.pathOffset||{x:this.minX+this.width/2,y:this.minY+this.height/2}},_render:function(a){var b=null,d=0,c=0,f=0,g=0,h=0,k=0,p=-this.pathOffset.x,u=-this.pathOffset.y;this.group&&
"path-group"===this.group.type&&(u=p=0);a.beginPath();for(var m=0,n=this.path.length;m<n;++m){var l=this.path[m];switch(l[0]){case "l":f+=l[1];g+=l[2];a.lineTo(f+p,g+u);break;case "L":f=l[1];g=l[2];a.lineTo(f+p,g+u);break;case "h":f+=l[1];a.lineTo(f+p,g+u);break;case "H":f=l[1];a.lineTo(f+p,g+u);break;case "v":g+=l[1];a.lineTo(f+p,g+u);break;case "V":g=l[1];a.lineTo(f+p,g+u);break;case "m":f+=l[1];g+=l[2];d=f;c=g;a.moveTo(f+p,g+u);break;case "M":f=l[1];g=l[2];d=f;c=g;a.moveTo(f+p,g+u);break;case "c":var q=
f+l[5];var r=g+l[6];h=f+l[3];k=g+l[4];a.bezierCurveTo(f+l[1]+p,g+l[2]+u,h+p,k+u,q+p,r+u);f=q;g=r;break;case "C":f=l[5];g=l[6];h=l[3];k=l[4];a.bezierCurveTo(l[1]+p,l[2]+u,h+p,k+u,f+p,g+u);break;case "s":q=f+l[3];r=g+l[4];null===b[0].match(/[CcSs]/)?(h=f,k=g):(h=2*f-h,k=2*g-k);a.bezierCurveTo(h+p,k+u,f+l[1]+p,g+l[2]+u,q+p,r+u);h=f+l[1];k=g+l[2];f=q;g=r;break;case "S":q=l[3];r=l[4];null===b[0].match(/[CcSs]/)?(h=f,k=g):(h=2*f-h,k=2*g-k);a.bezierCurveTo(h+p,k+u,l[1]+p,l[2]+u,q+p,r+u);f=q;g=r;h=l[1];k=
l[2];break;case "q":q=f+l[3];r=g+l[4];h=f+l[1];k=g+l[2];a.quadraticCurveTo(h+p,k+u,q+p,r+u);f=q;g=r;break;case "Q":q=l[3];r=l[4];a.quadraticCurveTo(l[1]+p,l[2]+u,q+p,r+u);f=q;g=r;h=l[1];k=l[2];break;case "t":q=f+l[1];r=g+l[2];null===b[0].match(/[QqTt]/)?(h=f,k=g):(h=2*f-h,k=2*g-k);a.quadraticCurveTo(h+p,k+u,q+p,r+u);f=q;g=r;break;case "T":q=l[1];r=l[2];null===b[0].match(/[QqTt]/)?(h=f,k=g):(h=2*f-h,k=2*g-k);a.quadraticCurveTo(h+p,k+u,q+p,r+u);f=q;g=r;break;case "a":e(a,f+p,g+u,[l[1],l[2],l[3],l[4],
l[5],l[6]+f+p,l[7]+g+u]);f+=l[6];g+=l[7];break;case "A":e(a,f+p,g+u,[l[1],l[2],l[3],l[4],l[5],l[6]+p,l[7]+u]);f=l[6];g=l[7];break;case "z":case "Z":f=d,g=c,a.closePath()}b=l}this._renderFill(a);this._renderStroke(a)},toString:function(){return"#<fabric.Path ("+this.complexity()+'): { "top": '+this.top+', "left": '+this.left+" }>"},toObject:function(a){a=c(this.callSuper("toObject",a),{path:this.path.map(function(a){return a.slice()}),pathOffset:this.pathOffset});this.sourcePath&&(a.sourcePath=this.sourcePath);
...
l=p[e]||e;if(c.length-1>g)for(var m=1,n=c.length;m<n;m+=g)a.push([e].concat(c.slice(m,m+g))),e=l;else a.push(c)}return a},_parseDimensions:function(){for(var a=[],d=[],c,e=null,f=0,h=0,p=0,l=0,m=0,n=0,q,r,t,v=0,x=this.path.length;v<x;++v){c=this.path[v];switch(c[0]){case "l":p+=c[1];l+=c[2];t=[];break;case "L":p=c[1];l=c[2];t=[];break;case "h":p+=c[1];t=[];break;case "H":p=c[1];t=[];break;case "v":l+=c[1];t=[];break;case "V":l=c[1];t=[];break;case "m":p+=c[1];l+=c[2];f=p;h=l;t=[];break;case "M":p=
c[1];l=c[2];f=p;h=l;t=[];break;case "c":q=p+c[5];r=l+c[6];m=p+c[3];n=l+c[4];t=b.util.getBoundsOfCurve(p,l,p+c[1],l+c[2],m,n,q,r);p=q;l=r;break;case "C":p=c[5];l=c[6];m=c[3];n=c[4];t=b.util.getBoundsOfCurve(p,l,c[1],c[2],m,n,p,l);break;case "s":q=p+c[3];r=l+c[4];null===e[0].match(/[CcSs]/)?(m=p,n=l):(m=2*p-m,n=2*l-n);t=b.util.getBoundsOfCurve(p,l,m,n,p+c[1],l+c[2],q,r);m=p+c[1];n=l+c[2];p=q;l=r;break;case "S":q=c[3];r=c[4];null===e[0].match(/[CcSs]/)?(m=p,n=l):(m=2*p-m,n=2*l-n);t=b.util.getBoundsOfCurve(p,
l,m,n,c[1],c[2],q,r);p=q;l=r;m=c[1];n=c[2];break;case "q":q=p+c[3];r=l+c[4];m=p+c[1];n=l+c[2];t=b.util.getBoundsOfCurve(p,l,m,n,m,n,q,r);p=q;l=r;break;case "Q":m=c[1];n=c[2];t=b.util.getBoundsOfCurve(p,l,m,n,m,n,c[3],c[4]);p=c[3];l=c[4];break;case "t":q=p+c[1];r=l+c[2];null===e[0].match(/[QqTt]/)?(m=p,n=l):(m=2*p-m,n=2*l-n);t=b.util.getBoundsOfCurve(p,l,m,n,m,n,q,r);p=q;l=r;break;case "T":q=c[1];r=c[2];null===e[0].match(/[QqTt]/)?(m=p,n=l):(m=2*p-m,n=2*l-n);t=b.util.getBoundsOfCurve(p,l,m,n,m,n,q,
r);p=q;l=r;break;case "a":t=b.util.getBoundsOfArc(p,l,c[1],c[2],c[3],c[4],c[5],c[6]+p,c[7]+l);p+=c[6];l+=c[7];break;case "A":t=b.util.getBoundsOfArc(p,l,c[1],c[2],c[3],c[4],c[5],c[6],c[7]);p=c[6];l=c[7];break;case "z":case "Z":p=f,l=h}e=c;t.forEach(function(b){a.push(b.x);d.push(b.y)});a.push(p);d.push(l)}c=k(a);e=k(d);f=g(a);h=g(d);return{left:c,top:e,width:f-c,height:h-e}}}),b.Path.fromObject=function(a,c){"string"===typeof a.path?b.loadSVGFromURL(a.path,function(d){d=d[0];var e=a.path;delete a.path;
b.util.object.extend(d,a);d.setSourcePath(e);c(d)}):c(new b.Path(a.path,a))},b.Path.ATTRIBUTE_NAMES=b.SHARED_ATTRIBUTES.concat(["d"]),b.Path.fromElement=function(a,d,e){a=b.parseAttributes(a,b.Path.ATTRIBUTE_NAMES);d&&d(new b.Path(a.d,c(a,e)))},b.Path.async=!0)})("undefined"!==typeof b?b:this);(function(a){var b=a.fabric||(a.fabric={}),k=b.util.object.extend,g=b.util.array.invoke,c=b.Object.prototype.toObject;b.PathGroup?b.warn("fabric.PathGroup is already defined"):(b.PathGroup=b.util.createClass(b.Path,
...
a.restore();this._removeShadow(a);a.restore()}},_set:function(a,b){if("fill"===a&&b&&this.isSameColor())for(var c=this.paths.length;c--;)this.paths[c]._set(a,b);return this.callSuper("_set",a,b)},toObject:function(a){a=k(c.call(this,a),{paths:g(this.getObjects(),"toObject",a)});this.sourcePath&&(a.sourcePath=this.sourcePath);return a},toDatalessObject:function(a){a=this.toObject(a);this.sourcePath&&(a.paths=this.sourcePath);return a},toSVG:function(a){var b=this.getObjects(),c=this.getPointByOrigin("left",
"top");c="translate("+c.x+" "+c.y+")";c=["<g ",'style="',this.getSvgStyles(),'" ','transform="',this.getSvgTransformMatrix(),c,this.getSvgTransform(),'" ',">\n"];for(var f=0,g=b.length;f<g;f++)c.push(b[f].toSVG(a));c.push("</g>\n");return a?a(c.join("")):c.join("")},toString:function(){return"#<fabric.PathGroup ("+this.complexity()+"): { top: "+this.top+", left: "+this.left+" }>"},isSameColor:function(){var a=(this.getObjects()[0].get("fill")||"").toLowerCase();return this.getObjects().every(function(b){return(b.get("fill")||
...
this.get("left")||this._originalTop!==this.get("top")},setObjectsCoords:function(){this.forEachObject(function(a){a.setCoords()});return this},_calcBounds:function(a){for(var b=[],c=[],d,e,f=["tr","br","bl","tl"],g=0,k=this._objects.length;g<k;++g){d=this._objects[g];d.setCoords();for(var h=0;h<f.length;h++)e=f[h],b.push(d.oCoords[e].x),c.push(d.oCoords[e].y)}this.set(this._getBounds(b,c,a))},_getBounds:function(a,e,f){var d=b.util.invertTransform(this.getViewportTransform()),k=b.util.transformPoint(new b.Point(g(a),
...
b&&b();return this},setCrossOrigin:function(a){this.crossOrigin=a;this._element.crossOrigin=a;return this},getOriginalSize:function(){var a=this.getElement();return{width:a.width,height:a.height}},_stroke:function(a){a.save();this._setStrokeStyles(a);a.beginPath();a.strokeRect(-this.width/2,-this.height/2,this.width,this.height);a.closePath();a.restore()},_renderDashedStroke:function(b){var g=-this.width/2,c=-this.height/2,f=this.width,e=this.height;b.save();this._setStrokeStyles(b);b.beginPath();
a.util.drawDashedLine(b,g,c,g+f,c,this.strokeDashArray);a.util.drawDashedLine(b,g+f,c,g+f,c+e,this.strokeDashArray);a.util.drawDashedLine(b,g+f,c+e,g,c+e,this.strokeDashArray);a.util.drawDashedLine(b,g,c+e,g,c,this.strokeDashArray);b.closePath();b.restore()},toObject:function(a){return h(this.callSuper("toObject",a),{src:this._originalElement.src||this._originalElement._src,filters:this.filters.map(function(a){return a&&a.toObject()}),crossOrigin:this.crossOrigin,alignX:this.alignX,alignY:this.alignY,
...
this.getSrc()+'" }>'},clone:function(a,b){this.constructor.fromObject(this.toObject(b),a)},applyFilters:function(b,g,c,f){g=g||this.filters;if(c=c||this._originalElement){var e=c,d=a.util.createCanvasElement(),h=a.util.createImage(),k=this;d.width=e.width;d.height=e.height;d.getContext("2d").drawImage(e,0,0,e.width,e.height);if(0===g.length)return this._element=c,b&&b(),d;g.forEach(function(a){a&&a.applyTo(d,a.scaleX||k.scaleX,a.scaleY||k.scaleY);!f&&a&&"Resize"===a.type&&(k.width*=a.scaleX,k.height*=
a.scaleY)});h.width=d.width;h.height=d.height;a.isLikelyNode?(h.src=d.toBuffer(void 0,a.Image.pngCompression),k._element=h,!f&&(k._filteredEl=h),b&&b()):(h.onload=function(){k._element=h;!f&&(k._filteredEl=h);b&&b();h.onload=d=e=null},h.src=d.toDataURL("image/png"));return d}},_render:function(a,b){var c=this._findMargins();var f=b?this.left:-this.width/2;b=b?this.top:-this.height/2;"slice"===this.meetOrSlice&&(a.beginPath(),a.rect(f,b,this.width,this.height),a.clip());if(!1===this.isMoving&&this.resizeFilters.length&&
...
this.getElement().height||0:0},complexity:function(){return 1}}),a.Image.CSS_CANVAS="canvas-img",a.Image.prototype.getSvgSrc=a.Image.prototype.getSrc,a.Image.fromObject=function(b,g){a.util.loadImage(b.src,function(c){a.Image.prototype._initFilters.call(b,b,function(f){b.filters=f||[];f=new a.Image(c,b);g&&g(f)})},null,b.crossOrigin)},a.Image.fromURL=function(b,g,c){a.util.loadImage(b,function(b){g&&g(new a.Image(b,c))},null,c&&c.crossOrigin)},a.Image.ATTRIBUTE_NAMES=a.SHARED_ATTRIBUTES.concat("x y width height preserveAspectRatio xlink:href".split(" ")),
a.Image.fromElement=function(b,g,c){b=a.parseAttributes(b,a.Image.ATTRIBUTE_NAMES);var f="xMidYMid",e="meet",d;b.preserveAspectRatio&&(d=b.preserveAspectRatio.split(" "));d&&d.length&&(e=d.pop(),"meet"!==e&&"slice"!==e?(f=e,e="meet"):d.length&&(f=d.pop()));d="none"!==f?f.slice(1,4):"none";f="none"!==f?f.slice(5,8):"none";b.alignX=d;b.alignY=f;b.meetOrSlice=e;a.Image.fromURL(b["xlink:href"],g,h(c?a.util.object.clone(c):{},b))},a.Image.async=!0,a.Image.pngCompression=1)})("undefined"!==typeof b?b:this);
...
(a=-c.getWidth()/2);c.set({left:c.getLeft()+a,top:c.getTop()-c.getHeight()/2+c.fontSize*(.18+c._fontSizeFraction)});return c},b.Text.fromObject=function(a){return new b.Text(a.text,g(a))},b.util.createAccessors(b.Text))})("undefined"!==typeof b?b:this);delete window.fabric;return b}().fabric;b.fabric=a}}});(function(){var b=Y(n.com.fabricjs).fabric,a=B([13,27,32]),l=a[0],q=a[1],r=a[2];window.onkeydown=function(a){return a.keyCode!=r};var h=A("Attribute",[T],{get __init__(){return t(this,function(a,
b){a.game=b;a.game.attributes.append(a);a.install();a.reset()})},get reset(){return t(this,function(a){a.commit()})},get predict(){return t(this,function(a){})},get interact(){return t(this,function(a){})},get commit(){return t(this,function(a){})}}),k=A("Sprite",[h],{get __init__(){return t(this,function(a,b,c,e){a.width=c;a.height=e;h.__init__(a,b)})},get install(){return t(this,function(a){a.image=new b.Rect(D({width:a.game.scaleX(a.width),height:a.game.scaleY(a.height),originX:"center",originY:"center",
fill:"white"}))})},get reset(){return t(this,function(a,b,c,e,f){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=0;if("undefined"==typeof c||null!=c&&c.hasOwnProperty("__kwargtrans__"))c=0;if("undefined"==typeof e||null!=e&&e.hasOwnProperty("__kwargtrans__"))e=0;if("undefined"==typeof f||null!=f&&f.hasOwnProperty("__kwargtrans__"))f=0;if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){d=arguments[d--];for(var g in d)switch(g){case "self":a=
d[g];break;case "vX":b=d[g];break;case "vY":c=d[g];break;case "x":e=d[g];break;case "y":f=d[g]}}}a.vX=b;a.vY=c;a.x=e;a.y=f;h.reset(a)})},get predict(){return t(this,function(a){a.x+=a.vX*a.game.deltaT;a.y+=a.vY*a.game.deltaT})},get commit(){return t(this,function(a){a.image.left=a.game.orthoX(a.x);a.image.top=a.game.orthoY(a.y)})},get draw(){return t(this,function(a){a.game.canvas.add(a.image)})}}),g=A("Paddle",[k],{margin:30,width:10,height:100,speed:400,get __init__(){return t(this,function(a,b,
c){a.index=c;k.__init__(a,b,a.width,a.height)})},get reset(){return t(this,function(a){k.reset(a,I({x:a.index?Math.floor(500)-a.margin:Math.floor(-500)+a.margin,y:0}))})},get predict(){return t(this,function(a){a.vY=0;a.index?a.game.keyCode==U("K")?a.vY=a.speed:a.game.keyCode==U("M")&&(a.vY=-a.speed):a.game.keyCode==U("A")?a.vY=a.speed:a.game.keyCode==U("Z")&&(a.vY=-a.speed);k.predict(a)})},get interact(){return t(this,function(a){a.y=Math.max(Math.floor(a.height/2)-Math.floor(325),Math.min(a.y,Math.floor(325)-
Math.floor(a.height/2)));a.y-Math.floor(a.height/2)<a.game.ball.y&&a.game.ball.y<a.y+Math.floor(a.height/2)&&(0==a.index&&a.game.ball.x<a.x||1==a.index&&a.game.ball.x>a.x)&&(a.game.ball.x=a.x,a.game.ball.vX=-a.game.ball.vX,a.game.ball.speedUp(a))})}}),c=A("Ball",[k],{side:8,speed:300,get __init__(){return t(this,function(a,b){k.__init__(a,b,a.side,a.side)})},get reset(){return t(this,function(a){var b=a.game.serviceIndex*Math.PI+(.5<Math.random()?1:-1)*Math.random()*Math.atan(.65);k.reset(a,I({vX:a.speed*
Math.cos(b),vY:a.speed*Math.sin(b)}))})},get predict(){return t(this,function(a){k.predict(a);a.x<Math.floor(-500)?a.game.scored(1):a.x>Math.floor(500)&&a.game.scored(0);a.y>Math.floor(325)?(a.y=Math.floor(325),a.vY=-a.vY):a.y<Math.floor(-325)&&(a.y=Math.floor(-325),a.vY=-a.vY)})},get speedUp(){return t(this,function(a,b){b=1+.15*Math.pow(1-Math.abs(a.y-b.y)/Math.floor(b.height/2),2);Math.abs(a.vX)<3*a.speed&&(a.vX*=b,a.vY*=b)})}}),f=A("Scoreboard",[h],{nameShift:75,hintShift:25,get install(){return t(this,
function(a){for(var c=[],d=$jscomp.makeIterator(B([B(["AZ keys:",-.4375]),B(["KM keys:",.0625])])),e=d.next();!e.done;e=d.next()){var f=$jscomp.makeIterator(e.value);e=f.next().value;f=f.next().value;c.append(new b.Text("Player {}".format(e),D({fill:"white",fontFamily:"arial",fontSize:"{}".format(a.game.canvas.width/30),left:a.game.orthoX(1E3*f),top:a.game.orthoY(Math.floor(325)+a.nameShift)})))}a.playerLabels=c;a.hintLabel=new b.Text("[spacebar] starts game, [enter] resets score",D({fill:"white",
fontFamily:"arial",fontSize:"{}".format(a.game.canvas.width/70),left:a.game.orthoX(-437.5),top:a.game.orthoY(Math.floor(325)+a.hintShift)}));a.image=new b.Line(G([a.game.orthoX(Math.floor(-500)),a.game.orthoY(Math.floor(325)),a.game.orthoX(Math.floor(500)),a.game.orthoY(Math.floor(325))]),D({stroke:"white"}))})},get increment(){return t(this,function(a,b){a.scores[b]++})},get reset(){return t(this,function(a){a.scores=G([0,0]);h.reset(a)})},get commit(){return t(this,function(a){for(var c=[],d=$jscomp.makeIterator(ca(a.scores,
B([-.125,.375]))),e=d.next();!e.done;e=d.next()){var f=$jscomp.makeIterator(e.value);e=f.next().value;f=f.next().value;c.append(new b.Text("{}".format(e),D({fill:"white",fontFamily:"arial",fontSize:"{}".format(a.game.canvas.width/30),left:a.game.orthoX(1E3*f),top:a.game.orthoY(Math.floor(325)+a.nameShift)})))}a.scoreLabels=c})},get draw(){return t(this,function(a){for(var b=$jscomp.makeIterator(ca(a.playerLabels,a.scoreLabels)),c=b.next();!c.done;c=b.next()){var d=$jscomp.makeIterator(c.value);c=
d.next().value;d=d.next().value;a.game.canvas.add(c);a.game.canvas.add(d);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)})}});a=A("Game",[T],{get __init__(){return t(this,function(a){a.serviceIndex=.5<Math.random()?1:0;a.pause=!0;a.keyCode=null;a.textFrame=document.getElementById("text_frame");a.canvasFrame=document.getElementById("canvas_frame");a.buttonsFrame=document.getElementById("buttons_frame");a.canvas=new b.Canvas("canvas",D({backgroundColor:"black",originX:"center",originY:"center"}));
a.canvas.onWindowDraw=a.draw;a.canvas.lineWidth=2;a.canvas.clear();a.attributes=G([]);a.paddles=function(){for(var b=[],c=0;2>c;c++)b.append(g(a,c));return b}();a.ball=c(a);a.scoreboard=f(a);window.setInterval(a.py_update,10);window.setInterval(a.draw,20);window.addEventListener("keydown",a.keydown);window.addEventListener("keyup",a.keyup);a.buttons=G([]);for(var d=$jscomp.makeIterator(B("A Z K M space enter".split(" "))),e=d.next();!e.done;e=d.next()){e=e.value;var h=document.getElementById(e);h.addEventListener("mousedown",
function(b){return function(){return a.mouseOrTouch(b,!0)}}(e));h.addEventListener("touchstart",function(b){return function(){return a.mouseOrTouch(b,!0)}}(e));h.addEventListener("mouseup",function(b){return function(){return a.mouseOrTouch(b,!1)}}(e));h.addEventListener("touchend",function(b){return function(){return a.mouseOrTouch(b,!1)}}(e));h.style.cursor="pointer";h.style.userSelect="none";a.buttons.append(h)}a.time=+new Date;window.onresize=a.resize;a.resize()})},get install(){return t(this,
function(a){a=$jscomp.makeIterator(a.attributes);for(var b=a.next();!b.done;b=a.next())b.value.install()})},get mouseOrTouch(){return t(this,function(a,b,c){a.keyCode=c?"space"==b?r:"enter"==b?l:U(b):null})},get py_update(){return t(this,function(a){var b=a.time;a.time=+new Date;a.deltaT=(a.time-b)/1E3;if(a.pause)a.keyCode==r?a.pause=!1:a.keyCode==l&&a.scoreboard.reset();else{var c=$jscomp.makeIterator(a.attributes);for(b=c.next();!b.done;b=c.next())b=b.value,b.predict();c=$jscomp.makeIterator(a.attributes);
for(b=c.next();!b.done;b=c.next())b=b.value,b.interact();a=$jscomp.makeIterator(a.attributes);for(b=a.next();!b.done;b=a.next())b=b.value,b.commit()}})},get scored(){return t(this,function(a,b){a.scoreboard.increment(b);a.serviceIndex=1-b;b=$jscomp.makeIterator(a.paddles);for(var c=b.next();!c.done;c=b.next())c.value.reset();a.ball.reset();a.pause=!0})},get commit(){return t(this,function(a){a=$jscomp.makeIterator(a.attributes);for(var b=a.next();!b.done;b=a.next())b.value.commit()})},get draw(){return t(this,
function(a){a.canvas.clear();a=$jscomp.makeIterator(a.attributes);for(var b=a.next();!b.done;b=a.next())b.value.draw()})},get resize(){return t(this,function(a){a.pageWidth=window.innerWidth;a.pageHeight=window.innerHeight;a.textTop=0;a.pageHeight>1.2*a.pageWidth?(a.canvasWidth=a.pageWidth,a.canvasTop=a.textTop+300):(a.canvasWidth=.6*a.pageWidth,a.canvasTop=a.textTop+200);a.canvasLeft=.5*(a.pageWidth-a.canvasWidth);a.canvasHeight=.6*a.canvasWidth;a.buttonsTop=a.canvasTop+a.canvasHeight+50;a.buttonsWidth=
500;a.textFrame.style.top=a.textTop;a.textFrame.style.left=a.canvasLeft+.05*a.canvasWidth;a.textFrame.style.width=.9*a.canvasWidth;a.canvasFrame.style.top=a.canvasTop;a.canvasFrame.style.left=a.canvasLeft;a.canvas.setDimensions(D({width:a.canvasWidth,height:a.canvasHeight}));a.buttonsFrame.style.top=a.buttonsTop;a.buttonsFrame.style.left=.5*(a.pageWidth-a.buttonsWidth);a.buttonsFrame.style.width=a.canvasWidth;a.install();a.commit();a.draw()})},get scaleX(){return t(this,function(a,b){return a.canvas.width/
1E3*b})},get scaleY(){return t(this,function(a,b){return a.canvas.height/750*b})},get orthoX(){return t(this,function(a,b){return a.scaleX(b+Math.floor(500))})},get orthoY(){return t(this,function(a,b){return a.scaleY(750-Math.floor(325)-b)})},get keydown(){return t(this,function(a,b){a.keyCode=b.keyCode})},get keyup(){return t(this,function(a,b){a.keyCode=null})}});var e=a();n.Attribute=h;n.Ball=c;n.Game=a;n.Paddle=g;n.Scoreboard=f;n.Sprite=k;n.enter=l;n.esc=q;n.fabric=b;n.fieldHeight=650;n.game=
e;n.orthoHeight=750;n.orthoWidth=1E3;n.space=r})();return n}window.pong=pong();
