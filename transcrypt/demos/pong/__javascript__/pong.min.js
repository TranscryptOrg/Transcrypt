...
'use strict';var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.checkStringArgs=function(m,w,u){if(null==m)throw new TypeError("The 'this' value for String.prototype."+u+" must not be null or undefined");if(w instanceof RegExp)throw new TypeError("First argument to String.prototype."+u+" must not be a regular expression");return m+""};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(m,w,u){m!=Array.prototype&&m!=Object.prototype&&(m[w]=u.value)};$jscomp.getGlobal=function(m){return"undefined"!=typeof window&&window===m?m:"undefined"!=typeof global&&null!=global?global:m};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(m,w,u,y){if(w){u=$jscomp.global;m=m.split(".");for(y=0;y<m.length-1;y++){var M=m[y];M in u||(u[M]={});u=u[M]}m=m[m.length-1];y=u[m];w=w(y);w!=y&&null!=w&&$jscomp.defineProperty(u,m,{configurable:!0,writable:!0,value:w})}};
$jscomp.polyfill("String.prototype.startsWith",function(m){return m?m:function(m,u){var w=$jscomp.checkStringArgs(this,m,"startsWith");m+="";var M=w.length,N=m.length;u=Math.max(0,Math.min(u|0,w.length));for(var E=0;E<N&&u<M;)if(w[u++]!=m[E++])return!1;return E>=N}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;
$jscomp.Symbol=function(m){return $jscomp.SYMBOL_PREFIX+(m||"")+$jscomp.symbolCounter_++};$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var m=$jscomp.global.Symbol.iterator;m||(m=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator"));"function"!=typeof Array.prototype[m]&&$jscomp.defineProperty(Array.prototype,m,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}});$jscomp.initSymbolIterator=function(){}};
$jscomp.arrayIterator=function(m){var w=0;return $jscomp.iteratorPrototype(function(){return w<m.length?{done:!1,value:m[w++]}:{done:!0}})};$jscomp.iteratorPrototype=function(m){$jscomp.initSymbolIterator();m={next:m};m[$jscomp.global.Symbol.iterator]=function(){return this};return m};
$jscomp.polyfill("Array.from",function(m){return m?m:function(m,u,y){$jscomp.initSymbolIterator();u=null!=u?u:function(m){return m};var w=[],N=m[Symbol.iterator];if("function"==typeof N)for(m=N.call(m);!(N=m.next()).done;)w.push(u.call(y,N.value));else{N=m.length;for(var E=0;E<N;E++)w.push(u.call(y,m[E]))}return w}},"es6","es3");
$jscomp.iteratorFromArray=function(m,w){$jscomp.initSymbolIterator();m instanceof String&&(m+="");var u=0,y={next:function(){if(u<m.length){var M=u++;return{value:w(M,m[M]),done:!1}}y.next=function(){return{done:!0,value:void 0}};return y.next()}};y[Symbol.iterator]=function(){return y};return y};$jscomp.polyfill("Array.prototype.keys",function(m){return m?m:function(){return $jscomp.iteratorFromArray(this,function(m){return m})}},"es6","es3");
$jscomp.polyfill("String.prototype.repeat",function(m){return m?m:function(m){var u=$jscomp.checkStringArgs(this,null,"repeat");if(0>m||1342177279<m)throw new RangeError("Invalid count value");m|=0;for(var y="";m;)if(m&1&&(y+=u),m>>>=1)u+=u;return y}},"es6","es3");
$jscomp.polyfill("Array.prototype.fill",function(m){return m?m:function(m,u,y){var w=this.length||0;0>u&&(u=Math.max(0,w+u));if(null==y||y>w)y=w;y=Number(y);0>y&&(y=Math.max(0,w+y));for(u=Number(u||0);u<y;u++)this[u]=m;return this}},"es6","es3");
function pong(){function m(b){return void 0===b||null===b?!1:0<=["boolean","number"].indexOf(typeof b)?b:b.__bool__ instanceof Function?b.__bool__()?b:!1:b.__len__ instanceof Function?0!==b.__len__()?b:!1:b instanceof Function?b:0!==B(b)?b:!1}function w(b){this.iterable=b;this.index=0}function u(b){this.iterable=b;this.index=0}function y(b,a,l){void 0==a&&(a=b,b=0);void 0==l&&(l=1);if(0<l&&b>=a||0>l&&b<=a)return[];for(var p=[];0<l?b<a:b>a;b+=l)p.push(b);return p}function M(b){if(null==b||"object"==
typeof b)return b;var a={},l;for(l in obj)b.hasOwnProperty(l)&&(a[l]=b[l]);return a}function N(b){if(null==b||"object"==typeof b)return b;var a={},l;for(l in obj)b.hasOwnProperty(l)&&(a[l]=N(b[l]));return a}function E(b){return b?[].slice.apply(b):[]}function D(b){b=b?[].slice.apply(b):[];b.__class__=D;return b}function O(b){var a=[];if(b)for(var l=0;l<b.length;l++)a.add(b[l]);a.__class__=O;return a}function fa(b,a){if(void 0==b)return new Uint8Array(0);a=W(b);if(a==S)return new Uint8Array(b);if(a==
L){a=new Uint8Array(B(b));for(var l=0;l<B(b);l++)a[l]=b.charCodeAt(l);return a}if(a==E||a==D)return new Uint8Array(b);throw ia;}function L(b){if("number"===typeof b)return b.toString();try{return b.__str__()}catch(a){try{return X(b)}catch(l){return String(b)}}}function ja(b){return this.hasOwnProperty(b)}function ka(){var b=[],a;for(a in this)T(a)||b.push(a);return b}function la(){var b=[],a;for(a in this)T(a)||b.push([a,this[a]]);return b}function ma(b){delete this[b]}function na(){for(var b in this)delete this[b]}
function oa(b,a){var l=this[b];void 0==l&&(l=this["py_"+b]);return void 0==l?void 0==a?null:a:l}function pa(b,a){var l=this[b];if(void 0!=l)return l;a=void 0==a?null:a;return this[b]=a}function qa(b,a){var l=this[b];if(void 0!=l)return delete this[b],l;if(void 0===a)throw ha(b,Error());return a}function ra(){var b=Object.keys(this)[0];if(null==b)throw ha("popitem(): dictionary is empty",Error());var a=D([b,this[b]]);delete this[b];return a}function sa(b){for(var a in b)this[a]=b[a]}function ta(){var b=
[],a;for(a in this)T(a)||b.push(this[a]);return b}function ua(b){return this[b]}function va(b,a){this[b]=a}function H(b){var a={};if(!b||b instanceof Array){if(b)for(var l=0;l<b.length;l++){var p=b[l];if(!(p instanceof Array)||2!=p.length)throw aa("dict update sequence element #"+l+" has length "+p.length+"; 2 is required",Error());var r=p[0];p=p[1];!(b instanceof Array)&&b instanceof Object&&(ba(b,H)||(p=H(p)));a[r]=p}}else if(ba(b,H))for(p=b.py_keys(),l=0;l<p.length;l++)r=p[l],a[r]=b[r];else if(b instanceof
Object)a=b;else throw aa("Invalid type of object for dict creation",Error());F(a,"__class__",{value:H,enumerable:!1,writable:!0});F(a,"__contains__",{value:ja,enumerable:!1});F(a,"py_keys",{value:ka,enumerable:!1});F(a,"__iter__",{value:function(){new w(this.py_keys())},enumerable:!1});F(a,Symbol.iterator,{value:function(){new u(this.py_keys())},enumerable:!1});F(a,"py_items",{value:la,enumerable:!1});F(a,"py_del",{value:ma,enumerable:!1});F(a,"py_clear",{value:na,enumerable:!1});F(a,"py_get",{value:oa,
enumerable:!1});F(a,"py_setdefault",{value:pa,enumerable:!1});F(a,"py_pop",{value:qa,enumerable:!1});F(a,"py_popitem",{value:ra,enumerable:!1});F(a,"py_update",{value:sa,enumerable:!1});F(a,"py_values",{value:ta,enumerable:!1});F(a,"__getitem__",{value:ua,enumerable:!1});F(a,"__setitem__",{value:va,enumerable:!1});return a}var n={},U=function(b,a,l){if(""!=a){a=a.split(".");for(var p=a.length,r=0;r<a.length;r++){if(!b.hasOwnProperty(a[r])){p=r;break}b=b[a[r]]}for(r=p;r<a.length;r++)b[a[r]]={},b=b[a[r]]}for(var h in l)b[h]=
l[h]};n.__nest__=U;var ca=function(b){b.__inited__||(b.__all__.__init__(b.__all__),b.__inited__=!0);return b.__all__};n.__init__=ca;var t=function(b,a,l){return b&&(b.hasOwnProperty("__class__")||"string"==typeof b||b instanceof String)?(l&&Object.defineProperty(b,l,{value:function(){var p=[].slice.apply(arguments);return a.apply(null,[b].concat(p))},writable:!0,enumerable:!0,configurable:!0}),function(){var p=[].slice.apply(arguments);return a.apply(null,[b].concat(p))}):a};n.__get__=t;n.__getcm__=
function(b,a,l){return b.hasOwnProperty("__class__")?function(){var p=[].slice.apply(arguments);return a.apply(null,[b.__class__].concat(p))}:function(){var p=[].slice.apply(arguments);return a.apply(null,[b].concat(p))}};n.__getsm__=function(b,a,l){return a};var Q={__name__:"type",__bases__:[],__new__:function(b,a,l,p){for(var r,h=function(){var c=[].slice.apply(arguments);return h.__new__(c)},k=l.length-1;0<=k;k--){var g=l[k],c;for(c in g)r=Object.getOwnPropertyDescriptor(g,c),Object.defineProperty(h,
c,r)}h.__metaclass__=b;h.__name__=a.startsWith("py_")?a.slice(3):a;h.__bases__=l;for(c in p)r=Object.getOwnPropertyDescriptor(p,c),Object.defineProperty(h,c,r);return h}};Q.__metaclass__=Q;n.py_metatype=Q;var J={__init__:function(b){},__metaclass__:Q,__name__:"object",__bases__:[],__new__:function(b){var a=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[a].concat(b));return a}};n.object=J;var C=function(b,a,l,p){void 0===p&&(p=a[0].__metaclass__);return p.__new__(p,
b,a,l)};n.__class__=C;n.__pragma__=function(){};U(n,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(b){var a=C("__Envir__",[J],{__module__:"org.transcrypt.__base__",get __init__(){return t(this,function(b){b.interpreter_name="python";b.transpiler_name="transcrypt";b.transpiler_version="3.6.101";b.target_subdir="__javascript__"})}}),l=a();b.__Envir__=a;b.__envir__=l;b.__name__="org.transcrypt.__base__"}}});U(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(b){var a=
C("Exception",[J],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d){var f=H();if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){var e=arguments[c--],b;for(b in e)switch(b){case "self":d=e[b];break;default:f[b]=e[b]}delete f.__kwargtrans__}c=D([].slice.apply(arguments).slice(1,c+1))}else c=D();d.__args__=c;try{d.stack=f.error.stack}catch(Aa){d.stack="No stack trace available"}})},get __repr__(){return t(this,
function(d){return B(d.__args__)?"{}{}".format(d.__class__.__name__,X(D(d.__args__))):"{}()".format(d.__class__.__name__)})},get __str__(){return t(this,function(d){return 1<B(d.__args__)?L(D(d.__args__)):B(d.__args__)?L(d.__args__[0]):""})}}),l=C("IterableError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f){a.__init__(d,"Can't iterate over non-iterable",K({error:f}))})}}),p=C("StopIteration",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,
function(d,f){a.__init__(d,"Iterator exhausted",K({error:f}))})}}),r=C("ValueError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f,c){a.__init__(d,f,K({error:c}))})}}),h=C("KeyError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f,c){a.__init__(d,f,K({error:c}))})}}),k=C("AssertionError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f,c){f?a.__init__(d,f,K({error:c})):a.__init__(d,
K({error:c}))})}}),g=C("NotImplementedError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f,c){a.__init__(d,f,K({error:c}))})}}),c=C("IndexError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f,c){a.__init__(d,f,K({error:c}))})}}),e=C("AttributeError",[a],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d,f,c){a.__init__(d,f,K({error:c}))})}}),f=C("py_TypeError",[a],{__module__:"org.transcrypt.__standard__",
get __init__(){return t(this,function(d,f,c){a.__init__(d,f,K({error:c}))})}}),d=C("Warning",[a],{__module__:"org.transcrypt.__standard__"}),q=C("UserWarning",[d],{__module__:"org.transcrypt.__standard__"}),v=C("DeprecationWarning",[d],{__module__:"org.transcrypt.__standard__"}),x=C("RuntimeWarning",[d],{__module__:"org.transcrypt.__standard__"}),G=function(d,f,c){if("undefined"==typeof f||null!=f&&f.hasOwnProperty("__kwargtrans__"))f=null;if("undefined"==typeof c||null!=c&&c.hasOwnProperty("__kwargtrans__"))c=
!1;if(arguments.length){var e=arguments.length-1;if(arguments[e]&&arguments[e].hasOwnProperty("__kwargtrans__")){e=arguments[e--];for(var b in e)switch(b){case "iterable":d=e[b];break;case "key":f=e[b];break;case "reverse":c=e[b]}}}f?d.sort(function(d,c){if(arguments.length){var e=arguments.length-1;if(arguments[e]&&arguments[e].hasOwnProperty("__kwargtrans__")){e=arguments[e--];for(var b in e)switch(b){case "a":d=e[b];break;case "b":c=e[b]}}}return f(d)>f(c)?1:-1}):d.sort();c&&d.reverse()},z=C("__Terminal__",
[J],{__module__:"org.transcrypt.__standard__",get __init__(){return t(this,function(d){d.buffer="";try{d.element=document.getElementById("__terminal__")}catch(da){d.element=null}d.element&&(d.element.style.overflowX="auto",d.element.style.boxSizing="border-box",d.element.style.padding="5px",d.element.innerHTML="_")})},get print(){return t(this,function(d){var f=" ";var c="\n";if(arguments.length){var e=arguments.length-1;if(arguments[e]&&arguments[e].hasOwnProperty("__kwargtrans__")){var b=arguments[e--],
g;for(g in b)switch(g){case "self":d=b[g];break;case "sep":f=b[g];break;case "end":c=b[g]}}var h=D([].slice.apply(arguments).slice(1,e+1))}else h=D();d.buffer="{}{}{}".format(d.buffer,f.join(function(){for(var d=[],f=h,c=0;c<B(f);c++)d.append(L(f[c]));return d}()),c).__getslice__(-4096,null,1);d.element?(d.element.innerHTML=d.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),d.element.scrollTop=d.element.scrollHeight):console.log(f.join(function(){for(var d=[],f=h,c=0;c<B(f);c++)d.append(L(f[c]));
return d}()))})},get input(){return t(this,function(d,f){if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){c=arguments[c--];for(var e in c)switch(e){case "self":d=c[e];break;case "question":f=c[e]}}}d.print("{}".format(f),K({end:""}));e=window.prompt("\n".join(d.buffer.py_split("\n").__getslice__(-16,null,1)));d.print(e);return e})}}),I=z();b.AssertionError=k;b.AttributeError=e;b.DeprecationWarning=v;b.Exception=a;b.IndexError=c;b.IterableError=
l;b.KeyError=h;b.NotImplementedError=g;b.RuntimeWarning=x;b.StopIteration=p;b.py_TypeError=f;b.UserWarning=q;b.ValueError=r;b.Warning=d;b.__Terminal__=z;b.__name__="org.transcrypt.__standard__";b.__sort__=G;b.__terminal__=I;b.filter=function(d,f){null==d&&(d=R);for(var c=[],e=0;e<B(f);e++){var b=f[e];d(b)&&c.append(b)}return c};b.map=function(d,f){for(var c=[],e=0;e<B(f);e++)c.append(d(f[e]));return c};b.sorted=function(d,f,c){if("undefined"==typeof f||null!=f&&f.hasOwnProperty("__kwargtrans__"))f=
null;if("undefined"==typeof c||null!=c&&c.hasOwnProperty("__kwargtrans__"))c=!1;if(arguments.length){var e=arguments.length-1;if(arguments[e]&&arguments[e].hasOwnProperty("__kwargtrans__"))for(b in e=arguments[e--],e)switch(b){case "iterable":d=e[b];break;case "key":f=e[b];break;case "reverse":c=e[b]}}var b=W(d)==H?M(d.py_keys()):M(d);G(b,f,c);return b}}}});n.__call__=function(){var b=[].slice.apply(arguments);return"object"==typeof b[0]&&"__call__"in b[0]?b[0].__call__.apply(b[1],b.slice(2)):b[0].apply(b[1],
b.slice(2))};U(n,"",ca(n.org.transcrypt.__base__));Q=n.__envir__;U(n,"",ca(n.org.transcrypt.__standard__));var wa=n.Exception,xa=n.StopIteration,aa=n.ValueError,ha=n.KeyError,ya=n.AssertionError,ia=n.py_TypeError,za=n.__sort__;n.print=n.__terminal__.print;n.input=n.__terminal__.input;Q.executor_name=Q.transpiler_name;n.main={__file__:""};n.__except__=null;var K=function(b){b.__kwargtrans__=null;b.constructor=Object;return b};n.__kwargtrans__=K;n.__globals__=function(b){return ba(b,H)?b:H(b)};n.__super__=
function(b,a){for(var l=0;l<b.__bases__.length;l++){var p=b.__bases__[l];if(a in p)return p[a]}throw new wa("Superclass method not found");};n.property=function(b,a){a||(a=function(){});return{get:function(){return b(this)},set:function(b){a(this,b)},enumerable:!0}};var F=function(b,a,l){b.hasOwnProperty(a)||Object.defineProperty(b,a,l)};n.__setProperty__=F;n.assert=function(b,a){if(!b)throw ya(a,Error());};n.__merge__=function(b,a){var l={},p;for(p in b)l[p]=b[p];for(p in a)l[p]=a[p];return l};n.dir=
function(b){var a=[],l;for(l in b)a.push(l.startsWith("py_")?l.slice(3):l);a.sort();return a};n.setattr=function(b,a,l){b[a]=l};n.getattr=function(b,a){return a in b?b[a]:b["py_"+a]};n.hasattr=function(b,a){try{return a in b||"py_"+a in b}catch(l){return!1}};n.delattr=function(b,a){a in b?delete b[a]:delete b["py_"+a]};n.__in__=function(b,a){return void 0===a||null===a?!1:a.__contains__ instanceof Function?a.__contains__(b):a.indexOf?-1<a.indexOf(b):a.hasOwnProperty(b)};var T=function(b){return b.startswith("__")&&
b.endswith("__")||"constructor"==b||b.startswith("py_")};n.__specialattrib__=T;var B=function(b){if(void 0===b||null===b)return 0;if(b.__len__ instanceof Function)return b.__len__();if(void 0!==b.length)return b.length;var a=0,l;for(l in b)T(l)||a++;return a};n.len=B;n.__t__=m;var Y=function(b){if("inf"==b)return Infinity;if("-inf"==b)return-Infinity;if("nan"==b)return NaN;if(isNaN(parseFloat(b))){if(!1===b)return 0;if(!0===b)return 1;throw aa("could not convert string to float: '"+L(b)+"'",Error());
}return+b};Y.__name__="float";Y.__bases__=[J];n.float=Y;var S=function(b){return Y(b)|0};S.__name__="int";S.__bases__=[J];n.int=S;var R=function(b){return!!m(b)};R.__name__="bool";R.__bases__=[S];n.bool=R;var W=function(b){var a=typeof b;if("object"==a)try{return"__class__"in b?b.__class__:J}catch(l){return a}else return"boolean"==a?R:"string"==a?L:"number"==a?0==b%1?S:Y:null};n.py_typeof=W;var Z=function(b,a){if(a instanceof Array){for(var l=0;l<a.length;l++){var p=a[l];if(Z(b,p))return!0}return!1}try{p=
b;if(p==a)return!0;for(l=[].slice.call(p.__bases__);l.length;){p=l.shift();if(p==a)return!0;p.__bases__.length&&(l=[].slice.call(p.__bases__).concat(l))}return!1}catch(r){return b==a||a==J}};n.issubclass=Z;var ba=function(b,a){try{return"__class__"in b?Z(b.__class__,a):Z(W(b),a)}catch(l){return Z(W(b),a)}};n.isinstance=ba;n.callable=function(b){return b&&"object"==typeof b&&"__call__"in b?!0:"function"===typeof b};var X=function(b){try{return b.__repr__()}catch(h){try{return b.__str__()}catch(k){try{if(null==
b)return"None";if(b.constructor==Object){var a="{",l=!1,p;for(p in b)if(!T(p)){var r=p.isnumeric()?p:"'"+p+"'";l?a+=", ":l=!0;a+=r+": "+X(b[p])}return a+"}"}return"boolean"==typeof b?b.toString().capitalize():b.toString()}catch(g){return"<object of type: "+typeof b+">"}}}};n.repr=X;n.chr=function(b){return String.fromCharCode(b)};var V=function(b){return b.charCodeAt(0)};n.ord=V;n.max=function(b){return 1==arguments.length?Math.max.apply(null,b):Math.max.apply(null,arguments)};n.min=function(b){return 1==
arguments.length?Math.min.apply(null,b):Math.min.apply(null,arguments)};n.abs=Math.abs;n.round=function(b,a){if(a){var l=Math.pow(10,a);b*=l}var p=Math.round(b);.5==p-b&&p%2&&--p;a&&(p/=l);return p};w.prototype.__next__=function(){if(this.index<this.iterable.length)return this.iterable[this.index++];throw xa(Error());};u.prototype.next=function(){return this.index<this.iterable.py_keys.length?{value:this.index++,done:!1}:{value:void 0,done:!0}};n.py_reversed=function(b){b=b.slice();b.reverse();return b};
var ea=function(){for(var b=[].slice.call(arguments),a=0;a<b.length;a++)"string"==typeof b[a]?b[a]=b[a].split(""):Array.isArray(b[a])||(b[a]=Array.from(b[a]));return(0==b.length?[]:b.reduce(function(b,a){return b.length<a.length?b:a})).map(function(a,p){return b.map(function(b){return b[p]})})};n.zip=ea;n.range=y;n.any=function(b){for(var a=0;a<b.length;a++)if(R(b[a]))return!0;return!1};n.all=function(b){for(var a=0;a<b.length;a++)if(!R(b[a]))return!1;return!0};n.sum=function(b){for(var a=0,l=0;l<
b.length;l++)a+=b[l];return a};n.enumerate=function(b){return ea(y(B(b)),b)};n.copy=M;n.deepcopy=N;n.list=E;Array.prototype.__class__=E;E.__name__="list";E.__bases__=[J];Array.prototype.__iter__=function(){return new w(this)};Array.prototype.__getslice__=function(b,a,l){0>b&&(b=this.length+b);null==a?a=this.length:0>a?a=this.length+a:a>this.length&&(a=this.length);for(var p=E([]);b<a;b+=l)p.push(this[b]);return p};Array.prototype.__setslice__=function(b,a,l,p){0>b&&(b=this.length+b);null==a?a=this.length:
0>a&&(a=this.length+a);if(null==l)Array.prototype.splice.apply(this,[b,a-b].concat(p));else for(var r=0;b<a;b+=l)this[b]=p[r++]};Array.prototype.__repr__=function(){if(this.__class__==O&&!this.length)return"set()";for(var b=this.__class__&&this.__class__!=E?this.__class__==D?"(":"{":"[",a=0;a<this.length;a++)a&&(b+=", "),b+=X(this[a]);this.__class__==D&&1==this.length&&(b+=",");return b+=this.__class__&&this.__class__!=E?this.__class__==D?")":"}":"]"};Array.prototype.__str__=Array.prototype.__repr__;
Array.prototype.append=function(b){this.push(b)};Array.prototype.py_clear=function(){this.length=0};Array.prototype.extend=function(b){this.push.apply(this,b)};Array.prototype.insert=function(b,a){this.splice(b,0,a)};Array.prototype.remove=function(b){b=this.indexOf(b);if(-1==b)throw aa("list.remove(x): x not in list",Error());this.splice(b,1)};Array.prototype.index=function(b){return this.indexOf(b)};Array.prototype.py_pop=function(b){return void 0==b?this.pop():this.splice(b,1)[0]};Array.prototype.py_sort=
function(){za.apply(null,[this].concat([].slice.apply(arguments)))};Array.prototype.__add__=function(b){return E(this.concat(b))};Array.prototype.__mul__=function(b){for(var a=this,l=1;l<b;l++)a=a.concat(this);return a};Array.prototype.__rmul__=Array.prototype.__mul__;n.tuple=D;D.__name__="tuple";D.__bases__=[J];n.set=O;O.__name__="set";O.__bases__=[J];Array.prototype.__bindexOf__=function(b){b+="";for(var a=0,l=this.length-1;a<=l;){var p=(a+l)/2|0,r=this[p]+"";if(r<b)a=p+1;else if(r>b)l=p-1;else return p}return-1};
Array.prototype.add=function(b){-1==this.indexOf(b)&&this.push(b)};Array.prototype.discard=function(b){b=this.indexOf(b);-1!=b&&this.splice(b,1)};Array.prototype.isdisjoint=function(b){this.sort();for(var a=0;a<b.length;a++)if(-1!=this.__bindexOf__(b[a]))return!1;return!0};Array.prototype.issuperset=function(b){this.sort();for(var a=0;a<b.length;a++)if(-1==this.__bindexOf__(b[a]))return!1;return!0};Array.prototype.issubset=function(b){return O(b.slice()).issuperset(this)};Array.prototype.union=function(b){for(var a=
O(this.slice().sort()),l=0;l<b.length;l++)-1==a.__bindexOf__(b[l])&&a.push(b[l]);return a};Array.prototype.intersection=function(b){this.sort();for(var a=O(),l=0;l<b.length;l++)-1!=this.__bindexOf__(b[l])&&a.push(b[l]);return a};Array.prototype.difference=function(b){b=O(b.slice().sort());for(var a=O(),l=0;l<this.length;l++)-1==b.__bindexOf__(this[l])&&a.push(this[l]);return a};Array.prototype.symmetric_difference=function(b){return this.union(b).difference(this.intersection(b))};Array.prototype.py_update=
function(){var b=[].concat.apply(this.slice(),arguments).sort();this.py_clear();for(var a=0;a<b.length;a++)b[a]!=b[a-1]&&this.push(b[a])};Array.prototype.__eq__=function(b){if(this.length!=b.length)return!1;this.__class__==O&&(this.sort(),b.sort());for(var a=0;a<this.length;a++)if(this[a]!=b[a])return!1;return!0};Array.prototype.__ne__=function(b){return!this.__eq__(b)};Array.prototype.__le__=function(b){return this.issubset(b)};Array.prototype.__ge__=function(b){return this.issuperset(b)};Array.prototype.__lt__=
function(b){return this.issubset(b)&&!this.issuperset(b)};Array.prototype.__gt__=function(b){return this.issuperset(b)&&!this.issubset(b)};n.bytearray=fa;n.bytes=fa;Uint8Array.prototype.__add__=function(b){var a=new Uint8Array(this.length+b.length);a.set(this);a.set(b,this.length);return a};Uint8Array.prototype.__mul__=function(b){for(var a=new Uint8Array(b*this.length),l=0;l<b;l++)a.set(this,l*this.length);return a};Uint8Array.prototype.__rmul__=Uint8Array.prototype.__mul__;n.str=L;String.prototype.__class__=
L;L.__name__="str";L.__bases__=[J];String.prototype.__iter__=function(){new w(this)};String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').py_replace("\t","\\t").py_replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};String.prototype.endswith=function(b){if(b instanceof Array)for(var a=0;a<b.length;a++){if(this.slice(-b[a].length)==b[a])return!0}else return""==
b||this.slice(-b.length)==b;return!1};String.prototype.find=function(b,a){return this.indexOf(b,a)};String.prototype.__getslice__=function(b,a,l){0>b&&(b=this.length+b);null==a?a=this.length:0>a&&(a=this.length+a);var p="";if(1==l)p=this.substring(b,a);else for(;b<a;b+=l)p=p.concat(this.charAt(b));return p};F(String.prototype,"format",{get:function(){return t(this,function(b){var a=D([].slice.apply(arguments).slice(1)),l=0;return b.replace(/\{(\w*)\}/g,function(b,r){""==r&&(r=l++);if(r==+r)return void 0==
a[r]?b:L(a[r]);for(var h=0;h<a.length;h++)if("object"==typeof a[h]&&void 0!=a[h][r])return L(a[h][r]);return b})})},enumerable:!0});String.prototype.isalnum=function(){return/^[0-9a-zA-Z]{1,}$/.test(this)};String.prototype.isalpha=function(){return/^[a-zA-Z]{1,}$/.test(this)};String.prototype.isdecimal=function(){return/^[0-9]{1,}$/.test(this)};String.prototype.isdigit=function(){return this.isdecimal()};String.prototype.islower=function(){return/^[a-z]{1,}$/.test(this)};String.prototype.isupper=
function(){return/^[A-Z]{1,}$/.test(this)};String.prototype.isspace=function(){return/^[\s]{1,}$/.test(this)};String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(b){return b.join(this)};String.prototype.lower=function(){return this.toLowerCase()};String.prototype.py_replace=function(b,a,l){return this.split(b,l).join(a)};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(b,a){return this.lastIndexOf(b,
a)};String.prototype.rsplit=function(b,a){if(void 0==b||null==b){b=/\s+/;var l=this.strip()}else l=this;if(void 0==a||-1==a)return l.split(b);l=l.split(b);return a<l.length?(a=l.length-a,[l.slice(0,a).join(b)].concat(l.slice(a))):l};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.py_split=function(b,a){if(void 0==b||null==b){b=/\s+/;var l=this.strip()}else l=this;if(void 0==a||-1==a)return l.split(b);l=l.split(b);return a<l.length?l.slice(0,a).concat([l.slice(a).join(b)]):
l};String.prototype.startswith=function(b){if(b instanceof Array)for(var a=0;a<b.length;a++){if(0==this.indexOf(b[a]))return!0}else return 0==this.indexOf(b);return!1};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};String.prototype.__mul__=function(b){for(var a="",l=0;l<b;l++)a+=this;return a};String.prototype.__rmul__=String.prototype.__mul__;n.dict=H;H.__name__="dict";H.__bases__=[J];F(Function.prototype,"__setdoc__",{value:function(b){this.__doc__=
b;return this},enumerable:!1});n.__jsmod__=function(b,a){return"object"==typeof b&&"__mod__"in b?b.__mod__(a):"object"==typeof a&&"__rmod__"in a?a.__rmod__(b):b%a};n.mod=function(b,a){return"object"==typeof b&&"__mod__"in b?b.__mod__(a):"object"==typeof a&&"__rmod__"in a?a.__rmod__(b):(b%a+a)%a};n.pow=function(b,a){return"object"==typeof b&&"__pow__"in b?b.__pow__(a):"object"==typeof a&&"__rpow__"in a?a.__rpow__(b):Math.pow(b,a)};n.__neg__=function(b){return"object"==typeof b&&"__neg__"in b?b.__neg__():
-b};n.__matmul__=function(b,a){return b.__matmul__(a)};n.__mul__=function(b,a){return"object"==typeof b&&"__mul__"in b?b.__mul__(a):"object"==typeof a&&"__rmul__"in a?a.__rmul__(b):"string"==typeof b?b.__mul__(a):"string"==typeof a?a.__rmul__(b):b*a};n.__truediv__=function(b,a){return"object"==typeof b&&"__truediv__"in b?b.__truediv__(a):"object"==typeof a&&"__rtruediv__"in a?a.__rtruediv__(b):"object"==typeof b&&"__div__"in b?b.__div__(a):"object"==typeof a&&"__rdiv__"in a?a.__rdiv__(b):b/a};n.__floordiv__=
function(b,a){return"object"==typeof b&&"__floordiv__"in b?b.__floordiv__(a):"object"==typeof a&&"__rfloordiv__"in a?a.__rfloordiv__(b):"object"==typeof b&&"__div__"in b?b.__div__(a):"object"==typeof a&&"__rdiv__"in a?a.__rdiv__(b):Math.floor(b/a)};n.__add__=function(b,a){return"object"==typeof b&&"__add__"in b?b.__add__(a):"object"==typeof a&&"__radd__"in a?a.__radd__(b):b+a};n.__sub__=function(b,a){return"object"==typeof b&&"__sub__"in b?b.__sub__(a):"object"==typeof a&&"__rsub__"in a?a.__rsub__(b):
b-a};n.__lshift__=function(b,a){return"object"==typeof b&&"__lshift__"in b?b.__lshift__(a):"object"==typeof a&&"__rlshift__"in a?a.__rlshift__(b):b<<a};n.__rshift__=function(b,a){return"object"==typeof b&&"__rshift__"in b?b.__rshift__(a):"object"==typeof a&&"__rrshift__"in a?a.__rrshift__(b):b>>a};n.__or__=function(b,a){return"object"==typeof b&&"__or__"in b?b.__or__(a):"object"==typeof a&&"__ror__"in a?a.__ror__(b):b|a};n.__xor__=function(b,a){return"object"==typeof b&&"__xor__"in b?b.__xor__(a):
"object"==typeof a&&"__rxor__"in a?a.__rxor__(b):b^a};n.__and__=function(b,a){return"object"==typeof b&&"__and__"in b?b.__and__(a):"object"==typeof a&&"__rand__"in a?a.__rand__(b):b&a};n.__eq__=function(b,a){return"object"==typeof b&&"__eq__"in b?b.__eq__(a):b==a};n.__ne__=function(b,a){return"object"==typeof b&&"__ne__"in b?b.__ne__(a):b!=a};n.__lt__=function(b,a){return"object"==typeof b&&"__lt__"in b?b.__lt__(a):b<a};n.__le__=function(b,a){return"object"==typeof b&&"__le__"in b?b.__le__(a):b<=
a};n.__gt__=function(b,a){return"object"==typeof b&&"__gt__"in b?b.__gt__(a):b>a};n.__ge__=function(b,a){return"object"==typeof b&&"__ge__"in b?b.__ge__(a):b>=a};n.__imatmul__=function(b,a){return"__imatmul__"in b?b.__imatmul__(a):b.__matmul__(a)};n.ipow=function(b,a){return"object"==typeof b&&"__pow__"in b?b.__ipow__(a):"object"==typeof b&&"__ipow__"in b?b.__pow__(a):"object"==typeof a&&"__rpow__"in a?a.__rpow__(b):Math.pow(b,a)};n.ijsmod__=function(b,a){return"object"==typeof b&&"__imod__"in b?
b.__ismod__(a):"object"==typeof b&&"__mod__"in b?b.__mod__(a):"object"==typeof a&&"__rpow__"in a?a.__rmod__(b):b%a};n.imod=function(b,a){return"object"==typeof b&&"__imod__"in b?b.__imod__(a):"object"==typeof b&&"__mod__"in b?b.__mod__(a):"object"==typeof a&&"__rmod__"in a?a.__rmod__(b):(b%a+a)%a};n.__imul__=function(b,a){return"object"==typeof b&&"__imul__"in b?b.__imul__(a):"object"==typeof b&&"__mul__"in b?b.__mul__(a):"object"==typeof a&&"__rmul__"in a?a.__rmul__(b):"string"==typeof b?b.__mul__(a):
"string"==typeof a?a.__rmul__(b):b*a};n.__idiv__=function(b,a){return"object"==typeof b&&"__idiv__"in b?b.__idiv__(a):"object"==typeof b&&"__div__"in b?b.__div__(a):"object"==typeof a&&"__rdiv__"in a?a.__rdiv__(b):b/a};n.__iadd__=function(b,a){return"object"==typeof b&&"__iadd__"in b?b.__iadd__(a):"object"==typeof b&&"__add__"in b?b.__add__(a):"object"==typeof a&&"__radd__"in a?a.__radd__(b):b+a};n.__isub__=function(b,a){return"object"==typeof b&&"__isub__"in b?b.__isub__(a):"object"==typeof b&&"__sub__"in
b?b.__sub__(a):"object"==typeof a&&"__rsub__"in a?a.__rsub__(b):b-a};n.__ilshift__=function(b,a){return"object"==typeof b&&"__ilshift__"in b?b.__ilshift__(a):"object"==typeof b&&"__lshift__"in b?b.__lshift__(a):"object"==typeof a&&"__rlshift__"in a?a.__rlshift__(b):b<<a};n.__irshift__=function(b,a){return"object"==typeof b&&"__irshift__"in b?b.__irshift__(a):"object"==typeof b&&"__rshift__"in b?b.__rshift__(a):"object"==typeof a&&"__rrshift__"in a?a.__rrshift__(b):b>>a};n.__ior__=function(b,a){return"object"==
typeof b&&"__ior__"in b?b.__ior__(a):"object"==typeof b&&"__or__"in b?b.__or__(a):"object"==typeof a&&"__ror__"in a?a.__ror__(b):b|a};n.__ixor__=function(b,a){return"object"==typeof b&&"__ixor__"in b?b.__ixor__(a):"object"==typeof b&&"__xor__"in b?b.__xor__(a):"object"==typeof a&&"__rxor__"in a?a.__rxor__(b):b^a};n.__iand__=function(b,a){return"object"==typeof b&&"__iand__"in b?b.__iand__(a):"object"==typeof b&&"__and__"in b?b.__and__(a):"object"==typeof a&&"__rand__"in a?a.__rand__(b):b&a};n.__getitem__=
function(b,a){return"object"==typeof b&&"__getitem__"in b?b.__getitem__(a):("string"==typeof b||b instanceof Array)&&0>a?b[b.length+a]:b[a]};n.__setitem__=function(b,a,l){"object"==typeof b&&"__setitem__"in b?b.__setitem__(a,l):("string"==typeof b||b instanceof Array)&&0>a?b[b.length+a]=l:b[a]=l};n.__getslice__=function(b,a,l,p){return"object"==typeof b&&"__getitem__"in b?b.__getitem__([a,l,p]):b.__getslice__(a,l,p)};n.__setslice__=function(b,a,l,p,r){"object"==typeof b&&"__setitem__"in b?b.__setitem__([a,
l,p],r):b.__setslice__(a,l,p,r)};U(n,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(b){var a=function(){var b={},a=a||{version:"1.5.0"};"undefined"!==typeof b&&(b.fabric=a);"undefined"!==typeof document&&"undefined"!==typeof window?(a.document=document,a.window=window,window.fabric=a):(a.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),a.window=a.document.createWindow?a.document.createWindow():a.document.parentWindow);a.isTouchSupported="ontouchstart"in
a.document.documentElement;a.isLikelyNode="undefined"!==typeof Buffer&&"undefined"===typeof window;a.SHARED_ATTRIBUTES="display transform fill fill-opacity fill-rule opacity stroke stroke-dasharray stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width".split(" ");a.DPI=96;a.reNum="(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)";(function(){function b(c,e){this.__eventListeners[c]&&(e?a.util.removeFromArray(this.__eventListeners[c],e):this.__eventListeners[c].length=0)}function h(c,
e){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var f in c)this.on(f,c[f]);else this.__eventListeners[c]||(this.__eventListeners[c]=[]),this.__eventListeners[c].push(e);return this}function k(c,e){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var f in c)b.call(this,f,c[f]);else b.call(this,c,e);return this}}function g(c,e){if(this.__eventListeners&&(c=this.__eventListeners[c])){for(var f=
...
this.getObjects(),b,k=0,g=arguments.length;k<g;k++)b=a.indexOf(arguments[k]),-1!==b&&(a.splice(b,1),this._onObjectRemoved(arguments[k]));this.renderOnAddRemove&&this.renderAll();return this},forEachObject:function(a,b){for(var h=this.getObjects(),g=h.length;g--;)a.call(b,h[g],g,h);return this},getObjects:function(a){return"undefined"===typeof a?this._objects:this._objects.filter(function(b){return b.type===a})},item:function(a){return this.getObjects()[a]},isEmpty:function(){return 0===this.getObjects().length},
size:function(){return this.getObjects().length},contains:function(a){return-1<this.getObjects().indexOf(a)},complexity:function(){return this.getObjects().reduce(function(a,b){return a+=b.complexity?b.complexity():0},0)}};(function(b){var h=Math.sqrt,k=Math.atan2,g=Math.PI/180;a.util={removeFromArray:function(c,e){e=c.indexOf(e);-1!==e&&c.splice(e,1);return c},getRandomInt:function(c,e){return Math.floor(Math.random()*(e-c+1))+c},degreesToRadians:function(c){return c*g},radiansToDegrees:function(c){return c/
g},rotatePoint:function(c,e,f){var d=Math.sin(f);f=Math.cos(f);c.subtractEquals(e);return(new a.Point(c.x*f-c.y*d,c.x*d+c.y*f)).addEquals(e)},transformPoint:function(c,e,f){return f?new a.Point(e[0]*c.x+e[2]*c.y,e[1]*c.x+e[3]*c.y):new a.Point(e[0]*c.x+e[2]*c.y+e[4],e[1]*c.x+e[3]*c.y+e[5])},invertTransform:function(c){c.slice();var e=1/(c[0]*c[3]-c[1]*c[2]);e=[e*c[3],-e*c[1],-e*c[2],e*c[0],0,0];c=a.util.transformPoint({x:c[4],y:c[5]},e);e[4]=-c.x;e[5]=-c.y;return e},toFixed:function(c,e){return parseFloat(Number(c).toFixed(e))},
parseUnit:function(c,e){var f=/\D{0,2}$/.exec(c);c=parseFloat(c);e||(e=a.Text.DEFAULT_SVG_FONT_SIZE);switch(f[0]){case "mm":return c*a.DPI/25.4;case "cm":return c*a.DPI/2.54;case "in":return c*a.DPI;case "pt":return c*a.DPI/72;case "pc":return c*a.DPI/72*12;case "em":return c*e;default:return c}},falseFunction:function(){return!1},getKlass:function(c,e){c=a.util.string.camelize(c.charAt(0).toUpperCase()+c.slice(1));return a.util.resolveNamespace(e)[c]},resolveNamespace:function(c){if(!c)return a;
c=c.split(".");for(var e=c.length,f=b||a.window,d=0;d<e;++d)f=f[c[d]];return f},loadImage:function(c,e,f,d){if(c){var b=a.util.createImage();b.onload=function(){e&&e.call(f,b);b=b.onload=b.onerror=null};b.onerror=function(){a.log("Error loading "+b.src);e&&e.call(f,null,!0);b=b.onload=b.onerror=null};0!==c.indexOf("data")&&"undefined"!==typeof d&&(b.crossOrigin=d);b.src=c}else e&&e.call(f,c)},enlivenObjects:function(c,e,f,d){function b(){++h===k&&e&&e(g)}c=c||[];var g=[],h=0,k=c.length;k?c.forEach(function(c,
e){if(c&&c.type){var h=a.util.getKlass(c.type,f);h.async?h.fromObject(c,function(f,a){a||(g[e]=f,d&&d(c,g[e]));b()}):(g[e]=h.fromObject(c),d&&d(c,g[e]),b())}else b()}):e&&e(g)},groupSVGElements:function(c,e,f){c=new a.PathGroup(c,e);"undefined"!==typeof f&&c.setSourcePath(f);return c},populateWithProperties:function(c,e,f){if(f&&"[object Array]"===Object.prototype.toString.call(f))for(var d=0,a=f.length;d<a;d++)f[d]in c&&(e[f[d]]=c[f[d]])},drawDashedLine:function(c,e,f,d,a,b){d-=e;var g=a-f;a=h(d*
d+g*g);d=k(g,d);g=b.length;var q=0,v=!0;c.save();c.translate(e,f);c.moveTo(0,0);c.rotate(d);for(e=0;a>e;)e+=b[q++%g],e>a&&(e=a),c[v?"lineTo":"moveTo"](e,0),v=!v;c.restore()},createCanvasElement:function(c){c||(c=a.document.createElement("canvas"));c.getContext||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(c);return c},createImage:function(){return a.isLikelyNode?new (require("canvas").Image):a.document.createElement("img")},createAccessors:function(c){c=c.prototype;for(var e=
c.stateProperties.length;e--;){var f=c.stateProperties[e],d=f.charAt(0).toUpperCase()+f.slice(1),a="set"+d;d="get"+d;c[d]||(c[d]=new Function('return this.get("'+f+'")'));c[a]||(c[a]=new Function("value",'return this.set("'+f+'", value)'))}},clipContext:function(c,e){e.save();e.beginPath();c.clipTo(e);e.clip()},multiplyTransformMatrices:function(c,e){return[c[0]*e[0]+c[2]*e[1],c[1]*e[0]+c[3]*e[1],c[0]*e[2]+c[2]*e[3],c[1]*e[2]+c[3]*e[3],c[0]*e[4]+c[2]*e[5]+c[4],c[1]*e[4]+c[3]*e[5]+c[5]]},getFunctionBody:function(c){return(String(c).match(/function[^{]*\{([\s\S]*)\}/)||
{})[1]},isTransparent:function(c,e,f,d){0<d&&(e=e>d?e-d:0,f=f>d?f-d:0);var a=!0;c=c.getImageData(e,f,2*d||1,2*d||1);e=3;for(f=c.data.length;e<f&&(a=0>=c.data[e],!1!==a);e+=4);return a}}})("undefined"!==typeof b?b:this);(function(){function b(f,e,a,b,g,r,l){var q=d.call(arguments);if(c[q])return c[q];var v=Math.PI,x=l*v/180,G=Math.sin(x);x=Math.cos(x);var I=0,A=0;a=Math.abs(a);b=Math.abs(b);var z=-x*f*.5-G*e*.5,n=-x*e*.5+G*f*.5,p=a*a,m=b*b,t=n*n,u=z*z,P=p*m-p*t-m*u,w=0;0>P?(p=Math.sqrt(1-P/(p*m)),
a*=p,b*=p):w=(g===r?-1:1)*Math.sqrt(P/(p*t+m*u));t=w*a*n/b;u=-w*b*z/a;w=x*t-G*u+.5*f;p=G*t+x*u+.5*e;m=k(1,0,(z-t)/a,(n-u)/b);n=k((z-t)/a,(n-u)/b,(-z-t)/a,(-n-u)/b);0===r&&0<n?n-=2*v:1===r&&0>n&&(n+=2*v);v=Math.ceil(Math.abs(n/v*2));z=[];n/=v;t=8/3*Math.sin(n/4)*Math.sin(n/4)/Math.sin(n/2);u=m+n;for(P=0;P<v;P++)z[P]=h(m,u,x,G,a,b,w,p,t,I,A),I=z[P][4],A=z[P][5],m=u,u+=n;return c[q]=z}function h(f,c,a,b,g,h,k,r,l,n,p){var q=d.call(arguments);if(e[q])return e[q];var v=Math.cos(f),x=Math.sin(f),G=Math.cos(c),
I=Math.sin(c),A=a*g*G-b*h*I+k,z=b*g*G+a*h*I+r;e[q]=[n+l*(-a*g*x-b*h*v),p+l*(-b*g*x+a*h*v),A+l*(a*g*I+b*h*G),z+l*(b*g*I-a*h*G),A,z];return e[q]}function k(d,f,c,e){d=Math.atan2(f,d);c=Math.atan2(e,c);return c>=d?c-d:2*Math.PI-(d-c)}function g(c,e,a,b,g,h,k,r){var q=d.call(arguments);if(f[q])return f[q];var v=Math.sqrt,x=Math.min,G=Math.max,I=Math.abs,l=[],n=[[],[]];var A=6*c-12*a+6*g;var z=-3*c+9*a-9*g+3*k;var da=3*a-3*c;for(var p=0;2>p;++p)if(0<p&&(A=6*e-12*b+6*h,z=-3*e+9*b-9*h+3*r,da=3*b-3*e),1E-12>
I(z)){if(!(1E-12>I(A))){var m=-da/A;0<m&&1>m&&l.push(m)}}else if(m=A*A-4*da*z,!(0>m)){var t=v(m);m=(-A+t)/(2*z);0<m&&1>m&&l.push(m);m=(-A-t)/(2*z);0<m&&1>m&&l.push(m)}for(I=v=l.length;v--;)m=l[v],A=1-m,z=A*A*A*c+3*A*A*m*a+3*A*m*m*g+m*m*m*k,n[0][v]=z,z=A*A*A*e+3*A*A*m*b+3*A*m*m*h+m*m*m*r,n[1][v]=z;n[0][I]=c;n[1][I]=e;n[0][I+1]=k;n[1][I+1]=r;x=[{x:x.apply(null,n[0]),y:x.apply(null,n[1])},{x:G.apply(null,n[0]),y:G.apply(null,n[1])}];return f[q]=x}var c={},e={},f={},d=Array.prototype.join;a.util.drawArc=
function(d,f,c,e){var a=[[],[],[],[]];e=b(e[5]-f,e[6]-c,e[0],e[1],e[3],e[4],e[2]);for(var g=0,h=e.length;g<h;g++)a[g][0]=e[g][0]+f,a[g][1]=e[g][1]+c,a[g][2]=e[g][2]+f,a[g][3]=e[g][3]+c,a[g][4]=e[g][4]+f,a[g][5]=e[g][5]+c,d.bezierCurveTo.apply(d,a[g])};a.util.getBoundsOfArc=function(d,f,c,e,a,h,k,r,l){var q=0,v=0,x=[];c=b(r-d,l-f,c,e,h,k,a);e=[[],[]];a=0;for(h=c.length;a<h;a++)q=g(q,v,c[a][0],c[a][1],c[a][2],c[a][3],c[a][4],c[a][5]),e[0].x=q[0].x+d,e[0].y=q[0].y+f,e[1].x=q[1].x+d,e[1].y=q[1].y+f,x.push(e[0]),
x.push(e[1]),q=c[a][4],v=c[a][5];return x};a.util.getBoundsOfCurve=g})();(function(){function b(a,b,c){if(a&&0!==a.length){var e=a.length-1,f=b?a[e][b]:a[e];if(b)for(;e--;)c(a[e][b],f)&&(f=a[e][b]);else for(;e--;)c(a[e],f)&&(f=a[e]);return f}}var h=Array.prototype.slice;Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(void 0===this||null===this)throw new TypeError;var b=Object(this),c=b.length>>>0;if(0===c)return-1;var e=0;0<arguments.length&&(e=Number(arguments[1]),e!==e?e=0:0!==
e&&e!==Number.POSITIVE_INFINITY&&e!==Number.NEGATIVE_INFINITY&&(e=(0<e||-1)*Math.floor(Math.abs(e))));if(e>=c)return-1;for(e=0<=e?e:Math.max(c-Math.abs(e),0);e<c;e++)if(e in b&&b[e]===a)return e;return-1});Array.prototype.forEach||(Array.prototype.forEach=function(a,b){for(var c=0,e=this.length>>>0;c<e;c++)c in this&&a.call(b,this[c],c,this)});Array.prototype.map||(Array.prototype.map=function(a,b){for(var c=[],e=0,f=this.length>>>0;e<f;e++)e in this&&(c[e]=a.call(b,this[e],e,this));return c});Array.prototype.every||
(Array.prototype.every=function(a,b){for(var c=0,e=this.length>>>0;c<e;c++)if(c in this&&!a.call(b,this[c],c,this))return!1;return!0});Array.prototype.some||(Array.prototype.some=function(a,b){for(var c=0,e=this.length>>>0;c<e;c++)if(c in this&&a.call(b,this[c],c,this))return!0;return!1});Array.prototype.filter||(Array.prototype.filter=function(a,b){for(var c=[],e,f=0,d=this.length>>>0;f<d;f++)f in this&&(e=this[f],a.call(b,e,f,this)&&c.push(e));return c});Array.prototype.reduce||(Array.prototype.reduce=
function(a){var b=this.length>>>0,c=0;if(1<arguments.length)var e=arguments[1];else{do{if(c in this){e=this[c++];break}if(++c>=b)throw new TypeError;}while(1)}for(;c<b;c++)c in this&&(e=a.call(null,e,this[c],c,this));return e});a.util.array={invoke:function(a,b){for(var c=h.call(arguments,2),e=[],f=0,d=a.length;f<d;f++)e[f]=c.length?a[f][b].apply(a[f],c):a[f][b].call(a[f]);return e},min:function(a,g){return b(a,g,function(c,a){return c<a})},max:function(a,g){return b(a,g,function(c,a){return c>=a})}}})();
...
"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&apos;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}})();(function(){var a=Array.prototype.slice,b=Function.prototype.apply,k=function(){};Function.prototype.bind||(Function.prototype.bind=function(g){var c=this,e=a.call(arguments,1);var f=e.length?function(){return b.call(c,this instanceof k?this:g,e.concat(a.call(arguments)))}:function(){return b.call(c,this instanceof k?this:g,arguments)};k.prototype=this.prototype;f.prototype=new k;return f})})();
(function(){function b(){}function h(f){var d=this.constructor.superclass.prototype[f];return 1<arguments.length?d.apply(this,k.call(arguments,1)):d.call(this)}var k=Array.prototype.slice,g=function(){},c=function(){for(var f in{toString:1})if("toString"===f)return!1;return!0}(),e=function(f,d,a){for(var e in d)e in f.prototype&&"function"===typeof f.prototype[e]&&-1<(d[e]+"").indexOf("callSuper")?f.prototype[e]=function(f){return function(){var c=this.constructor.superclass;this.constructor.superclass=
a;var e=d[f].apply(this,arguments);this.constructor.superclass=c;if("initialize"!==f)return e}}(e):f.prototype[e]=d[e],c&&(d.toString!==Object.prototype.toString&&(f.prototype.toString=d.toString),d.valueOf!==Object.prototype.valueOf&&(f.prototype.valueOf=d.valueOf))};a.util.createClass=function(){function f(){this.initialize.apply(this,arguments)}var d=null,c=k.call(arguments,0);"function"===typeof c[0]&&(d=c.shift());f.superclass=d;f.subclasses=[];d&&(b.prototype=d.prototype,f.prototype=new b,d.subclasses.push(f));
for(var a=0,x=c.length;a<x;a++)e(f,c[a],d);f.prototype.initialize||(f.prototype.initialize=g);f.prototype.constructor=f;f.prototype.callSuper=h;return f}})();(function(){function b(d){var f=Array.prototype.slice.call(arguments,1),c,a=f.length;for(c=0;c<a;c++){var e=typeof d[f[c]];if(!/^(?:function|object|unknown)$/.test(e))return!1}return!0}function h(d,f){return function(e){f.call(c(d),e||a.window.event)}}function k(d,f){return function(c){if(x[d]&&x[d][f])for(var e=x[d][f],b=0,g=e.length;b<g;b++)e[b].call(this,
c||a.window.event)}}function g(d,f,c){var a="touchend"===d.type?"changedTouches":"touches";return d[a]&&d[a][0]?d[a][0][f]-(d[a][0][f]-d[a][0][c])||d[c]:d[c]}var c,e,f=function(){var d=0;return function(f){return f.__uniqueID||(f.__uniqueID="uniqueID__"+d++)}}();(function(){var d={};c=function(f){return d[f]};e=function(f,c){d[f]=c}})();var d=b(a.document.documentElement,"addEventListener","removeEventListener")&&b(a.window,"addEventListener","removeEventListener"),q=b(a.document.documentElement,
"attachEvent","detachEvent")&&b(a.window,"attachEvent","detachEvent"),v={},x={};d?(d=function(d,f,c){d.addEventListener(f,c,!1)},q=function(d,f,c){d.removeEventListener(f,c,!1)}):q?(d=function(d,c,a){var b=f(d);e(b,d);v[b]||(v[b]={});v[b][c]||(v[b][c]=[]);a={handler:a,wrappedHandler:h(b,a)};v[b][c].push(a);d.attachEvent("on"+c,a.wrappedHandler)},q=function(d,c,a){var e=f(d),b;if(v[e]&&v[e][c])for(var g=0,h=v[e][c].length;g<h;g++)(b=v[e][c][g])&&b.handler===a&&(d.detachEvent("on"+c,b.wrappedHandler),
v[e][c][g]=null)}):(d=function(d,c,a){var e=f(d);x[e]||(x[e]={});if(!x[e][c]){x[e][c]=[];var b=d["on"+c];b&&x[e][c].push(b);d["on"+c]=k(e,c)}x[e][c].push(a)},q=function(d,c,a){d=f(d);if(x[d]&&x[d][c]){c=x[d][c];d=0;for(var e=c.length;d<e;d++)c[d]===a&&c.splice(d,1)}});a.util.addListener=d;a.util.removeListener=q;var G=function(d){return"unknown"!==typeof d.clientX?d.clientX:0},l=function(d){return"unknown"!==typeof d.clientY?d.clientY:0};a.isTouchSupported&&(G=function(d){return g(d,"pageX","clientX")},
l=function(d){return g(d,"pageY","clientY")});a.util.getPointer=function(d,f){d||(d=a.window.event);f=a.util.getScrollLeftTop(d.target||("unknown"!==typeof d.srcElement?d.srcElement:null),f);return{x:G(d)+f.left,y:l(d)+f.top}};a.util.object.extend(a.util,a.Observable)})();(function(){var b=a.document.createElement("div"),h="string"===typeof b.style.filter,k=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,g=function(c){return c};"string"===typeof b.style.opacity?g=function(c,a){c.style.opacity=a;return c}:
h&&(g=function(c,a){var f=c.style;c.currentStyle&&!c.currentStyle.hasLayout&&(f.zoom=1);k.test(f.filter)?f.filter=f.filter.replace(k,.9999<=a?"":"alpha(opacity="+100*a+")"):f.filter+=" alpha(opacity="+100*a+")";return c});a.util.setStyle=function(c,a){var f=c.style;if(!f)return c;if("string"===typeof a)return c.style.cssText+=";"+a,-1<a.indexOf("opacity")?g(c,a.match(/opacity:\s*(\d?\.?\d*)/)[1]):c;for(var d in a)"opacity"===d?g(c,a[d]):f["float"===d||"cssFloat"===d?"undefined"===typeof f.styleFloat?
"cssFloat":"styleFloat":d]=a[d];return c}})();(function(){function b(c,f){c=a.document.createElement(c);for(var d in f)"class"===d?c.className=f[d]:"for"===d?c.htmlFor=f[d]:c.setAttribute(d,f[d]);return c}var h=Array.prototype.slice,k=function(c){return h.call(c,0)};try{var g=k(a.document.childNodes)instanceof Array}catch(e){}g||(k=function(c){for(var f=Array(c.length),d=c.length;d--;)f[d]=c[d];return f});var c=a.document.defaultView&&a.document.defaultView.getComputedStyle?function(c,f){return(c=
a.document.defaultView.getComputedStyle(c,null))?c[f]:void 0}:function(c,f){var d=c.style[f];!d&&c.currentStyle&&(d=c.currentStyle[f]);return d};(function(){var c=a.document.documentElement.style,f="userSelect"in c?"userSelect":"MozUserSelect"in c?"MozUserSelect":"WebkitUserSelect"in c?"WebkitUserSelect":"KhtmlUserSelect"in c?"KhtmlUserSelect":"";a.util.makeElementUnselectable=function(d){"undefined"!==typeof d.onselectstart&&(d.onselectstart=a.util.falseFunction);f?d.style[f]="none":"string"===typeof d.unselectable&&
(d.unselectable="on");return d};a.util.makeElementSelectable=function(d){"undefined"!==typeof d.onselectstart&&(d.onselectstart=null);f?d.style[f]="":"string"===typeof d.unselectable&&(d.unselectable="");return d}})();(function(){a.util.getScript=function(c,f){var d=a.document.getElementsByTagName("head")[0],b=a.document.createElement("script"),e=!0;b.onload=b.onreadystatechange=function(d){!e||"string"===typeof this.readyState&&"loaded"!==this.readyState&&"complete"!==this.readyState||(e=!1,f(d||
a.window.event),b=b.onload=b.onreadystatechange=null)};b.src=c;d.appendChild(b)}})();a.util.getById=function(c){return"string"===typeof c?a.document.getElementById(c):c};a.util.toArray=k;a.util.makeElement=b;a.util.addClass=function(c,f){c&&-1===(" "+c.className+" ").indexOf(" "+f+" ")&&(c.className+=(c.className?" ":"")+f)};a.util.wrapElement=function(c,f,d){"string"===typeof f&&(f=b(f,d));c.parentNode&&c.parentNode.replaceChild(f,c);f.appendChild(c);return f};a.util.getScrollLeftTop=function(c,
f){var d,b,e=0,g=0,h=a.document.documentElement,k=a.document.body||{scrollLeft:0,scrollTop:0};for(b=c;c&&c.parentNode&&!d;)c=c.parentNode,1===c.nodeType&&"fixed"===a.util.getElementStyle(c,"position")&&(d=c),1===c.nodeType&&b!==f&&"absolute"===a.util.getElementStyle(c,"position")?g=e=0:c===a.document?(e=k.scrollLeft||h.scrollLeft||0,g=k.scrollTop||h.scrollTop||0):(e+=c.scrollLeft||0,g+=c.scrollTop||0);return{left:e,top:g}};a.util.getElementOffset=function(b){var f=b&&b.ownerDocument;var d={left:0,
top:0},e={left:0,top:0},g={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!f)return{left:0,top:0};for(var h in g)e[g[h]]+=parseInt(c(b,h),10)||0;f=f.documentElement;"undefined"!==typeof b.getBoundingClientRect&&(d=b.getBoundingClientRect());b=a.util.getScrollLeftTop(b,null);return{left:d.left+b.left-(f.clientLeft||0)+e.left,top:d.top+b.top-(f.clientTop||0)+e.top}};a.util.getElementStyle=c})();(function(){function b(a,c){return a+(/\?/.test(a)?"&":"?")+c}function h(){}
var k=function(){for(var a=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},function(){return new XMLHttpRequest}],c=a.length;c--;)try{if(a[c]())return a[c]}catch(e){}}();a.util.request=function(a,c){c||(c={});var e=c.method?c.method.toUpperCase():"GET",f=c.onComplete||function(){},d=k();d.onreadystatechange=function(){4===d.readyState&&(f(d),d.onreadystatechange=h)};if("GET"===
e){var g=null;"string"===typeof c.parameters&&(a=b(a,c.parameters))}d.open(e,a,!0);"POST"!==e&&"PUT"!==e||d.setRequestHeader("Content-Type","application/x-www-form-urlencoded");d.send(g);return d}})();a.log=function(){};a.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(b){"undefined"!==typeof console[b]&&"function"===typeof console[b].apply&&(a[b]=function(){return console[b].apply(console,arguments)})});(function(a){function b(a,b){this.x=a;this.y=b}a=a.fabric||(a.fabric=
...
a.x;this.y=a.y},swap:function(a){var b=this.x,c=this.y;this.x=a.x;this.y=a.y;a.x=b;a.y=c}})})("undefined"!==typeof b?b:this);(function(a){function b(a){this.status=a;this.points=[]}var k=a.fabric||(a.fabric={});k.Intersection?k.warn("fabric.Intersection is already defined"):(k.Intersection=b,k.Intersection.prototype={appendPoint:function(a){this.points.push(a)},appendPoints:function(a){this.points=this.points.concat(a)}},k.Intersection.intersectLineLine=function(a,c,e,f){var d=(f.x-e.x)*(a.y-e.y)-
(f.y-e.y)*(a.x-e.x);var g=(c.x-a.x)*(a.y-e.y)-(c.y-a.y)*(a.x-e.x);e=(f.y-e.y)*(c.x-a.x)-(f.x-e.x)*(c.y-a.y);0!==e?(d/=e,g/=e,0<=d&&1>=d&&0<=g&&1>=g?(g=new b("Intersection"),g.points.push(new k.Point(a.x+d*(c.x-a.x),a.y+d*(c.y-a.y)))):g=new b):g=0===d||0===g?new b("Coincident"):new b("Parallel");return g},k.Intersection.intersectLinePolygon=function(a,c,e){for(var f=new b,d=e.length,g=0;g<d;g++){var h=b.intersectLineLine(a,c,e[g],e[(g+1)%d]);f.appendPoints(h.points)}0<f.points.length&&(f.status="Intersection");
return f},k.Intersection.intersectPolygonPolygon=function(a,c){for(var e=new b,f=a.length,d=0;d<f;d++){var g=b.intersectLinePolygon(a[d],a[(d+1)%f],c);e.appendPoints(g.points)}0<e.points.length&&(e.status="Intersection");return e},k.Intersection.intersectPolygonRectangle=function(a,c,e){var f=c.min(e),d=c.max(e);e=new k.Point(d.x,f.y);var g=new k.Point(f.x,d.y);c=b.intersectLinePolygon(f,e,a);e=b.intersectLinePolygon(e,d,a);d=b.intersectLinePolygon(d,g,a);a=b.intersectLinePolygon(g,f,a);f=new b;f.appendPoints(c.points);
f.appendPoints(e.points);f.appendPoints(d.points);f.appendPoints(a.points);0<f.points.length&&(f.status="Intersection");return f})})("undefined"!==typeof b?b:this);(function(a){function b(c){c?this._tryParsingColor(c):this.setSource([0,0,0,1])}function k(c,a,f){0>f&&(f+=1);1<f&&--f;return f<1/6?c+6*(a-c)*f:.5>f?a:f<2/3?c+(a-c)*(2/3-f)*6:c}var g=a.fabric||(a.fabric={});g.Color?g.warn("fabric.Color is already defined."):(g.Color=b,g.Color.prototype={_tryParsingColor:function(c){var a;c in b.colorNameMap&&
(c=b.colorNameMap[c]);"transparent"===c?this.setSource([255,255,255,0]):((a=b.sourceFromHex(c))||(a=b.sourceFromRgb(c)),a||(a=b.sourceFromHsl(c)),a&&this.setSource(a))},_rgbToHsl:function(c,a,f){c/=255;a/=255;f/=255;var d=g.util.array.max([c,a,f]);var b=g.util.array.min([c,a,f]);var e=(d+b)/2;if(d===b)var h=b=0;else{var k=d-b;b=.5<e?k/(2-d-b):k/(d+b);switch(d){case c:h=(a-f)/k+(a<f?6:0);break;case a:h=(f-c)/k+2;break;case f:h=(c-a)/k+4}h/=6}return[Math.round(360*h),Math.round(100*b),Math.round(100*
e)]},getSource:function(){return this._source},setSource:function(c){this._source=c},toRgb:function(){var c=this.getSource();return"rgb("+c[0]+","+c[1]+","+c[2]+")"},toRgba:function(){var c=this.getSource();return"rgba("+c[0]+","+c[1]+","+c[2]+","+c[3]+")"},toHsl:function(){var c=this.getSource();c=this._rgbToHsl(c[0],c[1],c[2]);return"hsl("+c[0]+","+c[1]+"%,"+c[2]+"%)"},toHsla:function(){var c=this.getSource(),a=this._rgbToHsl(c[0],c[1],c[2]);return"hsla("+a[0]+","+a[1]+"%,"+a[2]+"%,"+c[3]+")"},
...
this._parseDimensions();this.minX=a.left;this.minY=a.top;this.width=a.width;this.height=a.height;a.left+="center"===this.originX?this.width/2:"right"===this.originX?this.width:0;a.top+="center"===this.originY?this.height/2:"bottom"===this.originY?this.height:0;this.top=this.top||a.top;this.left=this.left||a.left;this.pathOffset=this.pathOffset||{x:this.minX+this.width/2,y:this.minY+this.height/2}},_render:function(a){var b=null,d=0,c=0,e=0,g=0,h=0,k=0,q=-this.pathOffset.x,l=-this.pathOffset.y;this.group&&
"path-group"===this.group.type&&(l=q=0);a.beginPath();for(var v=0,n=this.path.length;v<n;++v){var m=this.path[v];switch(m[0]){case "l":e+=m[1];g+=m[2];a.lineTo(e+q,g+l);break;case "L":e=m[1];g=m[2];a.lineTo(e+q,g+l);break;case "h":e+=m[1];a.lineTo(e+q,g+l);break;case "H":e=m[1];a.lineTo(e+q,g+l);break;case "v":g+=m[1];a.lineTo(e+q,g+l);break;case "V":g=m[1];a.lineTo(e+q,g+l);break;case "m":e+=m[1];g+=m[2];d=e;c=g;a.moveTo(e+q,g+l);break;case "M":e=m[1];g=m[2];d=e;c=g;a.moveTo(e+q,g+l);break;case "c":var p=
e+m[5];var r=g+m[6];h=e+m[3];k=g+m[4];a.bezierCurveTo(e+m[1]+q,g+m[2]+l,h+q,k+l,p+q,r+l);e=p;g=r;break;case "C":e=m[5];g=m[6];h=m[3];k=m[4];a.bezierCurveTo(m[1]+q,m[2]+l,h+q,k+l,e+q,g+l);break;case "s":p=e+m[3];r=g+m[4];null===b[0].match(/[CcSs]/)?(h=e,k=g):(h=2*e-h,k=2*g-k);a.bezierCurveTo(h+q,k+l,e+m[1]+q,g+m[2]+l,p+q,r+l);h=e+m[1];k=g+m[2];e=p;g=r;break;case "S":p=m[3];r=m[4];null===b[0].match(/[CcSs]/)?(h=e,k=g):(h=2*e-h,k=2*g-k);a.bezierCurveTo(h+q,k+l,m[1]+q,m[2]+l,p+q,r+l);e=p;g=r;h=m[1];k=
m[2];break;case "q":p=e+m[3];r=g+m[4];h=e+m[1];k=g+m[2];a.quadraticCurveTo(h+q,k+l,p+q,r+l);e=p;g=r;break;case "Q":p=m[3];r=m[4];a.quadraticCurveTo(m[1]+q,m[2]+l,p+q,r+l);e=p;g=r;h=m[1];k=m[2];break;case "t":p=e+m[1];r=g+m[2];null===b[0].match(/[QqTt]/)?(h=e,k=g):(h=2*e-h,k=2*g-k);a.quadraticCurveTo(h+q,k+l,p+q,r+l);e=p;g=r;break;case "T":p=m[1];r=m[2];null===b[0].match(/[QqTt]/)?(h=e,k=g):(h=2*e-h,k=2*g-k);a.quadraticCurveTo(h+q,k+l,p+q,r+l);e=p;g=r;break;case "a":f(a,e+q,g+l,[m[1],m[2],m[3],m[4],
m[5],m[6]+e+q,m[7]+g+l]);e+=m[6];g+=m[7];break;case "A":f(a,e+q,g+l,[m[1],m[2],m[3],m[4],m[5],m[6]+q,m[7]+l]);e=m[6];g=m[7];break;case "z":case "Z":e=d,g=c,a.closePath()}b=m}this._renderFill(a);this._renderStroke(a)},toString:function(){return"#<fabric.Path ("+this.complexity()+'): { "top": '+this.top+', "left": '+this.left+" }>"},toObject:function(a){a=c(this.callSuper("toObject",a),{path:this.path.map(function(a){return a.slice()}),pathOffset:this.pathOffset});this.sourcePath&&(a.sourcePath=this.sourcePath);
...
(a=-c.getWidth()/2);c.set({left:c.getLeft()+a,top:c.getTop()-c.getHeight()/2+c.fontSize*(.18+c._fontSizeFraction)});return c},b.Text.fromObject=function(a){return new b.Text(a.text,g(a))},b.util.createAccessors(b.Text))})("undefined"!==typeof b?b:this);delete window.fabric;return b}().fabric;b.__name__="com.fabricjs";b.fabric=a}}});(function(){var b=ca(n.com.fabricjs).fabric,a=D([13,27,32]),l=a[0],m=a[1],r=a[2];window.onkeydown=function(a){return a.keyCode!=r};var h=C("Attribute",[J],{__module__:"__main__",
get __init__(){return t(this,function(a,b){a.game=b;a.game.attributes.append(a);a.install();a.reset()})},get reset(){return t(this,function(a){a.commit()})},get predict(){return t(this,function(a){})},get interact(){return t(this,function(a){})},get commit(){return t(this,function(a){})}}),k=C("Sprite",[h],{__module__:"__main__",get __init__(){return t(this,function(a,b,c,e){a.width=c;a.height=e;h.__init__(a,b)})},get install(){return t(this,function(a){a.image=new b.Rect(H({width:a.game.scaleX(a.width),
...
arguments[d--];for(var g in d)switch(g){case "self":a=d[g];break;case "vX":b=d[g];break;case "vY":c=d[g];break;case "x":e=d[g];break;case "y":f=d[g]}}}a.vX=b;a.vY=c;a.x=e;a.y=f;h.reset(a)})},get predict(){return t(this,function(a){a.x+=a.vX*a.game.deltaT;a.y+=a.vY*a.game.deltaT})},get commit(){return t(this,function(a){a.image.left=a.game.orthoX(a.x);a.image.top=a.game.orthoY(a.y)})},get draw(){return t(this,function(a){a.game.canvas.add(a.image)})}}),g=C("Paddle",[k],{__module__:"__main__",margin:30,
width:10,height:100,speed:400,get __init__(){return t(this,function(a,b,c){a.index=c;k.__init__(a,b,a.width,a.height)})},get reset(){return t(this,function(a){k.reset(a,K({x:a.index?Math.floor(500)-a.margin:Math.floor(-500)+a.margin,y:0}))})},get predict(){return t(this,function(a){a.vY=0;a.index?a.game.keyCode==V("K")?a.vY=a.speed:a.game.keyCode==V("M")&&(a.vY=-a.speed):a.game.keyCode==V("A")?a.vY=a.speed:a.game.keyCode==V("Z")&&(a.vY=-a.speed);k.predict(a)})},get interact(){return t(this,function(a){a.y=
Math.max(Math.floor(a.height/2)-Math.floor(325),Math.min(a.y,Math.floor(325)-Math.floor(a.height/2)));a.y-Math.floor(a.height/2)<a.game.ball.y&&a.game.ball.y<a.y+Math.floor(a.height/2)&&(0==a.index&&a.game.ball.x<a.x||1==a.index&&a.game.ball.x>a.x)&&(a.game.ball.x=a.x,a.game.ball.vX=-a.game.ball.vX,a.game.ball.speedUp(a))})}}),c=C("Ball",[k],{__module__:"__main__",side:8,speed:300,get __init__(){return t(this,function(a,b){k.__init__(a,b,a.side,a.side)})},get reset(){return t(this,function(a){var b=
...
3*a.speed&&(a.vX*=b,a.vY*=b)})}}),e=C("Scoreboard",[h],{__module__:"__main__",nameShift:75,hintShift:25,get install(){return t(this,function(a){for(var c=[],d=D([D(["AZ keys:",-.4375]),D(["KM keys:",.0625])]),e=0;e<B(d);e++){var f=d[e],g=f[1];c.append(new b.Text("Player {}".format(f[0]),H({fill:"white",fontFamily:"arial",fontSize:"{}".format(a.game.canvas.width/30),left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(325)+a.nameShift)})))}a.playerLabels=c;a.hintLabel=new b.Text("[spacebar] starts game, [enter] resets score",
H({fill:"white",fontFamily:"arial",fontSize:"{}".format(a.game.canvas.width/70),left:a.game.orthoX(-437.5),top:a.game.orthoY(Math.floor(325)+a.hintShift)}));a.image=new b.Line(E([a.game.orthoX(Math.floor(-500)),a.game.orthoY(Math.floor(325)),a.game.orthoX(Math.floor(500)),a.game.orthoY(Math.floor(325))]),H({stroke:"white"}))})},get increment(){return t(this,function(a,b){a.scores[b]++})},get reset(){return t(this,function(a){a.scores=E([0,0]);h.reset(a)})},get commit(){return t(this,function(a){for(var c=
[],d=ea(a.scores,D([-.125,.375])),e=0;e<B(d);e++){var f=d[e],g=f[1];c.append(new b.Text("{}".format(f[0]),H({fill:"white",fontFamily:"arial",fontSize:"{}".format(a.game.canvas.width/30),left:a.game.orthoX(1E3*g),top:a.game.orthoY(Math.floor(325)+a.nameShift)})))}a.scoreLabels=c})},get draw(){return t(this,function(a){for(var b=ea(a.playerLabels,a.scoreLabels),c=0;c<B(b);c++){var d=b[c],e=d[1];a.game.canvas.add(d[0]);a.game.canvas.add(e);a.game.canvas.add(a.hintLabel)}a.game.canvas.add(a.image)})}});
a=C("Game",[J],{__module__:"__main__",get __init__(){return t(this,function(a){a.serviceIndex=.5<Math.random()?1:0;a.pause=!0;a.keyCode=null;a.textFrame=document.getElementById("text_frame");a.canvasFrame=document.getElementById("canvas_frame");a.buttonsFrame=document.getElementById("buttons_frame");a.canvas=new b.Canvas("canvas",H({backgroundColor:"black",originX:"center",originY:"center"}));a.canvas.onWindowDraw=a.draw;a.canvas.lineWidth=2;a.canvas.clear();a.attributes=E([]);a.paddles=function(){for(var b=
[],c=0;2>c;c++)b.append(g(a,c));return b}();a.ball=c(a);a.scoreboard=e(a);window.setInterval(a.py_update,10);window.setInterval(a.draw,20);window.addEventListener("keydown",a.keydown);window.addEventListener("keyup",a.keyup);a.buttons=E([]);for(var d=D("A Z K M space enter".split(" ")),f=0;f<B(d);f++){var h=d[f],k=document.getElementById(h);k.addEventListener("mousedown",function(b){return function(){return a.mouseOrTouch(b,!0)}}(h));k.addEventListener("touchstart",function(b){return function(){return a.mouseOrTouch(b,
!0)}}(h));k.addEventListener("mouseup",function(b){return function(){return a.mouseOrTouch(b,!1)}}(h));k.addEventListener("touchend",function(b){return function(){return a.mouseOrTouch(b,!1)}}(h));k.style.cursor="pointer";k.style.userSelect="none";a.buttons.append(k)}a.time=+new Date;window.onresize=a.resize;a.resize()})},get install(){return t(this,function(a){a=a.attributes;for(var b=0;b<B(a);b++)a[b].install()})},get mouseOrTouch(){return t(this,function(a,b,c){a.keyCode=c?"space"==b?r:"enter"==
b?l:V(b):null})},get py_update(){return t(this,function(a){var b=a.time;a.time=+new Date;a.deltaT=(a.time-b)/1E3;if(a.pause)a.keyCode==r?a.pause=!1:a.keyCode==l&&a.scoreboard.reset();else{for(var c=a.attributes,d=0;d<B(c);d++)b=c[d],b.predict();c=a.attributes;for(d=0;d<B(c);d++)b=c[d],b.interact();c=a.attributes;for(d=0;d<B(c);d++)b=c[d],b.commit()}})},get scored(){return t(this,function(a,b){a.scoreboard.increment(b);a.serviceIndex=1-b;b=a.paddles;for(var c=0;c<B(b);c++)b[c].reset();a.ball.reset();
a.pause=!0})},get commit(){return t(this,function(a){a=a.attributes;for(var b=0;b<B(a);b++)a[b].commit()})},get draw(){return t(this,function(a){a.canvas.clear();a=a.attributes;for(var b=0;b<B(a);b++)a[b].draw()})},get resize(){return t(this,function(a){a.pageWidth=window.innerWidth;a.pageHeight=window.innerHeight;a.textTop=0;a.pageHeight>1.2*a.pageWidth?(a.canvasWidth=a.pageWidth,a.canvasTop=a.textTop+300):(a.canvasWidth=.6*a.pageWidth,a.canvasTop=a.textTop+200);a.canvasLeft=.5*(a.pageWidth-a.canvasWidth);
a.canvasHeight=.6*a.canvasWidth;a.buttonsTop=a.canvasTop+a.canvasHeight+50;a.buttonsWidth=500;a.textFrame.style.top=a.textTop;a.textFrame.style.left=a.canvasLeft+.05*a.canvasWidth;a.textFrame.style.width=.9*a.canvasWidth;a.canvasFrame.style.top=a.canvasTop;a.canvasFrame.style.left=a.canvasLeft;a.canvas.setDimensions(H({width:a.canvasWidth,height:a.canvasHeight}));a.buttonsFrame.style.top=a.buttonsTop;a.buttonsFrame.style.left=.5*(a.pageWidth-a.buttonsWidth);a.buttonsFrame.style.width=a.canvasWidth;
a.install();a.commit();a.draw()})},get scaleX(){return t(this,function(a,b){return a.canvas.width/1E3*b})},get scaleY(){return t(this,function(a,b){return a.canvas.height/750*b})},get orthoX(){return t(this,function(a,b){return a.scaleX(b+Math.floor(500))})},get orthoY(){return t(this,function(a,b){return a.scaleY(750-Math.floor(325)-b)})},get keydown(){return t(this,function(a,b){a.keyCode=b.keyCode})},get keyup(){return t(this,function(a,b){a.keyCode=null})}});var f=a();n.Attribute=h;n.Ball=c;n.Game=
a;n.Paddle=g;n.Scoreboard=e;n.Sprite=k;n.__name__="__main__";n.enter=l;n.esc=m;n.fabric=b;n.fieldHeight=650;n.game=f;n.orthoHeight=750;n.orthoWidth=1E3;n.space=r})();return n}window.pong=pong();
