...
<<<<<<< HEAD
{__all__:{__inited__:!1,__init__:function(e){var l=F("__Envir__",[N],{get __init__(){return q(this,function(h){h.transpiler_name="transcrypt";h.transpiler_version="3.5.146";h.target_subdir="__javascript__"})}}),m=l();e.__Envir__=l;e.__envir__=m}}});L(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(e){var l=F("Exception",[N],{get __init__(){return q(this,function(h){var d=y([].slice.apply(arguments).slice(1));h.args=d})},get __repr__(){return q(this,function(h){return O(h.args)?
=======
{__all__:{__inited__:!1,__init__:function(e){var l=F("__Envir__",[N],{get __init__(){return q(this,function(h){h.transpiler_name="transcrypt";h.transpiler_version="3.5.151";h.target_subdir="__javascript__"})}}),m=l();e.__Envir__=l;e.__envir__=m}}});L(n,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(e){var l=F("Exception",[N],{get __init__(){return q(this,function(h){var d=y([].slice.apply(arguments).slice(1));h.args=d})},get __repr__(){return q(this,function(h){return O(h.args)?
>>>>>>> develop
...
typeof e+">)"),"???"}}}};n.repr=ca;n.chr=function(e){return String.fromCharCode(e)};var P=function(e){return e.charCodeAt(0)};n.org=P;var S=function(){var e=[].slice.call(arguments);return(0==e.length?[]:e.reduce(function(e,m){return e.length<m.length?e:m})).map(function(l,m){return e.map(function(h){return h[m]})})};n.zip=S;n.range=X;n.enumerate=function(e){return S(X(O(e)),e)};n.copy=T;n.deepcopy=Y;n.list=H;Array.prototype.__class__=H;H.__name__="list";Array.prototype.__getslice__=function(e,l,
m){0>e&&(e=this.length+e);null==l?l=this.length:0>l&&(l=this.length+l);for(var h=H([]);e<l;e+=m)h.push(this[e]);return h};Array.prototype.__setslice__=function(e,l,m,h){0>e&&(e=this.length+e);null==l?l=this.length:0>l&&(l=this.length+l);if(null==m)Array.prototype.splice.apply(this,[e,l-e].concat(h));else for(var t=0;e<l;e+=m)this[e]=h[t++]};Array.prototype.__repr__=function(){if(this.__class__==D&&!this.length)return"set()";for(var e=this.__class__&&this.__class__!=H?this.__class__==y?"(":"{":"[",
...
this.indexOf(e);if(-1==e)throw"KeyError";this.splice(e,1)};Array.prototype.index=function(e){return this.indexOf(e)};Array.prototype.py_pop=function(e){return void 0==e?this.pop():this.splice(e,1)[0]};Array.prototype.py_sort=function(){ga.apply(null,[this].concat([].slice.apply(arguments)))};n.tuple=y;y.__name__="tuple";n.set=D;D.__name__="set";Array.prototype.__bindexOf__=function(e){e+="";for(var l=0,m=this.length-1;l<=m;){var h=(l+m)/2|0,t=this[h]+"";if(t<e)l=h+1;else if(t>e)m=h-1;else return h}return-1};
Array.prototype.add=function(e){-1==this.indexOf(e)&&this.push(e)};Array.prototype.discard=function(e){e=this.indexOf(e);-1!=e&&this.splice(e,1)};Array.prototype.isdisjoint=function(e){this.sort();for(var l=0;l<e.length;l++)if(-1!=this.__bindexOf__(e[l]))return!1;return!0};Array.prototype.issuperset=function(e){this.sort();for(var l=0;l<e.length;l++)if(-1==this.__bindexOf__(e[l]))return!1;return!0};Array.prototype.issubset=function(e){return D(e.slice()).issuperset(this)};Array.prototype.union=function(e){for(var l=
D(this.slice().sort()),m=0;m<e.length;m++)-1==l.__bindexOf__(e[m])&&l.push(e[m]);return l};Array.prototype.intersection=function(e){this.sort();for(var l=D(),m=0;m<e.length;m++)-1!=this.__bindexOf__(e[m])&&l.push(e[m]);return l};Array.prototype.difference=function(e){e=D(e.slice().sort());for(var l=D(),m=0;m<this.length;m++)-1==e.__bindexOf__(this[m])&&l.push(this[m]);return l};Array.prototype.symmetric_difference=function(e){return this.union(e).difference(this.intersection(e))};Array.prototype.update=
function(){var e=[].concat.apply(this.slice(),arguments).sort();this.clear();for(var l=0;l<e.length;l++)e[l]!=e[l-1]&&this.push(e[l])};n.__keys__=Z;n.__items__=aa;n.__del__=ba;n.dict=C;C.__name__="dict";n.str=K;String.prototype.__class__=K;K.__name__="str";String.prototype.__repr__=function(){return(-1==this.indexOf("'")?"'"+this+"'":'"'+this+'"').replace("\n","\\n")};String.prototype.__str__=function(){return this};String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};
String.prototype.endswith=function(e){return""==e||this.slice(-e.length)==e};String.prototype.find=function(e,l){return this.indexOf(e,l)};Object.defineProperty(String.prototype,"format",{get:function(){return q(this,function(e){var l=y([].slice.apply(arguments).slice(1)),m=0;return e.replace(/\{(\w*)\}/g,function(h,e){""==e&&(e=m++);if(e==+e)return"undefined"==l[e]?h:l[e];for(var d=0;d<l.length;d++)if("object"==typeof l[d]&&"undefined"!=typeof l[d][e])return l[d][e];return h})})},enumerable:!0});
String.prototype.isnumeric=function(){return!isNaN(parseFloat(this))&&isFinite(this)};String.prototype.join=function(e){return e.join(this)};String.prototype.lower=function(){return this.toLowerCase()};String.prototype.py_replace=function(e,l,m){return this.split(e,m).join(l)};String.prototype.lstrip=function(){return this.replace(/^\s*/g,"")};String.prototype.rfind=function(e,l){return this.lastIndexOf(e,l)};String.prototype.rsplit=function(e,l){var m=this.split(e||/s+/);return l?[m.slice(0,-l).join(e)].concat(m.slice(-l)):
m};String.prototype.rstrip=function(){return this.replace(/\s*$/g,"")};String.prototype.py_split=function(e,l){e||(e=" ");return this.split(e||/s+/,l)};String.prototype.startswith=function(e){return 0==this.indexOf(e)};String.prototype.strip=function(){return this.trim()};String.prototype.upper=function(){return this.toUpperCase()};n.__neg__=function(e){return"object"==typeof e&&"__neg__"in e?e.__neg__():-e};n.__matmul__=function(e,l){return e.__matmul__(l)};n.__mul__=function(e,l){return"object"==
typeof e&&"__mul__"in e?e.__mul__(l):"object"==typeof l&&"__rmul__"in l?l.__rmul__(e):e*l};n.__div__=function(e,l){return"object"==typeof e&&"__div__"in e?e.__div__(l):"object"==typeof l&&"__rdiv__"in l?l.__rdiv__(e):e/l};n.__add__=function(e,l){return"object"==typeof e&&"__add__"in e?e.__add__(l):"object"==typeof l&&"__radd__"in l?l.__radd__(e):e+l};n.__sub__=function(e,l){return"object"==typeof e&&"__sub__"in e?e.__sub__(l):"object"==typeof l&&"__rsub__"in l?l.__rsub__(e):e-l};n.__getitem__=function(e,
l){return"object"==typeof e&&"__getitem__"in e?e.__getitem__(l):e[l]};n.__setitem__=function(e,l,m){"object"==typeof e&&"__setitem__"in e?e.__setitem__(l,m):e[l]=m};n.__getslice__=function(e,l,m,h){return"object"==typeof e&&"__getitem__"in e?e.__getitem__([l,m,h]):e.__getslice__(l,m,h)};n.__setslice__=function(e,l,m,h,t){"object"==typeof e&&"__setitem__"in e?e.__setitem__([l,m,h],t):e.__setslice__(l,m,h,t)};n.__call__=function(){var e=[].slice.apply(arguments);return"object"==typeof e[0]&&"__call__"in
e[0]?e[0].__call__.apply(null,e.slice(1)):e[0].apply(null,e.slice(1))};L(n,"com.fabricjs",{__all__:{__inited__:!1,__init__:function(e){var l=function(){var e={},h=h||{version:"1.5.0"};"undefined"!==typeof e&&(e.fabric=h);"undefined"!==typeof document&&"undefined"!==typeof window?(h.document=document,h.window=window,window.fabric=h):(h.document=require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"),h.window=h.document.createWindow?h.document.createWindow():h.document.parentWindow);
...
0)}function d(a,b){this.__eventListeners||(this.__eventListeners={});if(1===arguments.length)for(var g in a)this.on(g,a[g]);else this.__eventListeners[a]||(this.__eventListeners[a]=[]),this.__eventListeners[a].push(b);return this}function k(a,b){if(this.__eventListeners){if(0===arguments.length)this.__eventListeners={};else if(1===arguments.length&&"object"===typeof arguments[0])for(var g in a)e.call(this,g,a[g]);else e.call(this,a,b);return this}}function c(a,b){if(this.__eventListeners){var g=this.__eventListeners[a];
if(g){for(var f=0,c=g.length;f<c;f++)g[f].call(this,b||{});return this}}}h.Observable={observe:d,stopObserving:k,fire:c,on:d,off:k,trigger:c}})();h.Collection={add:function(){this._objects.push.apply(this._objects,arguments);for(var e=0,d=arguments.length;e<d;e++)this._onObjectAdded(arguments[e]);this.renderOnAddRemove&&this.renderAll();return this},insertAt:function(e,d,k){var c=this.getObjects();k?c[d]=e:c.splice(d,0,e);this._onObjectAdded(e);this.renderOnAddRemove&&this.renderAll();return this},
...
c){return e(d,c,function(a,b){return a<b})},max:function(d,c){return e(d,c,function(a,b){return a>=b})}}})();(function(){function e(d,k){for(var c in k)d[c]=k[c];return d}h.util.object={extend:e,clone:function(d){return e({},d)}}})();(function(){String.prototype.trim||(String.prototype.trim=function(){return this.replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});h.util.string={camelize:function(e){return e.replace(/-+(.)?/g,function(d,k){return k?k.toUpperCase():""})},capitalize:function(e,d){return e.charAt(0).toUpperCase()+
(d?e.slice(1):e.slice(1).toLowerCase())},escapeXml:function(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&apos;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}})();(function(){var e=Array.prototype.slice,d=Function.prototype.apply,k=function(){};Function.prototype.bind||(Function.prototype.bind=function(c){var a=this,b=e.call(arguments,1),g;g=b.length?function(){return d.call(a,this instanceof k?this:c,b.concat(e.call(arguments)))}:function(){return d.call(a,this instanceof
k?this:c,arguments)};k.prototype=this.prototype;g.prototype=new k;return g})})();(function(){function e(){}function d(g){var f=this.constructor.superclass.prototype[g];return 1<arguments.length?f.apply(this,k.call(arguments,1)):f.call(this)}var k=Array.prototype.slice,c=function(){},a=function(){for(var g in{toString:1})if("toString"===g)return!1;return!0}(),b=function(g,f,b){for(var c in f)c in g.prototype&&"function"===typeof g.prototype[c]&&-1<(f[c]+"").indexOf("callSuper")?g.prototype[c]=function(g){return function(){var a=
this.constructor.superclass;this.constructor.superclass=b;var c=f[g].apply(this,arguments);this.constructor.superclass=a;if("initialize"!==g)return c}}(c):g.prototype[c]=f[c],a&&(f.toString!==Object.prototype.toString&&(g.prototype.toString=f.toString),f.valueOf!==Object.prototype.valueOf&&(g.prototype.valueOf=f.valueOf))};h.util.createClass=function(){function g(){this.initialize.apply(this,arguments)}var f=null,a=k.call(arguments,0);"function"===typeof a[0]&&(f=a.shift());g.superclass=f;g.subclasses=
[];f&&(e.prototype=f.prototype,g.prototype=new e,f.subclasses.push(g));for(var h=0,A=a.length;h<A;h++)b(g,a[h],f);g.prototype.initialize||(g.prototype.initialize=c);g.prototype.constructor=g;g.prototype.callSuper=d;return g}})();(function(){function e(g){var f=Array.prototype.slice.call(arguments,1),a,b,c=f.length;for(b=0;b<c;b++)if(a=typeof g[f[b]],!/^(?:function|object|unknown)$/.test(a))return!1;return!0}function d(g,f){return function(b){f.call(a(g),b||h.window.event)}}function k(g,f){return function(a){if(A[g]&&
A[g][f])for(var b=A[g][f],c=0,d=b.length;c<d;c++)b[c].call(this,a||h.window.event)}}function c(g,f,a){var b="touchend"===g.type?"changedTouches":"touches";return g[b]&&g[b][0]?g[b][0][f]-(g[b][0][f]-g[b][0][a])||g[a]:g[a]}var a,b,g=function(){var g=0;return function(f){return f.__uniqueID||(f.__uniqueID="uniqueID__"+g++)}}();(function(){var g={};a=function(f){return g[f]};b=function(f,a){g[f]=a}})();var f=e(h.document.documentElement,"addEventListener","removeEventListener")&&e(h.window,"addEventListener",
"removeEventListener"),p=e(h.document.documentElement,"attachEvent","detachEvent")&&e(h.window,"attachEvent","detachEvent"),w={},A={};f?(f=function(g,f,a){g.addEventListener(f,a,!1)},p=function(g,f,a){g.removeEventListener(f,a,!1)}):p?(f=function(f,a,c){var k=g(f);b(k,f);w[k]||(w[k]={});w[k][a]||(w[k][a]=[]);c={handler:c,wrappedHandler:d(k,c)};w[k][a].push(c);f.attachEvent("on"+a,c.wrappedHandler)},p=function(f,a,b){var c=g(f),d;if(w[c]&&w[c][a])for(var k=0,p=w[c][a].length;k<p;k++)(d=w[c][a][k])&&
d.handler===b&&(f.detachEvent("on"+a,d.wrappedHandler),w[c][a][k]=null)}):(f=function(f,a,b){var c=g(f);A[c]||(A[c]={});if(!A[c][a]){A[c][a]=[];var d=f["on"+a];d&&A[c][a].push(d);f["on"+a]=k(c,a)}A[c][a].push(b)},p=function(f,a,b){f=g(f);if(A[f]&&A[f][a]){a=A[f][a];f=0;for(var c=a.length;f<c;f++)a[f]===b&&a.splice(f,1)}});h.util.addListener=f;h.util.removeListener=p;var l=function(g){return"unknown"!==typeof g.clientX?g.clientX:0},m=function(g){return"unknown"!==typeof g.clientY?g.clientY:0};h.isTouchSupported&&
(l=function(g){return c(g,"pageX","clientX")},m=function(g){return c(g,"pageY","clientY")});h.util.getPointer=function(g,f){g||(g=h.window.event);var a=h.util.getScrollLeftTop(g.target||("unknown"!==typeof g.srcElement?g.srcElement:null),f);return{x:l(g)+a.left,y:m(g)+a.top}};h.util.object.extend(h.util,h.Observable)})();(function(){var e=h.document.createElement("div"),d="string"===typeof e.style.filter,k=/alpha\s*\(\s*opacity\s*=\s*([^\)]+)\)/,c=function(a){return a};"string"===typeof e.style.opacity?
c=function(a,b){a.style.opacity=b;return a}:d&&(c=function(a,b){var g=a.style;a.currentStyle&&!a.currentStyle.hasLayout&&(g.zoom=1);k.test(g.filter)?g.filter=g.filter.replace(k,.9999<=b?"":"alpha(opacity="+100*b+")"):g.filter+=" alpha(opacity="+100*b+")";return a});h.util.setStyle=function(a,b){var g=a.style;if(!g)return a;if("string"===typeof b)return a.style.cssText+=";"+b,-1<b.indexOf("opacity")?c(a,b.match(/opacity:\s*(\d?\.?\d*)/)[1]):a;for(var f in b)"opacity"===f?c(a,b[f]):g["float"===f||"cssFloat"===
f?"undefined"===typeof g.styleFloat?"cssFloat":"styleFloat":f]=b[f];return a}})();(function(){function e(a,g){var f=h.document.createElement(a),c;for(c in g)"class"===c?f.className=g[c]:"for"===c?f.htmlFor=g[c]:f.setAttribute(c,g[c]);return f}var d=Array.prototype.slice,k,c=function(a){return d.call(a,0)};try{k=c(h.document.childNodes)instanceof Array}catch(b){}k||(c=function(a){for(var g=Array(a.length),f=a.length;f--;)g[f]=a[f];return g});var a;a=h.document.defaultView&&h.document.defaultView.getComputedStyle?
function(a,g){var f=h.document.defaultView.getComputedStyle(a,null);return f?f[g]:void 0}:function(a,g){var f=a.style[g];!f&&a.currentStyle&&(f=a.currentStyle[g]);return f};(function(){var a=h.document.documentElement.style,g="userSelect"in a?"userSelect":"MozUserSelect"in a?"MozUserSelect":"WebkitUserSelect"in a?"WebkitUserSelect":"KhtmlUserSelect"in a?"KhtmlUserSelect":"";h.util.makeElementUnselectable=function(f){"undefined"!==typeof f.onselectstart&&(f.onselectstart=h.util.falseFunction);g?f.style[g]=
"none":"string"===typeof f.unselectable&&(f.unselectable="on");return f};h.util.makeElementSelectable=function(f){"undefined"!==typeof f.onselectstart&&(f.onselectstart=null);g?f.style[g]="":"string"===typeof f.unselectable&&(f.unselectable="");return f}})();(function(){h.util.getScript=function(a,g){var f=h.document.getElementsByTagName("head")[0],c=h.document.createElement("script"),d=!0;c.onload=c.onreadystatechange=function(f){!d||"string"===typeof this.readyState&&"loaded"!==this.readyState&&
"complete"!==this.readyState||(d=!1,g(f||h.window.event),c=c.onload=c.onreadystatechange=null)};c.src=a;f.appendChild(c)}})();h.util.getById=function(a){return"string"===typeof a?h.document.getElementById(a):a};h.util.toArray=c;h.util.makeElement=e;h.util.addClass=function(a,g){a&&-1===(" "+a.className+" ").indexOf(" "+g+" ")&&(a.className+=(a.className?" ":"")+g)};h.util.wrapElement=function(a,g,f){"string"===typeof g&&(g=e(g,f));a.parentNode&&a.parentNode.replaceChild(g,a);g.appendChild(a);return g};
h.util.getScrollLeftTop=function(a,g){var f,c,d=0,k=0,e=h.document.documentElement,l=h.document.body||{scrollLeft:0,scrollTop:0};for(c=a;a&&a.parentNode&&!f;)a=a.parentNode,1===a.nodeType&&"fixed"===h.util.getElementStyle(a,"position")&&(f=a),1===a.nodeType&&c!==g&&"absolute"===h.util.getElementStyle(a,"position")?k=d=0:a===h.document?(d=l.scrollLeft||e.scrollLeft||0,k=l.scrollTop||e.scrollTop||0):(d+=a.scrollLeft||0,k+=a.scrollTop||0);return{left:d,top:k}};h.util.getElementOffset=function(b){var g;
g=b&&b.ownerDocument;var f={left:0,top:0},c={left:0,top:0},d={borderLeftWidth:"left",borderTopWidth:"top",paddingLeft:"left",paddingTop:"top"};if(!g)return{left:0,top:0};for(var k in d)c[d[k]]+=parseInt(a(b,k),10)||0;g=g.documentElement;"undefined"!==typeof b.getBoundingClientRect&&(f=b.getBoundingClientRect());b=h.util.getScrollLeftTop(b,null);return{left:f.left+b.left-(g.clientLeft||0)+c.left,top:f.top+b.top-(g.clientTop||0)+c.top}};h.util.getElementStyle=a})();(function(){function e(c,a){return c+
(/\?/.test(c)?"&":"?")+a}function d(){}var k=function(){for(var c=[function(){return new ActiveXObject("Microsoft.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml2.XMLHTTP.3.0")},function(){return new XMLHttpRequest}],a=c.length;a--;)try{if(c[a]())return c[a]}catch(b){}}();h.util.request=function(c,a){a||(a={});var b=a.method?a.method.toUpperCase():"GET",g=a.onComplete||function(){},f=k(),p;f.onreadystatechange=function(){4===f.readyState&&
(g(f),f.onreadystatechange=d)};"GET"===b&&(p=null,"string"===typeof a.parameters&&(c=e(c,a.parameters)));f.open(b,c,!0);"POST"!==b&&"PUT"!==b||f.setRequestHeader("Content-Type","application/x-www-form-urlencoded");f.send(p);return f}})();h.log=function(){};h.warn=function(){};"undefined"!==typeof console&&["log","warn"].forEach(function(e){"undefined"!==typeof console[e]&&"function"===typeof console[e].apply&&(h[e]=function(){return console[e].apply(console,arguments)})});(function(e){function d(d,
c){this.x=d;this.y=c}e=e.fabric||(e.fabric={});e.Point?e.warn("fabric.Point is already defined"):(e.Point=d,d.prototype={constructor:d,add:function(k){return new d(this.x+k.x,this.y+k.y)},addEquals:function(d){this.x+=d.x;this.y+=d.y;return this},scalarAdd:function(k){return new d(this.x+k,this.y+k)},scalarAddEquals:function(d){this.x+=d;this.y+=d;return this},subtract:function(k){return new d(this.x-k.x,this.y-k.y)},subtractEquals:function(d){this.x-=d.x;this.y-=d.y;return this},scalarSubtract:function(k){return new d(this.x-
