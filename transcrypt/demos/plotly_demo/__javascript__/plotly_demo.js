...
function plotly_demo () {
				...
				__init__: function (__all__) {
					var __Envir__ = __class__ ('__Envir__', [object], {
						get __init__ () {return __get__ (this, function (self) {
							...
							self.transpiler_version = '3.5.228';
	...
	*/
	...
	(function () {
		...
		Plotly.plot (kind, itertools.chain (function () {
			...
			for (var i = 0; i < 20; i++) {
				__accu0__.append (dict ({x: denseGrid, y: function () {
					...
					return __accu1__;
				} (), z: getZValues (denseGrid, sparseGrid) [i], type: type, mode: 'lines', line: dict ({color: 'rgb(0,0,255)'}), zmin: -(0.2), zmax: 1, showscale: !(i)}));
			}
			return __accu0__;
		} (), function () {
			var __accu0__ = [];
			for (var i = 0; i < 20; i++) {
				__accu0__.append (dict ({x: function () {
					...
					return __accu1__;
				} (), y: denseGrid, z: zip.apply (null, getZValues (sparseGrid, denseGrid)) [i], type: type, mode: 'lines', line: dict ({color: 'rgb(0,0,255)'}), zmin: -(0.2), zmax: 1, showscale: !(i)}));
			}
			return __accu0__;
		...
		var kind = 'pie';
		Plotly.plot (kind, list ([dict ({name: 'rare', values: list ([1, 2, 3, 4, 5, 6]), labels: list (['least', 'less', 'little', 'much', 'more', 'most']), type: kind})]), dict ({title: kind}));
		var kind = 'scatter3d';
