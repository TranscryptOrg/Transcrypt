"use strict";
// Transcrypt'ed from Python, 2017-07-07 16:10:48
function pysteroids () {
				...
				__init__: function (__all__) {
					...
					var Keyboard = __class__ ('Keyboard', [object], {
						...
						get py_update () {return __get__ (this, function (self, interval) {
							var __iterable0__ = self.handlers.py_items ();
							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
								var __left0__ = __iterable0__ [__index0__];
								var _ = __left0__ [0];
								var eachhandler = __left0__ [1];
				...
				__init__: function (__all__) {
					...
					var LogRecord = __class__ ('LogRecord', [object], {
						...
						get getMessage () {return __get__ (this, function (self) {
							...
							if (self.args) {
								var msg = msg.format.apply (null, self.args);
							}
							return msg;
						});},
					...
					var BufferingFormatter = __class__ ('BufferingFormatter', [object], {
						...
						get format () {return __get__ (this, function (self, records) {
							...
							if (len (records) > 0) {
								...
								var __iterable0__ = records;
								for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
									var record = __iterable0__ [__index0__];
					...
					var Filterer = __class__ ('Filterer', [object], {
						...
						get filter () {return __get__ (this, function (self, record) {
							var rv = true;
							var __iterable0__ = self.filters;
							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					...
					var Manager = __class__ ('Manager', [object], {
						...
						get _fixupChildren () {return __get__ (this, function (self, ph, alogger) {
							...
							var __iterable0__ = ph.loggerMap.py_keys ();
							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					...
					var Logger = __class__ ('Logger', [Filterer], {
						...
						get warn () {return __get__ (this, function (self, msg) {
							...
							self.warning.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
						});},
						...
						get exception () {return __get__ (this, function (self, msg) {
							...
							self.error.apply (null, [msg].concat (args).concat ([__kwargtrans__ (__merge__ ({exc_info: exc_info}, kwargs))]));
						});},
						...
						get callHandlers () {return __get__ (this, function (self, record) {
							...
							var found = 0;
							while (c) {
								var __iterable0__ = c.handlers;
								for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
									var hdlr = __iterable0__ [__index0__];
									var found = found + 1;
					...
					var LoggerAdapter = __class__ ('LoggerAdapter', [object], {
						...
						get debug () {return __get__ (this, function (self, msg) {
							...
							self.log.apply (null, [DEBUG].concat ([msg]).concat (args).concat ([__kwargtrans__ (kwargs)]));
						});},
						get info () {return __get__ (this, function (self, msg) {
							var kwargs = dict ();
							if (arguments.length) {
							...
							self.log.apply (null, [INFO].concat ([msg]).concat (args).concat ([__kwargtrans__ (kwargs)]));
						});},
						get warning () {return __get__ (this, function (self, msg) {
							var kwargs = dict ();
							if (arguments.length) {
							...
							self.log.apply (null, [WARNING].concat ([msg]).concat (args).concat ([__kwargtrans__ (kwargs)]));
						});},
						get warn () {return __get__ (this, function (self, msg) {
							var kwargs = dict ();
							if (arguments.length) {
						...
						get error () {return __get__ (this, function (self, msg) {
							...
							self.log.apply (null, [ERROR].concat ([msg]).concat (args).concat ([__kwargtrans__ (kwargs)]));
						});},
						get exception () {return __get__ (this, function (self, msg) {
							var exc_info = true;
							var kwargs = dict ();
							...
							self.log.apply (null, [ERROR].concat ([msg]).concat (args).concat ([__kwargtrans__ (__merge__ ({exc_info: exc_info}, kwargs))]));
						});},
						get critical () {return __get__ (this, function (self, msg) {
							var kwargs = dict ();
							if (arguments.length) {
							...
							self.log.apply (null, [CRITICAL].concat ([msg]).concat (args).concat ([__kwargtrans__ (kwargs)]));
						});},
						get log () {return __get__ (this, function (self, level, msg) {
							var kwargs = dict ();
							if (arguments.length) {
					...
					var critical = function (msg) {
						...
						root.critical.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					var fatal = critical;
					var error = function (msg) {
						...
						root.error.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					var exception = function (msg) {
						...
						error.apply (null, [msg].concat (args).concat ([__kwargtrans__ (__merge__ ({exc_info: exc_info}, kwargs))]));
					};
					var warning = function (msg) {
						...
						root.warning.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					var warn = function (msg) {
						...
						warning.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					var info = function (msg) {
						...
						root.info.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					var debug = function (msg) {
						...
						root.debug.apply (null, [msg].concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					var log = function (level, msg) {
						...
						root.log.apply (null, [level].concat ([msg]).concat (args).concat ([__kwargtrans__ (kwargs)]));
					};
					...
					var shutdown = function (handlerList) {
						...
						var __iterable0__ = py_reversed (handlerList.__getslice__ (0, null, 1));
						for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
							var wr = __iterable0__ [__index0__];
							try {
								var h = wr ();
								if (h) {
									try {
				...
				__init__: function (__all__) {
					var _ctor = function (obj) {
						var _c_ = function () {
							...
							return new obj.apply (null, args);
						};
						return _c_;
					};
					var api = THREE
			...
			__all__: {
				...
				__init__: function (__all__) {
					...
					if (!(_warnings_defaults)) {
						...
						var __iterable0__ = silence;
						for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
							var cls = __iterable0__ [__index0__];
	...
	(function () {
		...
		var Game = __class__ ('Game', [object], {
			get __init__ () {return __get__ (this, function (self, canvas, fullscreen) {
				...
				set_limits.apply (null, self.extents);
			...
			get tick () {return __get__ (this, function (self) {
				...
				var dead = list ([]);
				var __iterable0__ = self.bullets;
				for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					var b = __iterable0__ [__index0__];
					if (b.position.z < 1000) {
						var __iterable1__ = self.asteroids;
						for (var __index1__ = 0; __index1__ < __iterable1__.length; __index1__++) {
							var a = __iterable1__ [__index1__];
				...
				if (self.ship.visible) {
					var __iterable0__ = self.asteroids;
					for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
						var a = __iterable0__ [__index0__];
			...
			get fire () {return __get__ (this, function (self, pos, vector, momentum, t) {
				var __iterable0__ = self.bullets;
				for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
					var each_bullet = __iterable0__ [__index0__];
