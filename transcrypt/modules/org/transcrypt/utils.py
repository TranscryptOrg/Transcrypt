...
class CommandArgs:
    def parse (self):
        ...
        self.argParser.add_argument ('-ni', '--noimports', help = 'compile only the source file without recursing to imports. This option allows JS bundlers to handle imported files.', action = 'store_true')
        self.argParser.add_argument ('--npm', help = 'reference the transcrypt npm repository (node_modules/transcrypt) for transcrypt modules.', action = 'store_true')
