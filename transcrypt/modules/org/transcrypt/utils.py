...
class CommandArgs:
    def parse (self):
        ...
        self.argParser.add_argument ('--npm', help = 'enable npm bundler mode, which compiles the specified file only (no recursing to imports) and references official transcrypt modules on the npm repository.', action = 'store_true')
