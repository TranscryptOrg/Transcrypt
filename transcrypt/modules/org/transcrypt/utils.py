...
class CommandArgs:
    def parse (self):
        ...
        self.argParser.add_argument ('-sh', '--shallow', help = 'compile only the source file without recursing to imports. This option allows JS bundlers to handle imported files.', action = 'store_true')
