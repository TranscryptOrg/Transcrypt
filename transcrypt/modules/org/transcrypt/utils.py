...
class CommandArgs:
    def parse (self):
        ...
        self.argParser.add_argument ('-jc', '--jscall', help = "allow JavaScript-style calls for Python methods. This is fast, but breaks bound method assignment", action = 'store_true')
