// Transcrypt'ed from Python, 2018-03-11 20:22:37
"use strict";
...
Array.prototype.__bindexOf__ (element) {
    element += '';
    var mindex = 0;
...
String.prototype.rsplit (sep, maxsplit) {
...
String.prototype.py_split (sep, maxsplit) {
    if (sep == undefined || sep == null) {
        sep = /\s+/;
        var stripped = this.strip ();
    }
