...
# END predef_aliases
		...
		'''
		The priorities explicitly given as integers in the list below are JavaScript priorities as specified by:
		https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Operator_Precedence .
		
		Python priorities are implicitly present in branch ordering of the AST generated by CPython's parser.
		'''
