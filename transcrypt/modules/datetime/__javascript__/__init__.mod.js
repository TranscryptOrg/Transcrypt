		...
		'datetime', {
			__all__: {
				...
				__init__: function (__all__) {
					...
					var _time =  __init__ (__world__.time);
					var _math =  __init__ (__world__.math);
					...
					var _DAYS_IN_MONTH = list ([-(1), 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]);
					var _DAYS_BEFORE_MONTH = list ([-(1)]);
					var dbm = 0;
					var __iterable0__ = _DAYS_IN_MONTH.__getslice__ (1, null, 1);
					...
					var _MONTHNAMES = list ([null, 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']);
					var _DAYNAMES = list ([null, 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']);
					...
					var timedelta = __class__ ('timedelta', [object], {
						...
						get __repr__ () {return __get__ (this, function (self) {
							if (self._microseconds) {
								return 'datetime.timedelta({}, {}, {})'.format (self._days, self._seconds, self._microseconds);
							}
							if (self._seconds) {
								return 'datetime.timedelta({}, {})'.format (self._days, self._seconds);
							}
					...
					var _td_min = timedelta (-(999999999));
					...
					var _tzinfo_class = tzinfo;
					var time = __class__ ('time', [object], {
						__module__: __name__,
					...
					var _time_class = time;
					var _tm_min = time (0, 0, 0);
					var _tm_max = time (23, 59, 59, 999999);
					...
					var datetime = __class__ ('datetime', [date], {
						...
						get astimezone () {return __get__ (this, function (self, tz) {
							...
							if (tz === null) {
								...
								var local = datetime.apply (null, localtm.__getslice__ (0, 6, 1));
								if (len (localtm) > 9) {
									...
									var delta = __sub__ (local, __call__.apply (null, [datetime].concat ([null]).concat (__getslice__ (__call__ (_time.gmtime, _time, ts), 0, 6, 1))));
						...
						get strptime () {return __getcm__ (this, function (cls, date_string, format) {
							return cls.apply (null, _time.strptime (date_string, format).__getslice__ (0, 6, 1));
						});},
						get utcoffset () {return __get__ (this, function (self) {
							if (self._tzinfo === null) {
								return null;
					...
					var _Omitted = '@#$^&$^';
					var timezone = __class__ ('timezone', [tzinfo], {
						__module__: __name__,
					...
					var _tz_utc = timezone._create (timedelta (0));
					var _tz_min = timezone._create (timezone._minoffset);
					var _tz_max = timezone._create (timezone._maxoffset);
					...
					var _EPOCH = datetime (1970, 1, 1, __kwargtrans__ ({tzinfo: timezone.utc}));
					__pragma__ ('<use>' +
						'math' +
						'time' +
					'</use>')
					__pragma__ ('<all>')
						__all__.MAXYEAR = MAXYEAR;
						__all__.MINYEAR = MINYEAR;
						__all__._DAYNAMES = _DAYNAMES;
						__all__._DAYS_BEFORE_MONTH = _DAYS_BEFORE_MONTH;
						__all__._DAYS_IN_MONTH = _DAYS_IN_MONTH;
						__all__._DI100Y = _DI100Y;
						__all__._DI400Y = _DI400Y;
						__all__._DI4Y = _DI4Y;
						__all__._EPOCH = _EPOCH;
						__all__._MAXORDINAL = _MAXORDINAL;
						__all__._MONTHNAMES = _MONTHNAMES;
						__all__._Omitted = _Omitted;
						__all__.__name__ = __name__;
						__all__._build_struct_time = _build_struct_time;
						__all__._check_date_fields = _check_date_fields;
						__all__._check_int_field = _check_int_field;
						__all__._check_time_fields = _check_time_fields;
						__all__._check_tzinfo_arg = _check_tzinfo_arg;
						__all__._check_tzname = _check_tzname;
						__all__._check_utc_offset = _check_utc_offset;
						__all__._cmp = _cmp;
						__all__._cmperror = _cmperror;
						__all__._d_max = _d_max;
						__all__._d_min = _d_min;
						__all__._date_class = _date_class;
						__all__._days_before_month = _days_before_month;
						__all__._days_before_year = _days_before_year;
						__all__._days_in_month = _days_in_month;
						__all__._divide_and_round = _divide_and_round;
						__all__._dt_max = _dt_max;
						__all__._dt_min = _dt_min;
						__all__._format_time = _format_time;
						__all__._is_leap = _is_leap;
						__all__._isoweek1monday = _isoweek1monday;
						__all__._ord2ymd = _ord2ymd;
						__all__._td_max = _td_max;
						__all__._td_min = _td_min;
						__all__._td_resolution = _td_resolution;
						__all__._time_class = _time_class;
						__all__._tm_max = _tm_max;
						__all__._tm_min = _tm_min;
						__all__._tz_max = _tz_max;
						__all__._tz_min = _tz_min;
						__all__._tz_utc = _tz_utc;
						__all__._tzinfo_class = _tzinfo_class;
						__all__._wrap_strftime = _wrap_strftime;
						__all__._ymd2ord = _ymd2ord;
						__all__.date = date;
						__all__.datetime = datetime;
						__all__.dbm = dbm;
						__all__.dim = dim;
						__all__.divmod = divmod;
						__all__.modf = modf;
						__all__.rjust = rjust;
						__all__.time = time;
						__all__.timedelta = timedelta;
						__all__.timezone = timezone;
						__all__.tzinfo = tzinfo;
						__all__.zfill = zfill;
					__pragma__ ('</all>')
				}
			}
