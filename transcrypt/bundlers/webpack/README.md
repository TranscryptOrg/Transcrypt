...
===============================================
*Adds a `Py3 -> Javascript` transpiler to your [Wepack](https://webpack.js.org/) build tool chain.*
...
This package is exactly that glue: it runs [Transcrypt](http://www.transcrypt.org/) (the `.py -> .js` transpiler) whenever [Wepack](https://webpack.js.org/) finds a `.py` file, effectively turning *Python* into *Javascript* automagically.
...
2. Install [npm](https://npmjs.org/) and [Wepack](https://webpack.js.org/). Instructions are at the websites.
