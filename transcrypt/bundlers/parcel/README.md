...
- **Why parcel-plugin-transcrypt?** To glue it all together. Just don't inhale too much.
...
2. Install [npm](https://npmjs.org/) and [Parcel](https://parceljs.org/). Instructions are at the websites.
3. Create an empty folder, and initialize npm: `npm init`. (all commands are done in a console within your project directory)
4. Install Parcel: `npm install parcel-bundler --save-dev`
5. Ensure Parcel runs within your project folder: `npx parcel --help`
6. Install this plugin: `npm install parcel-plugin-transcrypt --save-dev`
...
"devDependencies": {
    ...
    "parcel-plugin-transcrypt": "^1.0.3"
}
```
...
See the `transcrypt/development/manual_tests/parcel` directory (in the main Transcrypt source code) for testing the plugin itself.
