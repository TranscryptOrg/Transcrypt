...
2.	From the command prompt run *transcrypt -b -c -da autotest.py*. This will compile the autotests into file *autotest.js* and put it into the *__target__* subdirectory. Do NOT go to that directory (there's no need, stay where you went at point 4)
