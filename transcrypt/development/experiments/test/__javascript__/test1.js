"use strict";
// Transcrypt'ed from Python, 2018-01-13 11:36:36
function test1 () {
	...
	(function () {
		...
		var LOOPS = 50000;
		var clock = __init__ (__world__.time).clock;
		var __version__ = '1.1';
		...
		var Array2Glob = map ((function __lambda__ (x) {
			return x.__getslice__ (0, null, 1);
		}), list ([Array1Glob]) * 51);
		var PtrGlb = null;
		var PtrGlbNext = null;
		...
		if (__name__ == '__main__') {
			...
			var error = function (msg) {
				tuple ([print >> sys.stderr, msg]);
				tuple ([print >> sys.stderr, __mod__ ('usage: %s [number_of_loops]', sys.argv [0])]);
				sys.exit (100);
			};
...
//# sourceMappingURL=extra/sourcemap/test1.js.map
