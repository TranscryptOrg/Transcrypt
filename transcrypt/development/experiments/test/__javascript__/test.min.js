...
function test(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}function t(a){if(null==a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=t(a[d]));return b}function l(a){return a?[].slice.apply(a):[]}function q(a){a=a?[].slice.apply(a):[];a.__class__=q;return a}function r(a){var b=[];if(a)for(var d=0;d<a.length;d++)b.add(a[d]);b.__class__=r;return b}function O(a,b){if(void 0==a)return new Uint8Array(0);b=H(a);if(b==C)return new Uint8Array(a);if(b==
u){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==l||b==q)return new Uint8Array(a);throw R;}function u(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function S(a){return this.hasOwnProperty(a)}function T(){var a=[],b;for(b in this)D(b)||a.push(b);return a}function U(){var a=[],b;for(b in this)D(b)||a.push([b,this[b]]);return a}function V(a){delete this[a]}function W(){for(var a in this)delete this[a]}
function X(a,b){var d=this[a];void 0==d&&(d=this["py_"+a]);return void 0==d?void 0==b?null:b:d}function Y(a,b){var d=this[a];if(void 0!=d)return d;b=void 0==b?null:b;return this[a]=b}function Z(a,b){var d=this[a];if(void 0!=d)return delete this[a],d;if(void 0===b)throw K(a,Error());return b}function aa(){var a=Object.keys(this)[0];if(null==a)throw K("popitem(): dictionary is empty",Error());var b=q([a,this[a]]);delete this[a];return b}function ba(a){for(var b in a)this[b]=a[b]}function ca(){var a=
[],b;for(b in this)D(b)||a.push(this[b]);return a}function da(a){return this[a]}function ea(a,b){this[a]=b}function z(a){var b={};if(!a||a instanceof Array){if(a)for(var d=0;d<a.length;d++){var c=a[d];if(!(c instanceof Array)||2!=c.length)throw L("dict update sequence element #"+d+" has length "+c.length+"; 2 is required",Error());var e=c[0];c=c[1];!(a instanceof Array)&&a instanceof Object&&(A(a,z)||(c=z(c)));b[e]=c}}else if(A(a,z))for(c=a.py_keys(),d=0;d<c.length;d++)e=c[d],b[e]=a[e];else if(a instanceof
Object)b=a;else throw L("Invalid type of object for dict creation",Error());k(b,"__class__",{value:z,enumerable:!1,writable:!0});k(b,"__contains__",{value:S,enumerable:!1});k(b,"py_keys",{value:T,enumerable:!1});k(b,"__iter__",{value:function(){new g(this.py_keys())},enumerable:!1});k(b,Symbol.iterator,{value:function(){new f(this.py_keys())},enumerable:!1});k(b,"py_items",{value:U,enumerable:!1});k(b,"py_del",{value:V,enumerable:!1});k(b,"py_clear",{value:W,enumerable:!1});k(b,"py_get",{value:X,
enumerable:!1});k(b,"py_setdefault",{value:Y,enumerable:!1});k(b,"py_pop",{value:Z,enumerable:!1});k(b,"py_popitem",{value:aa,enumerable:!1});k(b,"py_update",{value:ba,enumerable:!1});k(b,"py_values",{value:ca,enumerable:!1});k(b,"__getitem__",{value:da,enumerable:!1});k(b,"__setitem__",{value:ea,enumerable:!1});return b}var c={},E=function(a,b,d){if(""!=b){b=b.split(".");for(var c=b.length,e=0;e<b.length;e++){if(!a.hasOwnProperty(b[e])){c=e;break}a=a[b[e]]}for(e=c;e<b.length;e++)a[b[e]]={},a=a[b[e]]}for(var f in d)a[f]=
d[f]};c.__nest__=E;var M=function(a){a.__inited__||(a.__all__.__init__(a.__all__),a.__inited__=!0);return a.__all__};c.__init__=M;var m=function(a,b,d){return a&&(a.hasOwnProperty("__class__")||"string"==typeof a||a instanceof String)?(d&&Object.defineProperty(a,d,{value:function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))},writable:!0,enumerable:!0,configurable:!0}),function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))}):b};c.__get__=m;c.__getcm__=
function(a,b,d){return a.hasOwnProperty("__class__")?function(){var d=[].slice.apply(arguments);return b.apply(null,[a.__class__].concat(d))}:function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))}};c.__getsm__=function(a,b,d){return b};var B={__name__:"type",__bases__:[],__new__:function(a,b,d,c){for(var e,n=function(){var a=[].slice.apply(arguments);return n.__new__(a)},f=d.length-1;0<=f;f--){var g=d[f],h;for(h in g)e=Object.getOwnPropertyDescriptor(g,h),Object.defineProperty(n,
h,e)}n.__metaclass__=a;n.__name__=b.startsWith("py_")?b.slice(3):b;n.__bases__=d;for(h in c)e=Object.getOwnPropertyDescriptor(c,h),Object.defineProperty(n,h,e);return n}};B.__metaclass__=B;c.py_metatype=B;var v={__init__:function(a){},__metaclass__:B,__name__:"object",__bases__:[],__new__:function(a){var b=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[b].concat(a));return b}};c.object=v;var p=function(a,b,d,c){void 0===c&&(c=b[0].__metaclass__);return c.__new__(c,
a,b,d)};c.__class__=p;c.__pragma__=function(){};E(c,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(a){var b=p("__Envir__",[v],{__module__:"org.transcrypt.__base__",get __init__(){return m(this,function(a){a.interpreter_name="python";a.transpiler_name="transcrypt";a.transpiler_version="3.6.95";a.target_subdir="__javascript__"})}}),d=b();a.__Envir__=b;a.__envir__=d;a.__name__="org.transcrypt.__base__"}}});E(c,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(a){var b=
p("Exception",[v],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a){var b=z();if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){var c=arguments[d--],e;for(e in c)switch(e){case "self":a=c[e];break;default:b[e]=c[e]}delete b.__kwargtrans__}d=q([].slice.apply(arguments).slice(1,d+1))}else d=q();a.__args__=d;try{a.stack=b.error.stack}catch(pa){a.stack="No stack trace available"}})},get __repr__(){return m(this,
function(a){return x(a.__args__)?"{}{}".format(a.__class__.__name__,I(q(a.__args__))):"{}()".format(a.__class__.__name__)})},get __str__(){return m(this,function(a){return 1<x(a.__args__)?u(q(a.__args__)):x(a.__args__)?u(a.__args__[0]):""})}}),d=p("IterableError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d){b.__init__(a,"Can't iterate over non-iterable",y({error:d}))})}}),c=p("StopIteration",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,
function(a,d){b.__init__(a,"Iterator exhausted",y({error:d}))})}}),e=p("ValueError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),f=p("KeyError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),g=p("AssertionError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){d?b.__init__(a,d,y({error:c})):b.__init__(a,
y({error:c}))})}}),h=p("NotImplementedError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),k=p("IndexError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),l=p("AttributeError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),t=p("py_TypeError",[b],{__module__:"org.transcrypt.__standard__",
get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),r=p("Warning",[b],{__module__:"org.transcrypt.__standard__"}),B=p("UserWarning",[r],{__module__:"org.transcrypt.__standard__"}),C=p("DeprecationWarning",[r],{__module__:"org.transcrypt.__standard__"}),D=p("RuntimeWarning",[r],{__module__:"org.transcrypt.__standard__"}),A=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=null;if("undefined"==typeof d||null!=d&&d.hasOwnProperty("__kwargtrans__"))d=
...
[v],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a){a.buffer="";try{a.element=document.getElementById("__terminal__")}catch(oa){a.element=null}a.element&&(a.element.style.overflowX="auto",a.element.style.boxSizing="border-box",a.element.style.padding="5px",a.element.innerHTML="_")})},get print(){return m(this,function(a){var b=" ";var d="\n";if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){var e=arguments[c--],
n;for(n in e)switch(n){case "self":a=e[n];break;case "sep":b=e[n];break;case "end":d=e[n]}}var f=q([].slice.apply(arguments).slice(1,c+1))}else f=q();a.buffer="{}{}{}".format(a.buffer,b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(u(b[d]));return a}()),d).__getslice__(-4096,null,1);a.element?(a.element.innerHTML=a.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),a.element.scrollTop=a.element.scrollHeight):console.log(b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(u(b[d]));
...
d;a.KeyError=f;a.NotImplementedError=h;a.RuntimeWarning=D;a.StopIteration=c;a.py_TypeError=t;a.UserWarning=B;a.ValueError=e;a.Warning=r;a.__Terminal__=E;a.__name__="org.transcrypt.__standard__";a.__sort__=A;a.__terminal__=G;a.filter=function(a,b){null==a&&(a=F);for(var d=[],c=0;c<x(b);c++){var e=b[c];a(e)&&d.append(e)}return d};a.map=function(a,b){for(var d=[],c=0;c<x(b);c++)d.append(a(b[c]));return d};a.sorted=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=
null;if("undefined"==typeof d||null!=d&&d.hasOwnProperty("__kwargtrans__"))d=!1;if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__"))for(e in c=arguments[c--],c)switch(e){case "iterable":a=c[e];break;case "key":b=c[e];break;case "reverse":d=c[e]}}var e=H(a)==z?w(a.py_keys()):w(a);A(e,b,d);return e}}}});c.__call__=function(){var a=[].slice.apply(arguments);return"object"==typeof a[0]&&"__call__"in a[0]?a[0].__call__.apply(a[1],a.slice(2)):a[0].apply(a[1],
a.slice(2))};E(c,"",M(c.org.transcrypt.__base__));B=c.__envir__;E(c,"",M(c.org.transcrypt.__standard__));var fa=c.Exception,ha=c.StopIteration,L=c.ValueError,K=c.KeyError,ia=c.AssertionError,P=c.IndexError,R=c.py_TypeError,ja=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;var N=c.print;B.executor_name=B.transpiler_name;c.main={__file__:""};c.__except__=null;var y=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=y;c.__globals__=function(a){return A(a,
z)?a:z(a)};c.__super__=function(a,b){for(var d=0;d<a.__bases__.length;d++){var c=a.__bases__[d];if(b in c)return c[b]}throw new fa("Superclass method not found");};c.property=function(a,b){b||(b=function(){});return{get:function(){return a(this)},set:function(a){b(this,a)},enumerable:!0}};var k=function(a,b,d){a.hasOwnProperty(b)||Object.defineProperty(a,b,d)};c.__setProperty__=k;c.assert=function(a,b){if(!a)throw ia(b,Error());};c.__merge__=function(a,b){var d={},c;for(c in a)d[c]=a[c];for(c in b)d[c]=
b[c];return d};c.dir=function(a){var b=[],d;for(d in a)b.push(d.startsWith("py_")?d.slice(3):d);b.sort();return b};c.setattr=function(a,b,d){a[b]=d};c.getattr=function(a,b){return b in a?a[b]:a["py_"+b]};c.hasattr=function(a,b){try{return b in a||"py_"+b in a}catch(d){return!1}};c.delattr=function(a,b){b in a?delete a[b]:delete a["py_"+b]};c.__in__=function(a,b){return void 0===b||null===b?!1:b.__contains__ instanceof Function?b.__contains__(a):b.indexOf?-1<b.indexOf(a):b.hasOwnProperty(a)};var D=
function(a){return a.startswith("__")&&a.endswith("__")||"constructor"==a||a.startswith("py_")};c.__specialattrib__=D;var x=function(a){if(void 0===a||null===a)return 0;if(a.__len__ instanceof Function)return a.__len__();if(void 0!==a.length)return a.length;var b=0,d;for(d in a)D(d)||b++;return b};c.len=x;c.__t__=e;var G=function(a){if("inf"==a)return Infinity;if("-inf"==a)return-Infinity;if("nan"==a)return NaN;if(isNaN(parseFloat(a))){if(!1===a)return 0;if(!0===a)return 1;throw L("could not convert string to float: '"+
u(a)+"'",Error());}return+a};G.__name__="float";G.__bases__=[v];c.float=G;var C=function(a){return G(a)|0};C.__name__="int";C.__bases__=[v];c.int=C;var F=function(a){return!!e(a)};F.__name__="bool";F.__bases__=[C];c.bool=F;var H=function(a){var b=typeof a;if("object"==b)try{return"__class__"in a?a.__class__:v}catch(d){return b}else return"boolean"==b?F:"string"==b?u:"number"==b?0==a%1?C:G:null};c.py_typeof=H;var J=function(a,b){if(b instanceof Array){for(var d=0;d<b.length;d++){var c=b[d];if(J(a,
c))return!0}return!1}try{c=a;if(c==b)return!0;for(d=[].slice.call(c.__bases__);d.length;){c=d.shift();if(c==b)return!0;c.__bases__.length&&(d=[].slice.call(c.__bases__).concat(d))}return!1}catch(ka){return a==b||b==v}};c.issubclass=J;var A=function(a,b){try{return"__class__"in a?J(a.__class__,b):J(H(a),b)}catch(d){return J(H(a),b)}};c.isinstance=A;c.callable=function(a){return a&&"object"==typeof a&&"__call__"in a?!0:"function"===typeof a};var I=function(a){try{return a.__repr__()}catch(la){try{return a.__str__()}catch(ma){try{if(null==
a)return"None";if(a.constructor==Object){var b="{",d=!1,c;for(c in a)if(!D(c)){var e=c.isnumeric()?c:"'"+c+"'";d?b+=", ":d=!0;b+=e+": "+I(a[c])}return b+"}"}return"boolean"==typeof a?a.toString().capitalize():a.toString()}catch(na){return"<object of type: "+typeof a+">"}}}};c.repr=I;c.chr=function(a){return String.fromCharCode(a)};c.ord=function(a){return a.charCodeAt(0)};c.max=function(a){return 1==arguments.length?Math.max.apply(null,a):Math.max.apply(null,arguments)};c.min=function(a){return 1==
...
function(a){this.push(a)};Array.prototype.py_clear=function(){this.length=0};Array.prototype.extend=function(a){this.push.apply(this,a)};Array.prototype.insert=function(a,b){this.splice(a,0,b)};Array.prototype.remove=function(a){a=this.indexOf(a);if(-1==a)throw L("list.remove(x): x not in list",Error());this.splice(a,1)};Array.prototype.index=function(a){return this.indexOf(a)};Array.prototype.py_pop=function(a){return void 0==a?this.pop():this.splice(a,1)[0]};Array.prototype.py_sort=function(){ja.apply(null,
...
r(this.slice().sort()),c=0;c<a.length;c++)-1==b.__bindexOf__(a[c])&&b.push(a[c]);return b};Array.prototype.intersection=function(a){this.sort();for(var b=r(),c=0;c<a.length;c++)-1!=this.__bindexOf__(a[c])&&b.push(a[c]);return b};Array.prototype.difference=function(a){a=r(a.slice().sort());for(var b=r(),c=0;c<this.length;c++)-1==a.__bindexOf__(this[c])&&b.push(this[c]);return b};Array.prototype.symmetric_difference=function(a){return this.union(a).difference(this.intersection(a))};Array.prototype.py_update=
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){try{var a=l([1,2,3]);a:{var b=a[10];if("undefined"==typeof b)if(a instanceof Array)if(10<a.length){var d=b;break a}else throw P(10,Error());else throw K(10,Error());d=b}N("a[10]=",d)}catch(n){if(A(n,P))N("indexError");else if(A(n,K))N("KeyError");else throw n;}c.__name__="__main__";c.a=a})();return c}window.test=test();
