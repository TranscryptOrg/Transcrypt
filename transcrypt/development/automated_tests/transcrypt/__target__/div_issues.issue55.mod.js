...
import {f1} from './div_issues.issue55.a.mod.js';
export {f1};
import {p, q, r} from './div_issues.issue55.sub1.mod.js';
export {p, q, r};
import {anA, aB} from './div_issues.issue55.sub2.mod.js';
export {anA, aB};
import {x as y} from './div_issues.issue55.sub3.mod.js';
export {y};