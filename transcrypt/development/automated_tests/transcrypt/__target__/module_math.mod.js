...
import {pi, e, exp, expm1, log, log1p, log2, log10, pow, sqrt, sin, cos, tan, asin, acos, atan, atan2, hypot, degrees, radians, sinh, cosh, tanh, asinh, acosh, atanh, floor, ceil, trunc, isnan, inf, nan} from './math.mod.js';
export {pi, e, exp, expm1, log, log1p, log2, log10, pow, sqrt, sin, cos, tan, asin, acos, atan, atan2, hypot, degrees, radians, sinh, cosh, tanh, asinh, acosh, atanh, floor, ceil, trunc, isnan, inf, nan};
