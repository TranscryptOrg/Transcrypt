// Transcrypt'ed from Python, 2018-08-28 20:47:44
...
__mergefields__ (C, {__reprfields__: new Set (['x', 'y', 'yy', 'z', 'zz', 't', 'w']), __comparefields__: new Set (['y', 'yy', 'z', 'zz', 'w']), __initfields__: new Set (['y', 'yy', 'z', 'zz'])});
