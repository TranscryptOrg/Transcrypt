...
import {HTMLGenerator, DataConverter, JSTesterUI} from './org.transcrypt.autotester.html.mod.js';
export {HTMLGenerator, DataConverter, JSTesterUI};
import * as __module_itertools__ from './itertools.mod.js';
...
export var AutoTester =  __class__ ('AutoTester', [object], {
	...
	get done () {return __get__ (this, function (self) {
		if (__envir__.executor_name == __envir__.transpiler_name) {
			...
			var fnameBase = __main__.__file__.py_replace ('\\', '/').rsplit ('/', 1) [-(1)];
