...
export {dropwhile, combinations_with_replacement, groupby, product, takewhile, cycle, repeat, permutations, tee, combinations, filterfalse, islice, count, chain, accumulate, pow, starmap, compress};
...
export var run = function (autoTester) {
	...
	for (var [key, group] of groupby (things, (function __lambda__ (x) {
		...
		for (var thing of group) {
			autoTester.check ('A {} is a {}.'.format (, key));
		}
		autoTester.check (' ');
	}
