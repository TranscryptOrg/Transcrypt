"use strict";
// Transcrypt'ed from Python, 2017-03-25 12:57:06
function hello_opov () {
				...
				__init__: function (__all__) {
					var __Envir__ = __class__ ('__Envir__', [object], {
						get __init__ () {return __get__ (this, function (self) {
							...
							self.transpiler_version = '3.6.19';
							self.target_subdir = '__javascript__';
						});}
					});
					var __envir__ = __call__ (__Envir__, null);
					__pragma__ ('<all>')
				...
				__init__: function (__all__) {
					var Exception = __class__ ('Exception', [object], {
						...
						get __repr__ () {return __get__ (this, function (self) {
							if (__call__ (len, null, self.__args__)) {
								return __call__ ('{}{}'.format, '{}{}', self.__class__.__name__, __call__ (repr, null, __call__ (tuple, null, self.__args__)));
							}
							else {
								return __call__ ('{}()'.format, '{}()', self.__class__.__name__);
							}
						});},
					...
					var IterableError = __class__ ('IterableError', [Exception], {
						get __init__ () {return __get__ (this, function (self, error) {
							__call__ (Exception.__init__, Exception, self, "Can't iterate over non-iterable", __kwargtrans__ ({error: error}));
						});}
					});
					var StopIteration = __class__ ('StopIteration', [Exception], {
						get __init__ () {return __get__ (this, function (self, error) {
							__call__ (Exception.__init__, Exception, self, 'Iterator exhausted', __kwargtrans__ ({error: error}));
						});}
					});
					var ValueError = __class__ ('ValueError', [Exception], {
						get __init__ () {return __get__ (this, function (self, error) {
							__call__ (Exception.__init__, Exception, self, 'Erroneous value', __kwargtrans__ ({error: error}));
						});}
					});
					var KeyError = __class__ ('KeyError', [Exception], {
						get __init__ () {return __get__ (this, function (self, error) {
							__call__ (Exception.__init__, Exception, self, 'Invalid key', __kwargtrans__ ({error: error}));
						});}
					});
					var AssertionError = __class__ ('AssertionError', [Exception], {
						get __init__ () {return __get__ (this, function (self, message, error) {
							if (message) {
								__call__ (Exception.__init__, Exception, self, message, __kwargtrans__ ({error: error}));
							}
							else {
								__call__ (Exception.__init__, Exception, self, __kwargtrans__ ({error: error}));
							}
						});}
					});
					...
					var __sort__ = function (iterable, key, reverse) {
						...
						if (key) {
							__call__ (iterable.sort, iterable, (function __lambda__ (a, b) {
								if (arguments.length) {
									var __ilastarg0__ = arguments.length - 1;
									if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
										var __allkwargs0__ = arguments [__ilastarg0__--];
							...
							__call__ (iterable.sort, iterable);
						}
						if (reverse) {
							__call__ (iterable.reverse, iterable);
						}
					};
					var sorted = function (iterable, key, reverse) {
						...
						if (__eq__ (py_typeof (iterable), dict)) {
							var result = __call__ (copy, null, __call__ (iterable.py_keys, iterable));
						}
						else {
					...
					var map = function (func, iterable) {
						return function () {
							...
							for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
								...
								__call__ (__accu0__.append, __accu0__, __call__ (func, null, item));
							}
							return __accu0__;
						} ();
					};
					...
					var __Terminal__ = __class__ ('__Terminal__', [object], {
						get __init__ () {return __get__ (this, function (self) {
							self.buffer = '';
							try {
								self.element = __call__ (document.getElementById, document, '__terminal__');
							}
							catch (__except0__) {
								self.element = null;
							}
						...
						get print () {return __get__ (this, function (self) {
							...
							self.buffer = __getslice__ (__call__ ('{}{}{}'.format, '{}{}{}', self.buffer, __call__ (sep.join, sep, function () {
								var __accu0__ = [];
								var __iterable0__ = args;
								for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
									var arg = __getitem__ (__iterable0__, __index0__);
									__call__ (__accu0__.append, __accu0__, __call__ (str, null, arg));
								}
								return __accu0__;
							} ()), end), __neg__ (4096), null, 1);
							if (self.element) {
								self.element.innerHTML = __call__ (self.buffer.py_replace, self.buffer, '\n', '<br>');
								self.element.scrollTop = self.element.scrollHeight;
							}
							else {
								__call__ (console.log, console, __call__ (sep.join, sep, function () {
									var __accu0__ = [];
									var __iterable0__ = args;
									for (var __index0__ = 0; __index0__ < __iterable0__.length; __index0__++) {
										var arg = __getitem__ (__iterable0__, __index0__);
						...
						get input () {return __get__ (this, function (self, question) {
							...
							__call__ (self.print, self, __call__ ('{}'.format, '{}', question), __kwargtrans__ ({end: ''}));
							var answer = __call__ (window.prompt, window, __call__ ('\n'.join, '\n', __getslice__ (__call__ (self.buffer.py_split, self.buffer, '\n'), __neg__ (16), null, 1)));
							__call__ (self.print, self, answer);
							return answer;
						});}
					});
