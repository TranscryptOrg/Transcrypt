"use strict";
// Transcrypt'ed from Python, 2016-11-18 11:28:19
function transcrypt_and_python () {
	...
	*/
	...
	(function () {
		if (__envir__.executor_name == __envir__.transpiler_name) {
			document.getElementById ('output').innerHTML = 'Using Transcrypt'.format (__symbols__);
		}
	}) ();
	return __all__;
}
window ['transcrypt_and_python'] = transcrypt_and_python ();
