...
a.slice(2))};D(c,"",L(c.org.transcrypt.__base__));A=c.__envir__;D(c,"",L(c.org.transcrypt.__standard__));var da=c.Exception,ea=c.StopIteration,J=c.ValueError,N=c.KeyError,fa=c.AssertionError,P=c.py_TypeError,ha=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;A.executor_name=A.transpiler_name;c.main={__file__:""};c.__except__=null;var z=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=z;c.__globals__=function(a){return K(a,y)?a:y(a)};c.__super__=
...
d,c],e):a.__setslice__(b,d,c,e)};(function(){var a=y({}),b=n("Animal",[t],{__module__:"__main__",get __init__(){return h(this,function(b,c,e,f){a[c]=b;b.py_name=c;b.food=e;b.sound=f;b.fed=!1;document.getElementById(b.py_name).innerHTML=b.speak("I was born just now!")})},get speak(){return h(this,function(a,b){return"{} says: ".format(a.py_name)+b})},get feed(){return h(this,function(a){document.getElementById(a.py_name).innerHTML=a.speak(a.fed?"No thanks, I first want to greet you with {}!".format(a.sound):
"Thanks a lot, I am now eating {}!".format(a.food));a.fed=!0})},get greet(){return h(this,function(a){document.getElementById(a.py_name).innerHTML=a.speak(a.fed?"{}, {}, {}!".format(a.sound,a.sound,a.sound):"Sorry, I want to eat {} first!".format(a.food));a.fed=!1})}});c.Animal=b;c.__name__="__main__";c._individuals=a;c.find=function(b){return a[b]}})();return c}window.animals=animals();
