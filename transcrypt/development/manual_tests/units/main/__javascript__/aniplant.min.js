...
function aniplant(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}function r(a){if(null==a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=r(a[d]));return b}function l(a){return a?[].slice.apply(a):[]}function p(a){a=a?[].slice.apply(a):[];a.__class__=p;return a}function q(a){var b=[];if(a)for(var d=0;d<a.length;d++)b.add(a[d]);b.__class__=q;return b}function N(a,b){if(void 0==a)return new Uint8Array(0);b=H(a);if(b==D)return new Uint8Array(a);if(b==
u){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==l||b==p)return new Uint8Array(a);throw Q;}function u(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function R(a){return this.hasOwnProperty(a)}function S(){var a=[],b;for(b in this)A(b)||a.push(b);return a}function T(){var a=[],b;for(b in this)A(b)||a.push([b,this[b]]);return a}function U(a){delete this[a]}function V(){for(var a in this)delete this[a]}
...
a.slice(2))};B(c,"",L(c.org.transcrypt.__base__));C=c.__envir__;B(c,"",L(c.org.transcrypt.__standard__));var ea=c.Exception,fa=c.StopIteration,J=c.ValueError,O=c.KeyError,ha=c.AssertionError,Q=c.py_TypeError,ia=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;var M=c.print;C.executor_name=C.transpiler_name;c.main={__file__:""};c.__except__=null;var y=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=y;c.__globals__=function(a){return K(a,z)?a:z(a)};
c.__super__=function(a,b){for(var d=0;d<a.__bases__.length;d++){var c=a.__bases__[d];if(b in c)return c[b]}throw new ea("Superclass method not found");};c.property=function(a,b){b||(b=function(){});return{get:function(){return a(this)},set:function(a){b(this,a)},enumerable:!0}};var k=function(a,b,d){a.hasOwnProperty(b)||Object.defineProperty(a,b,d)};c.__setProperty__=k;c.assert=function(a,b){if(!a)throw ha(b,Error());};c.__merge__=function(a,b){var d={},c;for(c in a)d[c]=a[c];for(c in b)d[c]=b[c];
return d};c.dir=function(a){var b=[],d;for(d in a)b.push(d.startsWith("py_")?d.slice(3):d);b.sort();return b};c.setattr=function(a,b,d){a[b]=d};c.getattr=function(a,b){return b in a?a[b]:a["py_"+b]};c.hasattr=function(a,b){try{return b in a||"py_"+b in a}catch(d){return!1}};c.delattr=function(a,b){b in a?delete a[b]:delete a["py_"+b]};c.__in__=function(a,b){return void 0===b||null===b?!1:b.__contains__ instanceof Function?b.__contains__(a):b.indexOf?-1<b.indexOf(a):b.hasOwnProperty(a)};var A=function(a){return a.startswith("__")&&
a.endswith("__")||"constructor"==a||a.startswith("py_")};c.__specialattrib__=A;var x=function(a){if(void 0===a||null===a)return 0;if(a.__len__ instanceof Function)return a.__len__();if(void 0!==a.length)return a.length;var b=0,d;for(d in a)A(d)||b++;return b};c.len=x;c.__t__=e;var E=function(a){if("inf"==a)return Infinity;if("-inf"==a)return-Infinity;if("nan"==a)return NaN;if(isNaN(parseFloat(a))){if(!1===a)return 0;if(!0===a)return 1;throw J("could not convert string to float: '"+u(a)+"'",Error());
}return+a};E.__name__="float";E.__bases__=[v];c.float=E;var D=function(a){return E(a)|0};D.__name__="int";D.__bases__=[v];c.int=D;var F=function(a){return!!e(a)};F.__name__="bool";F.__bases__=[D];c.bool=F;var H=function(a){var b=typeof a;if("object"==b)try{return"__class__"in a?a.__class__:v}catch(d){return b}else return"boolean"==b?F:"string"==b?u:"number"==b?0==a%1?D:E:null};c.py_typeof=H;var G=function(a,b){if(b instanceof Array){for(var d=0;d<b.length;d++){var c=b[d];if(G(a,c))return!0}return!1}try{c=
...
c,e],f):a.__setslice__(b,c,e,f)};B(c,"reporter",{__all__:{__inited__:!1,__init__:function(a){M("I am reporter.py, the sub module of the main unit");a.__name__="reporter";a.report=function(){M("report report report")}}}});(function(){var a={};B(a,"",L(c.reporter));M("I am aniplant.py, the main module of the main unit");c.__name__="__main__";c.run=function(){a.report()}})();return c}window.aniplant=aniplant();
